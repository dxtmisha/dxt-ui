// md5:fcef00d4f97bde25805714e4bd76bd8e true
...
/** Special character for deleting mask items @keywords mask delete char */
export declare const MASK_CHAR_DELETE = "~";
/** Default view character for the mask @keywords mask view default */
