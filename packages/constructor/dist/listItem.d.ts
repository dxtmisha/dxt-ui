...
declare type BadgeComponentInclude = {
    badge?: object;
};
 ...
 */
declare class BadgeInclude<Props extends BadgePropsInclude = BadgePropsInclude> {
 ...
 */
declare interface BadgeProps extends BadgePropsBasic, BadgePropsToken {
}
 ...
 */
declare class LabelHighlightInclude extends LabelInclude {
 ...
 */
declare interface LabelHighlightSlots extends LabelSlots {
}
...
export declare class ListItem {
     ...
     * @param emits the function is called when an event is triggered/ функция вызывается, когда срабатывает событие
     */
    constructor(props: ListItemProps, refs: ToRefs<ListItemProps>, element: Ref<HTMLElement | undefined>, classDesign: string, className: string, components?: DesignComp<ListItemComponents, ListItemProps> | undefined, slots?: ListItemSlots | undefined, emits?: ConstrEmit<ListItemEmits> | undefined);
    /** tag type/ тип тега */
    ...
    readonly bindsAndOpen: ComputedRef<{
        onClick: (event: MouseEvent, options?: EventClickValue_2) => void;
        id?: string;
        role: RoleType_2;
        tabindex: NumberOrString_2;
 ...
 */
export declare type ListItemClasses = {
    main: ConstrClass;
    body: string;
    context: string;
    label: string;
...
export declare type ListItemComponentInclude = {
    listItem?: object;
};
 ...
 */
export declare type ListItemComponents = IconComponentInclude & BadgeComponentInclude & ProgressComponentInclude & RippleComponentsInclude;
 ...
 */
export declare type ListItemEmits = EventClickEmits;
 ...
 */
export declare interface ListItemExpose extends EventClickExpose {
}
 ...
 */
export declare interface ListItemSlots extends LabelHighlightSlots, DescriptionSlots, PrefixSlots, CaptionSlots, SuffixSlots {
