...
import { isFilled as t } from "@dxtmisha/functional";
import { toCamelCase as n, toKebabCase as r } from "@dxtmisha/functional-basic";
//#region src/classes/Plugin/PluginTool.ts
var i = class {
	static isSrc(e) {
	...
	isVue() {
		return i.isVue(this.id);
	}
	isScss() {
		return i.isCss(this.id);
	}
	get() {
		return this.newCode;
	}
...
}, o = /* @__PURE__ */ "flex-position.flex-dynamic.justify-content.inset.horizon.vertically.left.right.absolute.absolute-top.absolute-bottom.absolute-after.padding-x.padding-y.padding-left.padding-right.margin-x.margin-y.margin-left.margin-right.width.height.width-basis.height-basis.aspect-ratio.aspect-ratio-width.aspect-ratio-height.squared.circle.font-size.line-height.text-align.text-overflow.clamp.text-select-none.text-case.paragraph-spacing.palette.palette-var.palette-color.palette-stroke.palette-background.palette-fill.palette-gradient.palette-border.color.color-opacity.stroke.stroke-opacity.background-color.background-opacity.background-size.fill.fill-opacity.gradient.gradient-opacity.border-color.border-opacity.translate-x.translate-y.scale.rotate".split("."), s = class {
	...
	is() {
		return this.code.isScss() && t(this.code.getCode()) && !this.code.has(this.getIgnoreComment());
	}
	getIgnoreComment() {
	...
	constructor(t, n, r, i, a, o = "vite-plugin-design-ui", c = {}) {
		e(this, "data", void 0), e(this, "first", !0), e(this, "mode", "production"), this.design = t, this.packageName = n, this.componentsReg = r, this.styleVarsReg = i, this.componentsList = a, this.name = o, this.options = c, this.data = new s(t, n, r, i, a);
	}
	init() {
		var e;
		return {
	...
	transform(e, t) {
		this.first && i.isJs(t) && (e = this.initMain(e), this.first = !1);
		let n = new a(t, e);
		return this.makeComponents(n), this.initStyles(n), { code: n.get() };
	}
	initMain(e) {
		let t = new c(this.packageName, e);
...
//#endregion
export { s as a, c as i, u as n, a as o, l as r, i as s, d as t };
