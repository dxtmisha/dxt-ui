 ...
 * Тип, описывающий подклассы.
 */
export declare type SectionClasses = {
    main: ConstrClass;
    headline: string;
    header: string;
    label: string;
 ...
 * Интерфейс для описания, какие компоненты надо подключить для работы.
 */
export declare type SectionComponents = BlockComponents;
 ...
 * Тип, описывающий доступные события.
 */
export declare type SectionEmits = BlockEmits;
 ...
 * Тип, описывающий доступные свойства.
 */
export declare interface SectionExpose extends BlockExpose {
}
 ...
 * Тип, описывающий входящие свойства.
 */
export declare interface SectionProps extends SectionPropsBasic, SectionPropsToken {
}

export declare interface SectionPropsBasic<Icon extends IconPropsBasic = IconPropsBasic> extends BlockPropsBasic<Icon> {
}

declare interface SectionPropsToken {
}
 ...
 * Тип, описывающий доступные слоты.
 */
export declare interface SectionSlots extends BlockSlots {
}
