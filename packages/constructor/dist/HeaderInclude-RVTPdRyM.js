...
var i = class {
	constructor(i, a, o, s, c, l, u) {
		e(this, "is", t(() => !!(this.components && (this.props.label || this.props.caption || this.props.icon || this.props.headerAttrs)))), e(this, "binds", t(() => r(n(this.extra), this.props.headerAttrs, {
