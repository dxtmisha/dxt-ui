...
import { EventItem as n, getRef as r, isDomRuntime as i, isFunction as a } from "@dxtmisha/functional";
...
var o = class {
	...
	getElement() {
		return a(this.element) ? this.element() : r(this.element);
	}
	findFirstElement() {
		var e;
	...
	findLastElement() {
		var e;
		let t = (e = this.getElement()) == null ? void 0 : e.querySelectorAll("*");
		if (console.log("elements", t), t) for (let e = t.length - 1; e >= 0; e--) {
			let n = t[e];
