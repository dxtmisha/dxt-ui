...
import { ListListInput } from '@dxtmisha/functional';
...
declare type ChipComponentInclude = {
    chip?: object;
};
 ...
 */
export declare type ChipGroupClasses = {
    main: ConstrClass;
    item: string;
};
 ...
 */
export declare type ChipGroupComponents = ChipComponentInclude;

export declare type ChipGroupData<Chip extends ChipPropsBasic = ChipPropsBasic> = ListListInput<Chip>;
 ...
 */
export declare type ChipGroupEmits = EventClickEmits & ModelEmitsSelected<ListSelectedList>;
 ...
 */
export declare interface ChipGroupExpose {
}

export declare type ChipGroupItem<Chip extends ChipPropsBasic = ChipPropsBasic> = ConstrBind<Chip>;

export declare type ChipGroupList<Chip extends ChipPropsBasic = ChipPropsBasic> = ChipGroupItem<Chip>[];
 ...
 */
export declare interface ChipGroupProps extends ChipGroupPropsBasic, ChipGroupPropsToken {
}

export declare interface ChipGroupPropsBasic<Chip extends ChipPropsBasic = ChipPropsBasic> extends ModelPropsSelected<ListSelectedList> {
    readonly?: boolean;
...
declare interface ChipGroupPropsToken {
}
 ...
 */
export declare interface ChipGroupSlots {
    default?(props: any): any;
}

declare interface ChipPropsBasic<Icon extends IconPropsBasic = IconPropsBasic, Progress extends ProgressPropsBasic = ProgressPropsBasic> extends ButtonPropsBasic<Icon, Progress> {
}
 ...
 */
declare class ModelValueInclude<Value = any> {
