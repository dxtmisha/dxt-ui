 ...
 */
export declare type DialogClasses = {
    main: ConstrClass;
    title: string;
    header: string;
    information: string;
 ...
 */
export declare type DialogComponents = ModalComponents & IconComponentInclude;
 ...
 */
export declare type DialogEmits = ModalEmits & {
    ok: [];
    close: [];
};
 ...
 * Тип, описывающий доступные свойства.
 */
export declare interface DialogExpose extends ModalExpose {
}
...
declare interface DialogPropsToken {
    success?: boolean;
    error?: boolean;
 ...
 */
export declare interface DialogSlots extends ModalSlots, LabelAlternativeSlots, DescriptionSlots {
}
