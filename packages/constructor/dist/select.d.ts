...
declare type MenuComponentInclude = {
    menu?: object;
};

declare type MenuControlBasic = ListExpose & {
    loading: Ref<boolean>;
    previous(): NumberOrStringOrBoolean | undefined;
    next(): NumberOrStringOrBoolean | undefined;
};

declare type MenuControlItem = MenuControlBasic & WindowControlItem;
 ...
 * Тип, описывающий доступные свойства.
 */
declare interface MenuExpose extends WindowExposeInclude, MenuControlBasic {
}

/** Type for menu expose functionality/ Тип для функциональности экспорта меню */
declare interface MenuExposeInclude {
 ...
 */
declare class MenuInclude<Props extends MenuPropsInclude = MenuPropsInclude, PropsExtra extends ConstrBind<MenuProps> = ConstrBind<MenuProps>> {
    protected readonly props: Readonly<Props>;
 ...
 * Тип, описывающий входящие свойства.
 */
declare interface MenuProps extends MenuPropsBasic, MenuPropsToken {
}

declare interface MenuPropsBasic<List extends ListPropsBasic = ListPropsBasic, ListItem extends ListItemPropsBasic = ListItemPropsBasic, Bars extends BarsPropsBasic = BarsPropsBasic, Window extends WindowPropsBasic = WindowPropsBasic> extends BarsPropsInclude<Bars>, WindowPropsInclude<Window>, ModelPropsSelected {
    selected?: ListSelectedList;
    hideList?: boolean;
    list?: ListRecord<ListItem>;
    liteThreshold?: number;
...
declare interface MenuPropsInclude<Menu extends MenuPropsBasic = MenuPropsBasic> {
    disabled?: boolean;
 ...
 * Тип, описывающий доступные слоты.
 */
declare type MenuSlots = ListSlots & MenuSlotInclude & {
 ...
 */
export declare type SelectComponents = MenuComponentInclude & FieldComponentInclude & SelectValueComponentInclude & InputComponentInclude;
 ...
 */
export declare type SelectEmits = FieldBasicEmits;
 ...
 * Тип, описывающий доступные свойства.
 */
export declare interface SelectExpose extends FieldBasicExpose, MenuExposeInclude {
}
...
declare interface SelectPropsToken {
}
 ...
 * Тип, описывающий доступные слоты.
 */
export declare interface SelectSlots extends FieldSlotsInclude, MenuSlotInclude {
}
 ...
 */
declare type SelectValueComponentInclude = {
    selectValue?: object;
};
