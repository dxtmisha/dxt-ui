 ...
 */
export declare type ModalComponents = WindowComponentInclude & BarsComponentInclude & ActionsComponentInclude;
 ...
 */
export declare type ModalEmits = WindowEmitsInclude & BarsEmitsInclude & ActionsEmitsInclude;
 ...
 * Тип, описывающий доступные свойства.
 */
export declare interface ModalExpose extends WindowExposeInclude {
}
 ...
 * Тип, описывающий входящие свойства.
 */
export declare interface ModalProps extends ModalPropsBasic, ModalPropsToken {
}

export declare interface ModalPropsBasic<Window extends WindowPropsBasic = WindowPropsBasic, Bars extends BarsPropsBasic = BarsPropsBasic, Actions extends ActionsPropsBasic = ActionsPropsBasic, Image extends ImagePropsBasic = ImagePropsBasic> extends WindowPropsInclude<Window>, BarsPropsInclude<Bars>, ActionsPropsInclude<Actions>, ImagePropsInclude<Image> {
    open?: boolean;
}
 ...
 */
export declare interface ModalSlots extends WindowSlots {
