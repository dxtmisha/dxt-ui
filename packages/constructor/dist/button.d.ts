...
export declare type ButtonComponentInclude = {
    button?: object;
};
 ...
 */
export declare type ButtonComponents = IconComponentInclude & ProgressComponentInclude & RippleComponentsInclude;
 ...
 */
export declare type ButtonEmits = EventClickEmits;
 ...
 */
export declare interface ButtonExpose extends LabelExpose, EventClickExpose {
}
 ...
 */
export declare interface ButtonProps extends ButtonPropsBasic, ButtonPropsToken {
}

export declare interface ButtonPropsBasic<Icon extends IconPropsBasic = IconPropsBasic, Progress extends ProgressPropsBasic = ProgressPropsBasic> extends LabelProps, EnabledProps, IconTrailingPropsInclude<Icon>, ProgressPropsInclude<Progress>, SkeletonPropsInclude, EventClickProps, AriaLabelPropsInclude {
    tag?: 'button' | 'a' | 'span' | string;
    type?: 'button' | 'submit' | 'reset' | string;
}

export declare interface ButtonPropsInclude<Button extends ButtonPropsBasic = ButtonPropsBasic> {
    buttonAttrs?: ConstrBind<Button>;
}

declare interface ButtonPropsToken {
    focus?: boolean;
    disabled?: boolean;
    selected?: boolean;
    readonly?: boolean;
 ...
 */
export declare interface ButtonSlots extends LabelSlots {
}
