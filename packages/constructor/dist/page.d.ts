 ...
 */
declare type BlockComponents = IconComponentInclude;

/**
 * BlockDesign
 */
declare class BlockDesign<COMP extends BlockComponents, EXPOSE extends BlockExpose, CLASSES extends BlockClasses, P extends BlockPropsBasic> extends DesignConstructorAbstract<HTMLDivElement, COMP, BlockEmits, EXPOSE, BlockSlots, CLASSES, P> {
 ...
 */
declare interface BlockExpose extends LabelExpose, DescriptionExpose {
}
 ...
 */
declare interface BlockProps extends BlockPropsBasic, BlockPropsToken {
}

declare interface BlockPropsBasic<Icon extends IconPropsBasic = IconPropsBasic> extends LabelProps, DescriptionProps, CaptionProps, IconPropsInclude<Icon> {
    headline?: string;
    tag?: string;
    tagHeader?: string;
}
 ...
 */
declare interface BlockSlots extends LabelAlternativeSlots, DescriptionSlots, CaptionSlots {
 ...
 * Page
 */
export declare class Page extends Block {
}
 ...
 * Тип, описывающий подклассы.
 */
export declare type PageClasses = {
    main: ConstrClass;
    headline: string;
    header: string;
    label: string;
 ...
 * Интерфейс для описания, какие компоненты надо подключить для работы.
 */
export declare type PageComponents = BlockComponents;
 ...
 * Тип, описывающий доступные события.
 */
export declare type PageEmits = BlockEmits;
 ...
 * Тип, описывающий доступные свойства.
 */
export declare interface PageExpose extends BlockExpose {
}
 ...
 * Тип, описывающий входящие свойства.
 */
export declare interface PageProps extends PagePropsBasic, PagePropsToken {
}

export declare interface PagePropsBasic<Icon extends IconPropsBasic = IconPropsBasic> extends BlockPropsBasic<Icon> {
}

declare interface PagePropsToken {
}
 ...
 * Тип, описывающий доступные слоты.
 */
export declare interface PageSlots extends BlockSlots {
}
