...
export declare class ListMenu {
     ...
     */
    constructor(props: ListMenuProps, refs: ToRefs<ListMenuProps>, element: Ref<HTMLElement | undefined>, classDesign: string, className: string, components?: DesignComp<ListMenuComponents, ListMenuProps> | undefined, slots?: ListMenuSlots | undefined, emits?: ConstrEmit<ListMenuEmits> | undefined);
}
 ...
 */
export declare type ListMenuClasses = {
    main: ConstrClass;
    head: string;
    list: string;
};

export declare type ListMenuComponentInclude = {
    listMenu?: object;
};
 ...
 */
export declare type ListMenuComponents = WindowComponentInclude;
 ...
 */
export declare type ListMenuEmits = WindowEmitsInclude;
 ...
 */
export declare interface ListMenuExpose extends WindowExposeInclude {
}
 ...
 */
export declare interface ListMenuProps extends ListMenuPropsBasic, ListMenuPropsToken {
}

export declare interface ListMenuPropsBasic<Window extends WindowPropsBasic = WindowPropsBasic> extends WindowPropsInclude<Window> {
}

declare interface ListMenuPropsToken {
    open?: boolean;
    axis?: 'x' | 'y';
    divider?: boolean;
}
 ...
 */
export declare interface ListMenuSlots {
