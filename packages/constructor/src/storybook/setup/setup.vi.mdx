...
<Meta title='@dxtmisha/vi/constructor/1. Chuẩn bị dự án'/>
...
- **types**: Chạy toàn bộ chu kỳ xây dựng và cập nhật các kiểu dữ liệu.
- **screenshot**: Khởi chạy kiểm thử hồi quy trực quan và tạo ảnh chụp màn hình.
- **prepublishOnly**: Thực hiện xây dựng hoàn chỉnh, tạo tài liệu và lưu ảnh chụp kiểu dữ liệu trước khi xuất bản gói.
