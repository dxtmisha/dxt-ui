...
export class SegmentControl extends TabsNavigation {
   ...
   */
  constructor(
    protected readonly props: SegmentControlProps,
    protected readonly refs: ToRefs<SegmentControlProps>,
    protected readonly element: Ref<HTMLElement | undefined>,
    protected readonly classDesign: string,
    protected readonly className: string,
    protected readonly components?: DesignComp<SegmentControlComponents, SegmentControlProps>,
