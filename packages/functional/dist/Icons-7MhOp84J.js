...
class it {
   ...
   */
  set(t) {
    return this.value = I(t), this.age = (/* @__PURE__ */ new Date()).getTime(), this.value === void 0 ? this.getMethod()?.removeItem(this.getIndex()) : this.getMethod()?.setItem(this.getIndex(), JSON.stringify({
      value: this.value,
      age: this.age
    })), this.value;
  }
