...
import { i as A, f as C, g as z, a as T, b as q, c as Q, d as H, e as m, h as V, j as v, k, l as y, r as W } from "./isSelected-CHrvJ7iu.js";
import { isRef as K } from "vue";
import { geo as Y } from "@dxtmisha/media";
function $(n) {
  return A(n) ? n() : n;
}
async function X(n) {
...
function _(n, t = "=", e = "&") {
  return C(
    n,
    (s, i) => `${i}${t}${encodeURIComponent(String(s).trim())}`
  ).sort().join(e);
}
function O(n) {
...
class P {
  ...
  constructor(t, e = ["click"], s, i, r) {
     ...
     */
    a(this, "elementControl");
    a(this, "elementControlEdit");
    /**
     ...
     */
    a(this, "listenerRecent", (t) => {
      var e, s;
      q(this.elementControl) ? ((e = this.listener) == null || e.call(this.element, t, this.detail), Q(this.options) && ((s = this.options) != null && s.once) && this.stop()) : this.stop();
    });
    /**
     * Event states.
     *
     ...
     */
    a(this, "activity", !1);
    a(this, "activityItems", []);
    this.listener = s, this.options = i, this.detail = r, this.element = z(t), this.elementControl = T(t), this.type = O(e);
  }
  /**
  ...
  setElement(t) {
    const e = z(t);
    return this.elementControlEdit || (this.elementControl = T(t)), this.element = e, this.reset(), this;
  }
  /**
   ...
   */
  setElementControl(t) {
    return this.elementControl = T(t), this.elementControlEdit = !H(this.elementControl), this.elementControlEdit || (this.elementControl = T(this.element)), this;
  }
  /**
...
const B = "ui-loading", w = class w {
  ...
  static registrationEvent(t, e) {
    m() && new P(window, B, t).setElementControl(e).start();
  }
  /**
...
a(w, "value", 0), a(w, "event"), m() && (w.event = new P(window, B));
let d = w;
function tt(n) {
...
class et {
  ...
  set(t) {
    var e;
    return this.value = $(t), this.age = (/* @__PURE__ */ new Date()).getTime(), this.value === void 0 ? this.remove() : (e = this.getMethod()) == null || e.setItem(this.getIndex(), JSON.stringify({
      value: this.value,
      age: this.age
    })), this.value;
  }
   ...
   */
  isCache(t) {
    return H(t) || this.age && this.age + t * 1e3 >= (/* @__PURE__ */ new Date()).getTime();
  }
  /**
...
const st = "geo-code", g = class g {
  ...
  static getByCode(t) {
    let e;
    return t && (t.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (e = this.getByCodeFull(t)), !e && t.match(/[A-Z]{2}/) && (e = this.getByCountry(this.toCountry(t))), !e && t.match(/[a-z]{2}/) && (e = this.getByLanguage(this.toLanguage(t)))), this.toFull(tt(e != null ? e : this.getList()[0]));
  }
  /**
  ...
  static findLocation() {
    var t;
    return m() && (this.storage.get() || ((t = document.querySelector("html")) == null ? void 0 : t.lang) || navigator.language || navigator.languages[0] || "en-GB") || "en-GB";
  }
  /**
...
a(g, "storage", new et(st)), a(g, "location"), a(g, "item"), a(g, "language"), a(g, "timezone", (/* @__PURE__ */ new Date()).getTimezoneOffset()), g.location = g.findLocation(), g.language = g.findLanguage(g.location), g.item = g.getByCode(g.location);
let E = g;
var it = /* @__PURE__ */ ((n) => (n.get = "GET", n.post = "POST", n.put = "PUT", n.delete = "DELETE", n))(it || {});
const j = "d-response-loading", x = [], h = class h {
  /**
   * Is the server local.
   *
   ...
   */
  static getUrl(t, e = !0) {
    return `${e ? this.url : ""}${t}`.replace("{locale}", E.getLocation()).replace("{country}", E.getCountry()).replace("{language}", E.getLanguage());
  }
  /**
  ...
  static getBodyForGet(t, e = "", s = "GET") {
    if (s === "GET") {
      const i = e.match(/\?/) ? "&" : "?", r = typeof t == "object" ? _(t) : t;
      if (v(r))
        return `${i}${r}`;
    }
    return "";
  ...
  static setPreparation(t) {
    return this.preparationItem = t, h;
  }
  /**
   ...
   */
  static setEnd(t) {
    return this.preparationEndItem = t, h;
  }
  /**
  ...
  static addResponse(t) {
    return this.response.push(...O(t)), h;
  }
  /**
   ...
   */
  static getResponse(t = "", e, s, i) {
    return this.response.find((r) => {
      if ($(R(r == null ? void 0 : r.disable)) !== !0 && (r.path instanceof RegExp && t.match(r.path) || t === r.path) && e === r.method && (x.indexOf(r) === -1 || i)) {
        const o = this.addRequestDefault(r == null ? void 0 : r.request);
        let u = !1;
        if (s === o || o === "*any" ? u = !0 : v(s) && v(o) && y(s) && y(o) && !(s instanceof FormData) && !(o instanceof FormData) && Object.values(s).length === Object.values(o).length && (u = Object.entries(o).reduce(
          (l, [p, c]) => l && (c === (s == null ? void 0 : s[p]) || c === "*any"),
          !0
        )), u)
          return i && console.warn(`Response type: ${r.path}`), x.push(r), !0;
      }
      return !1;
    });
  }
  ...
  static async fetch(t) {
    ...
    const {
      toData: e = !0,
      hideError: s = !1,
      queryReturn: i = void 0,
      globalPreparation: r = !0,
      globalEnd: o = !0
    } = t, u = await this.makeEmulator(t);
    if (u)
      return u;
    let l = {};
    d.show();
    try {
      ...
      const c = await this.makeQuery(t), f = o && this.preparationEndItem ? await this.makePreparationEnd(c) : {};
      if (this.status = c.status, this.statusText = c.statusText, f != null && f.reset)
        return d.hide(), await this.fetch(t);
      i ? l = await i(c) : "data" in f ? l = f.data : ((p = c.headers.get("Content-Type")) != null ? p : "").match("application/json") ? l = await c.json() : l = { data: await c.text() };
    } catch (c) {
      s && console.error("Api: ", c), this.error = c;
    }
    return d.hide(), this.makeData(l, e);
  }
  /**
  ...
  static fetchResponse(t, e) {
    return this.startResponseLoading(), new Promise((s) => {
      X(
        A(t.response) ? t.response(e) : t.response
      ).then((i) => {
        R(t == null ? void 0 : t.lag) ? (d.show(), setTimeout(() => {
          this.stopResponseLoading(), s(i), d.hide();
        }, W(0, 2e3))) : (this.stopResponseLoading(), s(i));
      });
    });
  }
  /**
  ...
  static async makeEmulator(t) {
    ...
    if (i || r) {
      const o = this.addRequestDefault(t.request), u = this.getResponse(e, s, o, r);
      if (u) {
        const l = await this.fetchResponse(u, o);
        return r && console.warn("Response data:", e, o, l), l;
      }
    }
  }
  /**
  ...
  static async makeQuery(t) {
    const e = this.addRequestDefault(t.request), {
      ...
      init: p = {}
    } = t, c = r != null ? r : this.getUrl(i, s), f = `${c}${this.getBodyForGet(e, c, o)}`, b = this.getHeaders(u, l), N = {
      ...p,
      method: o,
      body: this.getBody(e, o)
    };
    return b && (N.headers = b), await fetch(f, N);
  }
  /**
   ...
   */
  static makeData(t, e) {
    if (this.lastResponse = t, t && y(t) && ("message" in t && (this.lastMessage = String(t.message)), e && "data" in t)) {
      if (y(t.data)) {
        const s = { ...t.data };
  ...
  static startResponseLoading() {
    this.responseLoading && clearTimeout(this.responseLoading), m() && document.body.classList.add(j);
  }
  /**
  ...
  static stopResponseLoading() {
    this.responseLoading = setTimeout(() => {
      this.responseLoading = void 0, m() && document.body.classList.remove(j);
    }, 1200);
  }
};
a(h, "url", "/api/"), a(h, "response", []), a(h, "responseLoading"), a(h, "headers", {}), a(h, "requestDefault"), a(h, "preparation", !1), a(h, "preparationItem"), a(h, "preparationEndItem"), a(h, "status"), a(h, "statusText"), a(h, "error"), a(h, "lastResponse"), a(h, "lastMessage");
let I = h;
const S = "__UI_ICON", M = 320, U = "--LOAD--", L = class L {
  /**
  ...
  static async get(t, e = "", s = 1e3 * 60 * 3) {
    var r, o, u, l;
    const i = (l = (u = (r = this.icons) == null ? void 0 : r[this.getName(t)]) != null ? u : (o = this.icons) == null ? void 0 : o[t]) != null ? l : `${t.replace(/^@/, e != null ? e : this.url)}.svg`;
    return typeof i == "string" ? i === U && s > 0 ? (await this.wait(), this.get(t, e, s - M)) : i : await i;
  }
  /**
   ...
   */
  static getNameList() {
    return C(this.icons, (t, e) => e.replace(/^@/, ""));
  }
  /**
...
a(L, "icons", {}), a(L, "url", "/icons/"), m() && (S in window || (window[S] = {}), L.icons = window[S]);
let G = L;
export {
  I as A,
  et as D,
