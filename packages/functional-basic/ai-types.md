...
export declare class Api {
     ...
     * @returns true if server is localhost
     */
     ...
     * @returns final base URL string
     */
    static getOrigin(): string;
    /**
     * Gets the full path to the request script.
     * @param path path to the script
     * @param api whether to prepend base API URL
     * @returns full URL
     */
     ...
     * @returns body data for non-GET requests or FormData
     */
     ...
     * @param method HTTP method
     * @returns query string for GET requests
     */
     ...
     * @param request default request data
     */
     ...
     * @param pathRequest path or configuration
     * @returns Promise with response data
     */
    static request<T>(pathRequest: string | ApiFetch): Promise<T>;
    /**
     * Sends a GET method request.
     * @param request fetch configuration
     * @returns Promise with response data
     */
...
export declare class ApiCache {
     ...
     * @param getListener mechanism for getting data
     * @param setListener mechanism for setting data
     * @param removeListener mechanism for removing data
     * @param cacheStepAgeClearOld count before cleaning old cache
     */
...
export declare class ApiDataReturn<T = any> {
     ...
     * @param apiFetch API fetch configuration
...
export declare class ApiDefault {
     ...
     * @returns default request data or undefined
     */
    get(): Record<string, any> | undefined;
    /**
     * Adds default data to the request.
     * @param request request data
     * @returns merged request data
     */
...
export declare class ApiError {
     ...
     * @returns error storage instance
     */
    static getStorage(): ApiErrorStorage;
    /**
     * Adds an error item or a list of error items to the storage.
     * @param item error item or list of error items
     * @param url URL pattern or RegExp
     * @param method HTTP method
     */
...
export declare class ApiErrorItem {
     ...
     * @param error matched error item
     */
    ...
    /**
     * Returns the identified error item.
     * @returns error item
     */
    getError(): ApiErrorStorageItem;
    /**
     * Asynchronously retrieves the error code.
...
export declare class ApiErrorStorage {
    /**
     * Finds a matching error item in the storage.
     * @param method API method
     * @param response fetch response
     * @returns matched error item or undefined
     */
    find(method: ApiMethodItem, response: Response): Promise<ApiErrorStorageItem>;
    /**
     * Adds one or more error items to the internal storage.
     * @param item error item or list
     * @param url URL pattern or RegExp
     * @param method HTTP method
...
export declare class ApiHeaders {
     ...
     * @returns merged headers or undefined
     */
     ...
     * @param headers list of default headers
     * @returns this instance
     */
...
export declare class ApiHydration {
     ...
     * @param apiFetch API request configuration
     * @param response API response data
     */
    toClient<T>(apiFetch: ApiFetch, response: T): void;
    /**
     * Returns a string representation of the hydration data.
     */
    toString(): string;
}
...
export declare class ApiResponse {
    ...
    /**
     * Checks if there is a global cached request.
     * @param path link to the request
     * @param method request method
     * @param request request data
     * @param devMode optional dev mode flag
    ...
    /**
     * Returns a list of cached API responses.
     */
     ...
     * @param apiFetch fetch configuration
     * @returns emulated response or undefined
     */
...
import { FormattersType, FormattersOptionsList, FormattersOptionsInformation, FormattersListProp, FormattersItemProp, FormattersReturn, FormattersList } from '../types/formattersTypes';
/**
...
/**
 * The Intl namespace object contains internationalization constructors.
 */
...
export declare class SearchListData<T extends SearchItem, K extends SearchColumns<T>> {
    ...
    forEach(callback: (item: any, value: string) => SearchFormatItem<T, K> | undefined): SearchFormatList<T, K>;
...
import { SearchListOptions } from './SearchListOptions';
/**
 * Class responsible for matching search values.
 */
