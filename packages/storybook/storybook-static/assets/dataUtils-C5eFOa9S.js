...
`})}),`
`,e.jsx(n.h2,{id:"copyobjectlite",children:e.jsx(n.code,{children:"copyObjectLite"})}),`
`,e.jsxs(n.p,{children:["Creates a shallow copy of a simple object. If the ",e.jsx(n.code,{children:"source"})," parameter is passed, creates a new object and merges ",e.jsx(n.code,{children:"value"})," and ",e.jsx(n.code,{children:"source"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"value: T"})," — object to copy"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"source?: any"})," — additional properties to copy (optional)"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { copyObjectLite } from '@dxtmisha/functional'
...
// { name: 'John', age: 25 }
`})}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note:"})," This is a shallow copy — nested objects retain references to the originals. For deep cloning use ",e.jsx(n.code,{children:"copyObject"}),", ",e.jsx(n.code,{children:"structuredClone"})," or ",e.jsx(n.code,{children:"_.cloneDeep"}),"."]}),`
