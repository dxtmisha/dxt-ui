import{d as r,_ as i}from"./D1MotionTransform-CtbzB418.js";import{W as d,w as l,a as m,b as p}from"./wiki-fb_eBW86.js";import{r as c}from"./iframe-BlCC38XJ.js";import"./jsx-runtime-D_zvdyIk.js";const h=[{name:"adaptive",type:"string",option:["planeAlways","planeSm","planeMd","planeLg","planeXl","plane2xl"]},{name:"animationHeadPosition",type:"string",option:["top","toBottom"]},{name:"animationShow",type:"boolean"},{name:"ariaDescribedby",type:"string"},{name:"ariaLabelledby",type:"string"},{name:"autoClose",type:"boolean"},{name:"clickOpen",type:"boolean"},{name:"ignore",type:"string | HTMLElement"},{name:"ignoreSelector",type:"string"},{name:"inDom",type:"boolean"},{name:"modelOpen",type:"boolean"},{name:"onUpdate:modelOpen",type:"(value: boolean) => void"},{name:"onUpdate:open",type:"(value: boolean) => void"},{name:"open",type:"boolean"},{name:"role",type:"string"},{name:"section",type:"boolean"},{name:"tagBody",type:"string"}],a=new d("MotionTransform",h,r,l,m,p),g={title:"Ui/MotionTransform",component:i,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},e={render:s=>({components:{D1MotionTransform:i},setup:()=>({args:s}),template:`
    ...
    `})},o={name:"Двусторонняя привязка (v-model)",render:()=>({components:{D1MotionTransform:i},setup(){return{open:c(!1)}},template:`
        <div class="wiki-storybook-item--padding">
