import{d as m,_ as e}from"./D1ListItem-Crx23BEH.js";import{W as l,w as p,a as c,b as g}from"./wiki-fb_eBW86.js";import"./iframe-BlCC38XJ.js";import"./jsx-runtime-D_zvdyIk.js";import{_ as I}from"./D1Skeleton-_eyYcCpr.js";const d=[{name:"badge",type:"string | number | ConstrBind<BadgeProps>"},{name:"badgeDot",type:"boolean"},{name:"caption",type:"string | number"},{name:"dense",type:"boolean"},{name:"description",type:"string | number"},{name:"detail",type:"Record<string, any>"},{name:"disabled",type:"boolean"},{name:"divider",type:"boolean"},{name:"fill",type:"string",option:["custom"]},{name:"filterMode",type:"boolean"},{name:"focus",type:"boolean"},{name:"highlight",type:"string"},{name:"highlightLengthStart",type:"number"},{name:"href",type:"string"},{name:"icon",type:"IconValue<IconProps>"},{name:"iconAlign",type:"string",option:["center","edge"]},{name:"iconAttrs",type:"ConstrBind<IconProps>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTop",type:"boolean"},{name:"iconTrailing",type:"IconValue<IconProps>"},{name:"iconTrailingDirOnly",type:"boolean"},{name:"iconTrailingPalette",type:"boolean"},{name:"iconTrailingTurnOnly",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"index",type:"any"},{name:"isItemMenu",type:"boolean"},{name:"isMenu",type:"boolean"},{name:"isSkeleton",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"listId",type:"number"},{name:"loading",type:"boolean | ConstrBind<ProgressProps>"},{name:"open",type:"boolean"},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"parent",type:"string"},{name:"prefix",type:"string | number"},{name:"readonly",type:"boolean"},{name:"role",type:"string"},{name:"search",type:"string"},{name:"selected",type:"boolean"},{name:"selectedChild",type:"boolean"},{name:"size",type:"string",option:["sm","md","lg"]},{name:"suffix",type:"string | number"},{name:"tabindex",type:"string | number"},{name:"tag",type:"string",option:["button","a","span","div"]},{name:"to",type:"string | RouteLocationAsRelativeGeneric | RouteLocationAsPathGeneric"},{name:"type",type:"string"},{name:"value",type:"any"}],a=new l("ListItem",d,m,p,c,g),h={title:"Ui/ListItem",component:e,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},t={render:r=>({components:{D1ListItem:e},setup:()=>({args:r}),template:`
...
}`,...o.parameters?.docs?.source}}};const L=["ListItem","ListItemBasic","ListItemHighlight","ListItemFill","ListItemSkeleton"],S=Object.freeze(Object.defineProperty({__proto__:null,ListItem:t,ListItemBasic:n,ListItemFill:s,ListItemHighlight:i,ListItemSkeleton:o,__namedExportsOrder:L,default:h},Symbol.toStringTag,{value:"Module"}));export{S as L,t as a,a as b,n as c,i as d,s as e,o as f};
