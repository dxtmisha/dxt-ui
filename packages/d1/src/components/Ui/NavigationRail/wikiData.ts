...
const propsNames: StorybookProps = [
  ...
  { name: 'iconArrowRight', type: 'IconValue<NavigationItemProps>' },
  { name: 'itemAttrs', type: 'ConstrBind<NavigationRailItemProps | NavigationRailItemPropsBasic>' },
  { name: 'itemManagementAttrs', type: 'ConstrBind<NavigationRailItemProps | NavigationRailItemPropsBasic>' },
  { name: 'itemMenuAttrs', type: 'ConstrBind<NavigationRailItemProps | NavigationRailItemPropsBasic>' },
  { name: 'keyLabel', type: 'string' },
  { name: 'keyValue', type: 'string' },
  { name: 'list', type: 'ListRecord<NavigationRailItemProps | NavigationRailItemPropsBasic>' },
