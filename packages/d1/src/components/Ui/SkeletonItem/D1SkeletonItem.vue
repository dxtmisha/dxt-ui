...
} from '@dxtmisha/constructor/SkeletonItem'

import { defaults, type SkeletonItemProps } from './props'
...
const props = withDefaults(defineProps<SkeletonItemProps>(), defaults)
