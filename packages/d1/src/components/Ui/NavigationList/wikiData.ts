...
const propsNames: StorybookProps = [
  ...
  { name: 'itemAttrs', type: 'ConstrBind<NavigationItemProps>' },
  { name: 'itemGroupAttrs', type: 'ConstrBind<NavigationItemProps>' },
  { name: 'itemManagementAttrs', type: 'ConstrBind<NavigationItemProps>' },
  { name: 'itemMenuAttrs', type: 'ConstrBind<NavigationItemProps>' },
  { name: 'keyLabel', type: 'string' },
  { name: 'keyValue', type: 'string' },
  { name: 'list', type: 'ListRecord<NavigationItemProps>' },
...
export const NavigationListWikiData: WikiDataItem = {
