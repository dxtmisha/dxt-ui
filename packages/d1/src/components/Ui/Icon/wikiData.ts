...
const propsNames: StorybookProps = [
  ...
  { name: 'animationType', type: 'string | undefined', option: ['type1', 'type2'] },
  ...
  { name: 'rounded', type: 'string | undefined', option: ['auto', 'sm', 'md', 'lg', 'xl', 'full'] },
  { name: 'size', type: 'string | undefined', option: ['auto', 'x', 'xs', 'sm', 'md', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', '7xl', '8xl', '9xl'] },
