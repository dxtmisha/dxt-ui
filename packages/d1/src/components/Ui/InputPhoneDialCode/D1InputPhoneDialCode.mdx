...
<Canvas of={InputPhoneDialCode.InputPhoneDialCodeDefault}/>

<StorybookDescriptions componentName={'InputPhoneDialCode'} type={'labelType'}/>
<Canvas of={InputPhoneDialCode.InputPhoneDialCodeLabelType}/>

<StorybookDescriptions componentName={'Style'} type={'disabled'}/>
<Canvas of={InputPhoneDialCode.InputPhoneDialCodeDisabled}/>
