...
const propsNames: StorybookProps = [
  ...
  { name: 'itemAttrs', type: 'ConstrBind<SegmentControlItemProps>' },
  { name: 'keyLabel', type: 'string' },
  { name: 'keyValue', type: 'string' },
  { name: 'list', type: 'ListRecord<SegmentControlItemProps>' },
...
export const SegmentControlWikiData: WikiDataItem = {
