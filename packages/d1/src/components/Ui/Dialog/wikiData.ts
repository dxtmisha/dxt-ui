...
const propsNames: StorybookProps = [
  ...
  { name: 'buttonClose', type: 'string | ConstrBind<ButtonPropsBasic>' },
  { name: 'buttonOk', type: 'string | ConstrBind<ButtonPropsBasic>' },
  ...
  { name: 'iconError', type: 'IconValue<IconPropsBasic>' },
