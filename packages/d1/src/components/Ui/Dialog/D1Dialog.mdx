...
<StorybookDescriptions componentName={'Dialog'} type={'imagePosition'}/>
<Canvas of={Dialog.DialogImagePosition}/>

<StorybookDescriptions componentName={'Dialog'} type={'customButtons'}/>
<Canvas of={Dialog.DialogCustomButtons}/>
