...
const propsNames: StorybookProps = [
  ...
  { name: 'iconCheckbox', type: 'string | ConstrBind<ImageProps> | null' },
  { name: 'iconIndeterminate', type: 'string | ConstrBind<ImageProps> | null' },
...
export const RadioWikiData: WikiDataItem = {
  component: 'Radio',
  props: propsNames,
  slots: slotsNames,
  events: eventsNames,
