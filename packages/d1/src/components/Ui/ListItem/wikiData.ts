...
const propsNames: StorybookProps = [
  ...
  { name: 'checkboxAttrs', type: 'ConstrBind<CheckboxPropsBasic> | undefined' },
  ...
  { name: 'iconCheckbox', type: 'IconValue<IconProps> | undefined' },
  ...
  { name: 'radioAttrs', type: 'ConstrBind<RadioPropsBasic> | undefined' },
