...
const propsNames: StorybookProps = [
  ...
  { name: 'adaptive', type: 'string | undefined', option: ['menu', 'menuWindow', 'modal', 'modalDynamic', 'actionSheetRight', 'actionSheetBottom', 'static', 'actionSheet', 'actionSheetToModal', 'autoStaticSm', 'autoStaticMd', 'autoStaticLg', 'autoStaticXl', 'autoStatic2xl'] },
  { name: 'alignment', type: 'string | undefined', option: ['center', 'top', 'topRight', 'topLeft', 'topFull', 'right', 'rightFull', 'bottom', 'bottomRight', 'bottomLeft', 'bottomFull', 'left', 'leftFull'] },
  ...
  { name: 'axis', type: 'string | undefined', option: ['x', 'y', 'on'] },
  ...
  { name: 'imageSize', type: 'string | undefined', option: ['sm', 'md', 'lg', 'quarter', 'half'] },
  ...
  { name: 'origin', type: 'string | undefined', option: ['center', 'top', 'right', 'bottom', 'left', 'topToBottom', 'rightToLeft', 'bottomToTop', 'leftToRight'] },
