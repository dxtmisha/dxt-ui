...
const propsNames: StorybookProps = [
  ...
  { name: 'foot', type: 'TableHeader<TableFlexHeaderItemProps> | TableHeaders<TableFlexHeaderItemProps>' },
  ...
  { name: 'list', type: '(TableFlexItemProps[] & TableList<TableFlexItemProps>)' },
  ...
  { name: 'sortFunction', type: 'SortFunction<TableFlexItemProps>' },
  ...
  { name: 'tableRecordAttrs', type: 'ConstrBind<TableFlexRecordProps>' },
  { name: 'tableRowAttrs', type: 'Record<string, ConstrBind<TableFlexRecordProps>>' }
  // :propsList [!] System label / Системная метка
]
...
export const TableFlexWikiData: WikiDataItem = {
  component: 'TableFlex',
  props: propsNames,
  slots: slotsNames,
  events: eventsNames,
