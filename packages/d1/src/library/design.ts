...
export const componentsReg: RegExp = /((d1|dd)-?(accordion|action-?sheet|actions|anchor|arrow|badge|bars|block|button|cell|chip|chip-?group|dialog|field|field-?counter|field-?label|field-?message|hip-?group|icon|image|input|list|list-?group|list-?item|list-?menu|mask|menu|modal|motion-?transform|page|progress|ripple|scrollbar|section|select|select-?value|skeleton|textarea-?autosize|tooltip|window))/ig
