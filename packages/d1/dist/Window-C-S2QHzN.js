...
import { t } from "./ModelInclude-CYgWMv2f-BLxokMi0.js";
import { t as n } from "./AriaStaticInclude-CS1hPGyK-CzM-g2JN.js";
import { n as r, r as i } from "./Image-Divpn3_L.js";
import { t as a } from "./TextInclude-B_Uojln0-ClKB6W8i.js";
import { n as o, t as s } from "./WindowEsc-BLim9Zco-CwtxNgNE.js";
import { n as c, t as l } from "./D1Scrollbar-u3xFUupc.js";
import { n as u, r as d, t as f } from "./WindowClassesInclude-CENNdyRk-B196S0ph.js";
import { t as p } from "./D1Button-B2WKlXCT.js";
import { Teleport as m, computed as h, createBlock as g, defineComponent as _, h as v, mergeDefaults as y, onMounted as ee, onUnmounted as b, openBlock as x, ref as S, unref as C, watch as w } from "vue";
import { DesignConstructorAbstract as T, EventItem as E, executePromise as D, frame as O, getElement as k, getMouseClientX as A, getMouseClientY as j, getRef as M, inArray as N, isDomRuntime as P, isEnter as F, isFilled as I, setRef as L, toBind as R, toBinds as z } from "@dxtmisha/functional";
//#region ../constructor/dist/WindowInclude-D4eAeql2.js
var B = class {
	constructor(t, n, r, i, a, o, s, c) {
		e(this, "element", S()), e(this, "binds", h(() => z(M(this.extra), {
			...
			...R(t == null ? {} : t, this.binds.value),
			ref: this.element,
			onWindow: this.onWindow
		}, e, this.index) : []), e(this, "getPreparation", () => {
			var e, t, n, r, i;
			return (e = (t = M(this.extra)) == null || (n = t.preparation) == null ? void 0 : n.call(t)) == null ? (r = this.props.windowAttrs) == null || (i = r.preparation) == null ? void 0 : i.call(r) : e;
		}), e(this, "getOpening", () => {
			var e, t, n, r, i, a;
			return (e = (t = (n = M(this.extra)) == null || (r = n.opening) == null ? void 0 : r.call(n)) == null ? (i = this.props.windowAttrs) == null || (a = i.opening) == null ? void 0 : a.call(i) : t) == null ? !0 : e;
		}), e(this, "getClosing", () => {
			var e, t, n, r, i, a;
			return (e = (t = (n = M(this.extra)) == null || (r = n.closing) == null ? void 0 : r.call(n)) == null ? (i = this.props.windowAttrs) == null || (a = i.closing) == null ? void 0 : a.call(i) : t) == null ? !0 : e;
		}), e(this, "onWindow", (e) => {
			var t;
	...
	constructor(t) {
		e(this, "x", V), e(this, "y", V), this.element = t;
	}
	is() {
	...
	async preparation() {
		this.props.preparation && await D(this.props.preparation);
	}
	async before(e) {
		return e ? await this.beforeOpening() : await this.beforeClosing();
	}
	async beforeOpening() {
		return this.props.beforeOpening ? await D(this.props.beforeOpening) : !0;
	}
	async beforeClosing() {
		return this.props.beforeClosing ? await D(this.props.beforeClosing) : !0;
	}
	async after(e) {
		return e ? await this.opening() : await this.closing();
	}
	async opening() {
		return this.props.opening ? await D(this.props.opening) : !1;
	}
	async closing() {
		return this.props.closing ? await D(this.props.closing) : !1;
	}
}, H = class {
	constructor(e, t) {
	...
	constructor(t) {
		e(this, "item", S(d.close)), this.element = t;
	}
	isHide() {
	...
	constructor(t, n, r) {
		e(this, "item", S(!1)), e(this, "onTransitionend", () => {
			this.removeEvent(), this.disabled();
		}), this.props = t, this.classes = n, this.element = r, w(this.item, (e) => {
	...
	updateScroll() {
		...
		if (this.isOver() && this.props.overElement && e && e.scrollHeight > e.offsetHeight) {
			var t, n, r;
			let i = (t = k(this.props.overElement)) == null ? void 0 : t.getBoundingClientRect(), a = (n = this.element.getBody()) == null ? void 0 : n.getBoundingClientRect(), o = e == null ? void 0 : e.getBoundingClientRect(), s = (r = this.element.getControl()) == null ? void 0 : r.getBoundingClientRect();
			if (e && i && a && o) {
	...
	getOverHeight(e, t) {
		...
		if (this.props.overElement) {
			var r, i;
			let e = (r = k(this.props.overElement)) == null ? void 0 : r.getBoundingClientRect(), a = (i = this.element.getBody()) == null ? void 0 : i.getBoundingClientRect();
			if (e && a) {
	...
	constructor(t, n, r) {
		e(this, "event", void 0), e(this, "item", S(!1)), e(this, "listener", () => {
			L(this.item, this.isStatic());
		}), e(this, "make", () => {
			this.isStaticMod() ? (this.start(), requestAnimationFrame(this.listener)) : this.stop();
		}), this.props = t, this.element = r, w([n.staticMode], this.make, { immediate: !0 });
	}
	isStaticMod() {
	...
	constructor(e, t, n, r, i) {
		this.element = e, this.coordinates = t, this.position = n, this.origin = r, this.className = i, w(this.element.element, () => this.update());
	}
	update() {
		let e = this.element.getMain();
	...
	constructor(t, n, r, i, a, o, s, c, l, u, d, f) {
		e(this, "item", S(!1)), e(this, "first", S(!1)), e(this, "clicks", 0), e(this, "inDom", h(() => this.item.value || this.props.staticMode || !!this.props.inDom && this.first.value)), e(this, "set", async (e) => {
	...
	watchCoordinates() {
		return O(() => {
			let e = this.element.getMain();
			if (e) {
				let t = getComputedStyle(e).getPropertyValue(f).includes("--MENU--");
	...
	async update(e) {
		if (!this.open.isClicks() && (this.target = e, this.focus = this.getFocus(), P() && this.isTargetInBody() && !this.staticMode.item.value)) if (this.open.pressed(), this.open.item.value) {
	...
	isMenu(e = this.element.getMain()) {
		if (e) {
			let t = getComputedStyle(e).getPropertyValue(f);
	...
	constructor(t, n, r, i, a, o, s) {
		e(this, "event", void 0), e(this, "onClick", async (e) => {
			...
			(F(e, !1) || this.isArrowDown(e)) && (e.preventDefault(), await this.onClick(e));
		...
		}), this.props = t, this.tabIndex = n, this.status = r, this.client = i, this.flash = a, this.open = o, this.verification = s, this.event = new E("body", ["click", "contextmenu"], this.onGlobal), w([this.open.item, this.status.item], () => this.toggle());
	}
	start() {
	...
	async on(e) {
		this.tabIndex.updateOldElement(), this.client.set(A(e), j(e)), await this.verification.update(e.target);
	}
}, Z = 0, se = class {
	constructor(t, n, r, i) {
		e(this, "elements", []), this.props = t, this.classes = n, this.staticMode = r, this.open = i, w(this.open.item, (e) => {
	...
	constructor(r, l, d, f, p, m, g, _, v) {
		...
		}), this.props = r, this.refs = l, this.classDesign = f, this.className = p, this.components = m, this.slots = g, this.emits = _;
		let { ImageConstructor: y = i, ModelConstructor: x = t, ScrollbarConstructor: S = c, TabIndexConstructor: C = o, TextConstructor: T = a, WindowClassesConstructor: E = u, WindowClientConstructor: D = te, WindowCoordinatesConstructor: O = K, WindowElementConstructor: k = H, WindowEmitConstructor: A = X, WindowEscConstructor: j = s, WindowEventConstructor: M = oe, WindowFlashConstructor: N = G, WindowHiddenConstructor: P = se, WindowHookConstructor: F = ne, WindowOpenConstructor: I = ie, WindowOriginConstructor: L = J, WindowPersistentConstructor: R = W, WindowPositionConstructor: z = q, WindowStaticConstructor: B = Y, WindowStatusConstructor: V = U, WindowStylesConstructor: Z = re, WindowVerificationConstructor: Q = ae } = v == null ? {} : v;
		this.hook = new F(r), this.classes = new E(p), this.element = new k(this.classes, d), this.client = new D(this.element), this.tabIndex = new C(() => this.element.getBody(), void 0, () => !!this.props.autoTabIndex), this.status = new V(this.element), this.persistent = new R(r, this.classes, this.element), this.flash = new N(r, this.classes), this.coordinates = new O(this.classes, this.element), this.position = new z(r, this.client, this.element, this.coordinates), this.origin = new L(this.client, this.element, this.position), this.staticMode = new B(r, l, this.element), this.emit = new A(this.classes, this.element, _), this.styles = new Z(this.element, this.coordinates, this.position, this.origin, p), this.open = new I(r, this.client, this.hook, this.element, this.tabIndex, this.status, this.flash, this.coordinates, this.position, this.origin, this.emit, this.styles), this.verification = new Q(r, this.persistent, this.classes, this.element, this.staticMode, this.open), this.event = new M(r, this.tabIndex, this.status, this.client, this.flash, this.open, this.verification), this.scrollbar = new S(r, p, m, _), this.image = new y(r, m, _), this.esc = new j(this.open.item, () => this.open.close(), () => {
			var e;
			return !this.props.persistent && ((e = this.props.closeOnEsc) == null ? !0 : e);
		}), this.text = new T(this.props), this.hidden = new P(this.props, this.classes, this.staticMode, this.open), new x("open", this.emits, this.open.item), ee(() => {
			w([l.open], () => this.open.set(r.open), { immediate: !0 });
		}), b(this.stop);
	}
	isMenu() {
	...
	constructor(t, r, i, a = Q) {
		super(t, r, i), e(this, "item", void 0), e(this, "renderMain", () => v("div", this.propsMain.value, this.renderBody())), e(this, "renderBody", () => {
			var e, t;
			return v("div", {
				key: "body",
				...this.getAttrs(),
			...
			var e;
			let t = [];
			return this.initSlot("title", t, this.item.slotData.value), t.push(this.renderBodyContext()), this.initSlot("footer", t, this.item.slotData.value), [v("div", {
				key: "group",
	...
	setup(e, { expose: t, emit: n }) {
		let i = n, a = e, o = new le("d1.window", a, {
			emits: i,
			classes: h(() => ({ main: {
				"d1-window": !0,
				"d1-window--width--custom": I(a.width) && !N($.width, a.width),
				[`d1-window--width--${a.width}`]: N($.width, a.width),
				"d1-window--height--custom": I(a.height) && !N($.height, a.height),
				[`d1-window--height--${a.height}`]: N($.height, a.height),
				"d1-window--hide": a.hide,
				[`d1-window--axis--${a.axis}`]: N($.axis, a.axis),
				[`d1-window--imagePosition--${a.imagePosition}`]: N($.imagePosition, a.imagePosition),
				"d1-window--dense": a.dense,
				[`d1-window--alignment--${a.alignment}`]: N($.alignment, a.alignment),
				[`d1-window--origin--${a.origin}`]: N($.origin, a.origin),
				[`d1-window--adaptive--${a.adaptive}`]: N($.adaptive, a.adaptive),
				...
				[`d1-window--imageSize--${a.imageSize}`]: N($.imageSize, a.imageSize)
			} })),
			styles: h(() => {
				var e, t;
				return {
		...
		return t(o.expose()), (e, t) => (x(), g(C(s)));
	}
});
//#endregion
export { B as n, de as t };
