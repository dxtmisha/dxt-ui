...
import { t } from "./SnackbarItem-CFIQHHlF.js";
...
var h = class {
	...
	constructor(t, n, i, a) {
		...
		}), this.props = t, this.element = n, this.className = i, this.event = a;
	}
	getItemByValue(e) {
	...
	getItemValue(e) {
		var t;
		return (t = e.value) == null ? `snackbar-item-${++g}` : t;
	}
	getItemDelay(e) {
		var t, n;
	...
	constructor(t, n, r, i, a, o, s, c, l) {
		...
		let { DataConstructor: u = _, EventConstructor: d = h } = l == null ? {} : l;
		this.event = new d(c), this.data = new u(t, r, a, this.event);
	}
}, y = { delay: 8e3 }, b = class extends f {
	...
	setup(e, { expose: n, emit: a }) {
		let o = a, s = e, c = new b("d1.snackbar", s, {
			emits: o,
			classes: r(() => ({ main: {
				"d1-snackbar": !0,
				"d1-snackbar--full": s.full,
				"d1-snackbar--all": s.all,
				[`d1-snackbar--limit--${s.limit}`]: p(x.limit, s.limit),
				[`d1-snackbar--vertical--${s.vertical}`]: p(x.vertical, s.vertical),
				[`d1-snackbar--horizontal--${s.horizontal}`]: p(x.horizontal, s.horizontal),
				[`d1-snackbar--origin--${s.origin}`]: p(x.origin, s.origin)
			} })),
			styles: r(() => ({})),
