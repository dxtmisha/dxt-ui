import { computed as p, onUnmounted as B, watch as P, ref as d, nextTick as g, h as w, Teleport as _, defineComponent as M, openBlock as D, createBlock as A, unref as H, mergeDefaults as L } from "vue";
...
import { _ as U } from "./D1Arrow.vue_vue_type_script_setup_true_lang-7jq-R33W.js";
...
class tt {
  ...
  constructor(t, s, o, i, r, l) {
    ...
    }), e(this, "onScroll", () => this.toggle(!1, !0)), this.props = t, this.style = o, this.status = i, this.position = r, this.emits = l, this.event = new q(window, ["scroll-sync"], this.onScroll), P([s.open], () => {
  ...
  setup(n, { expose: t, emit: s }) {
    const o = s, i = n, r = p(() => ({
      main: {
        ...
        [`d1-tooltip--maxWidth--${i.maxWidth}`]: R(rt.maxWidth, i.maxWidth)
        // :classes-values [!] System label / Системная метка
      }
    })), l = p(() => ({
