...
declare const __VLS_component: DefineComponent<D1ImageProps, {
    type: ComputedRef<ImageTypeItem>;
    data: Ref<ImageEventItem>;
}, {}, {}, {}, ComponentOptionsMixin, ComponentOptionsMixin, {
    load: (image: ImageEventData) => any;
}, string, PublicProps, Readonly<D1ImageProps> & Readonly<{
...
export declare const D1Image: __VLS_WithTemplateSlots<typeof __VLS_component, __VLS_TemplateResult["slots"]>;

/**
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
export declare type D1ImageProps = ImagePropsBasic & PropsToken;
