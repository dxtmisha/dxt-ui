import { ref as f, watch as y, h as b, defineComponent as g, computed as d, openBlock as k, createBlock as C, unref as D, mergeDefaults as w } from "vue";
import { DesignConstructorAbstract as x, ListDataRef as L, forEach as S, toBinds as V } from "@dxtmisha/functional";
import { m as _ } from "./D1Icon.vue_vue_type_script_setup_true_lang-BINcl8rE.js";
import { V as A } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { D as B } from "./index-Axh1wfp9.js";
var G = Object.defineProperty, I = (s, e, t) => e in s ? G(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, m = (s, e, t) => I(s, typeof e != "symbol" ? e + "" : e, t);
let E = class {
  /**
   * Constructor
  ...
  constructor(e, t, o, l, i) {
    m(this, "value", f()), m(this, "onClick", (n, r) => {
      var a, c;
      r && "value" in r && !((a = this.readonly) != null && a.value) && (this.value.value = r.value), (c = this.event) == null || c.onClick(n, r);
    }), this.index = e, this.emits = t, this.event = o, this.inputValue = l, this.readonly = i, new A(this.index, this.emits, this.value), y(
      [this.inputValue],
      () => {
        var n;
...
class R {
  ...
  constructor(e, t, o, l, i, n, r, a, c) {
    ...
    const {
      EventClickIncludeConstructor: h = _,
      ListDataRefConstructor: p = L,
...
class j extends x {
  ...
  initRender() {
    ...
    return this.initSlot("default", t), b(
      "div",
      {
        ...this.getAttrs(),
