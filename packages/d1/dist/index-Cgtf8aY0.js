...
import { y as rt } from "./FieldInclude-BKoBWZdj-BnMZR_TN.js";
import { D as nt } from "./index-VkCaOUvo.js";
import { D as ot } from "./index-DY4G9SUw.js";
...
class bt {
  ...
  constructor(t, e, a, r, l, c, p, m, o) {
    ...
    const {
      ...
      FieldPatternIncludeConstructor: D = pt,
      FieldTypeIncludeConstructor: A = ut,
      FieldValidationIncludeConstructor: N = tt,
      FieldValueIncludeConstructor: T = et,
      FieldVisibilityIncludeConstructor: $ = ht,
      InputPasswordConstructor: P = ft,
      MaskIncludeConstructor: O = gt,
      TextIncludeConstructor: _ = st
    } = o != null ? o : {};
    this.text = new _(this.props), this.change = new v(this.props), this.visibility = new $(), this.type = new A(this.props, this.visibility), this.pattern = new D(this.props, this.type), this.inputMode = new F(this.props, this.type), this.attributes = new d(
      this.props,
      this.type,
      this.pattern,
      this.inputMode
