import { computed as g, h as w, Teleport as Z, onMounted as J, watch as f, onUnmounted as Q, ref as x, defineComponent as tt, openBlock as et, createBlock as st, unref as it, mergeDefaults as ot } from "vue";
...
import { V as mt } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { v as gt, E as yt } from "./WindowEsc-DTwn4Vsz-CY0loI-Z.js";
import { a as wt } from "./TextInclude--GERRCGj-qSMWmRIC.js";
...
import { _ as bt } from "./D1Button.vue_vue_type_script_setup_true_lang-P7Y9IoB6.js";
import { _ as Ct } from "./D1Image.vue_vue_type_script_setup_true_lang-CD2--_oV.js";
...
class St {
   ...
   */
  constructor(t, e, i, s) {
    o(this, "isImage", g(() => !!this.props.image)), o(this, "bind", g(() => rt(this.props.image, ht(this.extra), "value"))), this.props = t, this.components = e, this.emits = i, this.extra = s;
  }
  render() {
...
class Rt {
  ...
  constructor(t, e, i, s, n, r, a, h, c, d, M, S) {
    o(this, "item", x(!1)), o(this, "first", x(!1)), o(this, "clicks", 0), o(this, "inDom", g(() => this.item.value || this.props.staticMode || !!this.props.inDom && this.first.value)), o(this, "set", async (y) => {
      this.item.value !== !!y && await this.toggle();
    }), o(this, "open", async () => this.set(!0)), o(this, "close", async () => this.set(!1)), o(this, "toggle", async () => {
      if (this.clicks > 1)
        return;
      const y = !this.item.value;
      await this.hook.before(y) && (y ? (this.reset(), this.status.toDisplay(), await this.setOpen(y), requestAnimationFrame(async () => {
...
class Xt {
  ...
  constructor(t, e, i, s, n, r, a, h, c) {
    o(this, "client"), o(this, "hook"), o(this, "classes"), o(this, "element"), o(this, "tabIndex"), o(this, "status"), o(this, "persistent"), o(this, "flash"), o(this, "coordinates"), o(this, "position"), o(this, "origin"), o(this, "staticMode"), o(this, "emit"), o(this, "styles"), o(this, "open"), o(this, "verification"), o(this, "event"), o(this, "scrollbar"), o(this, "image"), o(this, "esc"), o(this, "text"), o(this, "hidden"), o(this, "slotData", g(() => ({
    ...
    const {
      ...
      ModelConstructor: M = mt,
      ScrollbarConstructor: S = Mt,
      TabIndexConstructor: y = gt,
      TextConstructor: W = wt,
    ...
    this.hook = new X(t), this.classes = new $(n), this.element = new P(this.classes, i), this.client = new D(this.element), this.tabIndex = new y(
...
class qt extends nt {
  ...
  constructor(t, e, i, s = Xt) {
    super(
      ...
      e,
      i
    ), o(this, "item"), o(this, "renderMain", () => w(
      "div",
  ...
  setup(l, { expose: t, emit: e }) {
    const i = e, s = l, n = g(() => ({
      main: {
        ...
        "d1-window": !0,
        "d1-window--width--custom": H(s.width) && !p(m.width, s.width),
        [`d1-window--width--${s.width}`]: p(m.width, s.width),
        "d1-window--height--custom": H(s.height) && !p(m.height, s.height),
        [`d1-window--height--${s.height}`]: p(m.height, s.height),
        "d1-window--hide": s.hide,
        [`d1-window--axis--${s.axis}`]: p(m.axis, s.axis),
        [`d1-window--imagePosition--${s.imagePosition}`]: p(m.imagePosition, s.imagePosition),
        "d1-window--dense": s.dense,
        [`d1-window--alignment--${s.alignment}`]: p(m.alignment, s.alignment),
        [`d1-window--origin--${s.origin}`]: p(m.origin, s.origin),
        [`d1-window--adaptive--${s.adaptive}`]: p(m.adaptive, s.adaptive),
        ...
        [`d1-window--imageSize--${s.imageSize}`]: p(m.imageSize, s.imageSize)
        // :classes-values [!] System label / Системная метка
      }
    })), r = g(() => {
      var c, d;
