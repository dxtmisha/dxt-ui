import { computed as u, defineComponent as h, openBlock as w, createBlock as f, unref as x, mergeDefaults as v } from "vue";
...
var M = Object.defineProperty, B = (t, s, e) => s in t ? M(t, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[s] = e, c = (t, s, e) => B(t, typeof s != "symbol" ? s + "" : s, e);
class _ {
  /**
   * Constructor
  ...
  constructor(s, e, n, i, r, a, o, l, p) {
    ...
    const {
      ListGroupOpenConstructor: m = b,
      WindowIncludeConstructor: d = C
    } = p != null ? p : {};
    this.open = new m(this.props), this.window = new d(
      this.props,
      this.className,
      this.components,
      this.emits,
