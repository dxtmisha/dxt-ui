...
var O = 1280, k = class {
	...
	constructor(t) {
		e(this, "item", n(() => {
			...
			if (e instanceof File || S(e)) {
				if (j.isPdf(e)) return M.pdf;
				if (e instanceof File) return M.file;
				if (e.match(/\//)) return M.image;
				if (e.match(/^#/)) return M.color;
				if (e.match(/^@/)) return M.public;
				if (e.match(/^\$/)) return M.material;
				if (e.match(/^flag-[a-z]{2}$/)) return M.flag;
				if (e.match(/^f-[a-z]{2}$/)) return M.flagCompressed;
				let t = e.match(/^(outlined|round|sharp|material)-/);
				return t ? t[1] : g.is(e) ? M.public : M.outlined;
			}
		})), this.props = t;
	}
}, P = {
	...
	async init() {
		...
		if (e) switch (this.type.item.value) {
			case M.pdf: return await j.get(e);
			case M.image:
			case M.file:
				try {
...
var B = class {
	...
	static makeSize() {
		z.reset(), this.objectsAdaptive.forEach((e) => {
			let t = e.element.value;
			t && z.get(e.group.value).makeWidth(e.width.value).makeHeight(e.height.value).makeOffsetWidth(t.offsetWidth).makeOffsetHeight(t.offsetHeight);
		});
	}
	static makePercent() {
		z.isSize() && this.objectsAdaptive.forEach((e) => {
			let t = e.element.value, n = z.get(e.group.value);
			if (t) {
	...
	static makeFactorMax() {
		z.isSize() && this.objectsAdaptive.forEach((e) => {
			z.get(e.group.value).makeFactorMax(e.factor.value);
		});
	}
	static isAdaptive() {
...
e(B, "objects", []), e(B, "objectsAdaptive", []), e(B, "cache", []), e(B, "event", void 0), e(B, "time", void 0);
var V = /* @__PURE__ */ function(e) {
	...
	constructor(t, r, i) {
		e(this, "percent", l({
			...
			var e;
			return (e = this.props.adaptiveGroup) == null ? H : e;
		})), e(this, "width", n(() => {
			var e;
			...
			if (this.width.value && this.percent.value.width > 0) return V.x;
			if (this.height.value && this.percent.value.height > 0) return V.y;
		})), e(this, "size", n(() => {
			if (this.element.value && this.data.isImage()) {
				let e = this.data.image.value;
				switch (this.type.value) {
					case V.x: return e.height * (this.element.value.offsetWidth * this.percent.value.width / e.width);
					case V.y: return e.width * (this.element.value.offsetHeight * this.percent.value.height / e.height);
				}
			}
			return 0;
		})), e(this, "factor", n(() => {
			...
			if (e) {
				...
				if (this.type.value === V.x && t > e.offsetHeight) return e.offsetHeight / t;
				if (this.type.value === V.y && t > e.offsetWidth) return e.offsetWidth / t;
			}
			return 1;
		})), this.props = t, this.data = r, this.element = i, p(() => {
			this.is() ? B.add(this) : B.remove(this);
		});
	}
	is() {
		var e;
	...
	getBackgroundSize() {
		let e = z.get(this.group.value).getFactorMax();
		switch (this.type.value) {
			case V.x: return `${100 * this.percent.value.width * e}% auto`;
			case V.y: return `auto ${100 * this.percent.value.height * e}%`;
		}
		return null;
	}
	setPercent(e, t) {
	...
	remove() {
		this.active.value && B.remove(this);
	}
	make() {
	...
	constructor(r, i, a, o, c) {
		e(this, "type", void 0), e(this, "data", void 0), e(this, "coordinator", void 0), e(this, "position", void 0), e(this, "adaptiveItem", void 0), e(this, "background", void 0), e(this, "img", void 0), e(this, "tag", n(() => this.img.is.value ? "img" : "span")), e(this, "text", n(() => {
			...
			if (e === M.flagCompressed && t) return String(t).replace("f-", "").toUpperCase();
			if (e && w(t) && [
				"filled",
				"outlined",
				"round",
			...
			if (e) switch (this.type.item.value) {
				...
				case M.icon: return { "background-image": this.background.image.value };
				case M.flag: return {
					"background-image": this.background.image.value,
					"background-size": "contain"
				};
				case M.public: return { "mask-image": this.background.image.value };
				case M.color: if (w(e)) return { "background-color": e };
			}
			return {};
		})), e(this, "binds", n(() => ({
			translate: "no",
		...
		let { ImageAdaptiveItemConstructor: l = U, ImageBackgroundConstructor: u = W, ImageCoordinatorConstructor: d = I, ImageDataConstructor: p = F, ImageImgConstructor: m = G, ImagePositionConstructor: h = L, ImageTypeConstructor: g = N } = c == null ? {} : c;
	...
	setup(e, { expose: t, emit: i }) {
		let a = i, o = e, s = new q("d1.image", o, {
			emits: a,
			classes: n(() => ({ main: {
				"d1-image": !0,
				...
				[`d1-image--size--${o.size}`]: y(J.size, o.size)
			} })),
			styles: n(() => ({}))
		}), l = s.render();
