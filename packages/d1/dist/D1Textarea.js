import { computed as r, h as B, defineComponent as b, openBlock as C, createBlock as w, unref as A, mergeDefaults as D } from "vue";
import { DesignConstructorAbstract as F, toBinds as d } from "@dxtmisha/functional";
import { w as T, D as z, O as k, T as S, V, N as M, H as O } from "./FieldEventInclude-h5Fg7306-DMkm_Aee.js";
import { y as _ } from "./FieldInclude-BKoBWZdj-BnMZR_TN.js";
import { D as E } from "./index-Bl1zqzEq.js";
import { D as H } from "./index-DY4G9SUw.js";
...
class P {
  ...
  constructor(e, i, o, a, l, n, u, c, h) {
    ...
    const {
      FieldAttributesIncludeConstructor: p = z,
      FieldChangeIncludeConstructor: m = k,
      FieldCodeIncludeConstructor: v = S,
      FieldElementIncludeConstructor: f = V,
      FieldEventIncludeConstructor: g = M,
      FieldIncludeConstructor: y = _,
      FieldValidationIncludeConstructor: x = O,
      FieldValueIncludeConstructor: I = T
    } = h != null ? h : {};
