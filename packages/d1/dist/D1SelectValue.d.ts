...
declare const __VLS_component: DefineComponent<D1SelectValueProps, {}, {}, {}, {}, ComponentOptionsMixin, ComponentOptionsMixin, {
    click: (event: MouseEvent, value: EventClickValue) => any;
    clickLite: (value: EventClickValue) => any;
}, string, PublicProps, Readonly<D1SelectValueProps> & Readonly<{
...
export declare const D1SelectValue: __VLS_WithTemplateSlots<typeof __VLS_component, __VLS_TemplateResult["slots"]>;

/**
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
export declare type D1SelectValueProps = SelectValuePropsBasic<IconProps, ChipProps> & PropsToken_5;
