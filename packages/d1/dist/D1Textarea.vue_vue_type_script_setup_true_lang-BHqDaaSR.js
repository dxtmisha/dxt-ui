...
import { y as O, D as E } from "./index-COZJq3Pe.js";
...
class P {
  ...
  constructor(e, i, o, a, l, n, u, c, h) {
    ...
    const {
      ...
      FieldElementIncludeConstructor: g = S,
      FieldEventIncludeConstructor: f = V,
      FieldIncludeConstructor: y = O,
      FieldValidationIncludeConstructor: x = M,
      FieldValueIncludeConstructor: I = z
    } = h != null ? h : {};
    this.change = new m(this.props), this.attributes = new p(this.props), this.elementItem = new g(
      this.props,
      this.element
    ), this.value = new I(
      this.props,
