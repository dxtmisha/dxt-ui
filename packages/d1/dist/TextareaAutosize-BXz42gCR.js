...
var p = class {
	...
	constructor(t, n, r, i, a, o, s, c, l) {
		...
		let { TextareaAutosizeResizeConstructor: u = m, TextareaAutosizeValueConstructor: d = p } = l == null ? {} : l;
		this.value = new d(t, n, c), this.resize = new u(t, r, this.value);
	}
}, g = { autosize: !0 }, _ = class extends d {
	...
	setup(e, { expose: r, emit: i }) {
		let a = i, o = e, c = new _("d1.textareaAutosize", o, {
			emits: a,
			classes: t(() => ({ main: {
				"d1-textareaAutosize": !0,
				"d1-textareaAutosize--autosize": o.autosize,
				[`d1-textareaAutosize--height--${o.height}`]: f(v.height, o.height)
			} })),
			styles: t(() => ({}))
		}), u = c.render();
