import { computed as m, ref as u, watch as N, h as _, defineComponent as C, openBlock as y, createBlock as k, unref as w, mergeDefaults as S } from "vue";
import { DesignConstructorAbstract as D, isSelected as I, getRef as p, toBinds as d, getBind as T } from "@dxtmisha/functional";
import { g as M } from "./D1Icon.vue_vue_type_script_setup_true_lang-B26p6g1f.js";
import { V as $ } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { l as b } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { _ as R } from "./D1TabsNavigation.vue_vue_type_script_setup_true_lang-BRFKqp0o.js";
import { _ as B } from "./D1MotionAxis.vue_vue_type_script_setup_true_lang-Bmz_LwGt.js";
...
class L {
  ...
  constructor(t, e, r, h, l, i, n, c, a) {
    ...
    const {
      ...
      ModelIncludeConstructor: x = $,
      MotionAxisIncludeConstructor: f = U,
      TabsNavigationIncludeConstructor: g = j,
      TabsSelectedConstructor: A = G
    } = a != null ? a : {};
    this.selected = new A(this.props, this.refs), this.event = new v(void 0, void 0, this.emits), this.tabsNavigation = new g(
      this.props,
      this.className,
      this.components,
      m(() => ({
