...
import { EventItem as r, executeFunction as i, getRef as a, isDomRuntime as o, isElementVisible as s, isFunction as c } from "@dxtmisha/functional";
//#region ../constructor/dist/TabIndexInclude-DLSfl7-6.js
var l = class {
	...
	getElement() {
		return c(this.element) ? this.element() : a(this.element);
	}
	findFirstElement() {
		var e;
		let t = (e = this.getElement()) == null ? void 0 : e.querySelectorAll("*");
		if (t) {
			for (let e of t) if ("tabIndex" in e && e.tabIndex >= 0 && s(e)) return e;
		}
	}
	findLastElement() {
		var e;
		...
		if (t) for (let e = t.length - 1; e >= 0; e--) {
			let n = t[e];
			if (n && "tabIndex" in n && n.tabIndex >= 0 && s(n)) return n;
		}
	}
	toFocus() {
