...
import { t } from "./Window-B3So1hII.js";
import { t as n } from "./Bars-BawPokrK.js";
import { t as r } from "./Actions-CmdbomE9.js";
import { r as i, t as a } from "./ModalDesignAbstract-09Xi8-4h-0ughIEtJ.js";
...
//#region ../constructor/dist/TouchEventInclude-c55bz912.js
var _ = 80, v = class {
	constructor(t, n, r, i) {
	...
	constructor(t, n, r, i, a, s, c, l, u) {
		...
		})), void 0, { align: "auto" }), e(this, "touchEvent", void 0), this.props = t, this.refs = n, this.element = r, this.classDesign = i, this.className = a, this.components = s, this.slots = c, this.emits = l, this.touchEvent = new d(void 0, (e, t, n, r) => r >= 0, (e, t) => t === "bottom" ? (this.window.expose.setOpen(!1).then(), !1) : !0);
	}
}, b = {
	barsBackHide: !0,
	touchClose: !0
