import { getElementId as a, domQuerySelector as i } from "@dxtmisha/functional";
var d = Object.defineProperty, $ = (s, t, e) => t in s ? d(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e, r = (s, t, e) => $(s, typeof t != "symbol" ? t + "" : t, e), n = /* @__PURE__ */ ((s) => (s.display = "display", s.preparation = "preparation", s.flash = "flash", s.open = "open", s.hide = "hide", s.close = "close", s))(n || {}), o = /* @__PURE__ */ ((s) => (s.block = "block", s.blockChildren = "blockChildren", s.blockOther = "blockOther", s.close = "close", s.static = "static", s.controlStatic = "controlStatic", s.controlOpenOnly = "controlOpenOnly", s.controlActive = "controlActive", s.persistent = "persistent", s))(o || {});
const u = "--sys-type-body";
class l {
  /**
   * Constructor
   ...
   */
  constructor(t) {
    r(this, "id", `window--${a()}`), r(this, "controlId", `${this.id}-control`), r(this, "list"), this.className = t, this.list = l.getClassesList(t, this.id);
  }
  /**
  ...
  findMain(t) {
    var e;
    return (e = t == null ? void 0 : t.closest(`.${this.className}`)) != null ? e : void 0;
  }
  /**
   ...
   */
  findControl() {
    return i(`.${this.list.control}.${this.id}`);
  }
  /**
  ...
  findControlByElement(t) {
    var e;
    if (t)
      return i(`.${this.list.control}.${(e = t.dataset) == null ? void 0 : e.window}`);
  }
  /**
   ...
   */
  findBody() {
    return i(`.${this.className}.${this.id} .${this.className}__body`);
  }
  /**
   ...
   */
  findBodyContext() {
    return i(`.${this.className}.${this.id} .${this.className}__body__context`);
  }
  /**
   ...
   */
  findBodyOther(t, e = n.open) {
    if (e === n.open) {
      const c = i(
        `.${this.className}:not(.${this.id})[data-status="${n.flash}"] .${this.className}__body ${t}`
      );
      if (c)
        return c;
    }
    return i(
      `.${this.className}:not(.${this.id})[data-status="${e}"] .${this.className}__body ${t}`
    );
  }
  /**
  ...
  static getClassesList(t, e = "id") {
    return {
      ...
      static: `${t}--${o.static}`,
      control: `${t}__control`,
      controlId: `${t}__control window__control ${e}`,
