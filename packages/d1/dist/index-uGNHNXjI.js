...
import { DesignConstructorAbstract as D, isFilled as T, applyTemplate as O, toNumber as g } from "@dxtmisha/functional";
...
class _ {
  ...
  constructor(t, e, o, l, n, c, h, u, m) {
    r(this, "text"), r(this, "is", a(() => this.props.counter !== void 0 || this.isMax.value)), r(this, "isMax", a(() => this.getMax() > 0)), r(this, "item", a(() => {
      ...
      return T(this.props.template) ? this.props.template.replace("[c]", i).replace("[m]", v) : this.isMax.value ? `${i} / ${v}` : i;
    })), r(this, "ariaText", a(() => {
      if (this.isMax.value) {
