...
import { m as R, _ as V } from "./D1Icon.vue_vue_type_script_setup_true_lang-BINcl8rE.js";
...
import { _ as ee } from "./D1Badge.vue_vue_type_script_setup_true_lang-Du68p-QN.js";
...
class he {
  ...
  constructor(e, i, r, t, n, a, o, c, h) {
    ...
    const {
      ...
      EventClickIncludeConstructor: k = R,
      IconTrailingIncludeConstructor: w = W,
    ...
    this.icon = new w(e, n, a), this.label = new $(
      e,
      n,
      void 0,
      o,
    ...
    ), this.ripple = new L(n, a, y), this.progress = C, this.skeleton = m, this.enabled = y, this.event = new k(e, y, c);
  }
}
const ce = {
  tabindex: "-1",
