import { ref as v, computed as m, h as y, defineComponent as x, openBlock as T, createBlock as M, unref as D, mergeDefaults as B } from "vue";
import { executePromise as b, toBinds as C, inArray as S } from "@dxtmisha/functional";
import { T as k, F as P } from "./ModalDesignAbstract-CdF7kXxe-4PrOiXMh.js";
import { D as A } from "./index-Bx1lEFLI.js";
import { D as E } from "./index-bF0IC8Yj.js";
import { D as $ } from "./index-D3YDqNji.js";
var H = Object.defineProperty, X = (n, t, e) => t in n ? H(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e, c = (n, t, e) => X(n, typeof t != "symbol" ? t + "" : t, e);
const d = 80;
class Y {
  /**
   * Constructor
...
var _ = Object.defineProperty, L = (n, t, e) => t in n ? _(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e, g = (n, t, e) => L(n, typeof t != "symbol" ? t + "" : t, e);
class I extends P {
  /**
   * Constructor
  ...
  constructor(t, e, o, i, s, a, r, u, l) {
    const {
      TouchEventIncludeConstructor: h = Y
    } = l != null ? l : {};
    super(
      t,
      e,
