...
import { getElementId as f, isFilled as S, toBinds as g, getRef as w, DesignConstructorAbstract as W, isDomRuntime as H, EventItem as U, isString as Q, inArray as m } from "@dxtmisha/functional";
...
import { g as Y } from "./D1Icon.vue_vue_type_script_setup_true_lang-Cs247ZwJ.js";
import { a as Z } from "./TextInclude--GERRCGj-qSMWmRIC.js";
import { C as ee } from "./FieldCounterInclude-D0oojGWY-Ni31uLiZ.js";
import { b as se } from "./FieldMessageInclude-BJDnir34-DohVjhSg.js";
import { B as te } from "./IconTrailingInclude-CdsOcDxv-CocNhqdl.js";
import { b as ie } from "./ProgressInclude-DlEbC7XP-Cahi9k1c.js";
import { $ as oe } from "./SkeletonInclude-BIUzAO2s-5OIs3oxk.js";
import { D as le } from "./index-DyLnu_cH.js";
import { D as re } from "./index-BqW5RZAY.js";
import { D as ae } from "./index-B7K26LcP.js";
import { D as ne } from "./index-B4sAKw5g.js";
var de = Object.defineProperty, he = (n, e, o) => e in n ? de(n, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : n[e] = o, p = (n, e, o) => he(n, typeof e != "symbol" ? e + "" : e, o);
class ce {
  /**
   * Constructor
  ...
  constructor(e, o, d, s, i, l, r, h) {
    p(this, "labelId", f()), p(this, "counterId", f()), p(this, "fieldCounter"), p(this, "is", c(() => {
      ...
      this.slots,
      this.index
    ) : []), this.props = e, this.className = o, this.components = d, this.slots = s, this.forId = i, this.isCounter = l, this.extra = r, this.index = h, this.fieldCounter = new ee(this.props, this.className);
  }
}
  ...
  constructor(e, o) {
    t(this, "left", 0), t(this, "right", 0), t(this, "title", 0), t(this, "event"), t(this, "update", (d = 128) => {
      requestAnimationFrame(() => {
        var s, i, l, r;
        const h = this.getElementSpace(), a = this.getElementPrefix();
        h && (this.left = h.offsetLeft, this.right = ((i = (s = h.parentElement) == null ? void 0 : s.offsetWidth) != null ? i : 0) - this.left - h.offsetWidth), this.title = (r = (l = a == null ? void 0 : a.offsetLeft) != null ? l : h == null ? void 0 : h.offsetLeft) != null ? r : 0, this.left < 0 ? this.update(d - 1) : this.make();
      });
    ...
    t(this, "text"), t(this, "icon"), t(this, "caption"), t(this, "prefix"), t(this, "suffix"), t(this, "fieldLabel"), t(this, "fieldMessage"), t(this, "progress"), t(this, "enabled"), t(this, "event"), t(this, "skeleton"), t(this, "icons"), t(this, "size"), t(this, "isClassic", c(
      ...
      return {
        ...
        binds: {
          id: this.id.value,
          class: y,
          ..._.invalid(this.isValidation.value),
          ..._.describedby(this.getDescribedby())
        }
      };
    })), this.props = e, this.refs = o, this.element = d, this.classDesign = s, this.className = i, this.components = l, this.slots = r, this.emits = h;
    const {
      CaptionIncludeConstructor: v = X,
      EnabledIncludeConstructor: x = K,
      EventClickIncludeConstructor: B = Y,
      FieldIconsConstructor: C = me,
      FieldLabelIncludeConstructor: $ = ce,
      FieldMessageIncludeConstructor: I = se,
      FieldSizeConstructor: N = be,
      IconTrailingIncludeConstructor: L = te,
      PrefixIncludeConstructor: A = G,
      ProgressIncludeConstructor: k = ie,
      SkeletonIncludeConstructor: T = oe,
