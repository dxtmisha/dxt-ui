import { h as c, computed as o, defineComponent as f, openBlock as M, createBlock as C, unref as D, mergeDefaults as y } from "vue";
...
import { $ as S } from "./SkeletonInclude-BIUzAO2s-5OIs3oxk.js";
import { l as w } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { D as I } from "./index-uGNHNXjI.js";
var x = Object.defineProperty, F = (a, s, t) => s in a ? x(a, s, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[s] = t, e = (a, s, t) => F(a, typeof s != "symbol" ? s + "" : s, t);
class V {
  /**
   * Constructor
...
class B {
  ...
  constructor(s, t, n, h, l, i, r, p, d) {
    ...
    const {
      ...
      FieldMessageMessageConstructor: g = V,
      SkeletonIncludeConstructor: v = S
    } = d != null ? d : {};
