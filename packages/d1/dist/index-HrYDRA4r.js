import { h as B, computed as l, defineComponent as C, openBlock as k, createBlock as w, unref as D, mergeDefaults as S } from "vue";
...
import { g as A, _ as M } from "./D1Icon.vue_vue_type_script_setup_true_lang-Cs247ZwJ.js";
...
class q {
  ...
  constructor(e, s, n, t, r, c, a, p, m) {
    ...
    const {
      ...
      IconTrailingIncludeConstructor: I = E,
      LabelIncludeConstructor: y = L,
      RippleIncludeConstructor: _ = R,
      SkeletonIncludeConstructor: x = X
    } = m != null ? m : {};
    this.skeleton = new x(this.props, this.classDesign, ["classTextVariant"]), this.enabled = new g(this.props), this.icon = new I(this.props, this.className, this.components), this.label = new y(
      this.props,
      this.className,
      void 0,
      this.slots,
