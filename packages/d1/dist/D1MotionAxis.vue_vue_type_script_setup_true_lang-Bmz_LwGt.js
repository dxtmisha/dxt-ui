import { h as x, computed as v, onMounted as b, watch as c, ref as u, defineComponent as k, openBlock as w, createBlock as D, unref as P, mergeDefaults as M } from "vue";
...
class F {
  ...
  initEvent(t) {
    if (this.element.value) {
      const e = (s) => {
        var l;
        this.isTransitionend(s) && (t(), (l = this.element.value) == null || l.removeEventListener("transitionend", e), this.toStop());
      };
...
class O {
  ...
  add(t) {
    ...
    if (t && s) {
      const l = s.getBoundingClientRect(), o = (e = s.querySelector(`[data-key="${t}"]`)) == null ? void 0 : e.getBoundingClientRect();
      l && o && (s.style.setProperty(`--${this.className}-sys-top`, `${o.top - l.top}px`), s.style.setProperty(`--${this.className}-sys-left`, `${o.left - l.left}px`), s.style.setProperty(`--${this.className}-sys-width`, `${o.width}px`), s.style.setProperty(`--${this.className}-sys-height`, `${o.height}px`));
    }
  }
  /**
  ...
  addNext() {
    ...
    const s = this.element.value;
    if (s) {
      const l = (t = s == null ? void 0 : s.querySelector(`[data-key="${this.selected.item.value}"]`)) == null ? void 0 : t.getBoundingClientRect();
      l && s.style.setProperty(`--${this.className}-sys-next-height`, `${(e = l == null ? void 0 : l.height) != null ? e : "0"}px`);
    }
  }
  /**
...
class T {
  ...
  constructor(t, e, s, l, o, a) {
    ...
    }), this.element = e, this.selected = s, this.previous = l, this.styles = o, this.emits = a, this.active.value = t.selected;
  }
  /**
...
class z {
  ...
  getByIndex(t) {
    var e;
    const s = (e = this.item.value) != null ? e : [], l = this.findIndex();
    if (l === -1)
      return s == null ? void 0 : s[0];
    const o = l + t;
    return o >= s.length ? s == null ? void 0 : s[0] : o <= -1 ? s == null ? void 0 : s[s.length - 1] : s == null ? void 0 : s[o];
  }
...
class G {
  ...
  constructor(t, e, s, l, o) {
    ...
    }), this.props = t, this.refs = e, this.element = s, this.slides = l, this.status = o, this.axis.value = t.axis, this.direction.value = t.direction, c([e.axis], () => this.setAxis(t.axis)), c([e.direction], () => this.setDirection(t.direction));
  }
}
class U {
  /**
  ...
  constructor(t, e, s, l, o, a, r, h, m) {
    ...
    }), this.props = t, this.refs = e, this.element = s, this.classDesign = l, this.className = o, this.components = a, this.slots = r, this.emits = h;
    const {
  ...
  setup(n, { expose: t, emit: e }) {
    const s = e, l = n, o = v(() => ({
      main: {
        ...
        "d1-motionAxis": !0,
        [`d1-motionAxis--axis--${l.axis}`]: g(y.axis, l.axis),
        [`d1-motionAxis--direction--${l.direction}`]: g(y.direction, l.direction)
        // :classes-values [!] System label / Системная метка
      }
    })), a = v(() => ({
