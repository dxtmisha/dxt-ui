import { computed as h, h as u, watch as P, onUnmounted as E, onMounted as F, onUpdated as q, defineComponent as z, openBlock as V, createBlock as R, unref as O, mergeDefaults as j } from "vue";
import { getElementId as f, isFilled as S, toBinds as g, getRef as _, DesignConstructorAbstract as W, isDomRuntime as H, EventItem as U, isString as Q, inArray as m } from "@dxtmisha/functional";
import { l as w } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { v as X } from "./CaptionInclude-CohAZRI2-Ui7bYJab.js";
import { m as G, v as J } from "./SuffixInclude-maZ7235l-4Uh8JpYX.js";
import { h as K } from "./EnabledInclude-B9oXYBtR-CUbxFX6i.js";
import { g as Y } from "./D1Icon.vue_vue_type_script_setup_true_lang-B26p6g1f.js";
...
import { D as re } from "./index-C7bQTPQs.js";
...
class he {
   ...
   */
  constructor(e, o, d, s, i, l, r, c) {
    p(this, "labelId", f()), p(this, "counterId", f()), p(this, "fieldCounter"), p(this, "is", h(() => {
      var a;
      return S(this.props.label) || !!((a = this.isCounter) != null && a.value);
    })), p(this, "id", h(() => {
      var a;
      return (a = this.isCounter) != null && a.value && this.props.counterShow ? this.counterId : "";
    })), p(this, "binds", h(
      () => {
        var a;
        return g(
      ...
      this.slots,
      this.index
    ) : []), this.props = e, this.className = o, this.components = d, this.slots = s, this.forId = i, this.isCounter = l, this.extra = r, this.index = c, this.fieldCounter = new ee(this.props, this.className);
  }
}
...
class me {
  ...
  constructor(e, o, d) {
    ...
    )), t(this, "isCancel", h(() => !!(this.props.cancel && !this.props.readonly && !this.props.disabled && !this.props.arrowCarousel && !this.props.arrowStepper && (this.props.cancel === "auto" && this.props.cancelShow || this.props.cancel === "always")))), t(this, "cancelBind", h(() => ({
      class: `${this.className}__cancel`,
      icon: this.props.iconClose,
      dynamic: !0,
      "data-event-type": "cancel",
      ariaLabel: this.text.cancel.value
    }))), t(this, "previousBind", h(() => ({
    ...
    }))), this.props = e, this.className = o, this.text = d;
  }
}
class be {
  /**
   ...
   */
  constructor(e, o) {
    t(this, "left", 0), t(this, "right", 0), t(this, "title", 0), t(this, "event"), t(this, "update", (d = 128) => {
      requestAnimationFrame(() => {
        var s, i, l, r;
        const c = this.getElementSpace(), a = this.getElementPrefix();
        c && (this.left = c.offsetLeft, this.right = ((i = (s = c.parentElement) == null ? void 0 : s.offsetWidth) != null ? i : 0) - this.left - c.offsetWidth), this.title = (r = (l = a == null ? void 0 : a.offsetLeft) != null ? l : c == null ? void 0 : c.offsetLeft) != null ? r : 0, this.left < 0 ? this.update(d - 1) : this.make();
      });
    }), this.element = e, this.className = o, P(e, () => this.update, { immediate: !0 }), H() && (this.event = new U(window, "resize", () => this.update()), E(() => {
      var d;
      return (d = this.event) == null ? void 0 : d.stop();
...
class fe {
   ...
   */
  constructor(e, o, d, s, i, l, r, c, a) {
    t(this, "text"), t(this, "icon"), t(this, "caption"), t(this, "prefix"), t(this, "suffix"), t(this, "fieldLabel"), t(this, "fieldMessage"), t(this, "progress"), t(this, "enabled"), t(this, "event"), t(this, "skeleton"), t(this, "icons"), t(this, "size"), t(this, "isClassic", h(
      () => !!(this.props.classic && !this.props.basic && !this.props.boxed && !this.props.filled && !this.props.outlined && !this.props.tonal)
    )), t(this, "isValidation", h(() => !!(this.props.validationMessage && (this.props.forceShowMessage || !this.props.readonly && !this.props.disabled)))), t(this, "id", h(() => String(this.props.id || f()))), t(this, "classes", h(() => ({
    ...
    })), this.props = e, this.refs = o, this.element = d, this.classDesign = s, this.className = i, this.components = l, this.slots = r, this.emits = c;
    const {
      CaptionIncludeConstructor: v = X,
      EnabledIncludeConstructor: x = K,
...
class ye extends W {
  ...
  constructor(e, o, d, s = fe) {
    super(
      ...
      return this.props.required && a.push(u(
        "span",
        ...
        u(
          ...
          u(
            "span",
            { class: (c = this.classes) == null ? void 0 : c.value.bodyTitleLabelText },
            a
          )
        )
      );
    ...
    }), t(this, "focusValue", () => !this.lengthElement.value && Q(this.props.value) ? this.props.value : ""), t(this, "lengthValue", () => {
      if (this.lengthElement.value)
        return `${this.lengthElement.value.offsetWidth}px`;
    }), t(this, "lengthElement", h(() => {
      var i, l;
      return (l = (i = this.element.value) == null ? void 0 : i.querySelector("*[data-length]")) != null ? l : void 0;
    })), t(this, "inputElement", h(() => {
      var i, l, r, c;
      return (c = (r = this.element.value) == null ? void 0 : r.querySelector(`input.${(i = this.classes) == null ? void 0 : i.value.bodyInput}, .${(l = this.classes) == null ? void 0 : l.value.bodyInput} input`)) != null ? c : void 0;
    })), this.item = new s(
      this.props,
      this.refs,
      this.element,
  ...
  initRender() {
    var e, o;
    const d = [];
    return this.item.isClassic.value && d.push(...this.item.fieldLabel.render()), d.push(
      ...this.renderBody(),
  ...
  setup(n, { expose: e, emit: o }) {
    const d = o, s = n, i = h(() => ({
      ...
      return {
        ...
        "--d1-field-sys-width": (a = s.width) != null ? a : null
        // :styles-values [!] System label / Системная метка
      };
    }), r = new ye(
      "d1.field",
