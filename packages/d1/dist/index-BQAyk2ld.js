import { computed as n, h as v, onMounted as S, nextTick as g, defineComponent as f, openBlock as b, createBlock as y, unref as D, mergeDefaults as _ } from "vue";
import { DesignConstructorAbstract as x, goScrollTo as N, inArray as T } from "@dxtmisha/functional";
var w = Object.defineProperty, z = (s, e, t) => e in s ? w(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, p = (s, e, t) => z(s, typeof e != "symbol" ? e + "" : e, t);
class $ {
  /**
   * Constructor
...
var k = Object.defineProperty, I = (s, e, t) => e in s ? k(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t, o = (s, e, t) => I(s, typeof e != "symbol" ? e + "" : e, t);
class C {
  /**
   * Constructor
  ...
  setup(s, { expose: e, emit: t }) {
    const l = t, i = s, a = n(() => ({
      main: {
        ...
        [`d1-horizontalScroll--align--${i.align}`]: T(H.align, i.align)
        // :classes-values [!] System label / Системная метка
      }
    })), c = n(() => ({
