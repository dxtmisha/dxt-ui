import { computed as p, ref as c, watch as L, h as A, defineComponent as D, openBlock as V, createBlock as q, unref as M, mergeDefaults as T } from "vue";
import { DesignConstructorAbstract as j, ListDataRef as N, isFunction as _, executePromise as F, Api as I, isFilled as W, isObject as H, toBinds as O, inArray as E } from "@dxtmisha/functional";
import { g as R } from "./D1Icon.vue_vue_type_script_setup_true_lang-Cs247ZwJ.js";
import { V as $ } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { v as G } from "./WindowInclude-qHcXkLtH-D0NScAjF.js";
import { u as P } from "./BarsInclude-BOEoY-O4-CYODSNy_.js";
import { D as U } from "./index-DNP45n88.js";
import { D as X } from "./index-bF0IC8Yj.js";
import { D as Y } from "./index-Bx1lEFLI.js";
...
class K {
   ...
   */
  async getAjax() {
    return _(this.props.ajax) ? F(this.props.ajax) : await I.request({
...
class st {
  ...
  constructor(t, s, i, a, o, l, h, n, d) {
    ...
    const {
      BarsIncludeConstructor: v = P,
      EventClickIncludeConstructor: f = R,
      ListDataRefConstructor: w = N,
  ...
  setup(r, { expose: t, emit: s }) {
    const i = s, a = r, o = p(() => ({
      main: {
        ...
        [`d1-menu--barsAdaptive--${a.barsAdaptive}`]: E(ot.barsAdaptive, a.barsAdaptive)
        // :classes-values [!] System label / Системная метка
      }
    })), l = p(() => ({
