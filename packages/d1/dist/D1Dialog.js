...
import { T as H, F as T } from "./ModalDesignAbstract-CdF7kXxe-4PrOiXMh.js";
import { y as F } from "./WindowClassesInclude-B56usxgx-Y5bmzXSo.js";
import { B as E } from "./IconInclude-CLqwI29Q-Dlz7DC2a.js";
import { D as V } from "./index-Bx1lEFLI.js";
import { D as N } from "./index-bF0IC8Yj.js";
import { D as W } from "./index-D3YDqNji.js";
import { D as $ } from "./index-DyLnu_cH.js";
...
class G extends T {
  ...
  constructor(t, s, d, e, n, a, r, u, p) {
    const {
      ...
      IconIncludeConstructor: w = E,
      LabelIncludeConstructor: C = O,
      TextIncludeConstructor: v = L,
      WindowClassesIncludeConstructor: k = F
    } = p != null ? p : {};
    super(
      t,
      s,
  ...
  setup(o, { expose: t, emit: s }) {
    const d = s, e = o, n = c(() => ({
      main: {
        ...
        [`d1-dialog--imagePosition--${e.imagePosition}`]: g(f.imagePosition, e.imagePosition),
        [`d1-dialog--width--${e.width}`]: g(f.width, e.width)
        // :classes-values [!] System label / Системная метка
      }
    })), a = c(() => ({
