import { h as a, computed as d, defineComponent as A, openBlock as $, createBlock as H, unref as N, mergeDefaults as E } from "vue";
import { DesignConstructorAbstract as _, getBind as L, toBinds as T, inArray as m } from "@dxtmisha/functional";
...
import { b as G } from "./FieldMessageInclude-BJDnir34-DohVjhSg.js";
import { $ as J } from "./SkeletonInclude-BIUzAO2s-5OIs3oxk.js";
import { b as Q } from "./ProgressInclude-DlEbC7XP-Cahi9k1c.js";
import { o as Y } from "./RippleInclude-Du5yIzX_-DwebniuR.js";
import { l as v } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { D as Z } from "./index-CoclgqEF.js";
import { D as ee } from "./index-B7K26LcP.js";
import { D as te } from "./index-B4sAKw5g.js";
import { D as ie } from "./index-uisGNUv8.js";
var se = Object.defineProperty, oe = (n, t, o) => t in n ? se(n, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : n[t] = o, e = (n, t, o) => oe(n, typeof t != "symbol" ? t + "" : t, o);
class ne {
  /**
   * Constructor
...
class re {
   ...
   */
  constructor(t, o, h, s, i, r, l, c, p) {
    e(this, "type", "checkbox"), e(this, "attributes"), e(this, "change"), e(this, "code"), e(this, "description"), e(this, "elementItem"), e(this, "enabled"), e(this, "event"), e(this, "icon"), e(this, "label"), e(this, "message"), e(this, "progress"), e(this, "ripple"), e(this, "skeleton"), e(this, "validation"), e(this, "value"), this.props = t, this.refs = o, this.element = h, this.classDesign = s, this.className = i, this.components = r, this.slots = l, this.emits = c;
    const {
      CheckboxIconConstructor: u = ne,
      ...
      FieldValueIncludeConstructor: D = W,
      LabelConstructor: S = P,
      ProgressConstructor: V = Q,
      RippleConstructor: F = Y,
      SkeletonConstructor: M = J
    } = p != null ? p : {};
    ...
    ), this.change = new f(this.props), this.elementItem = new x(this.props, this.element), this.attributes = new k(this.props), this.value = new D(
      this.props,
      this.refs,
      this.elementItem
    ...
    ), this.icon = new u(this.props, this.value), this.label = new S(
      t,
      i,
      void 0,
      l,
