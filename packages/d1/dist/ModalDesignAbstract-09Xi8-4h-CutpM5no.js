...
import { n as t } from "./Window-Dpg33aic.js";
import { n } from "./Bars-BawPokrK.js";
import { n as r } from "./Actions-CmdbomE9.js";
import { h as i } from "vue";
import { DesignConstructorAbstract as a, getElementId as o, toBinds as s } from "@dxtmisha/functional";
//#region ../constructor/dist/ModalDesignAbstract-09Xi8-4h.js
var c = class {
	constructor(i, a, s, c, l, u, d, f, p, m, h) {
		...
		let g = o(), _ = o();
		this.bars = new n(i, l, u, f, m, g, _), this.actions = new r(i, l, u, f, h), this.window = new t(i, l, u, f, p, g, _);
	}
}, l = {
	barsBackHide: !0,
	imagePosition: "top"
