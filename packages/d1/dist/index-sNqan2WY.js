...
import { g as R, _ as V } from "./D1Icon.vue_vue_type_script_setup_true_lang-Cs247ZwJ.js";
...
import { _ as ee } from "./D1Badge.vue_vue_type_script_setup_true_lang-DDyP8LuL.js";
...
class he {
  ...
  constructor(e, i, r, t, n, a, o, c, h) {
    ...
    const {
      ...
      EnabledIncludeConstructor: w = U,
      EventClickIncludeConstructor: _ = R,
      IconTrailingIncludeConstructor: k = W,
      LabelHighlightIncludeConstructor: $ = oe,
      PrefixIncludeConstructor: D = G,
      ProgressIncludeConstructor: L = X,
      RippleIncludeConstructor: A = Y,
    ...
    this.icon = new k(e, n, a), this.label = new $(
      ...
      void 0,
      m
    ), this.prefix = new D(e, n, o, m), this.caption = new v(e, n, o), this.suffix = new z(e, n, o), this.description = new B(e, n, o, m), this.badge = new d(
      e,
      n,
      a,
      {
    ...
    ), this.ripple = new A(n, a, y), this.progress = C, this.skeleton = m, this.enabled = y, this.event = new _(e, y, c);
  }
}
const ce = {
  tabindex: "-1",
