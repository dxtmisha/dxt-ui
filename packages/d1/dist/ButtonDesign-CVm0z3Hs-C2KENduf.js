...
import { DesignConstructorAbstract as x } from "@dxtmisha/functional";
import { a as S } from "./getClassTagAStatic-BnVYlXHI-DhbmeMA0.js";
import { x as N } from "./LabelInclude-D-mLvjK5-Bnui6CyX.js";
import { h as B } from "./EnabledInclude-B9oXYBtR-CUbxFX6i.js";
import { l as u } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { g as D } from "./D1Icon.vue_vue_type_script_setup_true_lang-B26p6g1f.js";
import { B as E } from "./IconTrailingInclude-CdsOcDxv-CocNhqdl.js";
import { b as L } from "./ProgressInclude-DlEbC7XP-Cahi9k1c.js";
import { o as I } from "./RippleInclude-Du5yIzX_-DwebniuR.js";
import { $ as O } from "./SkeletonInclude-BIUzAO2s-5OIs3oxk.js";
var P = Object.defineProperty, T = (i, t, e) => t in i ? P(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e, s = (i, t, e) => T(i, typeof t != "symbol" ? t + "" : t, e);
class A {
  /**
   * Constructor
  ...
  constructor(t, e, h, n, r, a, p, m, c) {
    ...
    const {
      EnabledConstructor: b = B,
      EventConstructor: d = D,
      IconConstructor: v = E,
      LabelConstructor: f = N,
      ProgressConstructor: C = L,
      RippleConstructor: w = I,
      SkeletonConstructor: y = O
    } = c != null ? c : {}, g = new C(
      t,
      r,
      a,
    ...
    this.label = new f(t, r, void 0, p), this.enabled = new b(t, g), this.icon = new v(t, r, a), this.progress = g, this.ripple = new w(r, a, this.enabled), this.skeleton = new y(
      t,
      n,
      ["classBackground"]
    ), this.event = new d(
