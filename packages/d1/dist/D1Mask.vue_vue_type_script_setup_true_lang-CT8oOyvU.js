...
import { DesignConstructorAbstract as rt, GeoRef as at, anyToString as T, isFloat as ht, toArray as nt, isFilled as ut, Datetime as $, GeoIntl as lt, strFill as L, isArray as x, getMaxLengthAllArray as ot, isString as M, forEach as F, isObjectNotArray as B, replaceRecursive as ct, getColumn as pt, isSelected as mt, getExp as gt, isObject as vt, writeClipboardData as dt, eventStopPropagation as ft, getClipboardData as bt, toBinds as yt, inArray as N } from "@dxtmisha/functional";
...
class Tt {
   ...
   */
  getNumberForString() {
    const t = this.fraction.value, e = L("9", this.rubberItem.getByIndex("n") + 1), i = t ? `.${L("3", t)}` : "", s = this.type.isCurrency() && this.props.currency ? ` ${this.props.currency}` : "";
    return `${e}${i}${s}`;
  }
  /**
...
class Vt {
  ...
  is(t, e) {
    const i = this.get(e);
    return i instanceof RegExp ? !!t.match(i) : M(i) ? !!t.match(new RegExp(i)) : !!t.match(E);
  }
  /**
  ...
  constructor(t, e, i, s) {
    a(this, "item", g(() => {
      ...
      for (const u in r) {
        ...
        r[u] && (M(l) ? Object.assign(r[u], { pattern: l }) : B(l) && B(r[u]) && Object.assign(r[u], l));
      }
      return r;
  ...
  constructor(t, e, i, s, r, u, l) {
    a(this, "list", g(() => {
      ...
      Object.values(this.list.value).filter(
        (n) => "transitionChar" in n && (M(n.transitionChar) || x(n.transitionChar))
      ),
      "transitionChar"
...
class zt {
  ...
  constructor(t, e, i, s, r, u, l, n, h) {
    ...
    const {
      ...
      MaskRubberTransitionConstructor: H = Lt,
