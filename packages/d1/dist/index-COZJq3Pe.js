...
import { toBinds as k, getRef as D, toBind as C, eventStopPropagation as p, isEnter as M } from "@dxtmisha/functional";
import { _ as O } from "./D1Field.vue_vue_type_script_setup_true_lang-DEnzkq-Y.js";
var B = Object.defineProperty, N = (t, e, r) => e in t ? B(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, h = (t, e, r) => N(t, typeof e != "symbol" ? e + "" : e, r);
class H {
  /**
   * Constructor
   ...
   */
  constructor(e, r, w, b, m, x, y, T, A, P, S) {
    h(this, "binds", g(() => {
      var i, s, o, n, l, a;
      return k(
        {
          ...
          arrowStepper: (n = (o = this.arrow) == null ? void 0 : o.isStepper()) != null ? n : this.props.arrow === "stepper",
          arrowAlign: (a = (l = this.arrow) == null ? void 0 : l.align()) != null ? a : this.props.arrowAlign,
      ...
      if (i.target.closest('[data-element="scoreboard"]'))
        switch (s) {
          case "icon":
            ...
            break;
          case "icon-trailing":
            (n = this.onTrailing) == null || n.call(this), p(i);
            break;
          case "cancel":
            (l = this.event) == null || l.onClear(i), p(i);
            break;
          case "next":
            (a = this.onNext) == null || a.call(this), (u = this.arrow) == null || u.next(), (c = this.event) == null || c.on(i), p(i);
            break;
          case "previous":
            (d = this.onPrevious) == null || d.call(this), (v = this.arrow) == null || v.previous(), (f = this.event) == null || f.on(i), p(i);
            break;
        }
    }), h(this, "onKeydown", (i, s) => {
      M(i) && (this.on(i, s != null ? s : {}), i.preventDefault());
    }), this.props = e, this.value = r, this.components = w, this.event = b, this.arrow = m, this.onIcon = x, this.onTrailing = y, this.onNext = T, this.onPrevious = A, this.extra = P, this.index = S;
  }
}
const I = O;
export {
