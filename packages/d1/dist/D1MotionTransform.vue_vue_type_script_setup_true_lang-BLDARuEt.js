import { ref as d, computed as a, h as r, Teleport as B, watch as p, onUnmounted as O, defineComponent as W, openBlock as D, createBlock as E, unref as M, mergeDefaults as z } from "vue";
...
import { V as _ } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { E as N, v as F } from "./WindowEsc-DTwn4Vsz-CY0loI-Z.js";
...
class V {
  ...
  constructor(t, e, n, o, s, h, m, c, u, g) {
    ...
    ), new b("open", this.emits, this.state.open), p([e.open], () => this.state.set(!!t.open)), O(() => this.event.stop());
  }
  /**
