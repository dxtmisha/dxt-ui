import { h as u, computed as l, toRef as S, onMounted as M, nextTick as A, watch as C, onUnmounted as L, ref as y, defineComponent as E, openBlock as D, createBlock as _, unref as F, mergeDefaults as G } from "vue";
import { DesignConstructorAbstract as T, ListDataRef as P, toBinds as c, isDomRuntime as f, EventItem as N, goScroll as O, isSelected as R, isFilled as $, isObject as H, inArray as V } from "@dxtmisha/functional";
import { l as d } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { m as q } from "./D1Icon.vue_vue_type_script_setup_true_lang-BINcl8rE.js";
import { y as U } from "./WindowClassesInclude-B56usxgx-Y5bmzXSo.js";
import { _ as j } from "./D1ListItem.vue_vue_type_script_setup_true_lang-D5WcLLN2.js";
import { _ as W } from "./D1ListGroup.vue_vue_type_script_setup_true_lang-CuJZyJcr.js";
import { _ as X } from "./D1ListMenu.vue_vue_type_script_setup_true_lang-CNZXcyRI.js";
...
class Q {
  ...
  constructor(t, e, i) {
    r(this, "item", y()), r(this, "focus", l(() => {
      var n, s;
      return (s = (n = this.item.value) == null ? void 0 : n.index) != null ? s : this.props.focus;
...
class Y {
   ...
   */
  constructor(t, e, i, n) {
    r(this, "index", -1), this.props = t, this.focus = e, this.data = i, this.emits = n;
  }
  /**
   ...
   */
  preparation(t) {
    const e = this.data.map.value, i = e.findIndex((n) => R(n.index, t));
...
class tt {
  ...
  constructor(t, e, i, n) {
    ...
    }), this.props = t, this.search = e, this.data = i, this.go = n, C(
      this.isActive,
      (s) => {
...
class st {
  ...
  constructor(t, e, i, n, s, a, h, m, p) {
    ...
    })), this.props = t, this.refs = e, this.element = i, this.classDesign = n, this.className = s, this.components = a, this.slots = h, this.emits = m;
    const {
    ...
    this.search = new w(this.props), this.focus = new I(this.props, this.element, this.id), this.data = new x(
      ...
      void 0,
      this.refs.max
    ), this.go = new k(this.props, this.focus, this.data, this.emits), this.control = new b(this.props, this.search, this.data, this.go), this.event = new g(void 0, void 0, m), this.windowClasses = new B(n), this.props.control && M(async () => {
...
class rt extends T {
   ...
   */
  constructor(t, e, i, n = st) {
    super(
      t,
      e,
      i
    ), r(this, "item"), r(this, "renderData", () => this.renderDataByItem("item", this.item.list.value, !0)), r(this, "renderItem", (s, a) => this.components.renderOne(
      "listItem",
      this.getItemAttrs(s, a)
    )), r(this, "renderItemGroup", (s, a) => this.components.renderOne(
      "listItem",
      this.item.getItemManagementFormGroup(s, a)
    )), r(this, "renderItemMenu", (s, a) => this.components.renderOne(
      "listItem",
      c(
        this.item.getItemManagementFormMenu(s, !!a.open.value),
        a.binds
      )
      ...
      return u("div", {
        key: s.value,
        class: [
          (a = this.classes) == null ? void 0 : a.value.space,
      ...
      return u("div", {
        key: s.value,
        class: [
          (a = this.classes) == null ? void 0 : a.value.line,
          this.item.windowClasses.get().static
        ],
        ...d.role("separator")
      });
      ...
      return u("div", {
        key: s.value,
        class: [
          (a = this.classes) == null ? void 0 : a.value.subtitle,
          this.item.windowClasses.get().static
        ],
        ...d.role("separator")
      }, s.label);
      ...
      var a;
      const h = {
        key: s.label && H(s.value) ? s.label : s.value,
        class: [
          (a = this.classes) == null ? void 0 : a.value.html,
          this.item.windowClasses.get().static
        ]
      };
      ...
      {
        head: (a) => this.renderItemGroup(s, a),
        list: () => this.renderDataByItem("group", this.item.getList(s))
      }
    )), r(this, "renderMenu", (s, a) => this.components.renderOne(
      "listMenu",
      {
        divider: this.props.divider,
        axis: a && this.props.axis === "x" ? "y" : "x",
        disabled: s.disabled
      },
      {
  ...
  renderDataByItem(t, e, i = !1) {
    ...
    return e.forEach((s) => {
      switch (s.type) {
        case "space":
          n.push(this.renderSpace(s));
          break;
        case "line":
          n.push(this.renderLine(s));
          break;
        case "subtitle":
          n.push(this.renderSubtitle(s));
          break;
        case "html":
          n.push(this.renderHtml(s));
          break;
        case "group":
          this.isHighlight(s) && n.push(this.renderGroup(s));
          break;
        case "menu":
          this.isHighlight(s) && n.push(this.renderMenu(s, i));
          break;
        default:
          n.push(this.renderItem(t, s));
          break;
      }
    }), n.push(u("div")), n;
  }
  ...
  setup(o, { expose: t, emit: e }) {
    const i = e, n = o, s = l(() => ({
      main: {
        ...
        "d1-list": !0,
        "d1-list--focus": n.focus,
        [`d1-list--axis--${n.axis}`]: V(ht.axis, n.axis),
        "d1-list--divider": n.divider
        // :classes-values [!] System label / Системная метка
      }
    })), a = l(() => ({
