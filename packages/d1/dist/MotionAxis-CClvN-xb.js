...
import { DesignConstructorAbstract as f, forEach as p, getRef as m, inArray as h, toBinds as g } from "@dxtmisha/functional";
//#region ../constructor/dist/MotionAxisInclude-DS2WvdMv.js
var _ = class {
	constructor(t, r, i, a, o, s, c) {
		e(this, "element", l()), e(this, "selectedItem", n(() => this.selected ? m(this.selected) : this.props.selected)), e(this, "binds", n(() => g(m(this.extra), { class: `${this.className}__motionAxis` }, this.props.motionAxisAttrs))), e(this, "render", (e, t) => this.components ? this.components.render("motionAxis", {
			...g(t, this.binds.value, { selected: this.selectedItem.value }),
			ref: this.element,
			onMotionAxis: this.onMotionAxis
		}, e, this.index) : []), e(this, "onMotionAxis", (e) => {
			var t;
			(t = this.emits) == null || t.call(this, "motionAxis", e);
		}), this.props = t, this.className = r, this.components = i, this.emits = a, this.extra = o, this.selected = s, this.index = c;
	}
}, v = class {
	constructor(t, n) {
	...
	constructor(r, i, a, o, c, l, u, f, p) {
		...
		let { ModelIncludeConstructor: m = t, MotionAxisElementConstructor: h = v, MotionAxisGoConstructor: g = w, MotionAxisPreviousConstructor: _ = x, MotionAxisSelectedConstructor: T = y, MotionAxisSlidesConstructor: E = C, MotionAxisStatusConstructor: D = S, MotionAxisStylesConstructor: O = b } = p == null ? {} : p;
		this.selected = new T(this.props), this.elementItem = new h(this.element, this.className), this.styles = new O(this.element, this.className, this.selected), this.previous = new _(this.styles), this.status = new D(this.props, this.elementItem, this.selected, this.previous, this.styles, this.emits), this.slides = new E(this.status), this.go = new g(this.props, this.refs, this.element, this.slides, this.status), new m("selected", this.emits, this.selected.item), s(() => {
	...
	setup(e, { expose: t, emit: i }) {
		let a = i, o = e, s = new D("d1.motionAxis", o, {
			emits: a,
			classes: n(() => ({ main: {
				"d1-motionAxis": !0,
				[`d1-motionAxis--axis--${o.axis}`]: h(O.axis, o.axis),
				[`d1-motionAxis--direction--${o.direction}`]: h(O.direction, o.direction)
			} })),
			styles: n(() => ({}))
		}), l = s.render();
