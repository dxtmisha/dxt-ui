...
declare const __VLS_component: DefineComponent<D1TabsProps, {
...
}, string, PublicProps, Readonly<D1TabsProps> & Readonly<{
...
export declare const D1Tabs: __VLS_WithTemplateSlots<typeof __VLS_component, __VLS_TemplateResult["slots"]>;

/**
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
export declare type D1TabsProps = TabsPropsBasic<TabItemProps, TabsNavigationProps, MotionAxisProps> & PropsToken_7;
 ...
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
declare type MotionAxisProps = MotionAxisPropsBasic & PropsToken_6;
 ...
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
declare type TabsNavigationProps = TabsNavigationPropsBasic<TabItemProps> & PropsToken_5;
