...
import { t } from "./LabelInclude-BJc8uC4Y-Wn8gBK6K.js";
import { t as n } from "./DescriptionInclude--_NvJ6ka-FXt3BEBB.js";
import { t as r } from "./IconInclude-Bex3cqNy-pV2QVrSN.js";
import { t as i } from "./TextInclude-BIa1AeDQ-C-pyoUw5.js";
import { t as a } from "./Window-BzF3hpOO.js";
import { t as o } from "./Bars-HkklEy9_.js";
import { t as s } from "./Actions-KKJJ2K_j.js";
import { r as c, t as l } from "./ModalDesignAbstract-09Xi8-4h-BQ46O_TF.js";
import { i as u } from "./WindowClassesInclude-C8R8pgeo-DhszkcJh.js";
import { t as d } from "./Icon-hEsmQkfg.js";
...
var C = class extends l {
	constructor(a, o, s, c, l, d, p, m, h) {
		...
		})), e(this, "icon", void 0), e(this, "label", void 0), e(this, "description", void 0), e(this, "windowClasses", void 0), e(this, "text", void 0), e(this, "iconValue", f(() => this.props.success ? this.props.iconSuccess : this.props.error ? this.props.iconError : this.props.icon)), this.props = a, this.refs = o, this.element = s, this.classDesign = c, this.className = l, this.components = d, this.slots = p, this.emits = m, this.icon = new _(v({ icon: this.iconValue }), l, d, o.iconAttrs), this.label = new y(a, l, void 0, p, void 0, void 0, !0), this.description = new g(a, l, p), this.windowClasses = new S(c), this.text = new x(this.props);
	}
}, w = {
	barsBackHide: !0,
	barsHide: !0,
