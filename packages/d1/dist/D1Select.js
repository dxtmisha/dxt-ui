import { ref as b, computed as a, h as f, defineComponent as V, openBlock as T, createBlock as k, unref as O, mergeDefaults as E } from "vue";
import { toBinds as m, getRef as _, toBind as L, DesignConstructorAbstract as N, executeFunction as $, isFilled as j } from "@dxtmisha/functional";
import { D as P, O as q, T as z, V as H, N as U, H as K, w as R } from "./FieldEventInclude-h5Fg7306-DMkm_Aee.js";
import { y as W } from "./FieldInclude-BKoBWZdj-BnMZR_TN.js";
import { l as y } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { D as G } from "./index-h4CZgIAO.js";
import { D as J } from "./index-DY4G9SUw.js";
import { D as Q } from "./index-Cv0hIkdl.js";
import { D as X } from "./index-Cgtf8aY0.js";
...
class oe {
  ...
  constructor(t, s, u, h, n, e, l, c, d) {
    i(this, "attributes"), i(this, "elementItem"), i(this, "change"), i(this, "value"), i(this, "code"), i(this, "validation"), i(this, "event"), i(this, "field"), i(this, "menu"), i(this, "input"), i(this, "filter"), i(this, "isSlot", a(() => {
      var o, g;
      return !!((o = this.slots) != null && o.contextTop || (g = this.slots) != null && g.contextBottom);
    ...
    const {
      ...
      MenuIncludeConstructor: D = ee,
      SelectFilterConstructor: M = ne,
      SelectInputConstructor: F = se
    } = d != null ? d : {};
