...
var O = class {
	...
	constructor(n, a, o, s, l, u, d, f, p) {
		...
		}), this.props = n, this.refs = a, this.element = o, this.classDesign = s, this.className = l, this.components = u, this.slots = d, this.emits = f;
		let { BarsIncludeConstructor: m = i, EventClickIncludeConstructor: h = t, ListDataRefConstructor: g = y, MenuGoConstructor: _ = N, MenuRequestConstructor: v = k, MenuSearchConstructor: b = A, MenuValueConstructor: x = M, MenuWindowConstructor: S = j, WindowIncludeConstructor: C = r } = p == null ? {} : p;
	...
	setup(e, { expose: t, emit: n }) {
		let r = n, i = e, u = new I("d1.menu", i, {
			emits: r,
			classes: c(() => ({ main: {
				"d1-menu": !0,
				"d1-menu--hideList": i.hideList,
				[`d1-menu--barsAdaptive--${i.barsAdaptive}`]: S(L.barsAdaptive, i.barsAdaptive)
			} })),
			styles: c(() => ({})),
			components: {
				list: s,
