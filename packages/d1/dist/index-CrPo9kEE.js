import { computed as u, toRef as F, onMounted as A, watch as x, ref as g, nextTick as S, defineComponent as B, openBlock as z, createBlock as T, unref as $, mergeDefaults as L } from "vue";
import { DesignConstructorAbstract as R, ListDataRef as E, isSelected as P, toBinds as N, getRef as I, isDomRuntime as V, EventItem as _, getElementId as H, toArray as q } from "@dxtmisha/functional";
import { l as M } from "./AriaStaticInclude-DRHG8ILX-ByYIvmyT.js";
import { g as O } from "./D1Icon.vue_vue_type_script_setup_true_lang-Cs247ZwJ.js";
import { V as j } from "./ModelInclude-BiYm_iCQ-BvlyUUtY.js";
import { D as U } from "./index-BQAyk2ld.js";
import { D as G } from "./index-HrYDRA4r.js";
...
class Q {
  ...
  constructor(t, e, r, o, h) {
    ...
    }), this.props = t, this.className = e, this.components = r, this.extra = o, this.index = h;
  }
}
class W {
  /**
   ...
   */
  isSelected(t) {
    return P(t, this.actualItem.value);
  }
  /**
...
class Z {
   ...
   */
  constructor(t, e, r, o, h, i) {
    s(this, "go", async (l, a) => {
      await S();
      const c = this.getItem(l), d = this.getItem(a);
      if (c && d) {
        const m = `${this.classDesign}-${this.getItemClassName()}`, f = c.getBoundingClientRect(), v = d.getBoundingClientRect(), p = v.left - f.left, y = `${p}px ${p >= 0 ? "-" : "+"} var(--${m}-gap, 0px)`;
        c.style.setProperty(`--${m}-sys-left`, y), c.style.setProperty(`--${m}-sys-width`, v.width + "px"), this.reset(c);
      }
    ...
    }), this.props = t, this.refs = e, this.element = r, this.classDesign = o, this.className = h, this.selected = i, x(
      this.selected.item,
      (l, a) => this.go(l, a)
    ), S().then(
      () => requestAnimationFrame(
...
class et {
  ...
  constructor(t, e, r, o, h, i, l, a, c) {
    ...
    }), this.props = t, this.refs = e, this.element = r, this.classDesign = o, this.className = h, this.components = i, this.slots = l, this.emits = a;
    const {
      EventClickIncludeConstructor: d = O,
      HorizontalScrollIncludeConstructor: m = Q,
      ListDataRefConstructor: f = E,
      ModelIncludeConstructor: v = j,
      TabsNavigationControlConstructor: p = tt,
      TabsNavigationIdsConstructor: y = Y,
      TabsNavigationFocusConstructor: k = X,
      TabsNavigationIndicatorConstructor: C = Z,
    ...
    this.scroll = new m(
      ...
      this.className,
      this.components
    ), this.selected = new w(this.props), this.focus = new k(
      this.element,
      this.selected
    ), this.data = new f(
      F(this.props, "list"),
...
class it extends R {
  ...
  constructor(t, e, r, o = et) {
    super(
      ...
      e,
      r
    ), s(this, "item"), s(this, "renderList", (h) => {
      const i = [];
