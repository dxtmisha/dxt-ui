...
declare const __VLS_component: DefineComponent<D1ModalProps, {
...
}, string, PublicProps, Readonly<D1ModalProps> & Readonly<{
...
export declare const D1Modal: __VLS_WithTemplateSlots<typeof __VLS_component, __VLS_TemplateResult["slots"]>;

/**
 * Type describing incoming properties/ Тип, описывающий входящие свойства
 */
export declare type D1ModalProps = ModalPropsBasic<WindowProps, BarsProps, ActionsProps, ImageProps> & PropsToken_9;
