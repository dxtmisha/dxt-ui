...
- The `delay` property prevents the progress indicator from appearing for short operations, eliminating unnecessary flickers in the interface.
- `delayHide` ensures smooth hiding of the indicator, even if the operation completed very quickly, creating a more natural transition.
- Both properties work together to create an optimal user experience when displaying loading states.
