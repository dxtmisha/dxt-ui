...
- `getItemsInfo(): Promise<UiFigmaFramesList>` — Returns detailed info (name, ID, image) for all items in the frame.
- `getMainItemsInfo(): Promise<UiFigmaFramesList>` — Returns detailed info (name, ID, image) for all main items.
