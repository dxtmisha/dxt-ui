...
Tạo một thực thể `ApiStatus` mới. Lớp này chuyên dùng để theo dõi và quản lý trạng thái của một yêu cầu API, bao gồm trạng thái HTTP, lỗi và dữ liệu phản hồi.
