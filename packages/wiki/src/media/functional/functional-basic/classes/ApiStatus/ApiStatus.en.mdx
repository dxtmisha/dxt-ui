...
Creates a new `ApiStatus` instance. The class is dedicated to tracking and managing the state of an API request, including HTTP status, errors, and response data.
