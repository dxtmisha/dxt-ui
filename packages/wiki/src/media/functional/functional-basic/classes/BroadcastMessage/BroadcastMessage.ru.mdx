...
- **Управление ресурсами** — включает метод `destroy()` для закрытия канала и освобождения системных ресурсов.
...
- `destroy(): void` — Закрывает канал и прекращает прослушивание сообщений.
