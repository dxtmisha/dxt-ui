...
Creates a new `ApiHeaders` instance. The class is used to store and manage headers that will be automatically added to every HTTP request. Provides centralized management for data such as authorization tokens or application metadata.
