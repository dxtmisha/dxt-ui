...
- `remove(): this` — Xóa bỏ chính xác khóa lưu trữ tương ứng từ phần môi trường phần mềm `localStorage` или `sessionStorage`, đồng thời lập tức dọn sạch dữ liệu khối nhớ hiện tại.
