...
export const wikiAttributes: StorybookArgsToList = {
  ...
  collageBarAttrs: {
    ...
    options: {
      category: StorybookCategory.attributes,
      description: {
        en: 'Additional attributes for the CollageBar component',
        ru: 'Дополнительные атрибуты для компонента CollageBar'
      }
    },
    hide: true
  },
  cropAreaAttrs: {
    ...
    options: {
      category: StorybookCategory.attributes,
      description: {
        en: 'Additional attributes for the CropArea component',
        ru: 'Дополнительные атрибуты для компонента CropArea'
      }
    },
    hide: true
  },
  ...
  tableRecordAttrs: {
    ...
    options: {
      category: StorybookCategory.attributes,
      description: {
        en: 'Additional attributes for the TableRecord component',
        ru: 'Дополнительные атрибуты для компонента TableRecord'
      }
    },
    hide: true
  },
  tableRowAttrs: {
    ...
    options: {
      category: StorybookCategory.attributes,
      description: {
        en: 'Additional attributes for Table row components',
        ru: 'Дополнительные атрибуты для компонентов строк Table'
      }
    },
    hide: true
  },
