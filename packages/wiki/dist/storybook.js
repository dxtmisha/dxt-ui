...
import { t } from "./wikiDescriptions-CJv5fdyX.js";
...
//#endregion
//#region src/media/mdx/ButtonGroup/buttonGroup.en.mdx
function $i(e) {
	let t = {
		code: "code",
		li: "li",
	...
	return s(a, { children: [
		o(t.p, { children: "Component for grouping multiple buttons into a single block." }),
		"\n",
		o(t.p, { children: "ButtonGroup allows organizing buttons into logical groups with shared styling and alignment. It supports horizontal and vertical orientation, automatic wrapping of elements, and passing shared attributes to all nested buttons." }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Key Features:" }) }),
		"\n",
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Horizontal and vertical orientation" }),
			"\n",
			o(t.li, { children: "Automatic wrapping of buttons (wrap) when space is limited" }),
			"\n",
			s(t.li, { children: ["Passing shared attributes (size, style, color) to all buttons via ", o(t.code, { children: "buttonAttrs" })] }),
			"\n",
			s(t.li, { children: [
				"Flexible management of the button list via the ",
				o(t.code, { children: "list" }),
				" array or the ",
				o(t.code, { children: "default" }),
				" slot"
			] }),
			"\n",
			o(t.li, { children: "Consistent spacing between buttons in the group" }),
			"\n"
		] }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Typical Usage Scenarios:" }) }),
		...
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Toolbars" }),
			"\n",
			o(t.li, { children: "Groups of switches or actions in forms" }),
			"\n",
			o(t.li, { children: "Navigation blocks" }),
			"\n",
			o(t.li, { children: "Control blocks in cards or lists" }),
			"\n",
			o(t.li, { children: "Option selection (filters, sorting)" }),
			"\n"
		] }),
		"\n",
		o(i, {
...
//#endregion
//#region src/media/mdx/ButtonGroup/buttonGroup.ru.mdx
function ta(e) {
	let t = {
		code: "code",
		li: "li",
	...
	return s(a, { children: [
		o(t.p, { children: "Компонент для группировки нескольких кнопок в единый блок." }),
		"\n",
		o(t.p, { children: "ButtonGroup позволяет организовать кнопки в логические группы с общей стилизацией и выравниванием. Поддерживает горизонтальную и вертикальную ориентацию, автоматический перенос элементов и передачу общих атрибутов всем вложенным кнопкам." }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Основные возможности:" }) }),
		"\n",
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Горизонтальная и вертикальная ориентация" }),
			"\n",
			o(t.li, { children: "Автоматический перенос кнопок (wrap) при нехватке места" }),
			"\n",
			s(t.li, { children: ["Передача общих атрибутов (размер, стиль, цвет) всем кнопкам через ", o(t.code, { children: "buttonAttrs" })] }),
			"\n",
			s(t.li, { children: [
				"Гибкое управление списком кнопок через массив ",
				o(t.code, { children: "list" }),
				" или слот ",
				o(t.code, { children: "default" })
			] }),
			"\n",
			o(t.li, { children: "Согласованные отступы между кнопками в группе" }),
			"\n"
		] }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Типичные сценарии использования:" }) }),
		...
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Панели инструментов (toolbars)" }),
			"\n",
			o(t.li, { children: "Группы переключателей или действий в формах" }),
			"\n",
			o(t.li, { children: "Навигационные блоки" }),
			"\n",
			o(t.li, { children: "Блоки управления в карточках или списках" }),
			"\n",
			o(t.li, { children: "Выбор опций (фильтры, сортировка)" }),
			"\n"
		] }),
		"\n",
		o(i, {
...
//#endregion
//#region src/media/mdx/ButtonGroup/wikiMdxButtonGroup.ts
var ra = {
	name: "ButtonGroup",
	descriptions: { buttonGroup: {
		en: ea,
		ru: na
	} }
};
...
//#endregion
//#region src/media/mdx/Checkbox/selected.en.mdx
function xa(e) {
	let t = {
		code: "code",
		h2: "h2",
	...
	return s(a, { children: [
		o(t.h2, { children: "Group Selection (selected)" }),
		"\n",
		s(t.p, { children: [
			"The ",
			o(t.code, { children: "selected" }),
			" property allows you to bind a group of checkboxes or radio buttons to a single variable. This is useful when you need to select one value from several available options (similar to radio-button behavior but using checkboxes)."
		] }),
		"\n",
		o(t.p, { children: "To use this feature:" }),
		"\n",
		s(t.ol, { children: [
			"\n",
			s(t.li, { children: [
		...
		"\n",
		s(t.p, { children: [
			"When an element is checked, its ",
			o(t.code, { children: "valueVariant" }),
			" is stored in the ",
			o(t.code, { children: "selected" }),
			" variable. When an element is unchecked, ",
			o(t.code, { children: "selected" }),
			" becomes ",
...
//#endregion
//#region src/media/mdx/Checkbox/selected.ru.mdx
function Ca(e) {
	let t = {
		code: "code",
		h2: "h2",
	...
	return s(a, { children: [
		o(t.h2, { children: "Групповой выбор (selected)" }),
		"\n",
		s(t.p, { children: [
			"Свойство ",
			o(t.code, { children: "selected" }),
			" позволяет связать группу чекбоксов или радиокнопок с одной переменной. Это полезно, когда нужно выбрать одно значение из нескольких доступных (аналог поведения radio-button, но с использованием чекбоксов)."
		] }),
		"\n",
		o(t.p, { children: "Для работы этой функции необходимо:" }),
		"\n",
		s(t.ol, { children: [
			"\n",
			s(t.li, { children: [
		...
		"\n",
		s(t.p, { children: [
			"Когда элемент отмечается, значение его ",
			o(t.code, { children: "valueVariant" }),
			" записывается в переменную ",
			o(t.code, { children: "selected" }),
			". Если элемент снимается, значение ",
			o(t.code, { children: "selected" }),
			" становится ",
			o(t.code, { children: "undefined" }),
			"."
...
function ro(e) {
	...
	return s(a, { children: [
		o(t.h2, { children: "Description" }),
		"\n",
		o(t.p, { children: "Container is a base layout component used to constrain content width and control horizontal spacing.\nBy default, it helps keep a readable content width and ensures consistent layout rhythm across screens." }),
		"\n",
		s(t.p, { children: [
			"The component supports alignment via ",
			...
			" and ",
			o(t.code, { children: "marginX" }),
			" design tokens.\nYou can also use the ",
			o(t.code, { children: "area" }),
			" prop to integrate with area context."
		] }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Key Features:" }) }),
		"\n",
		s(t.ul, { children: [
			"\n",
			s(t.li, { children: [
				"Constrain content width with the ",
				o(t.code, { children: "width" }),
				" token"
			] }),
			"\n",
			s(t.li, { children: ["Manage horizontal spacing via ", o(t.code, { children: "marginX" })] }),
			"\n",
			s(t.li, { children: [
			...
			"\n",
			s(t.li, { children: [o(t.code, { children: "default" }), " slot support for arbitrary content"] }),
			"\n",
			s(t.li, { children: [o(t.code, { children: "area" }), " prop support for context-based placement"] }),
			"\n"
		] }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Typical Use Cases:" }) }),
		...
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Outer wrapper for page sections" }),
			"\n",
			o(t.li, { children: "Limiting text and form width" }),
			"\n",
			o(t.li, { children: "Aligning content inside grid and block structures" }),
			"\n",
			o(t.li, { children: "Base container for reusable layout blocks" }),
			"\n"
		] }),
		"\n",
		o(i, {
		...
		s(t.blockquote, { children: [
			"\n",
			s(t.p, { children: [
				"Use Container as a foundational layout layer, while semantic sectioning is handled by outer components (",
				o(t.code, { children: "Section" }),
				", ",
				o(t.code, { children: "Group" }),
				", ",
				o(t.code, { children: "Page" }),
				")."
			] }),
			"\n"
		] })
...
function ao(e) {
	...
	return s(a, { children: [
		o(t.h2, { children: "Описание" }),
		"\n",
		o(t.p, { children: "Container - это базовый layout-компонент для ограничения ширины контента и управления горизонтальными отступами.\nПо умолчанию он помогает держать читаемую ширину блока и обеспечивает единый ритм макета между экранами." }),
		"\n",
		s(t.p, { children: [
			"Компонент поддерживает выравнивание через ",
			o(t.code, { children: "align" }),
			" (",
			o(t.code, { children: "left" }),
			", ",
			...
			", ",
			o(t.code, { children: "right" }),
			") и работает с дизайн-токенами ",
			o(t.code, { children: "width" }),
			" и ",
			o(t.code, { children: "marginX" }),
			".\nТакже можно использовать свойство ",
			o(t.code, { children: "area" }),
			" для интеграции с контекстом областей."
		] }),
		"\n",
		o(t.p, { children: o(t.strong, { children: "Основные возможности:" }) }),
		"\n",
		s(t.ul, { children: [
			"\n",
			s(t.li, { children: ["Ограничение ширины контента через токен ", o(t.code, { children: "width" })] }),
			"\n",
			s(t.li, { children: ["Управление горизонтальными отступами через ", o(t.code, { children: "marginX" })] }),
			"\n",
			s(t.li, { children: [
		...
		s(t.ul, { children: [
			"\n",
			o(t.li, { children: "Внешняя обертка секций страницы" }),
			"\n",
			o(t.li, { children: "Ограничение ширины текста и форм" }),
			"\n",
			o(t.li, { children: "Выравнивание контента в сетке и блочной структуре" }),
			"\n",
			o(t.li, { children: "Базовый контейнер для повторно используемых layout-блоков" }),
			"\n"
		] }),
		"\n",
		o(i, {
		...
		s(t.blockquote, { children: [
			"\n",
			s(t.p, { children: [
				"Используйте Container как базовый слой компоновки, а семантику секции задавайте внешними компонентами (",
				o(t.code, { children: "Section" }),
				", ",
				o(t.code, { children: "Group" }),
				", ",
...
var $g = [
	...
	constructor(n) {
		e(this, "item", void 0), e(this, "mdx", void 0), this.item = t.find((e) => e.name === n), this.mdx = $g.find((e) => e.name === n);
	}
	getItem() {
		return this.item;
	}
...
}, t_ = ({ componentName: e, type: t }) => new e_(e).getDescriptionByType(t);
//#endregion
export { t_ as StorybookDescriptions, ae as StorybookMain };
