...
`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`scaling--evolution-static-context-vs-mcp`,children:`Scaling & Evolution: Static Context vs MCP`}),`
`,(0,c.jsxs)(t.p,{children:[`As a design system expands and dozens of internal packages are linked, a natural architectural trade-off emerges between the size of the aggregated `,(0,c.jsx)(t.code,{children:`ai-prompt.md`}),` and the context window capacity of modern LLMs.`]}),`
`,(0,c.jsxs)(t.p,{children:[`The `,(0,c.jsx)(t.code,{children:`dxt-ui`}),` ecosystem supports two complementary models of context delivery:`]}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`1. Static Markdown Contracts (Current Foundation):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Strengths:`}),` Zero barrier to entry, 100% reliability, no requirement to manage background server processes, and native support across all developer environments (Antigravity, Cursor, Windsurf, Claude Code, GitHub Copilot).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Application:`}),` Best suited for the vast majority of product teams, ensuring deterministic agent behavior with minimal tooling overhead.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`2. Dynamic Model Context Protocol (MCP):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Strengths:`}),` Intelligent on-demand resource queries. The assistant queries specialized types, tokens, or rules strictly at tool invocation time, saving prompt tokens in enterprise-scale monorepos.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Out-of-the-Box Readiness:`}),` `,(0,c.jsx)(t.code,{children:`@dxtmisha/scripts`}),` concurrently compiles resource manifests `,(0,c.jsx)(t.code,{children:`ai-mcp-resources.json`}),` and `,(0,c.jsx)(t.code,{children:`ai-mcp-all-resources.json`}),`. The codebase is thus pre-configured to support local MCP servers without needing to rewrite metadata generation pipelines.`]}),`
`]}),`
`]}),`
