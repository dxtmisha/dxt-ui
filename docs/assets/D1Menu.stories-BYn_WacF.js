import{n as e,r as t}from"./chunk-BneVvdWh.js";import{Lt as n,_t as r}from"./iframe-CuL5mTF3.js";import{a as i,d as a,g as o,l as s,n as c,t as l,u}from"./wiki-Dd40E_Te.js";import{i as d,n as f,r as p,t as m}from"./D1Menu-BaXTkOdP.js";var h,g,_,v,y=e((()=>{u(),l(),d(),h=[{name:`ajax`,type:`string | (() => NormalOrPromise<ListRecord<any>>)`},{name:`autoClose`,type:`boolean`},{name:`barsAdaptive`,type:`string`,option:[`showAlways`,`showSm`,`showMd`,`showLg`,`showXl`,`show2xl`]},{name:`barsAttrs`,type:`ConstrBind<Bars>`},{name:`barsBackHide`,type:`boolean`},{name:`barsDescription`,type:`string`},{name:`barsHide`,type:`boolean`},{name:`barsLabel`,type:`string | number`},{name:`barsList`,type:`Bars['bars']`},{name:`cache`,type:`boolean`},{name:`disabled`,type:`boolean`},{name:`embedded`,type:`boolean`},{name:`filterMode`,type:`boolean`},{name:`hideList`,type:`boolean`},{name:`highlight`,type:`string`},{name:`highlightLengthStart`,type:`number`},{name:`isSelectedByValue`,type:`boolean`},{name:`itemAttrs`,type:`ConstrBind<ListItem>`},{name:`keyLabel`,type:`string`},{name:`keyValue`,type:`string`},{name:`list`,type:`ListRecord<any>`},{name:`listAttrs`,type:`ConstrBind<List>`},{name:`liteThreshold`,type:`number`},{name:`max`,type:`string | number`},{name:`modelSelected`,type:`string`},{name:`onUpdate:modelSelected`,type:`(value: string) => void`},{name:`onUpdate:selected`,type:`(value: string) => void`},{name:`request`,type:`ApiFetch`},{name:`roleItem`,type:`string`},{name:`roleList`,type:`string`},{name:`selected`,type:`ListSelectedList`},{name:`step`,type:`string | number`},{name:`tag`,type:`string`},{name:`windowAttrs`,type:`ConstrBind<Window>`}],g=[{name:`contextBottom`,description:`Context slot for bottom area / Слот контекстной области снизу`,properties:[{name:`props`,type:`MenuControlItem`}]},{name:`contextTop`,description:`Context slot for top area / Слот контекстной области сверху`,properties:[{name:`props`,type:`MenuControlItem`}]},{name:`control`,description:`Control slot for window management / Слот управления для управления окном`,properties:[{name:`props`,type:`MenuControlItem`}]},{name:`footer`,description:`Footer slot for window bottom/ Слот подвала для низа окна`,properties:[{name:`props`,type:`MenuControlItem`}]},{name:`title`,description:`Title slot for window title/ Слот заголовка для заголовка окна`,properties:[{name:`props`,type:`MenuControlItem`}]}],_=[{name:`bars`,properties:[{name:`event`,type:`MouseEvent`},{name:` value`,type:`EventClickValue`}]},{name:`barsBack`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`barsLite`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`click`,description:`Full click event with MouseEvent/ Полное событие клика с MouseEvent`,properties:[{name:`event`,type:`MouseEvent`},{name:` value`,type:`EventClickValue`}]},{name:`clickLite`,description:`Lightweight click event/ Упрощённое событие клика`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`clickSlot`,properties:[{name:`value?`,type:`string`}]},{name:`update:modelSelected`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`string`}]},{name:`update:selected`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`string`}]},{name:`updateValue`,properties:[{name:`value?`,type:`NumberOrStringOrBoolean`}]},{name:`window`,properties:[{name:`options`,type:`WindowEmitOptions`}]}],v={component:`Menu`,props:h,slots:g,events:_,defaults:p,wikiDesign:c}})),b,x=e((()=>{u(),i(),y(),b=new a(v.component,v.props,v.defaults,v.wikiDesign,s,o)})),S=t({Menu:()=>w,MenuAjax:()=>E,MenuNavigation:()=>T,MenuVModel:()=>D,__namedExportsOrder:()=>O,default:()=>C}),C,w,T,E,D,O,k=e((()=>{f(),x(),r(),C={title:`Ui/Menu`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Menu:m},setup:()=>({args:e}),template:`
      <D1Menu v-bind="args">
