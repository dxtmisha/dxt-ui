import{a as e,i as t}from"./preload-helper-Cv19cBWa.js";import{Ft as n,nn as r}from"./iframe-B-LNhFWZ.js";import{d as i,m as a,n as o,o as s,s as c,t as l,u}from"./wiki-DgltPJFG.js";import{i as d,n as f,r as p,t as m}from"./D1Progress-DXX-TsV0.js";var h,g,_,v,y=t((()=>{l(),d(),h=[{name:`ariaLabel`,type:`string`},{name:`circular`,type:`boolean`},{name:`clientOnly`,type:`boolean`},{name:`delay`,type:`string | number`},{name:`delayHide`,type:`string | number`},{name:`dense`,type:`boolean`},{name:`indeterminate`,type:`string`,option:[`type1`,`type2`,`type3`]},{name:`inverse`,type:`boolean`},{name:`linear`,type:`boolean`},{name:`max`,type:`string | number`},{name:`palette`,type:`string`,option:[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`slate`,`gray`,`zinc`,`neutral`,`stone`,`black`,`white`]},{name:`point`,type:`boolean`},{name:`position`,type:`string`,option:[`top`,`bottom`,`static`]},{name:`size`,type:`string`,option:[`sm`,`md`,`lg`]},{name:`textLoading`,type:`TextValue`},{name:`value`,type:`string | number`},{name:`visible`,type:`boolean`}],g=[],_=[],v={component:`Progress`,props:h,slots:g,events:_,defaults:p,wikiDesign:o}})),b,x=t((()=>{i(),c(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,s,a)})),S=e({Progress:()=>w,ProgressCircular:()=>D,ProgressDelays:()=>k,ProgressLinear:()=>E,ProgressTypes:()=>T,ProgressValues:()=>O,__namedExportsOrder:()=>A,default:()=>C}),C,w,T,E,D,O,k,A,j=t((()=>{f(),x(),n(),C={title:`Ui/Progress`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Progress:m},setup:()=>({args:e}),template:`
