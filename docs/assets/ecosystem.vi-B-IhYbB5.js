...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Mục đích:`}),` Chứa các quy định theo chủ đề được viết theo mẫu «Phản mẫu (Anti-Pattern) vs Mẫu khuyến nghị (Recommended Pattern)» (ví dụ: `,(0,c.jsx)(t.code,{children:`colors-and-palettes.md`}),`, `,(0,c.jsx)(t.code,{children:`skeleton.md`}),`, `,(0,c.jsx)(t.code,{children:`storage-state.md`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Ví dụ quy tắc (Zero-Duplication Skeleton):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`❌ `,(0,c.jsx)(t.em,{children:`Phản mẫu:`}),` Nhân đôi template HTML bằng cách dùng `,(0,c.jsx)(t.code,{children:`v-if="isLoading"`}),` với các khung xám tự dựng.`]}),`
`,(0,c.jsxs)(t.li,{children:[`✅ `,(0,c.jsx)(t.em,{children:`Mẫu thiết kế chuẩn:`}),` Bọc chính template HTML đó bên trong `,(0,c.jsx)(t.code,{children:`<MySkeleton :active="isLoading">`}),` với các modifier skeleton.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Sử dụng:`}),` Được script `,(0,c.jsx)(t.code,{children:`dxt-types`}),` phân tích khi tạo tài liệu để tự động hình thành các trigger trong khối `,(0,c.jsx)(t.code,{children:`## Mandatory Rules`}),` của `,(0,c.jsx)(t.code,{children:`ai-description.md`}),`. AI chỉ tải tệp hướng dẫn cụ thể khi nhiệm vụ được giao liên quan trực tiếp đến chủ đề đó.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[`
