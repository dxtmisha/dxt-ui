...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isExclude(item: LibraryAiPromptItem): boolean`}),` — Проверяет, должна ли библиотека быть исключена на основе конфигурации.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isInPackage(item: LibraryAiPromptItem): boolean`}),` — Проверяет, присутствует ли библиотека в корневом package.json.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPackageNames(): Set<string>`}),` — Получает набор имен пакетов, определенных в корневом package.json.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`initGitIgnore(): void`}),` — Добавляет созданные скриптом файлы и директории в файл `,(0,c.jsx)(t.code,{children:`.gitignore`}),` проекта.`]}),`
