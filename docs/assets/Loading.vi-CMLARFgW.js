...
`,n.jsxs(i.li,{children:[n.jsx(i.code,{children:"get(): number"})," — trả về giá trị hiện tại của bộ đếm."]}),`
...
`]}),`
`,n.jsx(i.h3,{id:"unregistrationevent",children:n.jsx(i.code,{children:"unregistrationEvent"})}),`
`,n.jsxs(i.p,{children:["Hủy đăng ký listener đã được thêm trước đó qua ",n.jsx(i.code,{children:"registrationEvent"}),"."]}),`
`,n.jsx(i.p,{children:n.jsx(i.strong,{children:"Tham số:"})}),`
`,n.jsxs(i.ul,{children:[`
`,n.jsxs(i.li,{children:[n.jsx(i.code,{children:"listener: EventListenerDetail<CustomEvent, { loading: boolean }>"})," — hàm xử lý đã sử dụng khi đăng ký."]}),`
`,n.jsxs(i.li,{children:[n.jsx(i.code,{children:"element?: ElementOrString<HTMLElement>"})," — phần tử DOM đã sử dụng khi đăng ký."]}),`
`]}),`
