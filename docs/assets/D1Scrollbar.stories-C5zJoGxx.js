import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,l as i,m as a,n as o,t as s,u as c}from"./wiki-DiKtF90Q.js";import{i as l,n as u,r as d,t as f}from"./D1Scrollbar-T-pSXcD2.js";var p,m,h=e((()=>{c(),s(),l(),p=[{name:`divider`,type:`boolean`},{name:`dividerBottom`,type:`boolean`},{name:`dividerHide`,type:`boolean`},{name:`dividerTop`,type:`boolean`},{name:`inverse`,type:`boolean`},{name:`standard`,type:`boolean`},{name:`tag`,type:`string`},{name:`visible`,type:`boolean`}],m={component:`Scrollbar`,props:p,defaults:d,wikiDesign:o}})),g,_=e((()=>{c(),n(),h(),g=new r(m.component,m.props,m.defaults,m.wikiDesign,i,a)})),v=t({Scrollbar:()=>b,__namedExportsOrder:()=>x,default:()=>y}),y,b,x,S=e((()=>{u(),_(),y={title:`Ui/Scrollbar`,component:f,parameters:{design:`d1`,docs:{description:{component:g.getDescription()}}},argTypes:g.getWiki(),args:g.getValues()},b={render:e=>({components:{D1Scrollbar:f},setup:()=>({args:e}),template:`
      <D1Scrollbar
  ...
  // :story-main [!] System label / Системная метка
}`,...b.parameters?.docs?.source}}},x=[`Scrollbar`]}));S();export{b as Scrollbar,x as __namedExportsOrder,y as default,_ as i,S as n,g as r,v as t};