import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { Vt as n, cn as r } from './iframe-D7czqiJA.js'; import { a as i, d as a, l as o, m as s, n as c, t as l, u } from './wiki-CUC2UhNU.js'; import { i as d, n as f, r as p, t as m } from './D1InputPhoneDialCode-CBMsuPOX.js'; var h, g, _, v, y = t(() => { l(), d(), h = [{ name: `buttonAttrs`, type: `ConstrBind<ButtonProps>` }, { name: `disabled`, type: `boolean` }, { name: `iconArrowDown`, type: `IconValue<IconProps>` }, { name: `labelType`, type: `string`, option: [`name`, `none`, `code`] }, { name: `menuCountryAttrs`, type: `ConstrBind<MenuCountryProps>` }, { name: `modelSelected`, type: `ListSelectedList` }, { name: `onUpdate:modelSelected`, type: `((value: ListSelectedList) => void)` }, { name: `onUpdate:selected`, type: `((value: ListSelectedList) => void)` }, { name: `value`, type: `string` }], g = [], _ = [{ name: `click`, description: `Full click event with MouseEvent/ Полное событие клика с MouseEvent`, properties: [{ name: `event`, type: `MouseEvent` }, { name: `value`, type: `EventClickValue` }] }, { name: `clickLite`, description: `Lightweight click event/ Упрощённое событие клика`, properties: [{ name: `value`, type: `EventClickValue` }] }, { name: `update:modelSelected`, description: `Update model value event/ Событие обновления значения модели`, properties: [{ name: `value`, type: `string` }] }, { name: `update:selected`, description: `Update value event/ Событие обновления значения`, properties: [{ name: `value`, type: `string` }] }, { name: `updateValue`, description: `Event for updating the value/ Событие обновления значения`, properties: [{ name: `value?`, type: `NumberOrStringOrBoolean | undefined` }] }], v = { component: `InputPhoneDialCode`, props: h, slots: g, events: _, defaults: p, wikiDesign: c } }), b, x = t(() => { a(), o(), y(), b = new u(v.component, v.props, v.defaults, v.wikiDesign, i, s) }), S = e({ InputPhoneDialCode: () => w, InputPhoneDialCodeVModel: () => T, __namedExportsOrder: () => E, default: () => C }), C, w, T, E, D = t(() => {
  f(), x(), n(), C = { title: `Ui/InputPhoneDialCode`, component: m, parameters: { design: `d1`, docs: { description: { component: b.getDescription() } } }, argTypes: b.getWiki(), args: b.getValues() }, w = { render: e => ({ components: { D1InputPhoneDialCode: m }, setup: () => ({ args: e }), template: `
...
}`, ...T.parameters?.docs?.source } } }, E = [`InputPhoneDialCode`, `InputPhoneDialCodeVModel`]
}); D(); export { w as InputPhoneDialCode, T as InputPhoneDialCodeVModel, E as __namedExportsOrder, C as default, x as i, D as n, b as r, S as t }
