...
`,e.jsxs(n.p,{children:["Để tạo một đối tượng quản lý siêu dữ liệu (meta-data), hãy gọi hàm khởi tạo ",e.jsx(n.code,{children:"new Meta()"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Tính năng:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Tự động hóa"})," — hàm khởi tạo tự động khởi tạo registry cho các thẻ HTML tiêu chuẩn, Open Graph và Twitter Card."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Tích hợp"})," — ngay lập tức tạo các instance ",e.jsx(n.code,{children:"MetaOg"})," và ",e.jsx(n.code,{children:"MetaTwitter"})," nội bộ."]}),`
`]}),`
