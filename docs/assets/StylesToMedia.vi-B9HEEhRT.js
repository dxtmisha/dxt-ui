...
`,n.jsx(t.h1,{id:"lớp-stylestomedia",children:"Lớp StylesToMedia"}),`
`,n.jsxs(t.p,{children:["Lớp ",n.jsx(t.code,{children:"StylesToMedia"})," chịu trách nhiệm tạo các truy vấn CSS ",n.jsx(t.code,{children:"@media"})," từ các thuộc tính thiết kế. Nó triển khai logic để bao bọc các quy tắc style lồng nhau bên trong một khối truy vấn media."]}),`
`,n.jsx(t.h2,{id:"các-tính-năng-chính",children:"Các tính năng chính"}),`
`,n.jsxs(t.ul,{children:[`
`,n.jsxs(t.li,{children:[n.jsx(t.strong,{children:"Bao bọc truy vấn Media"})," — Tự động bao bọc nội dung style được tạo bên trong một quy tắc ",n.jsx(t.code,{children:"@media screen and ..."}),"."]}),`
`,n.jsxs(t.li,{children:[n.jsx(t.strong,{children:"Phân giải truy vấn động"})," — Sử dụng tên thuộc tính thiết kế để định nghĩa điều kiện của truy vấn media."]}),`
...
`,n.jsxs(t.p,{children:["Khởi tạo trình chuyển đổi ",n.jsx(t.code,{children:"StylesToMedia"})," với thuộc tính bắt buộc và một hàm gọi nội dung cho các quy tắc lồng nhau."]}),`
...
`]}),`
`,n.jsx(t.pre,{children:n.jsx(t.code,{className:"language-typescript",children:`import { StylesToMedia } from '@dxtmisha/scripts'
...
`]})]})}function x(c={}){const{wrapper:t}={...h(),...c.components};return t?n.jsx(t,{...c,children:n.jsx(i,{...c})}):i(c)}export{x as default};
