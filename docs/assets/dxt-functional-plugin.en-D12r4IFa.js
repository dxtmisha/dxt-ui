import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/functional/# Plugin Initialization` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsxs)(n.strong, { children: [(0, c.jsx)(n.code, { children: `ErrorCenter` }), ` Setup`] }), `: Configures predefined error causes (`, (0, c.jsx)(n.code, { children: `ErrorCenter.addList` }), `) and registers global error handlers (`, (0, c.jsx)(n.code, { children: `ErrorCenter.addHandlerList` }), `) in the central error registry.`] }), `
