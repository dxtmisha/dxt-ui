...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`CLI-driven Workflow`}),` — executes requests by running the `,(0,c.jsx)(t.code,{children:`gemini`}),` CLI directly with an argument array via `,(0,c.jsx)(t.code,{children:`execFile`}),`, without a system shell.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Environment`}),` — relies on the availability of the `,(0,c.jsx)(t.code,{children:`execFile`}),` function and the filesystem for temporary storage.`]}),`
