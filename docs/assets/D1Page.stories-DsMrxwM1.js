import{I as P,K as f,L as D,M as b,d as m,N as v}from"./iframe-B21bnPHY.js";import{T as k,k as w}from"./BlockDesign-DHCkcwP1-DmXCTJhG.js";import{w as T,W as _,a as x,b as S}from"./wiki-BeIQM_4B.js";import"./jsx-runtime-u17CrQMm.js";class B extends w{}const I={tag:"main",tagHeader:"h1"};class H extends k{constructor(i,r,l,p=B){super(i,r,l,p)}}const g={...I},e=P({name:"D1Page",__name:"D1Page",props:b({label:{},labelId:{},description:{},descriptionId:{},caption:{},captionDecorative:{type:Boolean},icon:{},selected:{type:Boolean},iconTurn:{type:Boolean},iconHide:{type:Boolean},iconDir:{type:Boolean},iconPalette:{type:Boolean},iconAttrs:{},headline:{},tag:{},tagHeader:{}},g),setup(t,{expose:i,emit:r}){const l=r,p=t,u=m(()=>({main:{"d1-page":!0}})),h=m(()=>({})),d=new H("d1.page",p,{emits:l,classes:u,styles:h}),y=d.render();return i(d.expose()),(W,N)=>(v(),f(D(y)))}});e.__docgenInfo=Object.assign({displayName:e.name??e.__name},{name:"D1Page",exportName:"default",displayName:"D1Page",description:"",tags:{},sourceFiles:["/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/Page/D1Page.vue"]});const C=[{name:"caption",type:"string | number"},{name:"captionDecorative",type:"boolean"},{name:"description",type:"string | number"},{name:"descriptionId",type:"string"},{name:"headline",type:"string"},{name:"icon",type:"IconValue<IconPropsBasic>"},{name:"iconAttrs",type:"ConstrBind<IconPropsBasic>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"selected",type:"boolean"},{name:"tag",type:"string"},{name:"tagHeader",type:"string"}],s={component:"Page",props:C,defaults:g,wikiDesign:T},c=new _(s.component,s.props,s.defaults,s.wikiDesign,x,S),L={title:"Ui/Page",component:e,parameters:{design:"d1",docs:{description:{component:c.getDescription()}}},argTypes:c.getWiki(),args:c.getValues()},n={render:t=>({components:{D1Page:e},setup:()=>({args:t}),template:`
      <D1Page v-bind="args">
        <p>
...
}`,...o.parameters?.docs?.source}}};const O=["Page","PageBasic","PageSlots"],V=Object.freeze(Object.defineProperty({__proto__:null,Page:n,PageBasic:a,PageSlots:o,__namedExportsOrder:O,default:L},Symbol.toStringTag,{value:"Module"}));export{V as P,n as a,c as b,a as c,o as d};
