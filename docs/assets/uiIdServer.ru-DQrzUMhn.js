import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, p: `p`, pre: `pre`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/nitro-basic/Functions/uiIdServer - Серверный генератор ID` }), `
`, (0, c.jsx)(n.h1, { id: `uiidserver`, children: (0, c.jsx)(n.code, { children: `uiIdServer` }) }), `
`, (0, c.jsx)(n.p, { children: `Инициализирует глобальную функцию генерации уникальных идентификаторов для элементов на стороне сервера. Она использует значения контекста запроса для генерации уникальных идентификаторов во время SSR.` }), `
