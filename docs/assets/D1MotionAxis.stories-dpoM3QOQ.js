import{n as e,r as t}from"./chunk-BneVvdWh.js";import{Lt as n,_t as r}from"./iframe-I1fckF_t.js";import{a as i,d as a,g as o,l as s,n as c,t as l,u}from"./wiki-CMC-2lzg.js";import{i as d,n as f,r as p,t as m}from"./D1MotionAxis-B6XL5Sw3.js";var h,g,_,v,y=e((()=>{u(),l(),d(),h=[{name:`animationHeight`,type:`boolean`},{name:`axis`,type:`string`,option:[`x`,`y`,`z`]},{name:`direction`,type:`string`,option:[`next`,`back`,`auto`]},{name:`inDom`,type:`boolean`},{name:`inDomSlide`,type:`string[]`},{name:`modelSelected`,type:`string`},{name:`onUpdate:modelSelected`,type:`(value: string) => void`},{name:`onUpdate:selected`,type:`(value: string) => void`},{name:`selected`,type:`string`}],g=[],_=[{name:`end`,properties:[{name:`selected`,type:`string`}]},{name:`motionAxis`,properties:[{name:`options`,type:`MotionAxisEmitOptions`}]},{name:`start`,properties:[{name:`selected`,type:`string`}]},{name:`update:modelSelected`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`string`}]},{name:`update:selected`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`string`}]}],v={component:`MotionAxis`,props:h,slots:g,events:_,defaults:p,wikiDesign:c}})),b,x=e((()=>{u(),i(),y(),b=new a(v.component,v.props,v.defaults,v.wikiDesign,s,o)})),S=t({MotionAxis:()=>w,MotionAxisBasic:()=>T,MotionAxisScroll:()=>E,MotionAxisVModel:()=>D,__namedExportsOrder:()=>O,default:()=>C}),C,w,T,E,D,O,k=e((()=>{f(),x(),r(),C={title:`Ui/MotionAxis`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1MotionAxis:m},setup:()=>({args:e}),template:`
