import{d as c,_ as e}from"./D1Badge-DHAJZY5e.js";import{W as l,w as m,a as p,b as g}from"./wiki-fb_eBW86.js";import"./iframe-BlCC38XJ.js";import"./jsx-runtime-D_zvdyIk.js";const B=[{name:"ariaLabel",type:"string"},{name:"dot",type:"boolean"},{name:"formatting",type:"boolean"},{name:"hide",type:"boolean"},{name:"horizontal",type:"string",option:["center","right","left"]},{name:"icon",type:"IconValue<IconProps>"},{name:"iconAttrs",type:"ConstrBind<IconProps>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"labelMax",type:"NumberOrString"},{name:"outline",type:"boolean"},{name:"overlap",type:"string",option:["rectangular","circular","static"]},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"primary",type:"boolean"},{name:"secondary",type:"boolean"},{name:"selected",type:"boolean"},{name:"size",type:"string",option:["sm","md","lg","none"]},{name:"vertical",type:"string",option:["top","center","bottom"]}],i=new l("Badge",B,c,m,p,g),y={title:"Ui/Badge",component:e,parameters:{design:"d1",docs:{description:{component:i.getDescription()}}},argTypes:i.getWiki(),args:i.getValues()},a={render:d=>({components:{D1Badge:e},setup:()=>({args:d}),template:`
...
}`,...s.parameters?.docs?.source}}};const b=["Badge","BadgeBasic","BadgeDot","BadgePrimary","BadgeSecondary","BadgeOutline"],w=Object.freeze(Object.defineProperty({__proto__:null,Badge:a,BadgeBasic:o,BadgeDot:n,BadgeOutline:s,BadgePrimary:t,BadgeSecondary:r,__namedExportsOrder:b,default:y},Symbol.toStringTag,{value:"Module"}));export{w as B,a,i as b,o as c,n as d,t as e,r as f,s as g};
