import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/Meta - Quản lý thẻ meta SEO` }), `
...
`] }), `
`, (0, c.jsx)(n.h2, { id: `phương-thức-tạo-html`, children: `Phương thức tạo HTML` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `html(): string` }), ` — tạo chuỗi HTML đầy đủ của tất cả thẻ meta: tiêu chuẩn + Open Graph + Twitter Card. Dùng cho SSR.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `htmlTitle(): string` }), ` — tạo tiêu đề trang.`] }), `
`] }), `
`, (0, c.jsx)(n.h2, { id: `setter`, children: `Setter` }), `
`, (0, c.jsxs)(n.p, { children: [`All setter trả về `, (0, c.jsx)(n.code, { children: `this` }), ` để chuỗi phương thức.`] }), `
`, (0, c.jsxs)(n.ul, { children: [`
...
// ...
` }) }), `
`, (0, c.jsx)(n.h3, { id: `htmltitle-string`, children: (0, c.jsx)(n.code, { children: `htmlTitle(): string` }) }), `
`, (0, c.jsx)(n.p, { children: `Tạo tiêu đề hiện tại (bao gồm cả hậu tố).` }), `
`, (0, c.jsx)(n.pre, { children: (0, c.jsx)(n.code, { className: `language-javascript`, children: `const meta = new Meta()
