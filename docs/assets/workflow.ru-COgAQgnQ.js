...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Специальные теги`}),` — используйте теги, которые генератор переносит в `,(0,c.jsx)(t.code,{children:`ai-types.md`}),`:`,`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`@remarks`}),` — развернутые пояснения сложной инженерной логики.
`,(0,c.jsxs)(t.em,{children:[`(Поисковые теги `,(0,c.jsx)(t.code,{children:`@keywords`}),` писать вручную не нужно — генератор `,(0,c.jsx)(t.code,{children:`dxt-types`}),` с помощью ИИ автоматически сформирует их на Шаге 3).`]})]}),`
`]}),`
`]}),`
`]}),`
