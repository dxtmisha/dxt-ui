...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"send(request?: Request): Promise<Return | undefined>"})," — An asynchronous method for sending the ",e.jsx(n.code,{children:"PUT"})," request. It automatically manages the ",e.jsx(n.code,{children:"loading"})," state, applies the transformation function to the response, executes the ",e.jsx(n.code,{children:"action"})," callback on success, and safely handles errors by logging them to the console."]}),`
`]}),`
