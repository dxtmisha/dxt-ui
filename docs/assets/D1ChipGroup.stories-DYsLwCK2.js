import{w as O,r as h,f as G,h as D,at as x,W as V,X as L,D as W,E as A,F as B,I,c as _,J as N}from"./iframe-okvuAVTt.js";import{g as M}from"./D1Icon-Brgfn8k6.js";import{V as U}from"./ModelInclude-BiYm_iCQ-8b_GiUPq.js";import{D as j}from"./index-BmbzptAs.js";import{w as H,W as T,a as E,b as F}from"./wiki-BeTUR4cU.js";import"./jsx-runtime-u17CrQMm.js";var $=Object.defineProperty,P=(i,e,t)=>e in i?$(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,f=(i,e,t)=>P(i,typeof e!="symbol"?e+"":e,t);let R=class{constructor(e,t,a,n,o){f(this,"value",h()),f(this,"onClick",(s,l)=>{var c,p;l&&"value"in l&&!((c=this.readonly)!=null&&c.value)&&(this.value.value=l.value),(p=this.event)==null||p.onClick(s,l)}),this.index=e,this.emits=t,this.event=a,this.inputValue=n,this.readonly=o,new U(this.index,this.emits,this.value),O([this.inputValue],()=>{var s;this.value.value=(s=this.inputValue)==null?void 0:s.value},{immediate:!0})}getValue(){return this.value.value}};var X=Object.defineProperty,z=(i,e,t)=>e in i?X(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,d=(i,e,t)=>z(i,typeof e!="symbol"?e+"":e,t);class J{constructor(e,t,a,n,o,s,l,c,p){d(this,"data"),d(this,"event"),d(this,"model"),this.props=e,this.refs=t,this.element=a,this.classDesign=n,this.className=o,this.components=s,this.slots=l,this.emits=c;const{EventClickIncludeConstructor:w=M,ListDataRefConstructor:S=x,ModelValueIncludeConstructor:g=R}=p??{};this.event=new w(void 0,void 0,this.emits),this.model=new g("selected",this.emits,this.event,this.refs.selected,this.refs.readonly),this.data=new S(this.refs.list,void 0,void 0,void 0,void 0,this.model.value,this.refs.keyValue,this.refs.keyLabel)}getList(){return this.data.fullData.value}}const q={readonly:!0};class K extends G{constructor(e,t,a,n=J){super(e,t,a),d(this,"item"),d(this,"renderList",()=>V(this.item.getList(),o=>this.renderItem(o))),d(this,"renderItem",o=>{var s;return this.components.renderOne("chip",L({class:(s=this.classes)==null?void 0:s.value.item,iconHide:this.props.iconWhenSelected&&!o.selected,onClick:this.item.model.onClick},this.props.chipAttrs,o),void 0,o.index)}),this.item=new n(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits),this.init()}initExpose(){return{}}initClasses(){return{main:{},item:this.getSubClass("item")}}initStyles(){return{}}initRender(){var e;const t=this.renderList();return this.initSlot("default",t),D("div",{...this.getAttrs(),class:(e=this.classes)==null?void 0:e.value.main},t)}}const C={...q},r=W({name:"D1ChipGroup",__name:"D1ChipGroup",props:I({modelSelected:{},"onUpdate:selected":{type:Function},"onUpdate:modelSelected":{type:Function},readonly:{type:Boolean},selected:{type:[Number,String,Boolean,Array]},list:{},iconWhenSelected:{type:Boolean},keyLabel:{},keyValue:{},chipAttrs:{}},C),emits:["click","clickLite","update:selected","update:modelSelected"],setup(i,{expose:e,emit:t}){const a=t,n=i,o=_(()=>({main:{"d1-chipGroup":!0}})),s=_(()=>({})),l=new K("d1.chipGroup",n,{emits:a,classes:o,styles:s,components:{chip:j}}),c=l.render();return e(l.expose()),(p,w)=>(N(),A(B(c)))}});r.__docgenInfo=Object.assign({displayName:r.name??r.__name},{name:"D1ChipGroup",exportName:"default",displayName:"D1ChipGroup",description:"",tags:{},sourceFiles:["/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/ChipGroup/D1ChipGroup.vue"]});const Q=[{name:"chipAttrs",type:"ConstrBind<Chip>"},{name:"iconWhenSelected",type:"boolean"},{name:"keyLabel",type:"string"},{name:"keyValue",type:"string"},{name:"list",type:"ChipGroupData"},{name:"modelSelected",type:"ListSelectedList"},{name:"onUpdate:modelSelected",type:"(value: ListSelectedList) => void"},{name:"onUpdate:selected",type:"(value: ListSelectedList) => void"},{name:"readonly",type:"boolean"},{name:"selected",type:"ListSelectedList"}],v={component:"ChipGroup",props:Q,defaults:C,wikiDesign:H},y=new T(v.component,v.props,v.defaults,v.wikiDesign,E,F),Y={title:"Ui/ChipGroup",component:r,parameters:{design:"d1",docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},u={},k={name:"Базовые",render:()=>({components:{D1ChipGroup:r},template:`
...
}`,...b.parameters?.docs?.source}}};const Z=["ChipGroup","ChipGroupBasic","ChipGroupSelection","ChipGroupVModel"],ne=Object.freeze(Object.defineProperty({__proto__:null,ChipGroup:u,ChipGroupBasic:k,ChipGroupSelection:m,ChipGroupVModel:b,__namedExportsOrder:Z,default:Y},Symbol.toStringTag,{value:"Module"}));export{ne as C,u as a,y as b,k as c,m as d,b as e};
