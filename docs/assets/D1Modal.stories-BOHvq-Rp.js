import{d as h,I as f,K as v,L as k,M,N as D,O as g,r as B}from"./iframe-B21bnPHY.js";import{T as S,F as C,D as A}from"./index-iCokEgPP.js";import{D as W}from"./index-CV2r4llu.js";import{D as x}from"./index-BLNCa4Ok.js";import{w as P,W as _,a as T,b as O}from"./wiki-BeIQM_4B.js";import"./jsx-runtime-u17CrQMm.js";const I={barsBackHide:!0,imagePosition:"top"};class L extends C{constructor(e,r,d,o,c,m,a,p){super(e,r,d,o,c,m,a,p,h(()=>({open:e.open,image:e.image,adaptive:"modal",imagePosition:e.imagePosition,closeButton:e.barsBackHide}))),this.props=e,this.refs=r,this.element=d,this.classDesign=o,this.className=c,this.components=m,this.slots=a,this.emits=p}}class H extends S{initItem(e){return new(e??L)(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits)}initClasses(){return{main:{},title:this.getSubClass("title"),header:this.getSubClass("header"),body:this.getSubClass("body"),footer:this.getSubClass("footer")}}}const y={imagePosition:["top","left"],width:["sm","md","lg","xl","auto"]},w={...I,imagePosition:"top",width:"md"},t=f({name:"D1Modal",__name:"D1Modal",props:M({disabled:{type:Boolean},autoClose:{type:Boolean},windowAttrs:{},barsLabel:{},barsDescription:{},barsBackHide:{type:Boolean},barsHide:{type:Boolean},barsList:{},barsAttrs:{},actionsHide:{type:Boolean},actionsList:{},actionsSecondary:{},actionsAttrs:{},image:{},open:{type:Boolean},imagePosition:{},width:{}},w),emits:["window","bars","barsLite","barsBack","actions","actionsLite"],setup(n,{expose:e,emit:r}){const d=r,o=n,c=h(()=>({main:{"d1-modal":!0,[`d1-modal--imagePosition--${o.imagePosition}`]:g(y.imagePosition,o.imagePosition),[`d1-modal--width--${o.width}`]:g(y.width,o.width)}})),m=h(()=>({})),a=new H("d1.modal",o,{emits:d,classes:c,styles:m,components:{window:W,bars:x,actions:A}}),p=a.render();return e(a.expose()),(V,U)=>(D(),v(k(p)))}});t.__docgenInfo=Object.assign({displayName:t.name??t.__name},{name:"D1Modal",exportName:"default",displayName:"D1Modal",description:"",tags:{},sourceFiles:["/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/Modal/D1Modal.vue"]});const N=[{name:"actionsAttrs",type:"ConstrBind<Actions>"},{name:"actionsHide",type:"boolean"},{name:"actionsList",type:"ConstrBind<Actions['list']>"},{name:"actionsSecondary",type:"ConstrBind<Actions['listSecondary']>"},{name:"autoClose",type:"boolean"},{name:"barsAttrs",type:"ConstrBind<Bars>"},{name:"barsBackHide",type:"boolean"},{name:"barsDescription",type:"string"},{name:"barsHide",type:"boolean"},{name:"barsLabel",type:"string | number"},{name:"barsList",type:"Bars['bars']"},{name:"disabled",type:"boolean"},{name:"image",type:"string | ConstrBind<Image>"},{name:"imagePosition",type:"string",option:["top","left"]},{name:"open",type:"boolean"},{name:"width",type:"string",option:["sm","md","lg","xl","auto"]},{name:"windowAttrs",type:"ConstrBind<Window>"}],u={component:"Modal",props:N,defaults:w,wikiDesign:P},b=new _(u.component,u.props,u.defaults,u.wikiDesign,T,O),z={title:"Ui/Modal",component:t,parameters:{design:"d1",docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},s={render:n=>({components:{D1Modal:t},setup:()=>({args:n}),template:`
      <D1Modal v-bind="args">
...
}`,...l.parameters?.docs?.source}}};const E=["Modal","ModalVModel","ModalAllSlots"],K=Object.freeze(Object.defineProperty({__proto__:null,Modal:s,ModalAllSlots:l,ModalVModel:i,__namedExportsOrder:E,default:z},Symbol.toStringTag,{value:"Module"}));export{K as M,s as a,b,i as c,l as d};
