...
`,n.jsxs(e.p,{children:["Để khởi tạo đối tượng, hãy gọi hàm khởi tạo ",n.jsx(e.code,{children:"Datetime(date, type, code)"}),"."]}),`
...
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-typescript",children:`import { Datetime } from '@dxtmisha/functional-basic'
