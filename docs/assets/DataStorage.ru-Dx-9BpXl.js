...
`,n.jsxs(e.p,{children:["Для инициализации объекта вызовите конструктор ",n.jsx(e.code,{children:"DataStorage(name, isSession)"}),"."]}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Параметры:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"name: string"})," — название ключа в хранилище."]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"isSession: boolean = false"})," — нужно ли использовать ",n.jsx(e.code,{children:"sessionStorage"})," (по умолчанию ",n.jsx(e.code,{children:"localStorage"}),")."]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-typescript",children:`import { DataStorage } from '@dxtmisha/functional'
