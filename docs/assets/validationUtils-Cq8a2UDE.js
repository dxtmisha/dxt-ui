...
`})}),`
`,e.jsx(n.h2,{id:"isdomdata",children:e.jsx(n.code,{children:"isDomData"})}),`
`,e.jsx(n.p,{children:"Checks if the current environment is a data URL."}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { isDomData } from '@dxtmisha/functional'
