import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{Ht as n,xt as r}from"./iframe-yo6yIkeP.js";import{a as i,d as a,m as o,n as s,o as c,t as l,u}from"./wiki-Ck-JDNL8.js";import{i as d,n as f,r as p,t as m}from"./D1TabsNavigation-7OBz_2Nr.js";var h,g,_,v,y=e((()=>{l(),d(),h=[{name:`divider`,type:`boolean | undefined`},{name:`horizontalScrollAlign`,type:`string`,option:[`block`,`left`]},{name:`horizontalScrollAttrs`,type:`ConstrBind<HorizontalScrollPropsBasic> | undefined`},{name:`horizontalScrollFlush`,type:`boolean | undefined`},{name:`itemAttrs`,type:`ConstrBind<TabItemProps> | undefined`},{name:`keyLabel`,type:`string | undefined`},{name:`keyValue`,type:`string | undefined`},{name:`list`,type:`ListRecord<TabItemProps> | undefined`},{name:`modelSelected`,type:`ListSelectedList | undefined`},{name:`onUpdate:modelSelected`,type:`((value: ListSelectedList) => void) | undefined`},{name:`onUpdate:selected`,type:`((value: ListSelectedList) => void) | undefined`},{name:`selected`,type:`ListSelectedList | undefined`},{name:`tag`,type:`string | undefined`}],g=[{name:`leading`,description:`Slot for content before the tabs/ Слот для содержимого перед вкладками`,properties:[{name:`props`,type:`(any) | undefined`}]},{name:`trailing`,description:`Slot for content after the tabs/ Слот для содержимого после вкладок`,properties:[{name:`props`,type:`(any) | undefined`}]}],_=[{name:`click`,description:`Full click event with MouseEvent/ Полное событие клика с MouseEvent`,properties:[{name:`event`,type:`MouseEvent`},{name:`value`,type:`EventClickValue`}]},{name:`clickLite`,description:`Lightweight click event/ Упрощённое событие клика`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`update:modelSelected`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`ListSelectedList`}]},{name:`update:selected`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`ListSelectedList`}]}],v={component:`TabsNavigation`,props:h,slots:g,events:_,defaults:p,wikiDesign:s}})),b,x=e((()=>{a(),c(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,i,o)})),S=t({TabsNavigation:()=>w,TabsNavigationBasic:()=>T,TabsNavigationVModel:()=>E,__namedExportsOrder:()=>D,default:()=>C}),C,w,T,E,D,O=e((()=>{f(),x(),r(),C={title:`Ui/TabsNavigation`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1TabsNavigation:m},setup:()=>({args:e}),template:`
