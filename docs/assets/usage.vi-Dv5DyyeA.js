import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/styles/color/# Sử dụng Thuộc tính` }), `
...
` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Tham số đầu tiên là "tên thuộc tính", sẽ trở thành số đuôi trong biến `, (0, c.jsx)(n.code, { children: `--sys-[name]` }), `. Màu này sau đó có thể được áp dụng với các thành phần dạng nút con bằng cách sử dụng `, (0, c.jsx)(n.code, { children: `color('init')` }), ` hoặc đưa vào dưới định dạng CSS như `, (0, c.jsx)(n.code, { children: `rgba(var(--sys-color), 1)` }), `.`] })] })
