import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, p: `p`, pre: `pre`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/nitro-basic/Functions/uiIdServer - Trình tạo ID phía server` }), `
`, (0, c.jsx)(n.h1, { id: `uiidserver`, children: (0, c.jsx)(n.code, { children: `uiIdServer` }) }), `
`, (0, c.jsx)(n.p, { children: `Khởi tạo hàm tạo định danh duy nhất toàn cục cho các thành phần ở phía server. Nó sử dụng các giá trị của ngữ cảnh yêu cầu để tạo các ID duy nhất trong quá trình SSR.` }), `
