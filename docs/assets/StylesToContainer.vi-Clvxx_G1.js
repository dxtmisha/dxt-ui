...
`,(0,c.jsx)(t.h1,{id:`lớp-stylestocontainer`,children:`Lớp StylesToContainer`}),`
`,(0,c.jsxs)(t.p,{children:[`Lớp `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` chịu trách nhiệm tạo các truy vấn CSS `,(0,c.jsx)(t.code,{children:`@container`}),` từ các thuộc tính thiết kế. Nó triển khai logic để bao bọc các quy tắc style lồng nhau bên trong một khối container query.`]}),`
`,(0,c.jsx)(t.h2,{id:`các-tính-năng-chính`,children:`Các tính năng chính`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Bao bọc Container Query`}),` — Tự động bao bọc nội dung style được tạo bên trong một quy tắc `,(0,c.jsx)(t.code,{children:`@container`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Phân giải truy vấn động`}),` — Sử dụng giá trị thuộc tính thiết kế để định nghĩa điều kiện của container query.`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Khởi tạo trình chuyển đổi `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` với thuộc tính bắt buộc và một hàm gọi nội dung cho các quy tắc lồng nhau.`]}),`
...
`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-typescript`,children:`import { StylesToContainer } from '@dxtmisha/scripts'
