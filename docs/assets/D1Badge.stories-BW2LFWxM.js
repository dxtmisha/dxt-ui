import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { a as n, d as r, l as i, m as a, n as o, t as s, u as c } from './wiki-CUC2UhNU.js'; import { i as l, n as u, r as d, t as f } from './D1Badge-JT_fwE_h.js'; var p, m, h, g, _ = t(() => { s(), l(), p = [{ name: `ariaLabel`, type: `string` }, { name: `dot`, type: `boolean` }, { name: `formatting`, type: `boolean` }, { name: `hide`, type: `boolean` }, { name: `horizontal`, type: `string`, option: [`center`, `right`, `left`] }, { name: `icon`, type: `IconValue<IconProps>` }, { name: `iconAttrs`, type: `ConstrBind<IconProps>` }, { name: `iconDir`, type: `boolean` }, { name: `iconHide`, type: `boolean` }, { name: `iconPalette`, type: `boolean` }, { name: `iconTurn`, type: `boolean` }, { name: `label`, type: `NumberOrString` }, { name: `labelId`, type: `string` }, { name: `labelMax`, type: `NumberOrString` }, { name: `language`, type: `string` }, { name: `outline`, type: `boolean` }, { name: `overlap`, type: `string`, option: [`rectangular`, `circular`, `static`] }, { name: `palette`, type: `string`, option: [`red`, `orange`, `amber`, `yellow`, `lime`, `green`, `emerald`, `teal`, `cyan`, `sky`, `blue`, `indigo`, `violet`, `purple`, `fuchsia`, `pink`, `rose`, `slate`, `gray`, `zinc`, `neutral`, `stone`, `black`, `white`] }, { name: `primary`, type: `boolean` }, { name: `secondary`, type: `boolean` }, { name: `selected`, type: `boolean` }, { name: `size`, type: `string`, option: [`sm`, `md`, `lg`, `none`] }, { name: `vertical`, type: `string`, option: [`top`, `center`, `bottom`] }], m = [{ name: `default`, description: `Default slot content/ Содержимое слота по умолчанию`, properties: [{ name: `props`, type: `(any) | undefined` }] }], h = [], g = { component: `Badge`, props: p, slots: m, events: h, defaults: d, wikiDesign: o } }), v, y = t(() => { r(), i(), _(), v = new c(g.component, g.props, g.defaults, g.wikiDesign, n, a) }), b = e({ Badge: () => S, BadgeBasic: () => C, BadgeDot: () => w, BadgeOutline: () => D, BadgePrimary: () => T, BadgeSecondary: () => E, __namedExportsOrder: () => O, default: () => x }), x, S, C, w, T, E, D, O, k = t(() => {
  u(), y(), x = { title: `Ui/Badge`, component: f, parameters: { design: `d1`, docs: { description: { component: v.getDescription() } } }, argTypes: v.getWiki(), args: v.getValues() }, S = { render: e => ({ components: { D1Badge: f }, setup: () => ({ args: e }), template: `
...
}`, ...D.parameters?.docs?.source } } }, O = [`Badge`, `BadgeBasic`, `BadgeDot`, `BadgePrimary`, `BadgeSecondary`, `BadgeOutline`]
}); k(); export { S as Badge, C as BadgeBasic, w as BadgeDot, D as BadgeOutline, T as BadgePrimary, E as BadgeSecondary, O as __namedExportsOrder, x as default, y as i, k as n, v as r, b as t }
