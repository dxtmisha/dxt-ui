import{n as e,r as t}from"./chunk-BneVvdWh.js";import{It as n,gt as r}from"./iframe-InwAcaLb.js";import{a as i,d as a,l as o,m as s,n as c,t as l,u}from"./wiki-DiKtF90Q.js";import{i as d,n as f,r as p,t as m}from"./D1Window-B_Zy87Hg.js";var h,g,_=e((()=>{u(),l(),d(),h=[{name:`adaptive`,type:`string`,option:[`menu`,`menuWindow`,`modal`,`modalDynamic`,`actionSheetRight`,`actionSheetBottom`,`static`,`actionSheet`,`actionSheetToModal`,`autoStaticSm`,`autoStaticMd`,`autoStaticLg`,`autoStaticXl`,`autoStatic2xl`]},{name:`alignment`,type:`string`,option:[`top`,`left`,`center`,`topRight`,`topLeft`,`topFull`,`right`,`rightFull`,`bottom`,`bottomRight`,`bottomLeft`,`bottomFull`,`leftFull`]},{name:`ariaDescribedby`,type:`string`},{name:`ariaHaspopup`,type:`string`,option:[`menu`,`dialog`,`grid`,`listbox`,`tree`,`true`,`false`]},{name:`ariaLabelledby`,type:`string`},{name:`autoClose`,type:`boolean`},{name:`autoTabIndex`,type:`boolean`},{name:`axis`,type:`string`,option:[`x`,`y`,`on`]},{name:`beforeClosing`,type:`() => NormalOrPromise<boolean>`},{name:`beforeOpening`,type:`() => NormalOrPromise<boolean>`},{name:`closeButton`,type:`boolean`},{name:`closeMobileHide`,type:`boolean`},{name:`closeOnEsc`,type:`boolean`},{name:`closing`,type:`() => NormalOrPromise<boolean>`},{name:`contextmenu`,type:`boolean`},{name:`dense`,type:`boolean`},{name:`disabled`,type:`boolean`},{name:`divider`,type:`boolean`},{name:`embedded`,type:`boolean`},{name:`flash`,type:`boolean`},{name:`fullscreen`,type:`boolean`},{name:`height`,type:`string`,option:[`auto`,`max`,`sm`,`md`,`lg`,`custom`]},{name:`hide`,type:`boolean`},{name:`iconClose`,type:`IconValue<Icon>`},{name:`image`,type:`string | ConstrBind<Image>`},{name:`imagePosition`,type:`string`,option:[`top`,`left`]},{name:`imageSize`,type:`string`,option:[`sm`,`md`,`lg`,`quarter`,`half`]},{name:`indent`,type:`number`},{name:`inDom`,type:`boolean`},{name:`inert`,type:`boolean`},{name:`modelOpen`,type:`boolean`},{name:`onUpdate:modelOpen`,type:`(value: boolean) => void`},{name:`onUpdate:open`,type:`(value: boolean) => void`},{name:`open`,type:`boolean`},{name:`opening`,type:`() => NormalOrPromise<boolean>`},{name:`openOnArrowDown`,type:`boolean`},{name:`origin`,type:`string`,option:[`top`,`left`,`center`,`right`,`bottom`,`topToBottom`,`rightToLeft`,`bottomToTop`,`leftToRight`]},{name:`overElement`,type:`ElementOrString<HTMLElement>`},{name:`overscroll`,type:`boolean`},{name:`persistent`,type:`boolean`},{name:`preparation`,type:`() => NormalOrPromise<void>`},{name:`role`,type:`string`},{name:`scrollbarAttrs`,type:`ConstrBind<Scrollbar>`},{name:`staticMode`,type:`boolean`},{name:`textClose`,type:`TextValue`},{name:`width`,type:`string`,option:[`auto`,`max`,`sm`,`md`,`lg`,`custom`]},{name:`widthMatch`,type:`boolean`}],g={component:`Window`,props:h,defaults:p,wikiDesign:c}})),v,y=e((()=>{u(),i(),_(),v=new a(g.component,g.props,g.defaults,g.wikiDesign,o,s)})),b=t({Window:()=>S,WindowAxis:()=>w,WindowStaticMode:()=>C,WindowVModel:()=>T,__namedExportsOrder:()=>E,default:()=>x}),x,S,C,w,T,E,D=e((()=>{f(),y(),r(),x={title:`Ui/Window`,component:m,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1Window:m},setup:()=>({args:e}),template:`
    ...
    `})},C={name:`Статический режим`,render:()=>({components:{D1Window:m},template:`
    ...
    `})},w={name:`Позиционирование по оси`,render:()=>({components:{D1Window:m},template:`
    ...
    `})},T={name:`Двусторонняя привязка (v-model)`,render:()=>({components:{D1Window:m},setup(){return{open:n(!1)}},template:`
...
}`,...T.parameters?.docs?.source}}},E=[`Window`,`WindowStaticMode`,`WindowAxis`,`WindowVModel`]}));D();export{S as Window,w as WindowAxis,C as WindowStaticMode,T as WindowVModel,E as __namedExportsOrder,x as default,y as i,D as n,v as r,b as t};