import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/scripts/Classes/DesignTypescript - Bộ phân tích siêu dữ liệu kiểu` }), `
...
`, (0, c.jsxs)(n.p, { children: [`Lớp này thường được sử dụng bởi các trình tạo khác (như `, (0, c.jsx)(n.code, { children: `DesignTypes` }), ` hoặc `, (0, c.jsx)(n.code, { children: `DesignCommand` }), `) để thu hẹp khoảng cách giữa mã tĩnh và logic động. Bằng cách cung cấp một API sạch cho TypeScript Compiler phức tạp, nó cho phép hệ thống thiết kế luôn "nhận biết kiểu" trong tất cả các quy trình tự động của nó.`] })] })
