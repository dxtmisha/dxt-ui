...
Лёгкий эмит ввода без DOM-события: [value]`, properties: [{ name: `value`, type: `FieldValidationItem<any>` }] }, { name: `update:modelValue`, description: `Update model value event/ Событие обновления значения модели`, properties: [{ name: `value`, type: `any` }] }, { name: `update:value`, description: `Update value event/ Событие обновления значения`, properties: [{ name: `value`, type: `any` }] }], H = { component: `MenuChip`, props: z, slots: B, events: V, defaults: M, wikiDesign: v }
  }), W, G = t(() => { m(), g(), U(), W = new te(H.component, H.props, H.defaults, H.wikiDesign, p, _) }), K = e({ MenuChip: () => J, MenuChipBasic: () => Y, MenuChipSkeleton: () => Z, MenuChipVModel: () => X, __namedExportsOrder: () => Q, default: () => q }), q, J, Y, X, Z, Q, $ = t(() => {
    R(), G(), b(), a(), q = { title: `Ui/MenuChip`, component: L, parameters: { design: `d1`, docs: { description: { component: W.getDescription() } } }, argTypes: W.getWiki(), args: W.getValues() }, J = {}, Y = { name: `Базовые`, render: () => ({ components: { D1MenuChip: L }, setup() { return { options: c([{ label: `English`, value: `en` }, { label: `Russian`, value: `ru` }, { label: `Vietnamese`, value: `vi` }, { label: `Spanish`, value: `es` }]), value1: c(`en`), value2: c(`ru`), value3: c(`vi`) } }, template: `
    ...
    ` }) }, X = { name: `Двусторонняя привязка (v-model)`, render: () => ({ components: { D1MenuChip: L }, setup() { return { valueSingle: c(`option2`), valueMultiple: c([`option1`, `option3`]), options: [{ label: `First option`, value: `option1` }, { label: `Second option`, value: `option2` }, { label: `Third option`, value: `option3` }] } }, template: `
    ...
    ` }) }, Z = { name: `Скелетон`, render: () => ({ components: { D1MenuChip: L, D1Skeleton: x }, template: `
...
}`, ...Z.parameters?.docs?.source } } }, Q = [`MenuChip`, `MenuChipBasic`, `MenuChipVModel`, `MenuChipSkeleton`]
  }); $(); export { J as MenuChip, Y as MenuChipBasic, Z as MenuChipSkeleton, X as MenuChipVModel, Q as __namedExportsOrder, q as default, G as i, $ as n, W as r, K as t }
