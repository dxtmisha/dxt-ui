...
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Cảnh báo (SSR):`}),` Khi chạy trên máy chủ, hàm luôn trả về `,(0,c.jsx)(n.code,{children:`undefined`}),`. Nếu bạn sử dụng nó trong logic hiển thị của component, nó có thể dẫn đến lỗi không khớp hyradtion (hydration mismatch). Bạn nên gọi hàm này trong các hook vòng đời chỉ chạy trên client (ví dụ: `,(0,c.jsx)(n.code,{children:`onMounted`}),` trong Vue hoặc `,(0,c.jsx)(n.code,{children:`useEffect`}),` trong React).`]}),`
`]}),`
