...
`,(0,c.jsx)(t.li,{children:`Селекторы в тулбарах (например, размер шрифта, режим разметки, выбор языка)`}),`
`,(0,c.jsx)(t.li,{children:`Компактные выпадающие списки, где стандартная граница поля нежелательна`}),`
