...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAiDocDirectory(): string[]`}),` — возвращает директории, предназначенные для генерации документации.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAiDocStorybookPath(): string`}),` — возвращает путь экспорта для MDX-файлов Storybook.`]}),`
`]}),`
