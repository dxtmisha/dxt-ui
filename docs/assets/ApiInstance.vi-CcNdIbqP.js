import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, em: `em`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/ApiInstance - Quản lý yêu cầu (Request)` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Các phương thức CRUD` }), ` — các bí danh (alias) tiện lợi `, (0, c.jsx)(n.code, { children: `get` }), `, `, (0, c.jsx)(n.code, { children: `post` }), `, `, (0, c.jsx)(n.code, { children: `put` }), `, `, (0, c.jsx)(n.code, { children: `patch` }), `, `, (0, c.jsx)(n.code, { children: `delete` }), ` để thao tác với các yêu cầu HTTP`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Hydration` }), ` — chuyển dữ liệu từ máy chủ sang máy khách (SSR) để hiển thị tức thì`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Bộ nhớ đệm (Caching)` }), ` — lưu các phản hồi trong bộ nhớ trong hoặc ngoài thông qua `, (0, c.jsx)(n.code, { children: `ApiCache` })] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Giả lập phản hồi` }), ` — quản lý linh hoạt dữ liệu giả thông qua `, (0, c.jsx)(n.code, { children: `ApiResponse` })] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — hàm wrapper để thực thi các yêu cầu.`] }), `
`] }), `
...
`, (0, c.jsx)(n.h3, { id: `các-phương-thức-rút-gọn`, children: `Các phương thức rút gọn` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `get(request: ApiFetch): Promise<T>` }), ` — Bật một khối yêu cầu API bằng giao thức `, (0, c.jsx)(n.code, { children: `GET` }), ` theo cơ chế gỡ rối và ép đầu cung dữ liệu thông số search URL lên cấu trúc HTTP tự động.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `post(request: ApiFetch): Promise<T>` }), ` — Giao chuyển chùm truy vấn truyền động REST/GraphQL bằng luồng định tuyến tuân thủ HTTP `, (0, c.jsx)(n.code, { children: `POST` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `put(request: ApiFetch): Promise<T>` }), ` — Trình bày khả năng hiệu chỉnh một khối dữ liệu thông qua cấu hình thao tác tiêu chuẩn ở hệ phương án `, (0, c.jsx)(n.code, { children: `PUT` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `patch(request: ApiFetch): Promise<T>` }), ` — Kích hoạt việc cập nhật từng phần thông tin (partial update) của tài nguyên thông qua phương thức HTTP `, (0, c.jsx)(n.code, { children: `PATCH` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `delete(request: ApiFetch): Promise<T>` }), ` — Phát tín hiệu dọn dẹp theo phân hóa truyền thống ở nhát kích HTTP `, (0, c.jsx)(n.code, { children: `DELETE` }), `.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setOrigin(origin: string): this` }), ` — Thiết lập nguồn (giao thức và tên miền) cho URL base.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setWrapper(wrapper: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>): this` }), ` — Thiết lập hàm wrapper cho các yêu cầu.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.p, { children: [(0, c.jsx)(n.code, { children: `ApiFetch` }), ` là đối tượng cấu hình chính được truyền vào các phương thức `, (0, c.jsx)(n.code, { children: `request` }), `, `, (0, c.jsx)(n.code, { children: `get` }), `, `, (0, c.jsx)(n.code, { children: `post` }), `, `, (0, c.jsx)(n.code, { children: `put` }), `, `, (0, c.jsx)(n.code, { children: `patch` }), `, `, (0, c.jsx)(n.code, { children: `delete` }), `. Tất cả các trường đều là tùy chọn:`] }), `
`, (0, c.jsxs)(n.ul, { children: [`
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `method?: ApiMethod` }), ` — phương thức HTTP (`, (0, c.jsx)(n.code, { children: `'GET'` }), `, `, (0, c.jsx)(n.code, { children: `'POST'` }), `, `, (0, c.jsx)(n.code, { children: `'PUT'` }), `, `, (0, c.jsx)(n.code, { children: `'PATCH'` }), `, `, (0, c.jsx)(n.code, { children: `'DELETE'` }), `). Mặc định: `, (0, c.jsx)(n.code, { children: `'GET'` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `request?: FormData | Record<string, any> | string` }), ` — nội dung yêu cầu (POST/PUT/PATCH) hoặc tham số query (GET). Được gửi dưới dạng JSON hoặc `, (0, c.jsx)(n.code, { children: `FormData` }), `.`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `retryDelay?: number` }), ` — độ trễ cơ bản giữa các lần thử lại tính bằng mili giây. Mặc định: `, (0, c.jsx)(n.code, { children: `64` }), `ms. Jitter được sử dụng để ngăn chặn vấn đề thundering herd.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `endResetLimit?: number` }), ` — giới hạn đệ quy thử lại thông qua `, (0, c.jsx)(n.code, { children: `setEnd` }), ` với `, (0, c.jsx)(n.code, { children: `reset: true` }), `. Mặc định: `, (0, c.jsx)(n.code, { children: `8` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — hàm wrapper cục bộ để thực thi yêu cầu cụ thể này.`] }), `
`] }), `
...
`] }), `
`, (0, c.jsx)(n.h2, { id: `hàm-bọc-yêu-cầu-request-wrapper`, children: `Hàm bọc yêu cầu (Request Wrapper)` }), `
`, (0, c.jsxs)(n.p, { children: [`Hàm bọc yêu cầu (`, (0, c.jsx)(n.code, { children: `wrapper` }), `) cho phép bạn chặn và bọc quá trình thực thi của một yêu cầu mạng vật lý bằng một hàm tùy chỉnh. Điều này đặc biệt hữu ích khi tích hợp với các công cụ Giám sát hiệu suất ứng dụng (APM) như Sentry hoặc OpenTelemetry để cấu hình và theo dõi thời gian thực thi yêu cầu (tracing).`] }), `
`, (0, c.jsxs)(n.p, { children: [`Hàm bọc có thể được cấu hình toàn cục cho toàn bộ instance (thông qua `, (0, c.jsx)(n.code, { children: `options.wrapper` }), ` hoặc phương thức `, (0, c.jsx)(n.code, { children: `setWrapper` }), `) hoặc cục bộ cho một yêu cầu duy nhất bên trong đối tượng `, (0, c.jsx)(n.code, { children: `ApiFetch` }), `.`] }), `
`, (0, c.jsx)(n.h3, { id: `ví-dụ-sử-dụng-với-sentry`, children: `Ví dụ sử dụng với Sentry:` }), `
...
`, (0, c.jsx)(n.p, { children: `Hydration là một cơ chế để chuyển dữ liệu thu được trong quá trình Server-Side Rendering (SSR) sang phía client. Điều này giúp tránh việc thực hiện lại các yêu cầu mạng tương tự ngay sau khi trang được tải trong trình duyệt, giúp tăng tốc độ hiển thị và giảm tải cho máy chủ.` }), `
`, (0, c.jsx)(n.h3, { id: `cách-thức-hoạt-động`, children: `Cách thức hoạt động` }), `
`, (0, c.jsxs)(n.ol, { children: [`
`, (0, c.jsxs)(n.li, { children: [`
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Phía máy chủ (SSR):` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [`Tất cả các yêu cầu đã thực hiện (thường là phương thức `, (0, c.jsx)(n.code, { children: `GET` }), ` với `, (0, c.jsx)(n.code, { children: `global: true` }), `) sẽ tự động được lưu vào danh sách hydration.`] }), `
`, (0, c.jsxs)(n.li, { children: [`Sau khi hoàn tất tạo trang, cần gọi phương thức `, (0, c.jsx)(n.code, { children: `api.getHydrationScript()` }), ` và chèn chuỗi kết quả vào mẫu HTML (thường là ở cuối thẻ `, (0, c.jsx)(n.code, { children: `<body>` }), `).`] }), `
`] }), `
`] }), `
`, (0, c.jsxs)(n.li, { children: [`
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Phía client (Trình duyệt):` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [`Khi tạo một instance `, (0, c.jsx)(n.code, { children: `ApiInstance` }), `, nó sẽ tự động tìm kiếm script hydration trên trang.`] }), `
`, (0, c.jsx)(n.li, { children: `Dữ liệu tìm thấy sẽ được tải vào hệ thống và được thay thế cho lần gọi đầu tiên của các yêu cầu tương tự.` }), `
`, (0, c.jsx)(n.li, { children: `Nhờ đó, mã phía client nhận được dữ liệu ngay lập tức mà không cần chờ phản hồi từ mạng.` }), `
`] }), `
`] }), `
`] }), `
`, (0, c.jsx)(n.h3, { id: `ví-dụ-sử-dụng-ssr`, children: `Ví dụ sử dụng (SSR)` }), `
`, (0, c.jsx)(n.pre, { children: (0, c.jsx)(n.code, { className: `language-javascript`, children: `// Trên máy chủ
...
` }) }), `
`, (0, c.jsx)(n.h2, { id: `bộ-nhớ-đệm`, children: `Bộ nhớ đệm` }), `
`, (0, c.jsxs)(n.p, { children: [`Thư viện cung cấp cơ chế bộ nhớ đệm (caching) tích hợp cho các phản hồi, cho phép bạn lưu kết quả yêu cầu trong bộ nhớ hoặc trong bộ nhớ ngoài (ví dụ: `, (0, c.jsx)(n.code, { children: `LocalStorage` }), `).`] }), `
`, (0, c.jsx)(n.h3, { id: `các-tính-năng-chính-1`, children: `Các tính năng chính` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Thời gian sống (TTL)` }), ` — đối với mỗi yêu cầu, bạn có thể chỉ định thời gian hiệu lực của bộ nhớ đệm tính bằng giây.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Bộ nhớ ngoài` }), ` — khả năng tích hợp với bất kỳ bộ lưu trữ dữ liệu bất đồng bộ nào.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Tự động làm sạch` }), ` — dữ liệu cũ sẽ bị xóa khỏi bộ nhớ khi vượt quá giới hạn.`] }), `
`] }), `
`, (0, c.jsx)(n.h3, { id: `thiết-lập-bộ-nhớ-ngoài`, children: `Thiết lập bộ nhớ ngoài` }), `
`, (0, c.jsxs)(n.p, { children: [`Mặc định, bộ nhớ đệm chỉ hoạt động trong RAM và sẽ bị xóa khi tải lại trang. Để lưu dữ liệu lâu dài, bạn cần khởi tạo `, (0, c.jsx)(n.code, { children: `ApiCache` }), ` với các listener của riêng mình (ví dụ: sử dụng `, (0, c.jsx)(n.code, { children: `LocalStorage` }), ` hoặc `, (0, c.jsx)(n.code, { children: `IndexedDB` }), `):`] }), `
...
` }) }), `
`, (0, c.jsx)(n.h3, { id: `sử-dụng-trong-các-yêu-cầu`, children: `Sử dụng trong các yêu cầu` }), `
`, (0, c.jsxs)(n.p, { children: [`Để bật tính năng bộ nhớ đệm, chỉ cần truyền thời gian tính bằng giây vào trường `, (0, c.jsx)(n.code, { children: `cache` }), ` của đối tượng `, (0, c.jsx)(n.code, { children: `ApiFetch` }), `:`] }), `
`, (0, c.jsx)(n.pre, { children: (0, c.jsx)(n.code, { className: `language-javascript`, children: `// Lưu bộ nhớ đệm trong 1 giờ (3600 giây)
const data = await api.get({
  path: 'catalog/list',
  cache: 3600
});
` }) }), `
`, (0, c.jsx)(n.p, { children: `Nếu dữ liệu có trong bộ nhớ đệm và thời gian sống của nó chưa hết hạn, thư viện sẽ trả về dữ liệu đó ngay lập tức mà không thực hiện yêu cầu thực tế tới máy chủ.` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `method` }), ` — Phương thức HTTP (`, (0, c.jsx)(n.code, { children: `ApiMethodItem.get` }), `, `, (0, c.jsx)(n.code, { children: `post` }), `, `, (0, c.jsx)(n.code, { children: `put` }), `, `, (0, c.jsx)(n.code, { children: `patch` }), `, v.v...).`] }), `
