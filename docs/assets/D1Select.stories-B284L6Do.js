...
Лёгкий эмит ввода без DOM-события: [value]`,properties:[{name:`value`,type:`FieldValidationItem<any>`}]},{name:`update:modelValue`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`any`}]},{name:`update:value`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`any`}]}],U={component:`Select`,props:B,slots:V,events:H,defaults:P,wikiDesign:h}})))()}var G;function K(){return(K=e((()=>{f(),te(),W(),G=new re(U.component,U.props,U.defaults,U.wikiDesign,_,m)})))()}var le=t({Select:()=>J,SelectBasic:()=>Y,SelectSkeleton:()=>Z,SelectVModel:()=>X,__namedExportsOrder:()=>Q,default:()=>q}),q,J,Y,X,Z,Q;function $(){return($=e((()=>{z(),K(),ae(),r(),q={title:`Ui/Select`,component:R,parameters:{design:`d1`,docs:{description:{component:G.getDescription()}}},argTypes:G.getWiki(),args:G.getValues()},J={args:{editValue:!0,multiple:!0},render:e=>({components:{D1Select:R},setup:()=>({args:e}),template:`
    ...
    `})},Z={name:`Скелетон`,render:()=>({components:{D1Select:R,D1Skeleton:oe},template:`
...
}`,...Z.parameters?.docs?.source}}},Q=[`Select`,`SelectBasic`,`SelectVModel`,`SelectSkeleton`]})))()}export{X as a,K as c,Z as i,J as n,$ as o,Y as r,G as s,le as t};