...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`init: () => void`}),` — метод для явной ручной инициализации запроса и наблюдения.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`initSsr: () => void`}),` — метод для инициализации на стороне сервера (SSR).`]}),`
...
`]}),`
`,(0,c.jsx)(n.h2,{id:`асинхронная-версия`,children:`Асинхронная версия`}),`
`,(0,c.jsxs)(n.p,{children:[`Для случаев, когда требуется немедленная (не ленивая) инициализация запроса (например, для SSR), используйте `,(0,c.jsx)(n.a,{href:`./useApiManagementAsyncRef.ru.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiManagementAsyncRef`})})}),`. Он автоматически вызывает `,(0,c.jsx)(n.code,{children:`initSsr()`}),` при создании.`]}),`
...
`,(0,c.jsxs)(n.p,{children:[`Для обеспечения корректной работы `,(0,c.jsx)(n.strong,{children:`Server Side Rendering (SSR)`}),` рекомендуется использовать асинхронную версию `,(0,c.jsx)(n.a,{href:`./useApiManagementAsyncRef.ru.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiManagementAsyncRef`})})}),`. Она автоматически инициализирует запрос для предзагрузки на сервере.`]}),`
`,(0,c.jsxs)(n.p,{children:[`Если вы используете стандартный `,(0,c.jsx)(n.code,{children:`useApiManagementRef`}),`, вы можете вручную включить его в цикл SSR, вызвав `,(0,c.jsx)(n.code,{children:`initSsr()`}),` в `,(0,c.jsx)(n.code,{children:`setup()`}),` компонента. Это гарантирует, что данные будут загружены на стороне сервера.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`conditions?: Ref<boolean>`}),` — условие выполнения запроса.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`transformation?: (data: Type, isResponseContractValid?: ApiDataValidation) => ApiData<Return>`}),` — функция трансформации данных после получения.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateResponseContract?: (data: Type) => ApiDataValidation`}),` — функция для проверки контракта данных ответа.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`unmounted?: boolean`}),` — очищать ли данные после размонтирования компонента.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateRequestContract?: (data: Request) => ApiDataValidation & Return`}),` — функция валидации контракта запроса.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateResponseContract?: (data: T) => ApiDataValidation & Return`}),` — функция валидации контракта ответа.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`errorContract?: ApiErrorStorageList`}),` — хранилище контрактов ошибок ответа.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`toData?: boolean`}),` — оборачивать ли полезную нагрузку в свойство 'data'.`]}),`
