import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as i}from"./index-BaLriJNq.js";import{M as s}from"./blocks-SOxllcy3.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B21bnPHY.js";function c(t){const e={code:"code",h1:"h1",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(s,{title:"@dxtmisha/vi/functional-basic/Functions/getMouseClientX - Lấy tọa độ X của sự kiện"}),`
`,n.jsx(e.h1,{id:"getmouseclientx",children:n.jsx(e.code,{children:"getMouseClientX"})}),`
`,n.jsx(e.p,{children:"Trích xuất tọa độ X (vị trí ngang) của con trỏ (chuột hoặc cảm ứng) tương đối với vùng nhìn thấy của cửa sổ trình duyệt (viewport) từ đối tượng sự kiện."}),`
`,n.jsxs(e.p,{children:["Hàm này xử lý cả các sự kiện chuột tiêu chuẩn (",n.jsx(e.code,{children:"MouseEvent"}),") và các sự kiện chạm (",n.jsx(e.code,{children:"TouchEvent"}),"), ưu tiên thuộc tính ",n.jsx(e.code,{children:"clientX"}),". Nếu ",n.jsx(e.code,{children:"clientX"})," không được tìm thấy trực tiếp trên sự kiện, nó sẽ tiếp tục tìm kiếm bên trong các mảng ",n.jsx(e.code,{children:"targetTouches"})," và ",n.jsx(e.code,{children:"touches"}),"."]}),`
...
`,n.jsx(e.code,{children:"number"})," — Tọa độ X của con trỏ/điểm chạm. Nếu không tìm thấy, nó sẽ trả về ",n.jsx(e.code,{children:"0"}),"."]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-typescript",children:`import { getMouseClientX } from '@dxtmisha/functional-basic'
