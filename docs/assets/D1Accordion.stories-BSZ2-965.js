import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Dt as n,Mt as r,Nt as i,Pt as a,Rt as o,Ut as s,_ as c,an as l,jt as u,nn as d}from"./library-BfcLFF_v.js";import{O as f,d as p,i as m,j as h,k as ee,l as g,m as _,n as v,p as y,t as b,u as te}from"./wiki-BHyzKkJP.js";import{n as ne,t as re}from"./EventClickInclude-CHVU4Ljf-yU_qsivV.js";import{n as x,t as S}from"./ModelInclude-BLHqo2zE-C-RXp8tC.js";import{n as C,t as w}from"./ComponentIncludeAbstract-BW_HamXq-DX9ihqS3.js";import{n as ie,t as ae}from"./D1Cell-MC2wSGQH.js";import{n as T,t as E}from"./MotionTransform-DTDi39BX.js";var D;function O(){return(O=e((()=>{w(),D=class extends C{constructor(e,t,n,r,i,a){super(e,t,n,r,i),y(this,`emits`,void 0),y(this,`exposeItems`,[{name:`isShow`,type:`boolean`},{name:`getOpen`,type:`boolean`},{name:`setOpen`},{name:`toOpen`},{name:`toClose`},{name:`toggle`}]),y(this,`name`,`motionTransform`),y(this,`propsAttrsName`,`motionTransformAttrs`),y(this,`onTransform`,(e,t)=>{var n,r;(n=this.emits)==null||n.call(this,`transform`,e,t),(r=this.emits)==null||r.call(this,`transformLite`,t)}),this.emits=a}getAttrs(e){let t=this.getProps();return{...super.getAttrs(e),open:t.open}}toBinds(){let e=this.getProps();return{...super.toBinds(),clickOpen:e.clickOpen,autoClose:e.autoClose,onTransform:this.onTransform}}toExpose(){return{...super.toExpose(),getMotionTransformElement:()=>this.element.value}}}})))()}var k,A,j;function M(){return(M=e((()=>{ne(),x(),O(),n(),f(),k=class{constructor(e,t,n,r,i,a,o,s,l={}){y(this,`props`,void 0),y(this,`refs`,void 0),y(this,`element`,void 0),y(this,`classDesign`,void 0),y(this,`className`,void 0),y(this,`components`,void 0),y(this,`slots`,void 0),y(this,`emits`,void 0),y(this,`motionTransform`,void 0),y(this,`event`,void 0),y(this,`open`,d(!1)),y(this,`model`,void 0),y(this,`elementHead`,d()),y(this,`labelId`,c()),y(this,`descriptionId`,c()),this.props=e,this.refs=t,this.element=n,this.classDesign=r,this.className=i,this.components=a,this.slots=o,this.emits=s;let{EventClickIncludeConstructor:u=re,ModelIncludeConstructor:f=S,MotionTransformIncludeConstructor:p=D}=l;this.motionTransform=new p(this.className,this.props,this.components,()=>({section:!0,adaptive:`planeAlways`,inDom:!0,ariaLabelledby:this.labelId,ariaDescribedby:this.descriptionId,"data-divider":this.props.divider?`divider`:void 0}),void 0,this.emits),this.event=new u(void 0,void 0,s),this.model=new f(`open`,this.emits,this.open)}get bindsCell(){return h(this.props.cellAttrs,{ref:this.elementHead,icon:this.props.icon,iconTrailing:this.props.iconArrowDown,label:this.props.label,description:this.props.description,dynamic:!0,labelId:this.labelId,descriptionId:this.descriptionId,onClick:this.event.onClick,onKeydown:this.event.onKeydown})}},A={clickOpen:!0,autoClose:!0,divider:!0},j=class extends ee{constructor(e,t,n){super(e,t,n),y(this,`item`,void 0),y(this,`renderHead`,({isOpen:e,binds:t})=>{let n={};return this.slots&&(`label`in this.slots&&(n.label=e=>this.initSlot(`label`,void 0,e)),`description`in this.slots&&(n.description=e=>this.initSlot(`description`,void 0,e)),`caption`in this.slots&&(n.caption=e=>this.initSlot(`caption`,void 0,e)),`trailing`in this.slots&&(n.trailing=e=>this.initSlot(`trailing`,void 0,e)),`body`in this.slots&&(n.body=e=>this.initSlot(`body`,void 0,e))),this.components.renderOne(`cell`,h(this.item.bindsCell,t,{iconTurn:e,class:this.classes?.value.head}),n)}),y(this,`renderBody`,e=>a(`div`,this.getKeyClass(`body`),this.initSlot(`default`,void 0,e))),this.item=new k(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits),this.init()}initExpose(){return{...this.item.motionTransform.expose}}initClasses(){return{main:{},head:this.getSubClass(`head`),body:this.getSubClass(`body`)}}initStyles(){return{}}initRender(){return this.item.motionTransform.render({head:this.renderHead,body:this.renderBody},{...this.getAttrs(),class:this.classes?.value.main,...this.item.model.getBinds()})}}})))()}var N;function P(){return(P=e((()=>{ie(),N=ae})))()}var F;function I(){return(I=e((()=>{M(),F={...A,iconArrowDown:`keyboard_arrow_down`,divider:!0}})))()}var L;function R(){return(R=e((()=>{n(),M(),P(),T(),I(),L=i({name:`D1Accordion`,__name:`D1Accordion`,props:o({label:{},labelId:{},description:{},descriptionId:{},icon:{},open:{type:Boolean},clickOpen:{type:Boolean},autoClose:{type:Boolean},motionTransformAttrs:{},modelOpen:{},"onUpdate:open":{type:Function},"onUpdate:modelOpen":{type:Function},iconArrowDown:{},cellAttrs:{},divider:{type:Boolean}},F),emits:[`click`,`clickLite`,`transform`,`transformLite`,`update:open`,`update:modelOpen`],setup(e,{expose:t,emit:n}){let i=n,a=e,o=u(()=>({main:{"d1-accordion":!0,"d1-accordion--divider":a.divider}})),c=u(()=>({})),d=new j(`d1.accordion`,a,{emits:i,classes:o,styles:c,components:{cell:N,motionTransform:E}}),f=d.render();return t(d.expose()),(e,t)=>(s(),r(l(f)))}})})))()}var z;function B(){return(B=e((()=>{R(),z=L,L.__docgenInfo=Object.assign({displayName:L.name??L.__name},{name:`D1Accordion`,exportName:`default`,displayName:`D1Accordion`,description:``,tags:{},sourceFiles:[`/Volumes/T7/development/dxt-ui/packages/d1/src/components/Ui/Accordion/D1Accordion.vue`]})})))()}var V,H,U,W;function G(){return(G=e((()=>{b(),I(),V=[{name:`autoClose`,type:`boolean`},{name:`cellAttrs`,type:`ConstrBind<CellProps>`},{name:`clickOpen`,type:`boolean`},{name:`description`,type:`string | number`},{name:`descriptionId`,type:`string`},{name:`divider`,type:`boolean`},{name:`icon`,type:`IconValue<IconProps>`},{name:`iconArrowDown`,type:`IconValue<IconProps>`},{name:`label`,type:`NumberOrString`},{name:`labelId`,type:`string`},{name:`modelOpen`,type:`boolean`},{name:`motionTransformAttrs`,type:`ConstrBind<MotionTransformProps>`},{name:`onUpdate:modelOpen`,type:`((value: boolean) => void)`},{name:`onUpdate:open`,type:`((value: boolean) => void)`},{name:`open`,type:`boolean`}],H=[{name:`body`,description:`Slot for the main body content/ Слот для основного контента тела`,properties:[{name:`props`,type:`(CellClassesSub) | undefined`}]},{name:`caption`,description:`Caption slot/ Слот заголовка`,properties:[{name:`props`,type:`(any) | undefined`}]},{name:`default`,description:`Main expandable content of the accordion/ Основное раскрывающееся содержимое аккордеона`,properties:[{name:`props`,type:`(MotionTransformControlItem) | undefined`}]},{name:`description`,description:`Description slot/ Слот описания`,properties:[{name:`props`,type:`(any) | undefined`}]},{name:`label`,description:`Label slot content/ Содержимое слота метки`,properties:[{name:`props`,type:`(any) | undefined`}]},{name:`trailing`,description:`Slot for elements on the right/ Слот для элементов справа`,properties:[{name:`props`,type:`(CellClassesSub) | undefined`}]}],U=[{name:`click`,description:`Full click event with MouseEvent/ Полное событие клика с MouseEvent`,properties:[{name:`event`,type:`MouseEvent`},{name:`value`,type:`EventClickValue`}]},{name:`clickLite`,description:`Lightweight click event/ Упрощённое событие клика`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`transform`,description:`Transform event with native event and options/ Событие трансформации с нативным событием и опциями`,properties:[{name:`event`,type:`Event | undefined`},{name:`options`,type:`MotionTransformEmitOptions`}]},{name:`transformLite`,description:`Lightweight transform event with options only/ Облегчённое событие трансформации только с опциями`,properties:[{name:`options`,type:`MotionTransformEmitOptions`}]},{name:`update:modelOpen`,description:`Update model open event/ Событие обновления открытия модели`,properties:[{name:`value`,type:`boolean`}]},{name:`update:open`,description:`Update open event/ Событие обновления открытия`,properties:[{name:`value`,type:`boolean`}]}],W={component:`Accordion`,props:V,slots:H,events:U,defaults:F,wikiDesign:v}})))()}var K;function q(){return(q=e((()=>{p(),g(),G(),K=new te(W.component,W.props,W.defaults,W.wikiDesign,m,_)})))()}var oe=t({Accordion:()=>Y,AccordionSlots:()=>Z,AccordionVModel:()=>X,__namedExportsOrder:()=>Q,default:()=>J}),J,Y,X,Z,Q;function $(){return($=e((()=>{B(),q(),n(),J={title:`Ui/Accordion`,component:z,parameters:{design:`d1`,docs:{description:{component:K.getDescription()}}},argTypes:K.getWiki(),args:K.getValues()},Y={render:e=>({components:{D1Accordion:z},setup:()=>({args:e}),template:`
