import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/nitro-basic/Functions/initServerRouter - Server Router Initialization` }), `
`, (0, c.jsx)(n.h1, { id: `initserverrouter`, children: (0, c.jsx)(n.code, { children: `initServerRouter` }) }), `
`, (0, c.jsx)(n.p, { children: `An asynchronous function to initialize the Vue router during server-side rendering. It pushes the router to the current request URL and waits for it to be ready.` }), `
