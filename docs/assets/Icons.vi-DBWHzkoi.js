import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as h}from"./index-DC9WpFni.js";import{M as t}from"./blocks-DrZFBXp-.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-okvuAVTt.js";function s(c){const i={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...h(),...c.components};return n.jsxs(n.Fragment,{children:[n.jsx(t,{title:"@dxtmisha/vi/functional-basic/Classes/Icons - Quản lý Biểu tượng"}),`
...
`]}),`
`,n.jsx(i.h2,{id:"hệ-thống-tải",children:"Hệ thống tải"}),`
`,n.jsxs(i.p,{children:["Lớp ",n.jsx(i.code,{children:"Icons"})," hỗ trợ cơ chế chờ bất đồng bộ. Điều này cho phép bạn yêu cầu một biểu tượng trước khi nó thực sự được tải hoặc đăng ký trong hệ thống."]}),`
`,n.jsxs(i.ol,{children:[`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"Đăng ký chờ"}),": Sử dụng phương thức ",n.jsx(i.code,{children:"addLoad(name)"}),", một biểu tượng được đánh dấu bằng ký hiệu đặc biệt ",n.jsx(i.code,{children:"--LOAD--"}),". Điều này thông báo cho hệ thống biết rằng biểu tượng sẽ có sẵn sau đó."]}),`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"Quá trình chờ"}),": Nếu gọi ",n.jsx(i.code,{children:"get(name)"})," cho một biểu tượng đang ở trạng thái tải, phương thức sẽ không trả về lỗi mà thay vào đó sẽ chuyển sang chế độ chờ. Nó sẽ kiểm tra registry sau mỗi 320 ms."]}),`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"Hoàn tất"}),": Ngay khi biểu tượng được thêm qua ",n.jsx(i.code,{children:"add(name, ...)"}),", tất cả các lệnh gọi ",n.jsx(i.code,{children:"get"})," đang chờ sẽ tự động hoàn tất và trả về nội dung của biểu tượng đó."]}),`
`]}),`
`,n.jsx(i.p,{children:"Cơ chế này rất quan trọng đối với các hệ thống phân tán, nơi các thành phần có thể yêu cầu tài nguyên trước khi cơ sở dữ liệu truyền thông hoàn tất quá trình khởi tạo."}),`
...
`})})]})}function a(c={}){const{wrapper:i}={...h(),...c.components};return i?n.jsx(i,{...c,children:n.jsx(s,{...c})}):s(c)}export{a as default};
