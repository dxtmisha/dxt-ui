...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Hỗ trợ Đối số Linh hoạt`}),`: Cho phép nhắm mục tiêu động vào các tệp cụ thể và nút cụ thể thông qua tham số dòng lệnh.`]}),`
`]}),`
...
`,(0,c.jsx)(t.li,{children:`Tập lệnh đọc khóa tệp Figma mục tiêu và mã định danh nút tùy chọn được truyền trực tiếp từ các đối số dòng lệnh.`}),`
...
`,(0,c.jsx)(t.p,{children:`Để truy xuất hình ảnh layout, hãy chạy lệnh truyền vào khóa tệp Figma và ID nút cụ thể:`}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-bash`,children:`npx dxt-figma-layout [fileKey] [nodeId]
`})}),`
`,(0,c.jsx)(t.p,{children:`Ví dụ:`}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-bash`,children:`npx dxt-figma-layout abc123xyz456 1-24
`})}),`
`,(0,c.jsx)(t.h2,{id:`đối-số-cli`,children:`Đối số CLI`}),`
`,(0,c.jsx)(t.p,{children:`Lệnh chấp nhận hai tham số vị trí:`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`fileKey`}),`: Mã định danh duy nhất của tệp Figma (thường tìm thấy trong URL tệp Figma).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`nodeId`}),`: ID nút cụ thể bên trong tệp (ví dụ: `,(0,c.jsx)(t.code,{children:`1-24`}),` hoặc `,(0,c.jsx)(t.code,{children:`1:24`}),`) cần truy xuất.`]}),`
