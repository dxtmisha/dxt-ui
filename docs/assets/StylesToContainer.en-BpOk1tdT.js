...
`,(0,c.jsx)(t.h1,{id:`stylestocontainer-class`,children:`StylesToContainer Class`}),`
`,(0,c.jsxs)(t.p,{children:[`The `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` class is responsible for generating CSS `,(0,c.jsx)(t.code,{children:`@container`}),` queries from design properties. It implements the logic to wrap nested style rules within a container query block.`]}),`
`,(0,c.jsx)(t.h2,{id:`key-features`,children:`Key Features`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Container Query Wrapping`}),` — Automatically wraps the generated style content within a `,(0,c.jsx)(t.code,{children:`@container`}),` rule.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Dynamic Query Resolution`}),` — Uses the design property value to define the container query condition.`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Initialize the `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` converter with the required property and a content callable for the nested rules.`]}),`
