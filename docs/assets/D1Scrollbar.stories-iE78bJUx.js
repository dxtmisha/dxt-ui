import{d as a,_ as n}from"./D1Scrollbar-8dGJBxWx.js";import{w as r,W as s,a as l,b as c}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";const p=[{name:"divider",type:"boolean"},{name:"dividerBottom",type:"boolean"},{name:"dividerHide",type:"boolean"},{name:"dividerTop",type:"boolean"},{name:"inverse",type:"boolean"},{name:"standard",type:"boolean"},{name:"tag",type:"string"},{name:"visible",type:"boolean"}],i={component:"Scrollbar",props:p,defaults:a,wikiDesign:r},o=new s(i.component,i.props,i.defaults,i.wikiDesign,l,c),d={title:"Ui/Scrollbar",component:n,parameters:{design:"d1",docs:{description:{component:o.getDescription()}}},argTypes:o.getWiki(),args:o.getValues()},e={render:t=>({components:{D1Scrollbar:n},setup:()=>({args:t}),template:`
      <D1Scrollbar
  ...
  // :story-main [!] System label / Системная метка
}`,...e.parameters?.docs?.source}}};const m=["Scrollbar"],f=Object.freeze(Object.defineProperty({__proto__:null,Scrollbar:e,__namedExportsOrder:m,default:d},Symbol.toStringTag,{value:"Module"}));export{f as S,e as a,o as b};
