import{i as e}from"./preload-helper-Cv19cBWa.js";import{a as t,t as n}from"./jsx-runtime-D1H6-shM.js";import{f as r,s as i}from"./blocks-CKlddtvc.js";import{t as a}from"./mdx-react-shim-B1U8VZv0.js";function o(e){let n={blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(i,{title:`@dxtmisha/vi/functional-basic/Classes/Datetime - Tiện ích Ngày & Giờ`}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`getTimeZone(style?: GeoTimeZoneStyle): string`}),` — Trả về múi giờ (hỗ trợ các kiểu `,(0,c.jsx)(n.code,{children:`minute`}),`, `,(0,c.jsx)(n.code,{children:`hour`}),`, `,(0,c.jsx)(n.code,{children:`RFC`}),`; định dạng mặc định với dấu hai chấm).`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`getMaxDay(): number`}),` — Trả về số của ngày cuối cùng trong tháng hiện tại (28-31).`]}),`
`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`moveWeekdayLastByMonth(): this`}),` — Chuyển đến ngày cuối cùng của tuần cuối cùng trong tháng hiện tại.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`cloneWeekdayLastByMonth(): Datetime`}),` — Sao chép đến cuối tuần cuối cùng của tháng.`]}),`
...
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Cảnh báo (SSR):`}),` Việc tạo một thực thể `,(0,c.jsx)(n.code,{children:`Datetime`}),` mà không có ngày cụ thể (sử dụng thời gian hiện tại) để render trong SSR có thể dẫn đến lỗi hydration mismatch vì thời gian hoặc múi giờ trên máy chủ có thể khác với thời gian trên máy khách.`]}),`
`]}),`
`,(0,c.jsx)(n.h3,{id:`thực-tiễn-khuyến-nghị`,children:`Thực tiễn khuyến nghị`}),`
`,(0,c.jsxs)(n.p,{children:[`Khi sử dụng `,(0,c.jsx)(n.code,{children:`Datetime`}),` trong môi trường SSR:`]}),`
`,(0,c.jsxs)(n.ol,{children:[`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Luôn cung cấp ngày cụ thể`}),`: Truyền ngày cụ thể vào hàm khởi tạo thay vì sử dụng thời gian hiện tại.`]}),`
`]}),`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Sử dụng khởi tạo ngày ở phía máy chủ`}),`: Khởi tạo ngày ở máy chủ với các giá trị cụ thể để đảm bảo tính nhất quán.`]}),`
`]}),`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Chỉ khởi tạo ở phía máy khách cho ngày động`}),`: Đối với ngày cần hiển thị thời gian hiện tại, chỉ khởi tạo ở phía máy khách (ví dụ: trong `,(0,c.jsx)(n.code,{children:`useEffect`}),`).`]}),`
`]}),`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Cân nhắc sự khác biệt múi giờ`}),`: Lưu ý rằng múi giờ máy chủ và máy khách có thể khác nhau, ảnh hưởng đến tính toán và định dạng ngày.`]}),`
`]}),`
`]}),`
`,(0,c.jsx)(n.h3,{id:`ví-dụ-về-sử-dụng-an-toàn-trong-ssr`,children:`Ví dụ về sử dụng an toàn trong SSR`}),`
`,(0,c.jsx)(n.pre,{children:(0,c.jsx)(n.code,{className:`language-javascript`,children:`// ✅ Tốt: Ngày cụ thể cho SSR
