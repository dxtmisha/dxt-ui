...
`,(0,c.jsxs)(n.p,{children:[`Để đảm bảo hoạt động chính xác của `,(0,c.jsx)(n.strong,{children:`Server Side Rendering (SSR)`}),`, bạn nên sử dụng phiên bản bất đồng bộ `,(0,c.jsx)(n.a,{href:`./useApiManagementAsyncRef.vi.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiManagementAsyncRef`})})}),`. Nó tự động khởi tạo GET request để tải trước trên máy chủ.`]}),`
`,(0,c.jsxs)(n.p,{children:[`Nếu bạn đang sử dụng `,(0,c.jsx)(n.code,{children:`useApiManagementRef`}),` tiêu chuẩn, bạn có thể đưa nó vào chu trình SSR một cách thủ công bằng cách gọi `,(0,c.jsx)(n.code,{children:`initSsr()`}),` trong `,(0,c.jsx)(n.code,{children:`setup()`}),` của component. Điều này đảm bảo rằng dữ liệu sẽ được tải ở phía máy chủ.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`transformation?: (data: Type, isResponseContractValid?: ApiDataValidation) => ApiData<Return>`}),` — hàm transform dữ liệu sau khi fetch.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateResponseContract?: (data: Type) => ApiDataValidation`}),` — hàm xác thực hợp đồng dữ liệu phản hồi.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`errorContract?: ApiErrorStorageList`}),` — nơi lưu trữ hợp đồng lỗi phản hồi.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`toData?: boolean`}),` — có bao bọc dữ liệu trong thuộc tính 'data' hay không.`]}),`
