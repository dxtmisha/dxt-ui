import{a as e,i as t}from"./preload-helper-Cv19cBWa.js";import{d as n,m as r,n as i,o as a,s as o,t as s,u as c}from"./wiki-DgltPJFG.js";import{i as l,n as u,r as d,t as f}from"./D1HorizontalScroll-BvBaIS47.js";var p,m,h,g,_=t((()=>{s(),l(),p=[{name:`align`,type:`string`,option:[`block`,`center`,`left`,`right`]},{name:`bleed`,type:`boolean`},{name:`tag`,type:`string`}],m=[{name:`default`,description:`Slot for default horizontal scroll content/ Слот для основного содержимого горизонтальной прокрутки`,properties:[{name:`props`,type:`(any) | undefined`}]}],h=[],g={component:`HorizontalScroll`,props:p,slots:m,events:h,defaults:d,wikiDesign:i}})),v,y=t((()=>{n(),o(),_(),v=new c(g.component,g.props,g.defaults,g.wikiDesign,a,r)})),b=e({HorizontalScroll:()=>S,HorizontalScrollBasic:()=>C,__namedExportsOrder:()=>w,default:()=>x}),x,S,C,w,T=t((()=>{u(),y(),x={title:`Ui/HorizontalScroll`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1HorizontalScroll:f},setup:()=>({args:e}),template:`
