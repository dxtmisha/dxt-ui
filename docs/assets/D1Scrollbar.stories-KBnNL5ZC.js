import{d as t,_ as o}from"./D1Scrollbar-DKi639Ms.js";import{W as a,w as r,a as s,b as l}from"./wiki-b8Pce8s9.js";import"./iframe-CpPdPYqc.js";import"./jsx-runtime-D_zvdyIk.js";const c=[{name:"divider",type:"boolean"},{name:"dividerBottom",type:"boolean"},{name:"dividerHide",type:"boolean"},{name:"dividerTop",type:"boolean"},{name:"inverse",type:"boolean"},{name:"standard",type:"boolean"},{name:"tag",type:"string"},{name:"visible",type:"boolean"}],i=new a("Scrollbar",c,t,r,s,l),p={title:"Ui/Scrollbar",component:o,parameters:{design:"d1",docs:{description:{component:i.getDescription()}}},argTypes:i.getWiki(),args:i.getValues()},e={render:n=>({components:{D1Scrollbar:o},setup:()=>({args:n}),template:`
      <D1Scrollbar
