import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { Vt as n, cn as r } from './iframe-D7czqiJA.js'; import { a as i, d as a, l as o, m as s, n as c, t as l, u } from './wiki-CUC2UhNU.js'; import { i as d, n as f, r as p, t as m } from './D1Bars-Do0eVJ0b.js'; import { n as h, t as g } from './D1Skeleton-atWhpGi3.js'; var _, v, y, b, x = t(() => { l(), d(), _ = [{ name: `action`, type: `boolean` }, { name: `actionBars`, type: `ConstrBind<ButtonProps>[]` }, { name: `actionDescription`, type: `string | number` }, { name: `actionLabel`, type: `NumberOrString` }, { name: `backActionHide`, type: `boolean` }, { name: `backButton`, type: `ConstrBind<ButtonProps>` }, { name: `backHide`, type: `boolean` }, { name: `bars`, type: `ConstrBind<ButtonProps>[]` }, { name: `buttonAttrs`, type: `ConstrBind<ButtonProps>` }, { name: `description`, type: `string | number` }, { name: `descriptionId`, type: `string` }, { name: `iconBack`, type: `IconValue<IconProps>` }, { name: `iconClose`, type: `IconValue<IconProps>` }, { name: `isSkeleton`, type: `boolean` }, { name: `label`, type: `NumberOrString` }, { name: `labelId`, type: `string` }, { name: `modelAction`, type: `boolean` }, { name: `onUpdate:action`, type: `((value: boolean) => void)` }, { name: `onUpdate:modelAction`, type: `((value: boolean) => void)` }, { name: `padding`, type: `string`, option: [`sm`, `md`, `lg`, `ySm`, `yMd`, `yLg`, `none`] }, { name: `paddingByIndent`, type: `boolean` }, { name: `textClose`, type: `TextValue` }], v = [{ name: `actionBars`, description: `Slot for displaying a list of buttons in action mode/ Слот для отображения списка кнопок в режиме действия`, properties: [{ name: `props`, type: `(any) | undefined` }] }, { name: `bars`, description: `Slot for displaying a list of buttons/ Слот для отображения списка кнопок`, properties: [{ name: `props`, type: `(any) | undefined` }] }, { name: `default`, description: `Default slot content/ Содержимое слота по умолчанию`, properties: [{ name: `props`, type: `(any) | undefined` }] }, { name: `description`, description: `Description slot/ Слот описания`, properties: [{ name: `props`, type: `(any) | undefined` }] }], y = [{ name: `click`, description: `Full click event with MouseEvent/ Полное событие клика с MouseEvent`, properties: [{ name: `event`, type: `MouseEvent` }, { name: `value`, type: `EventClickValue` }] }, { name: `clickLite`, description: `Lightweight click event/ Упрощённое событие клика`, properties: [{ name: `value`, type: `EventClickValue` }] }, { name: `update:action`, description: `Event for updating the action mode status/ Событие обновления статуса режима действия`, properties: [{ name: `value`, type: `boolean` }] }, { name: `update:modelAction`, description: `Event for updating the action mode model status/ Событие обновления статуса модели режима действия`, properties: [{ name: `value`, type: `boolean` }] }], b = { component: `Bars`, props: _, slots: v, events: y, defaults: p, wikiDesign: c } }), S, C = t(() => { a(), o(), x(), S = new u(b.component, b.props, b.defaults, b.wikiDesign, i, s) }), w = e({ Bars: () => E, BarsBasic: () => D, BarsSkeleton: () => k, BarsSlots: () => A, BarsVModel: () => O, __namedExportsOrder: () => j, default: () => T }), T, E, D, O, k, A, j, M = t(() => {
  f(), C(), h(), n(), T = { title: `Ui/Bars`, component: m, parameters: { design: `d1`, docs: { description: { component: S.getDescription() } } }, argTypes: S.getWiki(), args: S.getValues() }, E = {}, D = { name: `Базовые`, render: () => ({ components: { D1Bars: m }, template: `
...
}`, ...A.parameters?.docs?.source } } }, j = [`Bars`, `BarsBasic`, `BarsVModel`, `BarsSkeleton`, `BarsSlots`]
}); M(); export { E as Bars, D as BarsBasic, k as BarsSkeleton, A as BarsSlots, O as BarsVModel, j as __namedExportsOrder, T as default, C as i, M as n, S as r, w as t }
