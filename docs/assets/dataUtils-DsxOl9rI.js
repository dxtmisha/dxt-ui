import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as c}from"./index-BaLriJNq.js";import{M as l}from"./blocks-SOxllcy3.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B21bnPHY.js";function i(r){const e={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(l,{title:"@dxtmisha/functional/ru/Data Utils"}),`
...
`})}),`
`,n.jsx(e.h2,{id:"copyobjectlite",children:n.jsx(e.code,{children:"copyObjectLite"})}),`
`,n.jsxs(e.p,{children:["Создает поверхностную копию простого объекта. Если передан параметр ",n.jsx(e.code,{children:"source"}),", создаёт новый объект и объединяет ",n.jsx(e.code,{children:"value"})," и ",n.jsx(e.code,{children:"source"}),"."]}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Параметры:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"value: T"})," — объект для копирования"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"source?: any"})," — дополнительные свойства для копирования (опционально)"]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-javascript",children:`import { copyObjectLite } from '@dxtmisha/functional'
...
// { name: 'John', age: 25 }
`})}),`
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:"Примечание:"})," Это поверхностная копия — вложенные объекты сохраняют ссылки на исходные. Для глубокого клонирования используйте ",n.jsx(e.code,{children:"copyObject"}),", ",n.jsx(e.code,{children:"structuredClone"})," или ",n.jsx(e.code,{children:"_.cloneDeep"}),"."]}),`
...
`})})]})}function j(r={}){const{wrapper:e}={...c(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(i,{...r})}):i(r)}export{j as default};
