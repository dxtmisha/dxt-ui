...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Bộ nhớ đệm tăng dần theo phiên bản`}),`: So sánh phiên bản gói với dữ liệu trong bộ nhớ đệm để ngăn việc xây dựng lại mã chưa thay đổi.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`Tệp nhật ký tùy chỉnh & Đồng bộ hóa `,(0,c.jsx)(t.code,{children:`.gitignore`})]}),`: Hỗ trợ đặt tên tệp nhật ký tùy chỉnh và tự động đăng ký đường dẫn tệp nhật ký vào `,(0,c.jsx)(t.code,{children:`.gitignore`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Giải quyết tập lệnh thông minh`}),`: Hỗ trợ lệnh xây dựng tùy chỉnh (`,(0,c.jsx)(t.code,{children:`code`}),`) hoặc tự động chọn lệnh xây dựng đầu tiên có sẵn trong `,(0,c.jsx)(t.code,{children:`package.json`}),` theo thứ tự ưu tiên nghiêm ngặt:`,`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Tự động lưu trữ nhật ký`}),`: Ghi lại các phiên bản cập nhật vào tệp nhật ký chỉ khi có ít nhất một gói được biên dịch thành công (`,(0,c.jsx)(t.code,{children:`changed > 0`}),`).`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`hàm-dựng-constructor`,children:`Hàm dựng (Constructor)`}),`
`,(0,c.jsxs)(t.p,{children:[`Hàm dựng chấp nhận đường dẫn thư mục gói tùy chỉnh (mặc định là hằng số `,(0,c.jsx)(t.code,{children:`UI_DIR_PACKAGES`}),` = `,(0,c.jsx)(t.code,{children:`'packages'`}),`), lệnh xây dựng tùy chọn (`,(0,c.jsx)(t.code,{children:`code`}),`), tên hoặc đường dẫn tệp nhật ký tùy chọn (`,(0,c.jsx)(t.code,{children:`logFile`}),`), và tải nhật ký bộ nhớ đệm hiện có:`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly code?: string`}),` — Lệnh xây dựng tùy chỉnh hoặc tên tập lệnh npm (ví dụ: `,(0,c.jsx)(t.code,{children:`'types'`}),` hoặc `,(0,c.jsx)(t.code,{children:`'npm run types'`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly logFile?: string`}),` — Tên hoặc đường dẫn tệp nhật ký xây dựng tùy chỉnh (ví dụ: `,(0,c.jsx)(t.code,{children:`'ui-types'`}),` hoặc `,(0,c.jsx)(t.code,{children:`'logs/ui-types.log.json'`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Đăng ký tệp nhật ký vào `,(0,c.jsx)(t.code,{children:`.gitignore`}),` (`,(0,c.jsx)(t.code,{children:`initGitIgnore`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getCode(packageFile: PackageFile): string | undefined`}),` — Xác định lệnh xây dựng: sử dụng `,(0,c.jsx)(t.code,{children:`this.code`}),` đã truyền (chuyển đổi tên tập lệnh thành `,(0,c.jsx)(t.code,{children:`npm run <script>`}),` khi thích hợp) hoặc quay về `,(0,c.jsx)(t.code,{children:`packageFile.getCodeBuildOrRecovery()`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getLogPath(): string[]`}),` — Trả về các phân đoạn đường dẫn đến tệp nhật ký dựa trên `,(0,c.jsx)(t.code,{children:`this.logFile`}),` (mặc định là `,(0,c.jsx)(t.code,{children:`['.', 'logs', 'ui-build.log.json']`}),`).`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`Xác định tập lệnh qua `,(0,c.jsx)(t.code,{children:`this.getCode(packageFile)`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Chạy lệnh xây dựng bên trong thư mục gói bằng hàm tiện ích `,(0,c.jsx)(t.code,{children:`run`}),`.`]}),`
...
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected initGitIgnore(): void`}),` — Thêm đường dẫn tệp nhật ký xây dựng vào `,(0,c.jsx)(t.code,{children:`.gitignore`}),` dưới phần `,(0,c.jsx)(t.code,{children:`# Logs`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected saveLog(): void`}),` — Lưu bản đồ nhật ký hiện tại `,(0,c.jsx)(t.code,{children:`this.log`}),` vào tệp nhật ký thông qua `,(0,c.jsx)(t.code,{children:`PropertiesFile.writeByPath`}),`.`]}),`
