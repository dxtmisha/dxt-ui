...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isExclude(item: LibraryAiPromptItem): boolean`}),` — Kiểm tra xem thư viện có nên bị loại trừ dựa trên cấu hình hay không.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isInPackage(item: LibraryAiPromptItem): boolean`}),` — Kiểm tra xem thư viện có tồn tại trong package.json gốc hay không.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPackageNames(): Set<string>`}),` — Lấy tập hợp các tên gói được định nghĩa trong package.json gốc.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`initGitIgnore(): void`}),` — Thêm các tệp và thư mục được tạo bởi tập lệnh này vào tệp `,(0,c.jsx)(t.code,{children:`.gitignore`}),` của dự án.`]}),`
