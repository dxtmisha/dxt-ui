...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Суть:`}),` содержит предметные регламенты в формате «Антипаттерн vs Рекомендуемый паттерн» (например, `,(0,c.jsx)(t.code,{children:`colors-and-palettes.md`}),`, `,(0,c.jsx)(t.code,{children:`skeleton.md`}),`, `,(0,c.jsx)(t.code,{children:`storage-state.md`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Пример регламента (Zero-Duplication Skeleton):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`❌ `,(0,c.jsx)(t.em,{children:`Антипаттерн:`}),` дублирование разметки через `,(0,c.jsx)(t.code,{children:`v-if="isLoading"`}),` с кастомными серыми блоками-заглушками.`]}),`
`,(0,c.jsxs)(t.li,{children:[`✅ `,(0,c.jsx)(t.em,{children:`Паттерн дизайн-системы:`}),` оборачивание той же самой разметки в `,(0,c.jsx)(t.code,{children:`<MySkeleton :active="isLoading">`}),` с модификаторами скелетона.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Использование:`}),` анализируется при сборке документации (`,(0,c.jsx)(t.code,{children:`dxt-types`}),`) для автоматического формирования триггеров в блоке `,(0,c.jsx)(t.code,{children:`## Mandatory Rules`}),` файла `,(0,c.jsx)(t.code,{children:`ai-description.md`}),`. Агент загружает конкретный гайд только тогда, когда задача явно требует знания этих стандартов.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[`
