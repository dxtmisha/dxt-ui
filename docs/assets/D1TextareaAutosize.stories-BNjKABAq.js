import{d as r,_ as a}from"./D1TextareaAutosize-Dls2XdpG.js";import{w as i,W as n,a as p,b as m}from"./wiki-BeTUR4cU.js";import"./iframe-okvuAVTt.js";import"./jsx-runtime-u17CrQMm.js";const u=[{name:"autosize",type:"boolean"},{name:"height",type:"string",option:["xs","sm","md","lg","xl"]},{name:"inputAttrs",type:"Record<string, any>"},{name:"value",type:"string"}],t={component:"TextareaAutosize",props:u,defaults:r,wikiDesign:i},s=new n(t.component,t.props,t.defaults,t.wikiDesign,p,m),c={title:"Ui/TextareaAutosize",component:a,parameters:{design:"d1",docs:{description:{component:s.getDescription()}}},argTypes:s.getWiki(),args:s.getValues()},e={render:o=>({components:{D1TextareaAutosize:a},setup:()=>({args:o}),template:`
