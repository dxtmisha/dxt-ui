import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/ApiErrorItem - Đối tượng lỗi` }), `
...
`, (0, c.jsxs)(n.p, { children: [(0, c.jsx)(n.code, { children: `ApiErrorItem` }), ` thường được tạo bởi factory `, (0, c.jsx)(n.code, { children: `ApiError.getItem()` }), `. Nó phục vụ như là sản phẩm cuối cùng của giai đoạn phân tích lỗi, sẵn sàng để được sử dụng bởi các thành phần UI hoặc dịch vụ ghi log.`] })] })
