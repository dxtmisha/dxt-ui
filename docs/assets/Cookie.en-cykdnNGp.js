...
`,e.jsxs(n.p,{children:["To initialize the object, call the ",e.jsx(n.code,{children:"Cookie(name)"})," constructor."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"name: string"})," — the name of the cookie you want to manage."]}),`
`]}),`
