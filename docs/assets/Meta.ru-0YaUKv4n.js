...
`,e.jsxs(n.p,{children:["Для создания объекта управления мета-данными вызовите конструктор ",e.jsx(n.code,{children:"new Meta()"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Особенности:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Автоматизация"})," — конструктор автоматически инициализирует реестры для стандартных HTML, Open Graph и Twitter Card тегов."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Интеграция"})," — сразу создаёт внутренние экземпляры ",e.jsx(n.code,{children:"MetaOg"})," и ",e.jsx(n.code,{children:"MetaTwitter"}),"."]}),`
`]}),`
