import{d as r,_ as i}from"./D1Window-C4b3BrhT.js";import{W as l,w as p,a as d,b as m}from"./wiki-BNdC282o.js";import{r as c}from"./iframe-BGVIV1-M.js";import"./jsx-runtime-D_zvdyIk.js";const u=[{name:"adaptive",type:"string",option:["menu","menuWindow","modal","modalDynamic","actionSheetRight","actionSheetBottom","static","actionSheet","actionSheetToModal","autoStaticSm","autoStaticMd","autoStaticLg","autoStaticXl","autoStatic2xl"]},{name:"alignment",type:"string",option:["top","left","center","topRight","topLeft","topFull","right","rightFull","bottom","bottomRight","bottomLeft","bottomFull","leftFull"]},{name:"autoClose",type:"boolean"},{name:"axis",type:"string",option:["x","y","on"]},{name:"beforeClosing",type:"() => NormalOrPromise<boolean>"},{name:"beforeOpening",type:"() => NormalOrPromise<boolean>"},{name:"closeButton",type:"boolean"},{name:"closeMobileHide",type:"boolean"},{name:"closing",type:"() => NormalOrPromise<boolean>"},{name:"contextmenu",type:"boolean"},{name:"dense",type:"boolean"},{name:"disabled",type:"boolean"},{name:"divider",type:"boolean"},{name:"flash",type:"boolean"},{name:"fullscreen",type:"boolean"},{name:"height",type:"string",option:["auto","max","sm","md","lg","custom"]},{name:"hide",type:"boolean"},{name:"iconClose",type:"string"},{name:"image",type:"string | ConstrBind<ImagePropsBasic>"},{name:"imagePosition",type:"string",option:["top","left"]},{name:"imageSize",type:"string",option:["sm","md","lg","quarter","half"]},{name:"indent",type:"number"},{name:"inDom",type:"boolean"},{name:"modelOpen",type:"boolean"},{name:"onUpdate:modelOpen",type:"(value: boolean) => void"},{name:"onUpdate:open",type:"(value: boolean) => void"},{name:"open",type:"boolean"},{name:"opening",type:"() => NormalOrPromise<boolean>"},{name:"origin",type:"string",option:["top","left","center","right","bottom","topToBottom","rightToLeft","bottomToTop","leftToRight"]},{name:"overElement",type:"ElementOrString<HTMLElement>"},{name:"overscroll",type:"boolean"},{name:"persistent",type:"boolean"},{name:"preparation",type:"() => NormalOrPromise<void>"},{name:"scrollbarAttrs",type:"ConstrBind<ScrollbarPropsBasic>"},{name:"staticMode",type:"boolean"},{name:"width",type:"string",option:["auto","max","sm","md","lg","custom"]},{name:"widthMatch",type:"boolean"}],a=new l("Window",u,r,p,d,m),b={title:"Ui/Window",component:i,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},t={render:s=>({components:{D1Window:i},setup:()=>({args:s}),template:`
