...
`,(0,c.jsx)(t.h1,{id:`класс-stylestoclassfull`,children:`Класс StylesToClassFull`}),`
`,(0,c.jsxs)(t.p,{children:[`Класс `,(0,c.jsx)(t.code,{children:`StylesToClassFull`}),` предназначен для создания CSS-правил, где селектор предоставляется в виде полной строки. В отличие от `,(0,c.jsx)(t.code,{children:`StylesToClass`}),`, этот класс всегда создает CSS-блок, даже если он не содержит внутренних свойств.`]}),`
`,(0,c.jsx)(t.h2,{id:`ключевые-возможности`,children:`Ключевые возможности`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Обязательная генерация`}),` — Всегда создает CSS-блок с указанным селектором.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Поддержка полного селектора`}),` — Напрямую использует предоставленную строку в качестве CSS-селектора без дополнительной обработки.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Автоматическая обертка блока`}),` — Корректно оборачивает содержимое в стандартные фигурные скобки CSS `,(0,c.jsx)(t.code,{children:`{}`}),`.`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`инициализация`,children:`Инициализация`}),`
`,(0,c.jsxs)(t.p,{children:[`Инициализируйте преобразователь `,(0,c.jsx)(t.code,{children:`StylesToClassFull`}),` с помощью необходимого свойства и функции контента для правил стиля.`]}),`
