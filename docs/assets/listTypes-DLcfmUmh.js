...
`})}),`
`,e.jsx(n.p,{children:"Эти типы списков обеспечивают полную типизацию для создания интерактивных списков, меню, навигации и других компонентов с поддержкой выбора, поиска и группировки элементов."})]})}function u(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{u as default};
