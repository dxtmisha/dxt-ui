...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`init: () => void`}),` — method for explicit manual initialization of request and observation.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`initSsr: () => void`}),` — method for server-side initialization (SSR).`]}),`
...
`]}),`
`,(0,c.jsx)(n.h2,{id:`async-version`,children:`Async Version`}),`
`,(0,c.jsxs)(n.p,{children:[`For cases where immediate (non-lazy) initialization is required (e.g., for SSR), use `,(0,c.jsx)(n.a,{href:`./useApiManagementAsyncRef.en.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiManagementAsyncRef`})})}),`. It automatically calls `,(0,c.jsx)(n.code,{children:`initSsr()`}),` upon creation.`]}),`
...
`]}),`
`,(0,c.jsx)(n.h2,{id:`ssr-and-initialization`,children:`SSR and Initialization`}),`
`,(0,c.jsxs)(n.p,{children:[`To ensure correct operation of `,(0,c.jsx)(n.strong,{children:`Server Side Rendering (SSR)`}),`, it is recommended to use the asynchronous version `,(0,c.jsx)(n.a,{href:`./useApiManagementAsyncRef.en.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiManagementAsyncRef`})})}),`. It automatically initializes the GET request for pre-fetching on the server.`]}),`
`,(0,c.jsxs)(n.p,{children:[`If you are using the standard `,(0,c.jsx)(n.code,{children:`useApiManagementRef`}),`, you can manually include it in the SSR cycle by calling `,(0,c.jsx)(n.code,{children:`initSsr()`}),` in the component's `,(0,c.jsx)(n.code,{children:`setup()`}),`. This ensures that the data will be loaded on the server side.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`transformation?: (data: Type, isResponseContractValid?: ApiDataValidation) => ApiData<Return>`}),` — function to transform data after fetching.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateResponseContract?: (data: Type) => ApiDataValidation`}),` — function to validate the response data contract.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`errorContract?: ApiErrorStorageList`}),` — storage of response error contracts.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`toData?: boolean`}),` — whether to wrap the payload in a 'data' property.`]}),`
