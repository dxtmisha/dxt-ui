import{d as p,_ as a}from"./D1Tooltip-m9uqAENb.js";import{w as s,W as r,a as l,b as m}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";const d=[{name:"arrowAttrs",type:"ConstrBind<ArrowProps>"},{name:"arrowPosition",type:"string",option:["auto","top","bottom","left","right"]},{name:"arrowShow",type:"boolean"},{name:"delay",type:"number"},{name:"delayHide",type:"number"},{name:"description",type:"string | number"},{name:"descriptionId",type:"string"},{name:"disabled",type:"boolean"},{name:"embedded",type:"boolean"},{name:"indent",type:"number"},{name:"inDom",type:"boolean"},{name:"interactive",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"maxWidth",type:"string",option:["sm","md","lg"]},{name:"open",type:"boolean"},{name:"top",type:"boolean"}],o={component:"Tooltip",props:d,defaults:p,wikiDesign:s},n=new r(o.component,o.props,o.defaults,o.wikiDesign,l,m),b={title:"Ui/Tooltip",component:a,parameters:{design:"d1",docs:{description:{component:n.getDescription()}}},argTypes:n.getWiki(),args:n.getValues()},t={render:i=>({components:{D1Tooltip:a},setup:()=>({args:i}),template:`
