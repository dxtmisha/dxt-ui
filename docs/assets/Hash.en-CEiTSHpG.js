...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"removeWatch<T>(name: string, callback: (value: T) => void): void"})," — Unsubscribes from changes for a specific variable."]}),`
