import{d as r,_ as s}from"./D1FieldCounter-Bj2uDy8d.js";import{w as a,W as n,a as m,b as l}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";const d=[{name:"counter",type:"string | number"},{name:"id",type:"string"},{name:"maxlength",type:"string | number"},{name:"maxlengthOnce",type:"string | number"},{name:"template",type:"string"},{name:"textCharacterLimit",type:"TextValue"},{name:"textCharacterRemaining",type:"TextValue"}],i={component:"FieldCounter",props:d,defaults:r,wikiDesign:a},o=new n(i.component,i.props,i.defaults,i.wikiDesign,m,l),k={title:"Ui/FieldCounter",component:s,parameters:{design:"d1",docs:{description:{component:o.getDescription()}}},argTypes:o.getWiki(),args:o.getValues()},e={},t={name:"Пользовательский шаблон",render:()=>({components:{D1FieldCounter:s},template:`
