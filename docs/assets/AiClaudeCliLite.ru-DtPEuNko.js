...
`,(0,c.jsxs)(t.p,{children:[`Класс `,(0,c.jsx)(t.code,{children:`AiClaudeCliLite`}),` представляет собой легковесную реализацию `,(0,c.jsx)(t.code,{children:`AiAbstract`}),`, взаимодействующую с официальным инструментом Claude CLI посредством системных команд оболочки (shell). Он управляет временными файлами промптов с помощью `,(0,c.jsx)(t.code,{children:`ApiTmp`}),`, чтобы обойти ограничения на длину аргументов терминала.`]}),`
`,(0,c.jsx)(t.h2,{id:`ключевые-особенности`,children:`Ключевые особенности`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Выполнение команд в оболочке`}),` — использует системную оболочку (`,(0,c.jsx)(t.code,{children:`node:child_process`}),`) для вызова CLI-команд `,(0,c.jsx)(t.code,{children:`claude`}),`.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Безопасность промптов`}),` — автоматически экранирует двойные кавычки и принудительно навязывает строгий формат вывода ответов (например, `,(0,c.jsx)(t.code,{children:`Output strictly the code/answer. No preamble, no chatter, no reasoning`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`response(model: string, contents: string): Promise<string>`}),` — Объединяет все временные файлы, экранирует кавычки, конструирует команду оболочки, запускает ее и очищает ресурсы.`]}),`
