...
`,e.jsxs(s.p,{children:["To initialize the object, call the ",e.jsx(s.code,{children:"ApiStatus()"})," constructor."]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-typescript",children:`import { ApiStatus } from '@dxtmisha/functional'
