...
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Внимание (SSR):`}),` При выполнении на сервере функция всегда возвращает `,(0,c.jsx)(n.code,{children:`undefined`}),`. Если вы используете её внутри логики рендеринга компонента, это может привести к ошибкам гидратации. Рекомендуется вызывать эту функцию только в хуках жизненного цикла, которые выполняются на клиенте (например, `,(0,c.jsx)(n.code,{children:`onMounted`}),` в Vue или `,(0,c.jsx)(n.code,{children:`useEffect`}),` в React).`]}),`
`]}),`
