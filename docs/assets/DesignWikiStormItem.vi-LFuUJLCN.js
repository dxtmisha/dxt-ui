import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/scripts/Classes/DesignWikiStormItem - Bộ phân giải siêu dữ liệu IDE cho thành phần` }), `
...
`, (0, c.jsxs)(n.p, { children: [(0, c.jsx)(n.code, { children: `DesignWikiStormItem` }), ` là "ngựa thồ" (workhorse) của bộ công cụ tạo siêu dữ liệu. Trong khi `, (0, c.jsx)(n.code, { children: `DesignWikiStorm` }), ` quản lý cấu trúc tệp tổng thể, lớp này xử lý sự phức tạp của việc phân tích từng thành phần riêng lẻ, đảm bảo rằng logic UI chuyên biệt được biểu diễn chính xác dưới định dạng mà các công cụ phát triển có thể hiểu được.`] })] })
