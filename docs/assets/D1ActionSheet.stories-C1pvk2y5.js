import{n as e,r as t}from"./chunk-BneVvdWh.js";import{B as n,F as r,Lt as i,St as a,Vt as o,_t as s,bt as c,h as l,kt as u,u as d,wt as f,xt as p,yt as m}from"./iframe-I1fckF_t.js";import{a as h,d as g,f as _,g as v,l as ee,n as te,p as y,t as ne,u as b}from"./wiki-CMC-2lzg.js";import{i as re,n as ie,o as x,r as S,t as C}from"./Actions-CxWHC0NA.js";import{n as w,t as ae}from"./Window-re3haz5v.js";import{n as oe,t as se}from"./Bars-LNQkT_sd.js";var T,E,D=e((()=>{_(),s(),d(),T=80,E=class{constructor(e,t,n,r){y(this,`touche`,i()),y(this,`toucheMove`,i()),y(this,`mouse`,i()),y(this,`mouseMove`,i()),y(this,`onTouch`,{onTouchstart:e=>{this.touche.value=e.targetTouches?.[0],this.mouse.value={x:this.touche.value?.clientX??0,y:this.touche.value?.clientY??0},this.update(e.target)},onTouchend:e=>this.reset(e.target),onTouchcancel:e=>this.reset(e.target),onTouchmove:e=>{this.toucheMove.value=e.targetTouches?.[0],this.mouseMove.value={x:this.toucheMove.value?.clientX??0,y:this.toucheMove.value?.clientY??0},this.updateMove(e.target)}}),y(this,`onMouse`,{onMousedown:e=>{this.mouse.value={x:e.clientX,y:e.clientY},this.update(e.target)},onMouseup:e=>this.reset(e.target),onMousemove:e=>{this.mouseMove.value={x:e.clientX,y:e.clientY},this.updateMove(e.target)}}),this.start=e,this.move=t,this.end=n,this.element=r}getElement(e){return this.element?.value??e.closest(`[data-touch]`)}getTypeX(e){return e>=T?`right`:e<-T?`left`:`none`}getTypeY(e){return e>=T?`bottom`:e<-T?`top`:`none`}async callback(e){let t=this.mouse.value,r=this.mouseMove.value;if(t&&r){let i=r.x-t.x,a=r.y-t.y;if(!e||await n(e(this.getTypeX(i),this.getTypeY(a),i,a,t,r,this.touche.value,this.toucheMove.value)))return{x:i,y:a}}}reset(e){let t=this.getElement(e);this.callback(this.end).then(e=>{t&&(e?this.resetData(t):setTimeout(()=>this.resetData(t),400))})}resetData(e){this.touche.value=void 0,this.toucheMove.value=void 0,this.mouse.value=void 0,this.mouseMove.value=void 0,e.style.removeProperty(`--sys-touch-start-x`),e.style.removeProperty(`--sys-touch-start-y`),e.style.removeProperty(`--sys-touch-move-x`),e.style.removeProperty(`--sys-touch-move-y`)}update(e){let t=this.getElement(e),r=this.mouse.value;t&&r&&(t.style.setProperty(`--sys-touch-start-x`,`${r.x}px`),t.style.setProperty(`--sys-touch-start-y`,`${r.y}px`),n(this.start?.call(this,r,this.touche.value)).then())}updateMove(e){let t=this.getElement(e);this.callback(this.move).then(e=>{t&&e&&(t.style.setProperty(`--sys-touch-move-x`,`${e.x}px`),t.style.setProperty(`--sys-touch-move-y`,`${e.y}px`))})}}})),O,k,A,j=e((()=>{_(),re(),D(),s(),d(),O=class extends S{constructor(e,t,n,r,i,a,o,s,c){let{TouchEventIncludeConstructor:l=E}=c??{};super(e,t,n,r,i,a,o,s,m(()=>({open:e.open,adaptive:`actionSheet`,closeButton:e.barsBackHide,closeMobileHide:e.touchClose})),void 0,{align:`auto`}),y(this,`touchEvent`,void 0),this.props=e,this.refs=t,this.element=n,this.classDesign=r,this.className=i,this.components=a,this.slots=o,this.emits=s,this.touchEvent=new l(void 0,(e,t,n,r)=>r>=0,(e,t)=>t===`bottom`?(this.window.expose.setOpen(!1).then(),!1):!0)}},k={barsBackHide:!0,touchClose:!0},A=class extends x{constructor(...e){super(...e),y(this,`renderTitleTouch`,e=>{let t=this.renderTitle(e);return this.props.touchClose?[a(`div`,{class:this.classes?.value.touch,...this.item.touchEvent.onTouch},[a(`div`,{class:this.classes?.value.tab}),...t])]:t})}initItem(){return new O(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits)}initClasses(){return{main:{},title:this.getSubClass(`title`),header:this.getSubClass(`header`),body:this.getSubClass(`body`),footer:this.getSubClass(`footer`),touch:this.getSubClass(`touch`),tab:this.getSubClass(`tab`)}}initRender(){return this.item.window.render({control:this.renderControl,title:this.renderTitleTouch,default:this.renderDefault,footer:this.renderFooter},l({class:this.classes?.value.main,"data-touch":`touch`},this.getAttrs()))}}})),M,N,P=e((()=>{j(),M={width:[`sm`,`md`,`lg`,`auto`]},N={...k,width:`md`}})),F=e((()=>{})),I,L=e((()=>{s(),d(),j(),w(),oe(),ie(),P(),F(),I=p({name:`D1ActionSheet`,__name:`D1ActionSheet`,props:f({disabled:{type:Boolean},autoClose:{type:Boolean},windowAttrs:{},barsLabel:{},barsDescription:{},barsBackHide:{type:Boolean},barsHide:{type:Boolean},barsList:{},barsAttrs:{},actionsHide:{type:Boolean},actionsList:{},actionsSecondary:{},actionsAttrs:{},open:{type:Boolean},touchClose:{type:Boolean},width:{}},N),emits:[`window`,`bars`,`barsLite`,`barsBack`,`actions`,`actionsLite`],setup(e,{expose:t,emit:n}){let i=n,a=e,s=new A(`d1.actionSheet`,a,{emits:i,classes:m(()=>({main:{"d1-actionSheet":!0,[`d1-actionSheet--width--${a.width}`]:r(M.width,a.width)}})),styles:m(()=>({})),components:{window:ae,bars:se,actions:C},compMod:{window:{divider:!0}}}),l=s.render();return t(s.expose()),(e,t)=>(u(),c(o(l)))}})})),R,z=e((()=>{L(),L(),R=I,I.__docgenInfo=Object.assign({displayName:I.name??I.__name},{name:`D1ActionSheet`,exportName:`default`,displayName:`D1ActionSheet`,description:``,tags:{},sourceFiles:[`/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/ActionSheet/D1ActionSheet.vue`]})})),B,V,H,U,W=e((()=>{b(),ne(),P(),B=[{name:`actionsAttrs`,type:`ConstrBind<Actions>`},{name:`actionsHide`,type:`boolean`},{name:`actionsList`,type:`ConstrBind<Actions['list']>`},{name:`actionsSecondary`,type:`ConstrBind<Actions['listSecondary']>`},{name:`autoClose`,type:`boolean`},{name:`barsAttrs`,type:`ConstrBind<Bars>`},{name:`barsBackHide`,type:`boolean`},{name:`barsDescription`,type:`string`},{name:`barsHide`,type:`boolean`},{name:`barsLabel`,type:`string | number`},{name:`barsList`,type:`Bars['bars']`},{name:`disabled`,type:`boolean`},{name:`open`,type:`boolean`},{name:`touchClose`,type:`boolean`},{name:`width`,type:`string`,option:[`sm`,`md`,`lg`,`auto`]},{name:`windowAttrs`,type:`ConstrBind<Window>`}],V=[{name:`control`,description:`Control slot for window management/
...
Слот заголовка для шапки окна`,properties:[{name:`props`,type:`WindowControlItem`}]}],H=[{name:`actions`,properties:[{name:`event`,type:`MouseEvent`},{name:` value`,type:`EventClickValue`}]},{name:`actionsLite`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`bars`,properties:[{name:`event`,type:`MouseEvent`},{name:` value`,type:`EventClickValue`}]},{name:`barsBack`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`barsLite`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`window`,properties:[{name:`options`,type:`WindowEmitOptions`}]}],U={component:`ActionSheet`,props:B,slots:V,events:H,defaults:N,wikiDesign:te}})),G,K=e((()=>{b(),h(),W(),G=new g(U.component,U.props,U.defaults,U.wikiDesign,ee,v)})),ce=t({ActionSheet:()=>J,ActionSheetAllSlots:()=>Z,ActionSheetTouchClose:()=>X,ActionSheetVModel:()=>Y,__namedExportsOrder:()=>Q,default:()=>q}),q,J,Y,X,Z,Q,$=e((()=>{z(),K(),s(),q={title:`Ui/ActionSheet`,component:R,parameters:{design:`d1`,docs:{description:{component:G.getDescription()}}},argTypes:G.getWiki(),args:G.getValues()},J={render:e=>({components:{D1ActionSheet:R},setup:()=>({args:e}),template:`
    ...
    `})},Y={name:`Двусторонняя привязка (v-model)`,render:()=>({components:{D1ActionSheet:R},setup(){return{open:i(!1)}},template:`
        <button class="wiki-storybook-button" @click="open = true">Open via v-model ({{ open }})</button>

        <D1ActionSheet v-model:open="open">
          <div class="wiki-storybook-item--padding">Your content here</div>
        </D1ActionSheet>
    `})},X={name:`Закрытие жестом`,render:()=>({components:{D1ActionSheet:R},setup(){return{openWithTouch:i(!1),openWithoutTouch:i(!1)}},template:`
