...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`list: SearchListInput<T>`}),` — danh sách dữ liệu nguồn (Mảng, Ref hoặc một hàm trả về mảng/Ref).`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`columns?: SearchColumnsInput<T, K>`}),` — danh sách các cột (key của đối tượng) để tìm kiếm (Mảng, Ref hoặc một hàm trả về mảng/Ref).`]}),`
