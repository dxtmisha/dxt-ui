...
`,e.jsxs(n.p,{children:["Creates a new ",e.jsx(n.code,{children:"EventItem"})," instance. To activate listening, the ",e.jsx(n.code,{children:"start()"})," method must be called."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"elementSelector?: ElementOrString"})," — target element or selector."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"type: string | string[] = 'click'"})," — event type or array of types."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"listener?: Function"})," — callback function."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"options?: EventOptions"})," — configuration object (",e.jsx(n.code,{children:"passive"}),", ",e.jsx(n.code,{children:"once"}),", ",e.jsx(n.code,{children:"capture"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"detail?: Record<string, any>"})," — custom data for the event."]}),`
`]}),`
