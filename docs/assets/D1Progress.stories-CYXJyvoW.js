import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Dt as n,nn as r}from"./library-BfcLFF_v.js";import{d as i,i as a,l as o,m as s,n as c,t as l,u}from"./wiki-BHyzKkJP.js";import{i as d,n as f,r as p,t as m}from"./D1Progress-5ZbSFiNM.js";var h,g,_,v;function y(){return(y=e((()=>{l(),d(),h=[{name:`ariaLabel`,type:`string`},{name:`circular`,type:`boolean`},{name:`clientOnly`,type:`boolean`},{name:`delay`,type:`string | number`},{name:`delayHide`,type:`string | number`},{name:`dense`,type:`boolean`},{name:`indeterminate`,type:`string`,option:[`type1`,`type2`,`type3`]},{name:`inverse`,type:`boolean`},{name:`linear`,type:`boolean`},{name:`max`,type:`string | number`},{name:`palette`,type:`string`,option:[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`slate`,`gray`,`zinc`,`neutral`,`stone`,`black`,`white`]},{name:`point`,type:`boolean`},{name:`position`,type:`string`,option:[`top`,`bottom`,`static`]},{name:`size`,type:`string`,option:[`sm`,`md`,`lg`]},{name:`textLoading`,type:`TextValue`},{name:`value`,type:`string | number`},{name:`visible`,type:`boolean`}],g=[],_=[],v={component:`Progress`,props:h,slots:g,events:_,defaults:p,wikiDesign:c}})))()}var b;function x(){return(x=e((()=>{i(),o(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,a,s)})))()}var S=t({Progress:()=>w,ProgressCircular:()=>D,ProgressDelays:()=>k,ProgressLinear:()=>E,ProgressTypes:()=>T,ProgressValues:()=>O,__namedExportsOrder:()=>A,default:()=>C}),C,w,T,E,D,O,k,A;function j(){return(j=e((()=>{f(),x(),n(),C={title:`Ui/Progress`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Progress:m},setup:()=>({args:e}),template:`
...
}`,...k.parameters?.docs?.source}}},A=[`Progress`,`ProgressTypes`,`ProgressLinear`,`ProgressCircular`,`ProgressValues`,`ProgressDelays`]})))()}export{E as a,j as c,k as i,b as l,w as n,T as o,D as r,O as s,S as t,x as u};