...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"get(): number"})," — returns the current counter value."]}),`
...
`]}),`
`,e.jsx(n.h3,{id:"unregistrationevent",children:e.jsx(n.code,{children:"unregistrationEvent"})}),`
`,e.jsxs(n.p,{children:["Unregisters a listener previously added via ",e.jsx(n.code,{children:"registrationEvent"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"listener: EventListenerDetail<CustomEvent, { loading: boolean }>"})," — the handler function used during registration."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"element?: ElementOrString<HTMLElement>"})," — the DOM element used during registration."]}),`
`]}),`
