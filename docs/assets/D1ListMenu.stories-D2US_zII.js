import{d as a,_ as s}from"./D1ListMenu-Bi3Iv3JL.js";import{w as i,W as r,a as p,b as l}from"./wiki-BeTUR4cU.js";import"./iframe-okvuAVTt.js";import"./jsx-runtime-u17CrQMm.js";const m=[{name:"autoClose",type:"boolean"},{name:"axis",type:"string",option:["x","y"]},{name:"disabled",type:"boolean"},{name:"divider",type:"boolean"},{name:"open",type:"boolean"},{name:"windowAttrs",type:"ConstrBind<Window>"}],e={component:"ListMenu",props:m,defaults:a,wikiDesign:i},t=new r(e.component,e.props,e.defaults,e.wikiDesign,p,l),d={title:"Ui/ListMenu",component:s,parameters:{design:"d1",docs:{description:{component:t.getDescription()}}},argTypes:t.getWiki(),args:t.getValues()},n={render:o=>({components:{D1ListMenu:s},setup:()=>({args:o}),template:`
