...
`,(0,c.jsx)(t.h1,{id:`класс-stylestocontainer`,children:`Класс StylesToContainer`}),`
`,(0,c.jsxs)(t.p,{children:[`Класс `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` отвечает за создание CSS-запросов `,(0,c.jsx)(t.code,{children:`@container`}),` на основе свойств дизайна. Он реализует логику для обертывания вложенных правил стилей в блок container query.`]}),`
`,(0,c.jsx)(t.h2,{id:`ключевые-возможности`,children:`Ключевые возможности`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Обертка Container Query`}),` — Автоматически оборачивает созданный контент стилей в правило `,(0,c.jsx)(t.code,{children:`@container`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Динамическое разрешение запроса`}),` — Использует значение свойства дизайна для определения условия container query.`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Инициализируйте преобразователь `,(0,c.jsx)(t.code,{children:`StylesToContainer`}),` с помощью необходимого свойства и функции контента для вложенных правил.`]}),`
