import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,r as n}from"./lib-BRDOWE9X.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{f as i,s as a}from"./blocks-WIGGT2yz.js";function o(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(a,{title:`@dxtmisha/vi/scripts/# Lệnh/dxt-package - Khởi tạo Cấu trúc Package`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Cấu hình Linh hoạt`}),`: Cho phép ghi đè loại package mặc định, các mẫu và thư mục cơ sở đích thông qua các đối số dòng lệnh.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Script đọc các đối số được cung cấp để xác định `,(0,c.jsx)(t.code,{children:`type`}),` của package (mặc định là `,(0,c.jsx)(t.code,{children:`library`}),`), các `,(0,c.jsx)(t.code,{children:`templates`}),` và thư mục đích `,(0,c.jsx)(t.code,{children:`dir`}),`.`]}),`
...
`})}),`
`,(0,c.jsx)(t.p,{children:`Để chỉ định loại tùy chỉnh và áp dụng các mẫu cụ thể, hãy truyền chúng dưới dạng đối số:`}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-bash`,children:`npx dxt-package vue "template1,template2"
`})}),`
`,(0,c.jsx)(t.p,{children:`Bạn cũng có thể chỉ định một thư mục cơ sở tùy chỉnh làm đối số thứ ba:`}),`
