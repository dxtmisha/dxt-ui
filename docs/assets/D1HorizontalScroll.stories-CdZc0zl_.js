import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,g as i,l as a,n as o,t as s,u as c}from"./wiki-COBgMBNI.js";import{i as l,n as u,r as d,t as f}from"./D1HorizontalScroll-B2GILsOJ.js";var p,m,h,g,_=e((()=>{c(),s(),l(),p=[{name:`align`,type:`string`,option:[`block`,`center`,`left`,`right`]},{name:`flush`,type:`boolean`},{name:`tag`,type:`string`}],m=[{name:`default`,description:`Slot for default horizontal scroll content/ Слот для основного содержимого горизонтальной прокрутки`}],h=[],g={component:`HorizontalScroll`,props:p,slots:m,events:h,defaults:d,wikiDesign:o}})),v,y=e((()=>{c(),n(),_(),v=new r(g.component,g.props,g.defaults,g.wikiDesign,a,i)})),b=t({HorizontalScroll:()=>S,HorizontalScrollBasic:()=>C,__namedExportsOrder:()=>w,default:()=>x}),x,S,C,w,T=e((()=>{u(),y(),x={title:`Ui/HorizontalScroll`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1HorizontalScroll:f},setup:()=>({args:e}),template:`
