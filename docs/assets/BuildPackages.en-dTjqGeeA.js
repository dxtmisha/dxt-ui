...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Incremental Version-Based Caching`}),`: Compares the package version with the log cache to prevent rebuilding unchanged code.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Custom Log File & GitIgnore Synchronization`}),`: Supports custom log file naming and automatically registers the generated log path into `,(0,c.jsx)(t.code,{children:`.gitignore`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Intelligent Script Resolution`}),`: Supports custom build commands/scripts (`,(0,c.jsx)(t.code,{children:`code`}),`) or automatically resolves the first available build command in `,(0,c.jsx)(t.code,{children:`package.json`}),` following strict priority order:`,`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Automatic Log Persistence`}),`: Writes updated build versions to the log file only when at least one package was successfully compiled (`,(0,c.jsx)(t.code,{children:`changed > 0`}),`).`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`constructor`,children:`Constructor`}),`
`,(0,c.jsxs)(t.p,{children:[`The constructor accepts a custom packages directory path (defaults to the `,(0,c.jsx)(t.code,{children:`UI_DIR_PACKAGES`}),` constant = `,(0,c.jsx)(t.code,{children:`'packages'`}),`), an optional build command (`,(0,c.jsx)(t.code,{children:`code`}),`), an optional log file name or path (`,(0,c.jsx)(t.code,{children:`logFile`}),`), and loads the existing build cache log:`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly code?: string`}),` — Custom build command or npm script name (e.g., `,(0,c.jsx)(t.code,{children:`'types'`}),` or `,(0,c.jsx)(t.code,{children:`'npm run types'`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly logFile?: string`}),` — Custom build log file name or path (e.g., `,(0,c.jsx)(t.code,{children:`'ui-types'`}),` or `,(0,c.jsx)(t.code,{children:`'logs/ui-types.log.json'`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Registers the log file in `,(0,c.jsx)(t.code,{children:`.gitignore`}),` (`,(0,c.jsx)(t.code,{children:`initGitIgnore`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getCode(packageFile: PackageFile): string | undefined`}),` — Resolves the build command: uses provided `,(0,c.jsx)(t.code,{children:`this.code`}),` (converting script names to `,(0,c.jsx)(t.code,{children:`npm run <script>`}),` when appropriate) or falls back to `,(0,c.jsx)(t.code,{children:`packageFile.getCodeBuildOrRecovery()`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getLogPath(): string[]`}),` — Returns the path segments to the build log file based on `,(0,c.jsx)(t.code,{children:`this.logFile`}),` (defaults to `,(0,c.jsx)(t.code,{children:`['.', 'logs', 'ui-build.log.json']`}),`).`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`Resolves the script via `,(0,c.jsx)(t.code,{children:`this.getCode(packageFile)`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Runs the build command inside the package directory using the `,(0,c.jsx)(t.code,{children:`run`}),` helper function.`]}),`
...
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected initGitIgnore(): void`}),` — Adds the build log file path to `,(0,c.jsx)(t.code,{children:`.gitignore`}),` under the `,(0,c.jsx)(t.code,{children:`# Logs`}),` section.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected saveLog(): void`}),` — Persists the current in-memory log map `,(0,c.jsx)(t.code,{children:`this.log`}),` to the log file via `,(0,c.jsx)(t.code,{children:`PropertiesFile.writeByPath`}),`.`]}),`
