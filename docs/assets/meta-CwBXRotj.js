import{j as e}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as s}from"./index-BaLriJNq.js";import{M as i}from"./blocks-SOxllcy3.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B21bnPHY.js";function a(t){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"@dxtmisha/functional/ru/Classes/Meta"}),`
`,e.jsx(n.h1,{id:"класс-meta",children:"Класс Meta"}),`
`,e.jsx(n.p,{children:"Унифицированный класс для управления всеми типами мета-тегов: стандартные HTML, Open Graph и Twitter Card. Предоставляет единый интерфейс для работы с SEO-оптимизацией и социальными сетями, автоматически синхронизируя изменения между всеми платформами."}),`
`,e.jsx(n.h2,{id:"основные-возможности",children:"Основные возможности"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Унифицированный API"})," — одна точка входа для всех типов мета-тегов"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Автоматическая синхронизация"})," — изменения в Meta автоматически применяются к Open Graph и Twitter Card"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Управление заголовком"}),' — поддержка суффикса для заголовка страницы (например, "Заголовок - Название сайта")']}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Полная интеграция"})," — объединяет MetaManager, MetaOg и MetaTwitter"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Упрощенный интерфейс"})," — сокращает количество кода для установки мета-тегов"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Поддержка keywords"})," — работа с ключевыми словами в виде строки или массива"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Robots директивы"})," — управление индексацией и crawling"]}),`
...
`,e.jsx(n.p,{children:"Создает экземпляр Meta с интегрированной поддержкой Open Graph и Twitter Card. Автоматически инициализирует внутренние экземпляры MetaOg и MetaTwitter."}),`
...
`,e.jsx(n.p,{children:"Получает заголовок страницы без суффикса."}),`
...
`,e.jsx(n.p,{children:"Получает мета-тег keywords."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"string"})," — ключевые слова через запятую"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает мета-тег description."}),`
...
`,e.jsx(n.p,{children:"Получает URL изображения Open Graph."}),`
...
`,e.jsx(n.p,{children:"Получает канонический URL."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"string"})," — канонический URL"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает значение мета-тега robots."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"MetaRobots"})," — директива для роботов"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает мета-тег author."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"string"})," — имя автора"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает название сайта Open Graph."}),`
...
`,e.jsx(n.p,{children:"Получает локаль Open Graph."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"string"})," — локаль (например, 'ru_RU')"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает экземпляр MetaOg для расширенных операций с Open Graph."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"MetaOg"})," — экземпляр класса MetaOg"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Получает экземпляр MetaTwitter для расширенных операций с Twitter Card."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"MetaTwitter"})," — экземпляр класса MetaTwitter"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Устанавливает заголовок страницы с автоматическим добавлением суффикса и обновляет Open Graph и Twitter Card."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"title: string"})," — заголовок страницы (без суффикса)"]}),`
`]}),`
...
`,e.jsx(n.p,{children:"Устанавливает мета-тег keywords. Принимает строку или массив."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"keywords: string | string[]"})," — ключевые слова"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"this"})," — для цепочечных вызовов"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Устанавливает мета-тег description."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:"Устанавливает изображение для Open Graph и Twitter Card одновременно."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"image: string"})," — URL изображения"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"this"})," — для цепочечных вызовов"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Устанавливает канонический URL и автоматически обновляет og:url и twitter:url."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"canonical: string"})," — канонический URL"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"this"})," — для цепочечных вызовов"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Устанавливает мета-тег robots для управления индексацией."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"robots: MetaRobots"})," — директива robots"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"this"})," — для цепочечных вызовов"]}),`
...
`,e.jsx(n.p,{children:"Устанавливает мета-тег author."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"author: string"})," — имя автора"]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"this"})," — для цепочечных вызовов"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Устанавливает название сайта для Open Graph и Twitter Card одновременно."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:"Устанавливает локаль для Open Graph."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:"Устанавливает суффикс для автоматического добавления к заголовку страницы."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Параметры:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"suffix?: string"})," — суффикс заголовка (необязательный)"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.p,{children:"Генерирует полный HTML для всех мета-тегов, включая Open Graph и Twitter Card."}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Возвращает:"})," ",e.jsx(n.code,{children:"string"})," — HTML-строка со всеми мета-тегами"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
...
`,e.jsx(n.h3,{id:"полная-настройка-страницы",children:"Полная настройка страницы"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { Meta, MetaRobots } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h3,{id:"интеграция-с-vue-router",children:"Интеграция с Vue Router"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { Meta } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h3,{id:"интеграция-с-react",children:"Интеграция с React"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { Meta } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h3,{id:"динамическое-обновление-из-api",children:"Динамическое обновление из API"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { Meta } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h3,{id:"управление-robots-для-разных-сценариев",children:"Управление robots для разных сценариев"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { Meta, MetaRobots } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h3,{id:"использование-расширенных-возможностей-open-graph-и-twitter-card",children:"Использование расширенных возможностей Open Graph и Twitter Card"}),`
...
`,e.jsx(n.h3,{id:"инициализация",children:"Инициализация"}),`
`,e.jsx(n.p,{children:"Установите общие параметры один раз при запуске приложения:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const meta = new Meta()
meta.setSuffix('Название Сайта')
meta.setSiteName('Название Сайта')
meta.setLocale('ru_RU')
`})}),`
`,e.jsx(n.h3,{id:"обновление-при-навигации",children:"Обновление при навигации"}),`
`,e.jsx(n.p,{children:"Обновляйте мета-теги при смене страницы:"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Title:"})," до 60 символов (без суффикса)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Description:"})," 150-160 символов"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Keywords:"})," 10-15 ключевых слов"]}),`
`]}),`
`,e.jsx(n.h3,{id:"обязательные-теги",children:"Обязательные теги"}),`
`,e.jsx(n.p,{children:"Минимально необходимые мета-теги:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Title (через ",e.jsx(n.code,{children:"setTitle"}),")"]}),`
`,e.jsxs(n.li,{children:["Description (через ",e.jsx(n.code,{children:"setDescription"}),")"]}),`
`,e.jsxs(n.li,{children:["Canonical (через ",e.jsx(n.code,{children:"setCanonical"}),")"]}),`
`,e.jsxs(n.li,{children:["Image для социальных сетей (через ",e.jsx(n.code,{children:"setImage"}),")"]}),`
`]}),`
`,e.jsx(n.h3,{id:"изображения",children:"Изображения"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Размер: 1200×630 px (оптимально)"}),`
`,e.jsx(n.li,{children:"Формат: JPG, PNG, WebP"}),`
`,e.jsx(n.li,{children:"Максимум: 8 MB"}),`
`]}),`
`,e.jsx(n.h2,{id:"примечания",children:"Примечания"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Класс объединяет функциональность MetaManager, MetaOg и MetaTwitter"}),`
`,e.jsx(n.li,{children:"Изменения в Meta автоматически применяются ко всем связанным мета-тегам"}),`
`,e.jsx(n.li,{children:"Суффикс добавляется только к document.title и социальным тегам"}),`
`,e.jsxs(n.li,{children:["Метод ",e.jsx(n.code,{children:"html()"})," наследуется от MetaManager и генерирует HTML для всех управляемых тегов"]}),`
`,e.jsx(n.li,{children:"Класс совместим с SSR — проверяет наличие DOM перед доступом к document"}),`
`,e.jsx(n.li,{children:"Keywords менее важны для современного SEO, но могут использоваться для внутреннего поиска"}),`
`,e.jsxs(n.li,{children:["Для расширенной работы с Open Graph используйте напрямую ",e.jsx(n.code,{children:"meta.og"})]}),`
`,e.jsxs(n.li,{children:["Для расширенной работы с Twitter Card используйте напрямую ",e.jsx(n.code,{children:"meta.twitter"})]}),`
`]})]})}function h(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{h as default};
