...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`initSsr(): void`}),` — Метод для инициализации на стороне сервера. Использует `,(0,c.jsx)(n.code,{children:`onServerPrefetch`}),` для выполнения запроса во время SSR.`]}),`
...
`,(0,c.jsx)(n.h2,{id:`ssr-server-side-rendering`,children:`SSR (Server-Side Rendering)`}),`
`,(0,c.jsxs)(n.p,{children:[`Для корректной работы на стороне сервера (SSR) необходимо использовать метод `,(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`initSsr()`})}),`.`]}),`
`,(0,c.jsxs)(n.h3,{id:`метод-initssr`,children:[`Метод `,(0,c.jsx)(n.code,{children:`initSsr()`})]}),`
`,(0,c.jsxs)(n.p,{children:[`При вызове в `,(0,c.jsx)(n.code,{children:`setup()`}),` компонента гарантирует, что данные будут загружены на сервере перед рендерингом страницы, а на клиенте подставятся мгновенно.`]}),`
`,(0,c.jsx)(n.pre,{children:(0,c.jsx)(n.code,{className:`language-typescript`,children:`const { data, initSsr } = useApiRef('path/to/api')

// Вызываем для поддержки SSR
initSsr()
`})}),`
`,(0,c.jsxs)(n.h3,{id:`автоматизация-через-asyncref`,children:[`Автоматизация через `,(0,c.jsx)(n.code,{children:`AsyncRef`})]}),`
`,(0,c.jsxs)(n.p,{children:[`Чтобы не вызывать `,(0,c.jsx)(n.code,{children:`initSsr()`}),` вручную, можно использовать асинхронную версию композабла — `,(0,c.jsx)(n.a,{href:`./useApiAsyncRef.ru.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiAsyncRef`})})}),`. Он автоматически вызывает `,(0,c.jsx)(n.code,{children:`initSsr()`}),` при создании.`]}),`
