import{a as e,i as t}from"./preload-helper-Cv19cBWa.js";import{d as n,i as r,m as i,n as a,o,s,t as c,u as l}from"./wiki-DgltPJFG.js";import{i as u,n as d,r as f,t as p}from"./D1Skeleton-CxiItvxF.js";var m,h,g,_,v=t((()=>{c(),u(),m=[{name:`active`,type:`boolean`}],h=[{name:`default`,description:`Slot for default skeleton content/ Слот для основного содержимого скелета`,properties:[{name:`props`,type:`(SkeletonClassesList) | undefined`}]}],g=[],_={component:`Skeleton`,props:m,slots:h,events:g,defaults:f,wikiDesign:a}})),y,b=t((()=>{n(),s(),v(),y=new l(_.component,_.props,_.defaults,_.wikiDesign,o,i)})),x=e({Skeleton:()=>C,SkeletonBasic:()=>w,__namedExportsOrder:()=>T,default:()=>S}),S,C,w,T,E=t((()=>{d(),b(),s(),S={title:`Ui/Skeleton`,component:p,parameters:{design:`d1`,docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},C={render:e=>({components:{D1Skeleton:p},setup:()=>({args:e}),template:`
      <D1Skeleton v-bind="args">
      <div class="wiki-storybook-card d1-skeleton__background">
        <div class="wiki-storybook-card__image d1-skeleton__background" style="background-image: url('${r}')"/>
