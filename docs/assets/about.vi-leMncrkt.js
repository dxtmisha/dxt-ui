...
`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`mở-rộng-và-tiến-hóa-ngữ-cảnh-tĩnh-vs-mcp`,children:`Mở rộng và Tiến hóa: Ngữ cảnh tĩnh vs MCP`}),`
`,(0,c.jsxs)(t.p,{children:[`Khi hệ thống thiết kế mở rộng và kết nối hàng chục package nội bộ, một thách thức kiến trúc tự nhiên xuất hiện giữa kích thước tệp tổng hợp `,(0,c.jsx)(t.code,{children:`ai-prompt.md`}),` và dung lượng cửa sổ ngữ cảnh của các LLM hiện đại.`]}),`
`,(0,c.jsxs)(t.p,{children:[`Hệ sinh thái `,(0,c.jsx)(t.code,{children:`dxt-ui`}),` hỗ trợ hai mô hình phân phối ngữ cảnh tương hỗ:`]}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`1. Hợp đồng Markdown tĩnh (Nền tảng hiện tại):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Ưu điểm:`}),` Rào cản tiếp cận bằng 0, độ tin cậy 100%, không cần duy trì tiến trình máy chủ nền, hỗ trợ gốc trên mọi môi trường phát triển (Antigravity, Cursor, Windsurf, Claude Code, GitHub Copilot).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Ứng dụng:`}),` Hoàn hảo cho phần lớn các dự án và đội ngũ sản phẩm, đảm bảo hành vi nhất quán của AI với chi phí hạ tầng tối thiểu.`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`2. Giao thức Model Context Protocol động (MCP):`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Ưu điểm:`}),` Truy vấn tài nguyên thông minh theo nhu cầu (on-demand). Trợ lý chỉ yêu cầu các kiểu dữ liệu, token hoặc quy tắc chuyên biệt vào đúng thời điểm gọi công cụ, giúp tiết kiệm token trong các monorepo doanh nghiệp quy mô lớn.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Sẵn sàng ngay lập tức:`}),` Script `,(0,c.jsx)(t.code,{children:`@dxtmisha/scripts`}),` đồng thời tạo ra các tệp đặc tả tài nguyên `,(0,c.jsx)(t.code,{children:`ai-mcp-resources.json`}),` và `,(0,c.jsx)(t.code,{children:`ai-mcp-all-resources.json`}),`. Nhờ đó, mã nguồn đã sẵn sàng hoàn toàn để triển khai máy chủ MCP cục bộ mà không cần viết lại hệ thống tạo siêu dữ liệu.`]}),`
`]}),`
`]}),`
