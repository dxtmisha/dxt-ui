...
`,(0,c.jsx)(t.h1,{id:`lớp-stylestoanimate`,children:`Lớp StylesToAnimate`}),`
`,(0,c.jsxs)(t.p,{children:[`Lớp `,(0,c.jsx)(t.code,{children:`StylesToAnimate`}),` chịu trách nhiệm tạo các hiệu ứng CSS `,(0,c.jsx)(t.code,{children:`@keyframes`}),` từ các thuộc tính thiết kế. Nó triển khai logic để bao bọc các quy tắc khung hình chính (keyframes) lồng nhau trong một khối animation có tên.`]}),`
`,(0,c.jsx)(t.h2,{id:`các-tính-năng-chính`,children:`Các tính năng chính`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Bao bọc Keyframes`}),` — Tự động bao bọc nội dung style được tạo bên trong một khối `,(0,c.jsx)(t.code,{children:`@keyframes`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Đặt tên động`}),` — Sử dụng tên của thuộc tính thiết kế để định nghĩa định danh cho hiệu ứng.`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Khởi tạo trình chuyển đổi `,(0,c.jsx)(t.code,{children:`StylesToAnimate`}),` với thuộc tính bắt buộc và một hàm gọi nội dung cho các bước khung hình chính (keyframes).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`content?: () => string[]`}),` — một hàm có thể gọi trả về một mảng các chuỗi đại diện cho các keyframes.`]}),`
