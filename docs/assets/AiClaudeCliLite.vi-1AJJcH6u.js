...
`,(0,c.jsxs)(t.p,{children:[`Lớp `,(0,c.jsx)(t.code,{children:`AiClaudeCliLite`}),` là một triển khai gọn nhẹ của `,(0,c.jsx)(t.code,{children:`AiAbstract`}),` tương tác với công cụ Claude CLI chính thức thông qua các lệnh terminal shell của hệ thống. Nó quản lý các tệp lời nhắc tạm thời bằng cách sử dụng `,(0,c.jsx)(t.code,{children:`ApiTmp`}),` nhằm vượt qua giới hạn độ dài đối số của terminal.`]}),`
`,(0,c.jsx)(t.h2,{id:`tính-năng-chính`,children:`Tính năng chính`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Thực thi Shell CLI`}),` — tận dụng shell hệ thống (`,(0,c.jsx)(t.code,{children:`node:child_process`}),`) để gọi các lệnh CLI `,(0,c.jsx)(t.code,{children:`claude`}),`.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`An toàn Lời nhắc`}),` — tự động thoát các dấu ngoặc kép và thực thi định dạng phản hồi nghiêm ngặt (ví dụ: `,(0,c.jsx)(t.code,{children:`Output strictly the code/answer. No preamble, no chatter, no reasoning`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`response(model: string, contents: string): Promise<string>`}),` — Liên kết tất cả các tệp tạm thời, xử lý ký tự ngoặc kép, xây dựng câu lệnh thực thi shell, chạy nó và dọn dẹp tài nguyên.`]}),`
