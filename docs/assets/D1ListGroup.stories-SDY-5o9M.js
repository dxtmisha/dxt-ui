import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n,i as r,l as i,m as a,n as o,t as s,u as c}from"./wiki-BHyzKkJP.js";import{i as l,n as u,r as d,t as f}from"./D1ListGroup-DHzNjhil.js";var p,m,h,g;function _(){return(_=e((()=>{s(),l(),p=[{name:`divider`,type:`boolean`},{name:`open`,type:`boolean`}],m=[{name:`head`,description:`Slot for the group header/ Слот для заголовка группы`,properties:[{name:`props`,type:`(ListGroupSlotsPropsInclude) | undefined`}]},{name:`list`,description:`Slot for the group list content/ Слот для содержимого списка группы`,properties:[{name:`props`,type:`(any) | undefined`}]}],h=[],g={component:`ListGroup`,props:p,slots:m,events:h,defaults:d,wikiDesign:o}})))()}var v;function y(){return(y=e((()=>{n(),i(),_(),v=new c(g.component,g.props,g.defaults,g.wikiDesign,r,a)})))()}var b=t({ListGroup:()=>S,__namedExportsOrder:()=>C,default:()=>x}),x,S,C;function w(){return(w=e((()=>{u(),y(),x={title:`Ui/ListGroup`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1ListGroup:f},setup:()=>({args:e}),template:`
