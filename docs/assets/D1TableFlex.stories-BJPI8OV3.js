import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Bt as n,Ft as r,Gt as i,Nt as a,Pt as o,in as s,kt as c,sn as l}from"./library-CO1fW2cN.js";import{d as u,f as d,i as f,l as p,n as m,t as h,u as g}from"./wiki-BMj2WokS.js";import{n as _,t as v}from"./AriaStaticInclude-DoPfNULn-CgdAxtFN.js";import{a as y,i as b,n as x,r as S,t as C}from"./ScrollSticky-C5XbfRdi.js";import{n as w,t as T}from"./D1TableFlexRecord-CPcC5m69.js";var E,D,O;function k(){return(k=e((()=>{v(),b(),E={lazy:!0,page:1,stickyScrollBottom:!0},D=class extends S{get tag(){return`div`}get tagCaption(){return`div`}get tagColgroup(){}get tagHeader(){return`div`}get tagFoot(){return`div`}get tagItems(){return`div`}get binds(){return{...super.binds,..._.role(`table`)}}},O=class extends y{constructor(e,t,n,r=D){super(e,t,n,r)}initClasses(){return{main:{},table:this.getSubClass(`table`),colgroup:this.getSubClass(`colgroup`),col:this.getSubClass(`col`),header:this.getSubClass(`header`),foot:this.getSubClass(`foot`),items:this.getSubClass(`items`),caption:this.getSubClass(`caption`)}}}})))()}var A;function j(){return(j=e((()=>{w(),A=T})))()}var M;function N(){return(N=e((()=>{k(),M={...E}})))()}var P;function F(){return(F=e((()=>{c(),k(),x(),j(),N(),P=r({name:`D1TableFlex`,__name:`D1TableFlex`,props:n({caption:{},captionDecorative:{type:Boolean},list:{},search:{},searchColumns:{},searchOptions:{},sort:{},sortDir:{},sortFunction:{type:Function},page:{},rows:{},stickyScrollBottom:{type:Boolean},isSkeleton:{type:Boolean},stickyLeft:{},tableItemAttrs:{},tableItemColumnAttrs:{},selected:{},stickyTop:{},keyValue:{},lazy:{type:Boolean},defaultHeight:{},tableRecordAttrs:{},tableRowAttrs:{},columns:{},columnsWidth:{},header:{},foot:{},headerTop:{type:Boolean},captionBottom:{type:Boolean},bleed:{type:Boolean}},M),emits:[`sort`],setup(e,{expose:t,emit:n}){let r=n,s=e,c=a(()=>({main:{"d1-tableFlex":!0,"d1-tableFlex--headerTop":s.headerTop,"d1-tableFlex--captionBottom":s.captionBottom,"d1-tableFlex--bleed":s.bleed}})),u=a(()=>({})),d=new O(`d1.tableFlex`,s,{emits:r,classes:c,styles:u,components:{tableRecord:A,scrollSticky:C}}),f=d.render();return t(d.expose()),(e,t)=>(i(),o(l(f)))}})})))()}var I;function L(){return(L=e((()=>{F(),I=P,P.__docgenInfo=Object.assign({displayName:P.name??P.__name},{name:`D1TableFlex`,exportName:`default`,displayName:`D1TableFlex`,description:``,tags:{},sourceFiles:[`/Users/tung/Documents/GitHub/dxt-ui/packages/d1/src/components/Ui/TableFlex/D1TableFlex.vue`]})})))()}var R,z,B,V;function H(){return(H=e((()=>{h(),N(),R=[{name:`bleed`,type:`boolean`},{name:`caption`,type:`string | number`},{name:`captionBottom`,type:`boolean`},{name:`captionDecorative`,type:`boolean`},{name:`columns`,type:`string[]`},{name:`columnsWidth`,type:`Record<string, string | number>`},{name:`defaultHeight`,type:`string | number`},{name:`foot`,type:`TableHeader<TableFlexHeaderItemProps> | TableHeaders<TableFlexHeaderItemProps>`},{name:`header`,type:`TableHeader<TableFlexHeaderItemProps> | TableHeaders<TableFlexHeaderItemProps>`},{name:`headerTop`,type:`boolean`},{name:`isSkeleton`,type:`boolean`},{name:`keyValue`,type:`string`},{name:`lazy`,type:`boolean`},{name:`list`,type:`(TableFlexItemProps[] & TableList<TableFlexItemProps>)`},{name:`page`,type:`string | number`},{name:`rows`,type:`string | number`},{name:`search`,type:`string`},{name:`searchColumns`,type:`string[]`},{name:`searchOptions`,type:`SearchOptions`},{name:`selected`,type:`string | string[]`},{name:`sort`,type:`SortColumn`},{name:`sortDir`,type:`string`,option:[`asc`,`desc`]},{name:`sortFunction`,type:`SortFunction<TableFlexItemProps>`},{name:`stickyLeft`,type:`string[]`},{name:`stickyScrollBottom`,type:`boolean`},{name:`stickyTop`,type:`string[]`},{name:`tableItemAttrs`,type:`ConstrBind<TableFlexItemProps>`},{name:`tableItemColumnAttrs`,type:`Record<string, ConstrBind<TableFlexItemProps>>`},{name:`tableRecordAttrs`,type:`ConstrBind<TableFlexRecordProps>`},{name:`tableRowAttrs`,type:`Record<string, ConstrBind<TableFlexRecordProps>>`}],z=[{name:`body`,description:`Slot for custom table body content /
...
Слот для пользовательского содержимого элементов таблицы`,properties:[{name:`props`,type:`({ columns: string[]; }) | undefined`}]}],B=[{name:`sort`,description:`Event triggered when sort button is clicked / Событие, вызываемое при клике по кнопке сортировки`,properties:[{name:`item`,type:`SortColumnItem`}]}],V={component:`TableFlex`,props:R,slots:z,events:B,defaults:M,wikiDesign:m}})))()}var U;function W(){return(W=e((()=>{u(),p(),H(),U=new g(V.component,V.props,V.defaults,V.wikiDesign,f,d)})))()}var G=t({TableFlex:()=>q,TableFlexBasic:()=>J,TableFlexSearch:()=>Z,TableFlexSlots:()=>Y,TableFlexSort:()=>X,__namedExportsOrder:()=>Q,default:()=>K}),K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{L(),W(),c(),K={title:`Ui/TableFlex`,component:I,parameters:{design:`d1`,docs:{description:{component:U.getDescription()}}},argTypes:U.getWiki(),args:U.getValues()},q={},J={name:`Базовый`,render:()=>({components:{D1TableFlex:I},template:`
