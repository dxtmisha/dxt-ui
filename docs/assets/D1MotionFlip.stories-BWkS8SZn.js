import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Bt as n,Dt as r,Mt as i,Nt as a,Pt as o,Rt as s,Ut as c,Vt as l,an as u,jt as d,nn as f,qt as p}from"./library-BfcLFF_v.js";import{O as m,d as h,i as g,k as _,l as v,m as y,n as b,p as x,t as S,u as C}from"./wiki-BHyzKkJP.js";var w,T,E,D,O,k,A,j;function M(){return(M=e((()=>{r(),m(),w=class{constructor(e,t,n){x(this,`props`,void 0),x(this,`elementManager`,void 0),x(this,`items`,void 0),x(this,`frameId`,void 0),x(this,`timerId`,void 0),x(this,`isTransitioning`,!1),x(this,`isEnable`,()=>!this.props.disabled&&this.elementManager.isEnable()),x(this,`reset`,()=>{this.isTransitioning||(this.isTransitioning=!0,requestAnimationFrame(()=>{this.stop(),this.props.auto&&this.items.init()}))}),x(this,`update`,async e=>{if(this.isEnable()){this.items.init(),await e(),this.go();return}await e()}),x(this,`go`,()=>{this.stop(),this.frameId=requestAnimationFrame(()=>{this.items.update(),this.elementManager.addClassFreeze(),this.frameId=requestAnimationFrame(()=>{this.elementManager.addClassGo(),this.frameId=void 0,this.timerId=setTimeout(()=>this.reset(),1024)})})}),x(this,`onTransition`,e=>{this.items.resetItem(e)&&this.reset()}),x(this,`stop`,()=>{this.frameId!==void 0&&(cancelAnimationFrame(this.frameId),this.frameId=void 0),this.timerId!==void 0&&(clearTimeout(this.timerId),this.timerId=void 0),this.isTransitioning=!1,this.elementManager.resetStatus(),this.items.reset()}),this.props=e,this.elementManager=t,this.items=n}},T=class{constructor(e,t){x(this,`element`,void 0),x(this,`className`,void 0),this.element=e,this.className=t}isEnable(){return!!this.element.value}getClassName(){return this.className}getElement(){return this.element.value}addClassFreeze(){var e;(e=this.element.value)==null||e.classList.add(`${this.className}--freeze`)}addClassGo(){var e;(e=this.element.value)==null||e.classList.add(`${this.className}--go`)}resetStatus(){var e;(e=this.element.value)==null||e.classList.remove(`${this.className}--freeze`,`${this.className}--go`)}},E=class{constructor(e,t){x(this,`element`,void 0),x(this,`elementManager`,void 0),x(this,`original`,void 0),this.element=e,this.elementManager=t}isElement(e){return this.element===e}reset(){return this.resetStyle().removeClass()}update(e){if(this.original){let t=e??this.getRectangle();this.setStyle(`top`,this.original.top-t.top).setStyle(`left`,this.original.left-t.left).setStyle(`width`,t.width).setStyle(`width-to`,this.original.width).setStyle(`height`,t.height).setStyle(`height-to`,this.original.height).addClass()}return this}initOriginalSize(){let e=this.element.getBoundingClientRect();return this.original={top:e.top,left:e.left,width:e.width,height:e.height},this}getItemClassName(){return`${this.elementManager.getClassName()}__item`}setStyle(e,t){let n=this.elementManager.getClassName();return this.element.style.setProperty(`--${n}-sys-${e}`,`${t}px`),this}addClass(){return this.element.classList.add(this.getItemClassName()),this}removeClass(){return this.element.classList.remove(this.getItemClassName()),this}removeStyle(e){let t=this.elementManager.getClassName();return this.element.style.removeProperty(`--${t}-sys-${e}`),this}resetStyle(){return this.removeStyle(`top`).removeStyle(`left`).removeStyle(`width`).removeStyle(`width-to`).removeStyle(`height`).removeStyle(`height-to`),this}getRectangle(){return this.element.getBoundingClientRect()}},D=class{constructor(e){x(this,`elementManager`,void 0),x(this,`items`,[]),this.elementManager=e}reset(){this.items.forEach(e=>e.reset())}resetItem(e){if(e.propertyName===`transform`){var t;return!!((t=this.find(e.target?.parentElement))!=null&&t.reset())}return!1}update(){let e=this.items.map(e=>e.getRectangle());this.items.forEach((t,n)=>t.update(e[n]))}init(){let e=this.elementManager.getElement();if(e){let t=Array.from(e.children);this.items=t.map(e=>new E(e,this.elementManager).initOriginalSize())}else this.items=[]}initOriginalSize(){this.items.forEach(e=>e.initOriginalSize())}find(e){return this.items.find(t=>t.isElement(e))}},O=class{constructor(e,t,r,i){x(this,`props`,void 0),x(this,`action`,void 0),x(this,`elementManager`,void 0),x(this,`items`,void 0),x(this,`observer`,void 0),x(this,`onMutation`,()=>{this.action.isEnable()&&(this.action.go(),this.takeRecords())}),this.props=e,this.action=t,this.elementManager=r,this.items=i,n(()=>{p([()=>this.props.auto,()=>this.elementManager.getElement()],()=>{this.update()},{immediate:!0})}),l(()=>{this.stop()})}update(){this.props.auto?this.start():this.stop()}start(){let e=this.elementManager.getElement();e&&(this.stop(),this.items.init(),this.observer=new MutationObserver(this.onMutation),this.observer.observe(e,{childList:!0}))}stop(){this.observer&&=(this.observer.disconnect(),void 0)}takeRecords(){var e;(e=this.observer)==null||e.takeRecords()}},k=class{constructor(e,t,n,r,i,a,o,s,c={}){x(this,`props`,void 0),x(this,`refs`,void 0),x(this,`element`,void 0),x(this,`classDesign`,void 0),x(this,`className`,void 0),x(this,`components`,void 0),x(this,`slots`,void 0),x(this,`emits`,void 0),x(this,`action`,void 0),x(this,`elementManager`,void 0),x(this,`items`,void 0),x(this,`observer`,void 0),this.props=e,this.refs=t,this.element=n,this.classDesign=r,this.className=i,this.components=a,this.slots=o,this.emits=s;let{MotionFlipActionConstructor:l=w,MotionFlipElementConstructor:u=T,MotionFlipItemsConstructor:d=D,MotionFlipObserverConstructor:f=O}=c;this.elementManager=new u(this.element,this.className),this.items=new d(this.elementManager),this.action=new l(this.props,this.elementManager,this.items),this.observer=new f(this.props,this.action,this.elementManager,this.items)}},A=class extends _{constructor(e,t,n,r=k){super(e,t,n),x(this,`item`,void 0),this.item=new r(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits),this.init()}initExpose(){return{stop:()=>this.item.action.stop(),update:e=>this.item.action.update(e)}}initClasses(){return{main:{},item:this.getSubClass(`item`)}}initStyles(){return{}}initRender(){return o(`div`,{ref:this.element,class:this.classes?.value.main,onTransitionend:this.item.action.onTransition},this.initSlot(`default`))}},j={auto:!0}})))()}var N;function P(){return(P=e((()=>{M(),N={...j}})))()}var F;function I(){return(I=e((()=>{r(),M(),P(),F=a({name:`D1MotionFlip`,__name:`D1MotionFlip`,props:s({auto:{type:Boolean},disabled:{type:Boolean}},N),setup(e,{expose:t,emit:n}){let r=n,a=e,o=d(()=>({main:{"d1-motionFlip":!0}})),s=d(()=>({})),l=new A(`d1.motionFlip`,a,{emits:r,classes:o,styles:s}),f=l.render();return t(l.expose()),(e,t)=>(c(),i(u(f)))}})})))()}var L;function R(){return(R=e((()=>{I(),L=F,F.__docgenInfo=Object.assign({displayName:F.name??F.__name},{name:`D1MotionFlip`,exportName:`default`,displayName:`D1MotionFlip`,description:``,tags:{},sourceFiles:[`/Volumes/T7/development/dxt-ui/packages/d1/src/components/Ui/MotionFlip/D1MotionFlip.vue`]})})))()}var z,B,V,H;function U(){return(U=e((()=>{S(),P(),z=[{name:`auto`,type:`boolean`},{name:`disabled`,type:`boolean`}],B=[{name:`default`,description:`Default slot for content elements / Слот по умолчанию для элементов контента`,properties:[{name:`props`,type:`(any) | undefined`}]}],V=[],H={component:`MotionFlip`,props:z,slots:B,events:V,defaults:N,wikiDesign:b}})))()}var W;function G(){return(G=e((()=>{h(),v(),U(),W=new C(H.component,H.props,H.defaults,H.wikiDesign,g,y)})))()}var K=t({MotionFlip:()=>J,MotionFlipBasic:()=>Y,__namedExportsOrder:()=>X,default:()=>q}),q,J,Y,X;function Z(){return(Z=e((()=>{R(),G(),r(),q={title:`Ui/MotionFlip`,component:L,parameters:{design:`d1`,docs:{description:{component:W.getDescription()}}},argTypes:W.getWiki(),args:W.getValues()},J={render:e=>({components:{D1MotionFlip:L},setup:()=>({args:e}),template:`
