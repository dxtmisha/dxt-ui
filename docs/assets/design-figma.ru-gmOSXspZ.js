...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Гибкая поддержка аргументов`}),`: Позволяет динамически нацеливаться на конкретные файлы и узлы через параметры командной строки.`]}),`
`]}),`
...
`,(0,c.jsx)(t.li,{children:`Скрипт считывает ключ файла Figma и необязательный идентификатор узла, переданные непосредственно в качестве аргументов командной строки.`}),`
...
`,(0,c.jsx)(t.p,{children:`Чтобы получить изображения макетов, выполните команду, передав ключ файла Figma и идентификатор узла:`}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-bash`,children:`npx dxt-figma-layout [fileKey] [nodeId]
`})}),`
`,(0,c.jsx)(t.p,{children:`Пример:`}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-bash`,children:`npx dxt-figma-layout abc123xyz456 1-24
`})}),`
`,(0,c.jsx)(t.h2,{id:`аргументы-cli`,children:`Аргументы CLI`}),`
`,(0,c.jsx)(t.p,{children:`Команда принимает два позиционных параметра:`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`fileKey`}),`: Уникальный идентификатор файла Figma (обычно находится в URL-адресе файла Figma).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`nodeId`}),`: Конкретный идентификатор узла внутри файла (например, `,(0,c.jsx)(t.code,{children:`1-24`}),` или `,(0,c.jsx)(t.code,{children:`1:24`}),`) для извлечения.`]}),`
