...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`list: SearchListInput<T>`}),` — исходный список данных (массив, Ref или функция, возвращающая массив/Ref).`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`columns?: SearchColumnsInput<T, K>`}),` — список колонок (ключей объекта), по которым выполняется поиск (массив, Ref или функция, возвращающая массив/Ref).`]}),`
