import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional/Composables/useApiPost - Выполнение POST-запросов` }), `
`, (0, c.jsx)(n.h1, { id: `useapipost`, children: (0, c.jsx)(n.code, { children: `useApiPost` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Возвращает объект с состоянием загрузки и методом `, (0, c.jsx)(n.code, { children: `send` }), ` для выполнения `, (0, c.jsx)(n.code, { children: `POST` }), `-запросов к API. Является удобной оберткой над `, (0, c.jsx)(n.code, { children: `useApiRequest` }), ` с предустановленным методом `, (0, c.jsx)(n.code, { children: `POST` }), `. Принимает настройки в виде единого объекта `, (0, c.jsx)(n.code, { children: `UseApiPostSetup` }), `.`] }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Параметры:` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setup: UseApiPostSetup` }), ` — Объект настроек запроса:`, `
`, (0, c.jsxs)(n.ul, { children: [`
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `send(request?: Request): Promise<Return | undefined>` }), ` — Асинхронный метод для отправки `, (0, c.jsx)(n.code, { children: `POST` }), `-запроса. Он автоматически управляет состоянием `, (0, c.jsx)(n.code, { children: `loading` }), `, проверяет контракты валидации запроса и ответа, применяет функцию трансформации к ответам, вызывает коллбэк `, (0, c.jsx)(n.code, { children: `action` }), ` при успехе и безопасно обрабатывает ошибки.`] }), `
`] }), `
