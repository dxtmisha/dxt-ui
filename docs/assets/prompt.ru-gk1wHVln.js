...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Chronological Guard`}),` — обязательный порядок изучения контекста (`,(0,c.jsx)(t.code,{children:`ai-prompt.md`}),` ➔ `,(0,c.jsx)(t.code,{children:`ai-memory.md`}),` ➔ `,(0,c.jsx)(t.code,{children:`ai-types.md`}),` ➔ `,(0,c.jsx)(t.code,{children:`ai-developer.md`}),`).`]}),`
...
0. Mandatory Deep Study (CHRONOLOGICAL GUARD):
   - Step 1: Read root ai-prompt.md and study library descriptions.
   - Step 2: Read/create local ai-memory.md strictly in current package root.
   - Step 3: Study ai-types.md via search BEFORE writing code.
   - Step 4: Study ai-developer.md when directly modifying package code.
