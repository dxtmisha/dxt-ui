...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Unique Identifiers`}),` — increments a global file ID counter shared across all instances to prevent concurrent write collisions.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Clean PURGE Actions`}),` — removes only the temporary files created by the instance, keeping files of concurrently running instances intact.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Removes only the temporary files created by this instance from the `,(0,c.jsx)(t.code,{children:`./ai-tmp`}),` directory, making cleanup safe for concurrent executions.`]}),`
