import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,c as r,d as i,f as a,i as o,l as s,n as c,o as l,r as u,s as d,t as f,u as p}from"./wiki-BMj2WokS.js";import{i as m,n as h,r as g,t as _}from"./D1Image-PUwePLbY.js";var v,y,b,x;function S(){return(S=e((()=>{f(),m(),v=[{name:`adaptive`,type:`boolean`},{name:`adaptiveAlways`,type:`boolean`},{name:`adaptiveGroup`,type:`string`},{name:`alt`,type:`string`},{name:`coordinator`,type:`number[] | any`},{name:`disabled`,type:`boolean`},{name:`fetchPriority`,type:`string`,option:[`auto`,`high`,`low`]},{name:`hide`,type:`boolean`},{name:`lazy`,type:`boolean`},{name:`objectHeight`,type:`string | number`},{name:`objectWidth`,type:`string | number`},{name:`picture`,type:`ImagePicture`},{name:`preloadOffset`,type:`string`},{name:`size`,type:`string`,option:[`auto`,`contain`,`cover`]},{name:`srcset`,type:`string | Record<string, string>`},{name:`static`,type:`boolean`},{name:`tagImg`,type:`boolean`},{name:`turn`,type:`boolean`},{name:`url`,type:`string`},{name:`value`,type:`string | any`},{name:`x`,type:`string | number`},{name:`y`,type:`string | number`}],y=[],b=[{name:`load`,description:`Event triggered when the image is loaded/ Событие, срабатывающее при загрузке изображения`,properties:[{name:`image`,type:`ImageEventData`}]}],x={component:`Image`,props:v,slots:y,events:b,defaults:g,wikiDesign:c}})))()}var C;function w(){return(w=e((()=>{i(),s(),S(),C=new p(x.component,x.props,x.defaults,x.wikiDesign,o,a)})))()}var T=t({Image:()=>D,ImageAdaptive:()=>j,ImageSize:()=>k,ImageTagImg:()=>A,ImageType:()=>O,__namedExportsOrder:()=>M,default:()=>E}),E,D,O,k,A,j,M;function N(){return(N=e((()=>{h(),w(),s(),E={title:`Ui/Image`,component:_,parameters:{design:`d1`,docs:{description:{component:C.getDescription()}}},argTypes:C.getWiki(),args:C.getValues()},D={args:{value:`https://png.pngtree.com/thumb_back/fh260/background/20230611/pngtree-sunset-images-free-download-free-landscape-wallpapers-image_2913889.jpg`,tagImg:!0,disabled:!1,hide:!1,turn:!1,alt:``,size:`auto`,x:``,y:``,lazy:!0,fetchPriority:`high`},render:e=>({components:{D1Image:_},setup:()=>({args:e}),template:`
      <div class="wiki-storybook-item wiki-storybook-item--widescreen wiki-storybook-item--squared--sm">
        <D1Image v-bind="args"/>
      </div>
    `})},O={name:`Тип значения`,render:()=>({components:{D1Image:_},setup(){return{image1:l,demoPdf:r}},template:`
    ...
    `})},j={name:`Адаптированные изображения`,render:()=>({components:{D1Image:_},setup(){return{phone1:d,phone2:n,phone3:u}},template:`
        <div class="wiki-storybook-group">
          <div class="wiki-storybook-item wiki-storybook-item--squared--md">
