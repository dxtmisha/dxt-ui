...
Лёгкий эмит ввода без DOM-события: [value]`, properties: [{ name: `value`, type: `FieldValidationItem<NumberOrString>` }] }, { name: `update:modelValue`, description: `Update model value event/ Событие обновления значения модели`, properties: [{ name: `value`, type: `NumberOrString` }] }, { name: `update:value`, description: `Update value event/ Событие обновления значения`, properties: [{ name: `value`, type: `NumberOrString` }] }], b = { component: `Input`, props: _, slots: v, events: y, defaults: h, wikiDesign: c }
    ...
    ` }) }, M = { name: `Двусторонняя привязка (v-model)`, render: () => ({ components: { D1Input: g }, setup() { return { inputValue: r(`Initial value`), maskValue: r(``), numberValue: r(42) } }, template: `
        <div class="wiki-storybook-flex-column">
...
}`, ...N.parameters?.docs?.source } } }, P = [`Input`, `InputTypes`, `InputNumber`, `InputCurrency`, `InputDate`, `InputMask`, `InputVModel`, `InputSkeleton`]
  }); F(); export { E as Input, k as InputCurrency, A as InputDate, j as InputMask, O as InputNumber, N as InputSkeleton, D as InputTypes, M as InputVModel, P as __namedExportsOrder, T as default, C as i, F as n, S as r, w as t }
