...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`get(): string`}),` — Returns the final version of the template after all transformations.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getNameFile(name: string): string`}),` — Processes a filename or string to replace project-level placeholders.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`replaceName(): this`}),` — Replaces the primary component name marks throughout the template.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`replacePath(): this`}),` — Fixes relative paths (`,(0,c.jsx)(t.code,{children:`../../../`}),`) to point to the correct project root location.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`replaceMark(name: string, data: string[], end = ''): this`}),` — Performs block replacement for a specific label by injecting an array of strings.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`replaceOnce(name?: string, removeReplacement?: boolean | Function): this`}),` — Handles single-use replacement markers (`,(0,c.jsx)(t.code,{children:`.once`}),`).`]}),`
`]}),`
