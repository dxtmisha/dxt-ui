...
`,e.jsxs(n.p,{children:["To initialize the object, call the ",e.jsx(n.code,{children:"CacheItem(callback)"})," constructor."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"callback: () => T"})," — a function that will generate data for the cache."]}),`
`]}),`
