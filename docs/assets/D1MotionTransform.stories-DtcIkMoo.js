import{n as e,r as t}from"./chunk-BneVvdWh.js";import{It as n,gt as r}from"./iframe-InwAcaLb.js";import{a as i,d as a,l as o,m as s,n as c,t as l,u}from"./wiki-DiKtF90Q.js";import{i as d,n as f,r as p,t as m}from"./D1MotionTransform-BDUcJHCL.js";var h,g,_=e((()=>{u(),l(),d(),h=[{name:`adaptive`,type:`string`,option:[`planeAlways`,`planeSm`,`planeMd`,`planeLg`,`planeXl`,`plane2xl`]},{name:`animationHeadPosition`,type:`string`,option:[`top`,`toBottom`]},{name:`animationShow`,type:`boolean`},{name:`ariaDescribedby`,type:`string`},{name:`ariaLabelledby`,type:`string`},{name:`autoClose`,type:`boolean`},{name:`clickOpen`,type:`boolean`},{name:`ignore`,type:`string | HTMLElement`},{name:`ignoreSelector`,type:`string`},{name:`inDom`,type:`boolean`},{name:`modelOpen`,type:`boolean`},{name:`onUpdate:modelOpen`,type:`(value: boolean) => void`},{name:`onUpdate:open`,type:`(value: boolean) => void`},{name:`open`,type:`boolean`},{name:`section`,type:`boolean`},{name:`tagBody`,type:`string`}],g={component:`MotionTransform`,props:h,defaults:p,wikiDesign:c}})),v,y=e((()=>{u(),i(),_(),v=new a(g.component,g.props,g.defaults,g.wikiDesign,o,s)})),b=t({MotionTransform:()=>S,MotionTransformAnimationHeadPosition:()=>T,MotionTransformIgnore:()=>w,MotionTransformVModel:()=>C,__namedExportsOrder:()=>E,default:()=>x}),x,S,C,w,T,E,D=e((()=>{f(),y(),r(),x={title:`Ui/MotionTransform`,component:m,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1MotionTransform:m},setup:()=>({args:e}),template:`
    ...
    `})},C={name:`Двусторонняя привязка (v-model)`,render:()=>({components:{D1MotionTransform:m},setup(){return{open:n(!1)}},template:`
        <div class="wiki-storybook-item--padding">
    ...
    `})},w={name:`Зоны игнорирования`,render:()=>({components:{D1MotionTransform:m},template:`
...
}`,...T.parameters?.docs?.source}}},E=[`MotionTransform`,`MotionTransformVModel`,`MotionTransformIgnore`,`MotionTransformAnimationHeadPosition`]}));D();export{S as MotionTransform,T as MotionTransformAnimationHeadPosition,w as MotionTransformIgnore,C as MotionTransformVModel,E as __namedExportsOrder,x as default,y as i,D as n,v as r,b as t};