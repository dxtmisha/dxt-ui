import{n as e}from"./chunk-DnJy8xQt.js";import{r as t}from"./react-Ornc7p8c.js";import{t as n}from"./jsx-runtime-DNNexOQt.js";import{f as r,s as i}from"./blocks-BDI5G1Gi.js";import{t as a}from"./mdx-react-shim-n552quEh.js";function o(e){let n={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(i,{title:`@dxtmisha/ru/functional/Composables/useApiRef - Работа с запросами`}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`transformation?: (data: T, isResponseContractValid?: ApiDataValidation) => ApiData<R>`}),` — функция преобразования ответа перед сохранением в `,(0,c.jsx)(n.code,{children:`data`}),`. Получает вторым аргументом результат валидации контракта.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`validateResponseContract?: (data: T) => ApiDataValidation`}),` — функция для проверки контракта данных ответа.`]}),`
...
`,(0,c.jsxs)(n.ul,{children:[`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`data: ComputedRef<ApiData<R> | undefined>`}),` — Ссылка на загруженные данные (Computed). Инициирует `,(0,c.jsx)(n.strong,{children:`ленивую инициализацию`}),` (запрос и watcher) при первым обращении.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`isResponseContractValid: ComputedRef<boolean>`}),` — `,(0,c.jsx)(n.code,{children:`true`}),`, если контракт ответа валиден (статус `,(0,c.jsx)(n.code,{children:`success`}),`).`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`responseValidationResult: ComputedRef<ApiDataValidation | undefined>`}),` — полный объект результата валидации контракта.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`init(awaitFetch?: boolean): Promise<void>`}),` — Метод для явной инициализации запроса и watchers. Вызывается автоматически при первом обращении к `,(0,c.jsx)(n.code,{children:`data`}),`. Если `,(0,c.jsx)(n.code,{children:`awaitFetch`}),` передано как `,(0,c.jsx)(n.code,{children:`true`}),`, дожидается выполнения первого запроса.`]}),`
...
`,(0,c.jsx)(n.h2,{id:`ssr-и-инициализация`,children:`SSR и инициализация`}),`
`,(0,c.jsxs)(n.p,{children:[`Метод `,(0,c.jsx)(n.code,{children:`init`}),` предназначен для управления процессом первичной загрузки данных, что критически важно для корректной работы `,(0,c.jsx)(n.strong,{children:`Server Side Rendering (SSR)`}),` и обеспечения быстрой отрисовки интерфейса на клиенте.`]}),`
`,(0,c.jsx)(n.h3,{id:`механика-работы-hydration`,children:`Механика работы (Hydration)`}),`
`,(0,c.jsxs)(n.ol,{children:[`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`На стороне сервера (SSR):`}),`
При первом открытии страницы необходимо вызвать `,(0,c.jsx)(n.code,{children:`await init()`}),` в `,(0,c.jsx)(n.code,{children:`async setup()`}),`. Это заставит сервер дождаться ответа от API и отрендерить компонент уже с готовыми данными. Полученные данные автоматически попадают в кэш состояния, который передается клиенту.`]}),`
`]}),`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`На стороне клиента (Hydration):`}),`
Когда браузер "оживляет" (гидрирует) страницу, `,(0,c.jsx)(n.code,{children:`useApiRef`}),` первым делом проверяет наличие данных в кэше. Если данные там есть (пришли с сервера), они мгновенно подставляются в `,(0,c.jsx)(n.code,{children:`data`}),`, исключая повторный запрос к API.`]}),`
`]}),`
`,(0,c.jsxs)(n.li,{children:[`
`,(0,c.jsxs)(n.p,{children:[(0,c.jsx)(n.strong,{children:`Динамическая навигация (Client-side Nav):`}),`
Если пользователь переходит на страницу динамически (без перезагрузки), компонент рендерится сразу, не дожидаясь завершения `,(0,c.jsx)(n.code,{children:`init()`}),`. Это позволяет мгновенно показать `,(0,c.jsx)(n.strong,{children:`скелетон (skeleton)`}),` или индикатор загрузки (`,(0,c.jsx)(n.code,{children:`loading`}),`), пока данные подгружаются в фоновом режиме.`]}),`
`]}),`
`]}),`
...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`retry?: number`}),` — количество повторных попыток при сбое.`]}),`
`]}),`
