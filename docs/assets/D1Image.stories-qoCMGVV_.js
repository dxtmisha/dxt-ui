import{d as m,_ as s}from"./D1Image-ospKwdTj.js";import{W as d,w as k,a as l,b as v}from"./wiki-BNdC282o.js";import"./iframe-BGVIV1-M.js";import"./jsx-runtime-D_zvdyIk.js";import{d as c,i as r,p as b,a as y,b as p}from"./media-DmstNXdr.js";const u=[{name:"adaptive",type:"boolean"},{name:"adaptiveAlways",type:"boolean"},{name:"adaptiveGroup",type:"string"},{name:"coordinator",type:"any"},{name:"disabled",type:"boolean"},{name:"hide",type:"boolean"},{name:"objectHeight",type:"string | number"},{name:"objectWidth",type:"string | number"},{name:"size",type:"string",option:["auto","contain","cover"]},{name:"turn",type:"boolean"},{name:"url",type:"string"},{name:"value",type:"any"},{name:"x",type:"string | number"},{name:"y",type:"string | number"}],t=new d("Image",u,m,k,l,v),g={title:"Ui/Image",component:s,parameters:{design:"d1",docs:{description:{component:t.getDescription()}}},argTypes:t.getWiki(),args:t.getValues()},e={render:n=>({components:{D1Image:s},setup:()=>({args:n}),template:`
