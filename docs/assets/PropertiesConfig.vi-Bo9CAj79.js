...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getProjectName(): string`}),` — Truy xuất định danh gốc của dự án.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getDesignName(): string`}),` — Trả về định danh chính của hệ thống thiết kế.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getDesignAlternativeName(): string[]`}),` — Trả về các alias thay thế cho thiết kế.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getSeparator(): string`}),` — Trả về ký tự phân tách đường dẫn được sử dụng trong các token.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getWikiLanguage(): string`}),` — Trả về mã ngôn ngữ đích cho tài liệu.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAiDocDirectory(): string[]`}),` — Trả về các thư mục mục tiêu để tạo tài liệu.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAiDocStorybookPath(): string`}),` — Trả về đích xuất cho các tệp MDX của Storybook.`]}),`
`]}),`
