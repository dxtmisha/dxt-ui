import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { d as r, f as i, s as a } from './blocks-CKlddtvc.js'; import { t as o } from './mdx-react-shim-B1U8VZv0.js'; function s(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(a, { title: `@dxtmisha/ru/wiki/styles/# Контейнеры элементов` }), `
...
` }) }), `
`, (0, l.jsx)(r, { children: (0, l.jsx)(`div`, { class: `wiki-storybook-item`, children: (0, l.jsx)(n.p, { children: `Элемент 1:1` }) }) }), `
...
`, (0, l.jsxs)(n.li, { children: [(0, l.jsx)(n.code, { children: `.wiki-storybook-item--overflowAuto` }), `: Включает стандартную прокрутку браузера (`, (0, l.jsx)(n.code, { children: `overflow: auto` }), `).`] }), `
`, (0, l.jsxs)(n.li, { children: [(0, l.jsx)(n.code, { children: `.wiki-storybook-item--borderNone` }), `: Удаляет стандартную рамку (границу).`] }), `
...
`] }), `
`, (0, l.jsx)(r, { children: (0, l.jsx)(`div`, { class: `wiki-storybook-item wiki-storybook-item--widthAuto wiki-storybook-item--auto wiki-storybook-item--padding wiki-storybook-item--center`, children: (0, l.jsx)(n.p, { children: `Контент с паддингом в центре (width: auto)` }) }) })] })
