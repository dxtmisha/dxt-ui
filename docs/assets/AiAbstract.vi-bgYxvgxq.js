...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`key: string`}),` — API key cho dịch vụ AI.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`model: string`}),` — Định danh mô hình ban đầu (ví dụ: 'gpt-4o').`]}),`
`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-typescript`,children:`// Ví dụ về cách sử dụng một triển khai cụ thể
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getContents(): string[]`}),` — Trả về danh sách các nội dung bổ sung đã tích lũy.`]}),`
`]}),`
`,(0,c.jsx)(t.h3,{id:`cấu-hình-setters`,children:`Cấu hình (Setters)`}),`
`,(0,c.jsx)(t.p,{children:`Các phương thức trong nhóm này hỗ trợ chuỗi lệnh.`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`setKey(key: string): this`}),` — Thiết lập hoặc thay đổi API key. Khởi tạo lại client nếu nó đã hoạt động.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`setModel(model: string): this`}),` — Thay đổi mô hình hiện tại để tạo phản hồi.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`addPrompt(prompt: string): void`}),` — Thêm một dòng mới vào bộ đệm lời nhắc cố định.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`addImage(image: AiImageItem): this`}),` — Thêm một hình ảnh vào danh sách tích lũy.`]}),`
