...
`,e.jsx(n.h1,{id:"класс-stylestoanimate",children:"Класс StylesToAnimate"}),`
`,e.jsxs(n.p,{children:["Класс ",e.jsx(n.code,{children:"StylesToAnimate"})," отвечает за создание CSS-анимаций ",e.jsx(n.code,{children:"@keyframes"})," на основе свойств дизайна. Он реализует логику для обертывания вложенных правил ключевых кадров в именованный блок анимации."]}),`
`,e.jsx(n.h2,{id:"ключевые-возможности",children:"Ключевые возможности"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Обертка Keyframes"})," — Автоматически оборачивает созданный контент стилей в блок ",e.jsx(n.code,{children:"@keyframes"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Динамическое именование"})," — Использует имя свойства дизайна для определения идентификатора анимации."]}),`
...
`,e.jsxs(n.p,{children:["Инициализируйте преобразователь ",e.jsx(n.code,{children:"StylesToAnimate"})," с помощью необходимого свойства и функции контента для шагов анимации."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"content?: () => string[]"})," — вызываемая функция, которая возвращает массив строк, представляющих ключевые кадры."]}),`
