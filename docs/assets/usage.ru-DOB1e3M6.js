import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/styles/color/# Использование свойств` }), `
...
` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Первый параметр — это «имя свойства», которое станет суффиксом в переменной `, (0, c.jsx)(n.code, { children: `--sys-[имя]` }), `. Затем этот цвет может быть применен в дочерних узлах через `, (0, c.jsx)(n.code, { children: `color('init')` }), ` или считан в CSS `, (0, c.jsx)(n.code, { children: `rgba(var(--sys-color), 1)` }), `.`] })] })
