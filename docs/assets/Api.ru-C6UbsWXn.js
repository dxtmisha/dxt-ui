...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"global?: boolean"})," — использовать глобальный кэш ответов."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"devMode?: boolean"})," — включить логирование разработки."]}),`
...
`]}),`
`,e.jsx(n.h2,{id:"структура-данных-ответа",children:"Структура данных ответа"}),`
`,e.jsxs(n.p,{children:["Запросы возвращают ",e.jsx(n.code,{children:"Promise<ApiData<T>>"}),"."]}),`
`,e.jsx(n.h3,{id:"apidatat",children:e.jsx(n.code,{children:"ApiData<T>"})}),`
`,e.jsx(n.p,{children:"Структура возвращаемых данных зависит от типа ответа:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Массив"}),": Если ответ является массивом, ",e.jsx(n.code,{children:"ApiData<T>"})," представляет собой ",e.jsx(n.code,{children:"T[]"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Объект"}),": Если ответ является объектом, ",e.jsx(n.code,{children:"ApiData<T>"})," включает в себя поля из ",e.jsx(n.code,{children:"T"})," и стандартную обертку ",e.jsx(n.code,{children:"ApiDataItem<T>"}),"."]}),`
`]}),`
`,e.jsx(n.h3,{id:"apidataitemt",children:e.jsx(n.code,{children:"ApiDataItem<T>"})}),`
`,e.jsx(n.p,{children:"Объект ответа содержит следующие поля:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"data?: T"})," — основная полезная нагрузка, если ответ был обернут."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"success?: boolean"})," — флаг успешности."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"status?: ApiStatusType"})," — тип статуса (",e.jsx(n.code,{children:"'success'"}),", ",e.jsx(n.code,{children:"'error'"}),", ",e.jsx(n.code,{children:"'warning'"}),", ",e.jsx(n.code,{children:"'info'"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"message?: string"})," — сообщение ответа или описание ошибки."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"statusObject?: ApiStatusItem"})," — техническая информация о запросе:",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"status?: number"})," — HTTP-код статуса (например, 200, 404)."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"statusText?: string"})," — текст статуса HTTP."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"error?: string"})," — внутреннее сообщение об ошибке, если запрос не удался."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"lastResponse?: any"})," — данные последнего ответа до парсинга."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"lastStatus?: ApiStatusType"})," — статус последнего запроса."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"lastMessage?: string"})," — сообщение последнего запроса."]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"disable"})," — (Опционально) Отключить этот мок (boolean или callback)."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"isForGlobal"})," — (Опционально) Пометить как глобальный мок."]}),`
...
// abortCtrl.abort()
`})})]})}function j(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(c,{...s})}):c(s)}export{j as default};
