import{d as r,_ as i}from"./D1MotionTransform-DHthcCK5.js";import{W as d,w as l,a as c,b as m}from"./wiki-CHTdS6ju.js";import{r as p}from"./iframe-C6i5AnHO.js";import"./jsx-runtime-D_zvdyIk.js";const h=[{name:"adaptive",type:"string",option:["planeAlways","planeSm","planeMd","planeLg","planeXl","plane2xl"]},{name:"animationHeadPosition",type:"string",option:["top","toBottom"]},{name:"animationShow",type:"boolean"},{name:"autoClose",type:"boolean"},{name:"clickOpen",type:"boolean"},{name:"ignore",type:"string | HTMLElement"},{name:"ignoreSelector",type:"string"},{name:"modelOpen",type:"boolean"},{name:"onUpdate:modelOpen",type:"(value: boolean) => void"},{name:"onUpdate:open",type:"(value: boolean) => void"},{name:"open",type:"boolean"},{name:"section",type:"boolean"}],a=new d("MotionTransform",h,r,l,c,m),g={title:"Ui/MotionTransform",component:i,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},e={render:s=>({components:{D1MotionTransform:i},setup:()=>({args:s}),template:`
