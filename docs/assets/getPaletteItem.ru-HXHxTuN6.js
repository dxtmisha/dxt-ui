...
`,(0,c.jsxs)(t.p,{children:[`Функция генерирует вложенную цепочку переменных CSS (используя параметр fallback функции `,(0,c.jsx)(t.code,{children:`var()`}),`) для поиска цвета в нескольких узлах палитры.`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`String`}),` — вложенная строка вида `,(0,c.jsx)(t.code,{children:`var(--name1, var(--name2, ...))`}),`.`]}),`
`]}),`
