...
Слот для пользовательского содержимого элементов таблицы`,properties:[{name:`props`,type:`({ columns: string[]; }) | undefined`}]}],B=[{name:`sort`,description:`Event triggered when sort button is clicked / Событие, вызываемое при клике по кнопке сортировки`,properties:[{name:`item`,type:`SortColumnItem`}]}],V={component:`TableFlex`,props:R,slots:z,events:B,defaults:M,wikiDesign:m}})))()}var U;function W(){return(W=e((()=>{u(),f(),H(),U=new g(V.component,V.props,V.defaults,V.wikiDesign,d,p)})))()}var G=t({TableFlex:()=>q,TableFlexBasic:()=>J,TableFlexSearch:()=>Z,TableFlexSlots:()=>Y,TableFlexSort:()=>X,__namedExportsOrder:()=>Q,default:()=>K}),K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{L(),W(),n(),K={title:`Ui/TableFlex`,component:I,parameters:{design:`d1`,docs:{description:{component:U.getDescription()}}},argTypes:U.getWiki(),args:U.getValues()},q={},J={name:`Базовый`,render:()=>({components:{D1TableFlex:I},template:`
