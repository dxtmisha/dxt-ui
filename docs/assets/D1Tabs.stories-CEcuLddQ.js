import{f as _,c as d,w as S,ah as I,r as g,X as y,h as M,d as T,e as B,D as L,E as U,F as V,I as W,J as $}from"./iframe-okvuAVTt.js";import{g as j}from"./D1Icon-Brgfn8k6.js";import{V as H}from"./ModelInclude-BiYm_iCQ-8b_GiUPq.js";import{l as x}from"./AriaStaticInclude-DRHG8ILX-DsrSPayf.js";import{_ as P}from"./D1TabsNavigation-CU6_3K6G.js";import{_ as E}from"./D1MotionAxis-Db5SBOvc.js";import{w as F,W as O,a as R,b as X}from"./wiki-BeTUR4cU.js";import"./jsx-runtime-u17CrQMm.js";var Y=Object.defineProperty,z=(a,e,s)=>e in a?Y(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s,t=(a,e,s)=>z(a,typeof e!="symbol"?e+"":e,s);class G{constructor(e,s,n,c,r,i,o){t(this,"element",g()),t(this,"selectedItem",d(()=>this.selected?T(this.selected):this.props.selected)),t(this,"binds",d(()=>y(T(this.extra),{class:`${this.className}__motionAxis`},this.props.motionAxisAttrs))),t(this,"render",(m,l)=>this.components?this.components.render("motionAxis",{...y(l,this.binds.value,{selected:this.selectedItem.value}),ref:this.element,onMotionAxis:this.onMotionAxis},m,this.index):[]),t(this,"onMotionAxis",m=>{var l;(l=this.emits)==null||l.call(this,"motionAxis",m)}),this.props=e,this.className=s,this.components=n,this.emits=c,this.extra=r,this.selected=i,this.index=o}}class J{constructor(e,s,n,c,r){t(this,"element",g()),t(this,"binds",d(()=>y(T(this.extra),{class:`${this.className}__tabsNavigation`,itemAttrs:this.props.tabItemAttrs},B(this.props.tabs,"list"),this.props.tabsNavigationAttrs))),t(this,"ids",d(()=>{var i;return(i=this.element.value)==null?void 0:i.ids})),t(this,"render",(i,o)=>this.components?this.components.render("tabsNavigation",y(o,this.binds.value,{ref:this.element}),i,this.index):[]),this.props=e,this.className=s,this.components=n,this.extra=c,this.index=r}}class q{constructor(e,s){t(this,"item",g()),t(this,"set",n=>{this.item.value=n}),t(this,"update",()=>{this.is(this.props.selected)||this.set(this.props.selected)}),this.props=e,this.refs=s,this.item.value=e.selected,S([this.refs.selected],this.update)}is(e){return I(e,this.item.value)}}class K{constructor(e,s,n,c,r,i,o,m,l){t(this,"event"),t(this,"motionAxis"),t(this,"tabsNavigation"),t(this,"selected"),this.props=e,this.refs=s,this.element=n,this.classDesign=c,this.className=r,this.components=i,this.slots=o,this.emits=m;const{EventClickIncludeConstructor:k=j,ModelIncludeConstructor:D=H,MotionAxisIncludeConstructor:A=G,TabsNavigationIncludeConstructor:N=J,TabsSelectedConstructor:C=q}=l??{};this.selected=new C(this.props,this.refs),this.event=new k(void 0,void 0,this.emits),this.tabsNavigation=new N(this.props,this.className,this.components,d(()=>({selected:this.selected.item.value,onClick:this.event.onClick,"onUpdate:selected":this.selected.set}))),this.motionAxis=new A(this.props,this.className,this.components,this.emits,void 0,d(()=>String(this.selected.item.value))),new D("selected",this.emits,this.selected.item)}}const Q={};class Z extends _{constructor(e,s,n,c=K){super(e,s,n),t(this,"item"),t(this,"slidesRender",()=>{var r;if(this.slots){const i={};for(const o in this.slots){const m=(r=this.item.tabsNavigation.ids.value)==null?void 0:r[o];i[o]=()=>{var l;return M("div",{class:(l=this.classes)==null?void 0:l.value.slide,...x.role("tabpanel"),...x.labelledby(m)},this.initSlot(o))}}return i}}),this.item=new c(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits),this.init()}initExpose(){return{}}initClasses(){return{main:{},slide:this.getSubClass("slide")}}initStyles(){return{}}initRender(){return this.item.tabsNavigation.ids.value?[...this.item.tabsNavigation.render(),...this.item.motionAxis.render(this.slidesRender())]:this.item.tabsNavigation.render()}}const ee=P,te=E,w={...Q},p=L({name:"D1Tabs",__name:"D1Tabs",props:W({tabs:{},tabItemAttrs:{},tabsNavigationAttrs:{},selected:{},motionAxisAttrs:{},modelSelected:{},"onUpdate:selected":{type:Function},"onUpdate:modelSelected":{type:Function}},w),emits:["click","clickLite","update:selected","update:modelSelected","motionAxis"],setup(a,{expose:e,emit:s}){const n=s,c=a,r=d(()=>({main:{"d1-tabs":!0}})),i=d(()=>({})),o=new Z("d1.tabs",c,{emits:n,classes:r,styles:i,components:{tabsNavigation:ee,motionAxis:te}}),m=o.render();return e(o.expose()),(l,k)=>($(),U(V(m)))}});p.__docgenInfo=Object.assign({displayName:p.name??p.__name},{name:"D1Tabs",exportName:"default",displayName:"D1Tabs",description:"",tags:{},sourceFiles:["/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/Tabs/D1Tabs.vue"]});const se=[{name:"modelSelected",type:"ListSelectedList"},{name:"motionAxisAttrs",type:"ConstrBind<MotionAxis>"},{name:"onUpdate:modelSelected",type:"(value: ListSelectedList) => void"},{name:"onUpdate:selected",type:"(value: ListSelectedList) => void"},{name:"selected",type:"string"},{name:"tabItemAttrs",type:"ConstrBind<TabItem>"},{name:"tabs",type:"ListRecord<TabItem> | ConstrBind<TabsNavigation>"},{name:"tabsNavigationAttrs",type:"ConstrBind<TabsNavigation>"}],v={component:"Tabs",props:se,defaults:w,wikiDesign:F},f=new O(v.component,v.props,v.defaults,v.wikiDesign,R,X),ae={title:"Ui/Tabs",component:p,parameters:{design:"d1",docs:{description:{component:f.getDescription()}}},argTypes:f.getWiki(),args:f.getValues()},b={render:a=>({components:{D1Tabs:p},setup:()=>({args:a}),template:`
      <D1Tabs v-bind="args">
  ...
  <template #notifications>Stay updated with the latest alerts and announcements.</template>
    ...
    `})},h={name:"v-model",render:()=>({components:{D1Tabs:p},setup(){return{selected:g("tab1")}},template:`
