...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isScreenshot()`}),` — Xác minh xem thư mục `,(0,c.jsx)(t.code,{children:`ai-screenshot`}),` có tồn tại hay không.`]}),`
`]}),`
`,(0,c.jsx)(t.hr,{}),`
`,(0,c.jsx)(t.h3,{id:`phương-thức-trợ-giúp-công-khai--bảo-vệ-protected`,children:`Phương thức Trợ giúp Công khai & Bảo vệ (Protected)`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getProjectName(): string`}),` — Đọc tên dự án từ tệp cấu hình `,(0,c.jsx)(t.code,{children:`package.json`}),` cục bộ.`]}),`
