import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { blockquote: `blockquote`, code: `code`, h1: `h1`, h2: `h2`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/# UI/properties/types/Thuộc tính (property)` }), `
...
` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Kiểu phân bổ `, (0, c.jsx)(n.code, { children: `property` }), ` là trọng điểm cấu trúc mọi file cục diện style nội tại của `, (0, c.jsx)(n.code, { children: `dxt-ui` }), `, tạo móng CSS vững chắc trước khi những tầng nâng cao (logic BEM, media query, variable động) nhào lộn xâm nhập.`] })] })
