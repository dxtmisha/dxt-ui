...
`})}),`
`,n.jsx(e.p,{children:"Класс GeoIntlRef предоставляет мощную реактивную систему интернационализации для Vue приложений с автоматическим форматированием данных в соответствии с международными стандартами."})]})}function j(l={}){const{wrapper:e}={...r(),...l.components};return e?n.jsx(e,{...l,children:n.jsx(s,{...l})}):s(l)}export{j as default};
