import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/scripts/# Commands/dxt-screenshot - Dev Server Screenshot Capturer` }), `
...
` }) }), `
`, (0, c.jsxs)(n.p, { children: [`The resulting capture files will be saved in the `, (0, c.jsx)(n.code, { children: `./ai-screenshot/` }), ` folder.`] })] })
