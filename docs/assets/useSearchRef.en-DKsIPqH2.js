...
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`list: SearchListInput<T>`}),` — source data list (Array, Ref, or a function returning an array/Ref).`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`columns?: SearchColumnsInput<T, K>`}),` — list of columns (object keys) to search in (Array, Ref, or a function returning an array/Ref).`]}),`
