import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { a as n, d as r, l as i, m as a, n as o, t as s, u as c } from './wiki-CUC2UhNU.js'; import { i as l, n as u, r as d, t as f } from './D1SelectValue-DZsMEHxW.js'; var p, m, h, g, _ = t(() => { s(), l(), p = [{ name: `chipAttrs`, type: `ConstrBind<ChipProps>` }, { name: `disabled`, type: `boolean` }, { name: `iconAttrs`, type: `ConstrBind<IconProps>` }, { name: `iconCancel`, type: `IconValue<IconProps>` }, { name: `iconShow`, type: `boolean` }, { name: `multiple`, type: `boolean` }, { name: `placeholder`, type: `string` }, { name: `readonly`, type: `boolean` }, { name: `value`, type: `ListList` }], m = [], h = [{ name: `click`, description: `Full click event with MouseEvent/ Полное событие клика с MouseEvent`, properties: [{ name: `event`, type: `MouseEvent` }, { name: `value`, type: `EventClickValue` }] }, { name: `clickLite`, description: `Lightweight click event/ Упрощённое событие клика`, properties: [{ name: `value`, type: `EventClickValue` }] }], g = { component: `SelectValue`, props: p, slots: m, events: h, defaults: d, wikiDesign: o } }), v, y = t(() => { r(), i(), _(), v = new c(g.component, g.props, g.defaults, g.wikiDesign, n, a) }), b = e({ SelectValue: () => S, SelectValueBasic: () => C, __namedExportsOrder: () => w, default: () => x }), x, S, C, w, T = t(() => {
  u(), y(), x = { title: `Ui/SelectValue`, component: f, parameters: { design: `d1`, docs: { description: { component: v.getDescription() } } }, argTypes: v.getWiki(), args: v.getValues() }, S = {}, C = { name: `Базовые`, render: () => ({ components: { D1SelectValue: f }, template: `
...
}`, ...C.parameters?.docs?.source } } }, w = [`SelectValue`, `SelectValueBasic`]
}); T(); export { S as SelectValue, C as SelectValueBasic, w as __namedExportsOrder, x as default, y as i, T as n, v as r, b as t }
