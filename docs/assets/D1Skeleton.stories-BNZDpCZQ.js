import{d,_ as s}from"./D1Skeleton-LvRPzgGQ.js";import{w as r,W as a,a as l,b as k}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";import{i as c}from"./media-DJmoeva7.js";const v=[{name:"active",type:"boolean"}],i={component:"Skeleton",props:v,defaults:d,wikiDesign:r},o=new a(i.component,i.props,i.defaults,i.wikiDesign,l,k),b={title:"Ui/Skeleton",component:s,parameters:{design:"d1",docs:{description:{component:o.getDescription()}}},argTypes:o.getWiki(),args:o.getValues()},e={render:n=>({components:{D1Skeleton:s},setup:()=>({args:n}),template:`
      <D1Skeleton v-bind="args">
      <div class="wiki-storybook-card d1-skeleton__background">
        <div class="wiki-storybook-card__image d1-skeleton__background" style="background-image: url('${c}')"/>
    ...
    `})},t={name:"Базовое использование",render:()=>({components:{D1Skeleton:s},template:`
...
}`,...t.parameters?.docs?.source}}};const _=["Skeleton","SkeletonBasic"],x=Object.freeze(Object.defineProperty({__proto__:null,Skeleton:e,SkeletonBasic:t,__namedExportsOrder:_,default:b},Symbol.toStringTag,{value:"Module"}));export{x as S,e as a,o as b,t as c};
