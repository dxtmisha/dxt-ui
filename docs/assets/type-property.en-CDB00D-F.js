import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { blockquote: `blockquote`, code: `code`, h1: `h1`, h2: `h2`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/# UI/properties/types/Properties (property)` }), `
...
` }) }), `
`, (0, c.jsxs)(n.p, { children: [`The `, (0, c.jsx)(n.code, { children: `property` }), ` type fundamentally drives all localized stylesheet generations inside `, (0, c.jsx)(n.code, { children: `dxt-ui` }), `, laying the pure CSS architectural groundwork preceding any BEM logic, media query compilation, or dynamic variable evaluations.`] })] })
