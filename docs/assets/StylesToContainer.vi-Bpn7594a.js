import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/scripts/Classes/StylesToContainer - Trình tạo Container Query` }), `
`, (0, c.jsx)(n.h1, { id: `lớp-stylestocontainer`, children: `Lớp StylesToContainer` }), `
`, (0, c.jsxs)(n.p, { children: [`Lớp `, (0, c.jsx)(n.code, { children: `StylesToContainer` }), ` chịu trách nhiệm tạo các truy vấn CSS `, (0, c.jsx)(n.code, { children: `@container` }), ` từ các thuộc tính thiết kế. Nó triển khai logic để bao bọc các quy tắc style lồng nhau bên trong một khối container query.`] }), `
`, (0, c.jsx)(n.h2, { id: `các-tính-năng-chính`, children: `Các tính năng chính` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Bao bọc Container Query` }), ` — Tự động bao bọc nội dung style được tạo bên trong một quy tắc `, (0, c.jsx)(n.code, { children: `@container` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Phân giải truy vấn động` }), ` — Sử dụng giá trị thuộc tính thiết kế để định nghĩa điều kiện của container query.`] }), `
...
`, (0, c.jsxs)(n.p, { children: [`Khởi tạo trình chuyển đổi `, (0, c.jsx)(n.code, { children: `StylesToContainer` }), ` với thuộc tính bắt buộc và một hàm gọi nội dung cho các quy tắc lồng nhau.`] }), `
