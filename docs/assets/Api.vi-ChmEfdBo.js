...
`,(0,c.jsx)(n.p,{children:`Một lớp wrapper tĩnh (static class) bọc API Fetch để thao tác hiệu quả với các yêu cầu mạng. Nó cung cấp khả năng cấu hình nâng cao, xử lý trạng thái toàn cục, giả lập phản hồi (mocking), cấu hình các hook chuẩn bị, và tự động phân tích dữ liệu (parsing).`}),`
...
`,(0,c.jsxs)(n.p,{children:[`Hỗ trợ phương pháp nối chuỗi (chaining methods) trả về lớp `,(0,c.jsx)(n.code,{children:`Api`}),` gốc:`]}),`
`,(0,c.jsxs)(n.ul,{children:[`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`setHeaders(headers: Record<string, string>): Api`}),` — Áp dụng một thư mục Header chuẩn cho toàn hệ thống.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`setRequestDefault(request: Record<string, any>): Api`}),` — Đưa toàn bộ thông số tham số mặc định chuẩn vào mạng.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`setUrl(url: string): Api`}),` — Ghi đè định danh URL mặc định nhánh server API.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`setPreparation(callback: (apiFetch: ApiFetch) => Promise<void>): Api`}),` — Thiết lập vòng lặp hook `,(0,c.jsx)(n.em,{children:`ngay trước`}),` thời khắc thao tác diễn ra.`]}),`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`setEnd(callback: (query: Response, apiFetch: ApiFetch) => Promise<ApiPreparationEnd>): Api`}),` — Thiết lập vòng lặp hook `,(0,c.jsx)(n.em,{children:`sau`}),` khi tín hiệu mạng phản hồi trả về.`]}),`
`]}),`
...
`,(0,c.jsxs)(n.ul,{children:[`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.strong,{children:`Thứ tự thực thi`}),`: Nếu nhiều yêu cầu được bắt đầu đồng thời, thư viện đảm bảo rằng hook chuẩn bị sẽ được thực thi `,(0,c.jsx)(n.strong,{children:`tuần tự`}),`. Tất cả các yêu cầu tiếp theo sẽ đợi hook hiện tại kết thúc trong chế độ chờ (với khoảng thời gian thăm dò 160ms). Điều này ngăn chặn xung đột, ví dụ như khi nhiều yêu cầu đồng thời cố gắng làm mới token.`]}),`
...
`,(0,c.jsxs)(n.ul,{children:[`
`,(0,c.jsxs)(n.li,{children:[(0,c.jsx)(n.code,{children:`reset?: boolean`}),` — nếu được đặt thành `,(0,c.jsx)(n.code,{children:`true`}),`, thư viện sẽ hủy chuỗi hiện tại và `,(0,c.jsx)(n.strong,{children:`thực hiện lại yêu cầu`}),` (đệ quy). Toàn bộ quá trình chuẩn bị và thực thi sẽ được khởi động lại. Việc này được dùng để tự động xử lý quyền truy cập đã được làm mới.`]}),`
...
`,(0,c.jsxs)(n.li,{children:[`Nếu bộ giả lập không tìm được mock tương ứng nào khớp (bởi vì khác `,(0,c.jsx)(n.code,{children:`path`}),`, `,(0,c.jsx)(n.code,{children:`method`}),`, hoặc `,(0,c.jsx)(n.code,{children:`request`}),`), Lớp `,(0,c.jsx)(n.code,{children:`Api`}),` sẽ tự động chuyển hướng gọi thẳng yêu cầu tới máy chủ vật lý ở điểm xa.`]}),`
