import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/# UI/properties/flags/Lớp con (subclass)` }), `
`, (0, c.jsx)(n.h1, { id: `lớp-con-subclass`, children: `Lớp con (subclass)` }), `
`, (0, c.jsxs)(n.p, { children: [`Cờ `, (0, c.jsx)(n.code, { children: `_subclass: true` }), ` cho phép gắn nhãn rõ ràng một nút là một lớp con (BEM-element). Điều này là cần thiết nếu tên nút không được trình phân tích cú pháp tự động nhận dạng. Các thuộc tính sẽ được tự động bọc trong một bộ chọn lớp con (`, (0, c.jsx)(n.code, { children: `&__name { ... }` }), `).`] }), `
