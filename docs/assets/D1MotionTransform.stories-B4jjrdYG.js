import{n as e,r as t}from"./chunk-BneVvdWh.js";import{Lt as n,_t as r}from"./iframe-CqYdK-d6.js";import{a as i,d as a,g as o,l as s,n as c,t as l,u}from"./wiki-BtAa-rOh.js";import{i as d,n as f,r as p,t as m}from"./D1MotionTransform-gr4bvVH2.js";var h,g,_,v,y=e((()=>{u(),l(),d(),h=[{name:`adaptive`,type:`string`,option:[`planeAlways`,`planeSm`,`planeMd`,`planeLg`,`planeXl`,`plane2xl`]},{name:`animationHeadPosition`,type:`string`,option:[`top`,`toBottom`]},{name:`animationShow`,type:`boolean`},{name:`ariaDescribedby`,type:`string`},{name:`ariaLabelledby`,type:`string`},{name:`autoClose`,type:`boolean`},{name:`clickOpen`,type:`boolean`},{name:`ignore`,type:`string | HTMLElement`},{name:`ignoreSelector`,type:`string`},{name:`inDom`,type:`boolean`},{name:`modelOpen`,type:`boolean`},{name:`onUpdate:modelOpen`,type:`(value: boolean) => void`},{name:`onUpdate:open`,type:`(value: boolean) => void`},{name:`open`,type:`boolean`},{name:`section`,type:`boolean`},{name:`tagBody`,type:`string`}],g=[{name:`body`,description:`Body slot for content/ Слот тела для содержимого`,properties:[{name:`props`,type:`MotionTransformControlItem`}]},{name:`head`,description:`Head slot for controls/ Слот шапки для элементов управления`,properties:[{name:`props`,type:`MotionTransformControlItem`}]}],_=[{name:`transform`,properties:[{name:`event`,type:`Event`},{name:` options`,type:`MotionTransformEmitOptions`}]},{name:`transformLite`,properties:[{name:`options`,type:`MotionTransformEmitOptions`}]},{name:`update:modelOpen`,description:`Update model open event/ Событие обновления открытия модели`,properties:[{name:`value`,type:`boolean`}]},{name:`update:open`,description:`Update open event/ Событие обновления открытия`,properties:[{name:`value`,type:`boolean`}]}],v={component:`MotionTransform`,props:h,slots:g,events:_,defaults:p,wikiDesign:c}})),b,x=e((()=>{u(),i(),y(),b=new a(v.component,v.props,v.defaults,v.wikiDesign,s,o)})),S=t({MotionTransform:()=>w,MotionTransformAnimationHeadPosition:()=>D,MotionTransformIgnore:()=>E,MotionTransformVModel:()=>T,__namedExportsOrder:()=>O,default:()=>C}),C,w,T,E,D,O,k=e((()=>{f(),x(),r(),C={title:`Ui/MotionTransform`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1MotionTransform:m},setup:()=>({args:e}),template:`
