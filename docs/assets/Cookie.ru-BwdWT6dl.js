...
`,e.jsx(n.p,{children:"Создайте экземпляр, передав имя куки, которым вы хотите управлять."}),`
...
`,e.jsxs(n.p,{children:["Внутри ",e.jsx(n.code,{children:"Cookie"})," регистрирует все созданные экземпляры в общем словаре ",e.jsx(n.code,{children:"items"}),". Если вы создадите ",e.jsx(n.code,{children:"new Cookie('auth')"})," в двух разных файлах, они будут корректно использовать и обновлять один и тот же базовый экземпляр в памяти."]})]})}function j(s={}){const{wrapper:n}={...c(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{j as default};
