...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`get(): WebTypesTagItem | undefined`}),` — возвращает консолидированное определение тега, содержащее имя, описание, источник и атрибуты.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAttribute(item: WikiStorybookProp): WebTypesAttributeItem`}),` — преобразует отдельное свойство Storybook в определение атрибута Web-Types.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getAttributes(): WebTypesAttributes`}),` — компилирует полный список атрибутов для компонента.`]}),`
`]}),`
