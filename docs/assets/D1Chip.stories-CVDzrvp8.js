import{d as l,_ as i}from"./D1Chip-NnA-zfoO.js";import{w as m,W as d,a as c,b as p}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";import{_ as b}from"./D1Skeleton-LvRPzgGQ.js";const y=[{name:"adaptive",type:"string",option:["iconAlways","block","auto","iconSm","iconMd","iconLg","iconXl","icon2xl","fullSm","fullMd","fullLg","fullXl","full2xl"]},{name:"ariaLabel",type:"string"},{name:"assistive",type:"boolean"},{name:"container",type:"string",option:["iconSm","iconMd","iconLg","iconXl","icon2xl","fullSm","fullMd","fullLg","fullXl","full2xl"]},{name:"detail",type:"Record<string, any>"},{name:"disabled",type:"boolean"},{name:"focus",type:"boolean"},{name:"grid",type:"boolean"},{name:"href",type:"string"},{name:"icon",type:"IconValue<Icon>"},{name:"iconAttrs",type:"ConstrBind<Icon>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTrailing",type:"IconValue<Icon>"},{name:"iconTrailingDirOnly",type:"boolean"},{name:"iconTrailingPalette",type:"boolean"},{name:"iconTrailingTurnOnly",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"input",type:"boolean"},{name:"inverse",type:"boolean"},{name:"isSkeleton",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"loading",type:"boolean | ConstrBind<Progress>"},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"readonly",type:"boolean"},{name:"roundedFull",type:"boolean"},{name:"selected",type:"boolean"},{name:"size",type:"string",option:["sm","md","lg"]},{name:"tag",type:"string",option:["button","a","span"]},{name:"textAlign",type:"string",option:["left","center","right"]},{name:"to",type:"string | RouteLocationAsRelativeGeneric | RouteLocationAsPathGeneric"},{name:"type",type:"string",option:["button","submit","reset"]},{name:"value",type:"EventClickValue['value']"}],a={component:"Chip",props:y,defaults:l,wikiDesign:m},k=new d(a.component,a.props,a.defaults,a.wikiDesign,c,p),v={title:"Ui/Chip",component:i,parameters:{design:"d1",docs:{description:{component:k.getDescription()}}},argTypes:k.getWiki(),args:k.getValues()},e={},o={name:"Базовые",render:()=>({components:{D1Chip:i},template:`
    ...
    `})},r={name:"Скелетон",render:()=>({components:{D1Chip:i,D1Skeleton:b},template:`
        <div class="wiki-storybook-group">
          <div class="wiki-storybook-item wiki-storybook-item--squared--sm wiki-storybook-item--center">
...
}`,...r.parameters?.docs?.source}}};const w=["Chip","ChipBasic","ChipInput","ChipAssistive","ChipAdaptive","ChipSkeleton"],g=Object.freeze(Object.defineProperty({__proto__:null,Chip:e,ChipAdaptive:n,ChipAssistive:s,ChipBasic:o,ChipInput:t,ChipSkeleton:r,__namedExportsOrder:w,default:v},Symbol.toStringTag,{value:"Module"}));export{g as C,e as a,k as b,o as c,t as d,s as e,n as f,r as g};
