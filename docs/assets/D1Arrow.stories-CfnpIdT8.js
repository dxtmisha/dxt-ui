import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Dt as n,nn as r}from"./library-BfcLFF_v.js";import{d as i,i as a,l as o,m as s,n as c,t as l,u}from"./wiki-BHyzKkJP.js";import{i as d,n as f,r as p,t as m}from"./D1Arrow-CGi1bFUD.js";var h,g,_,v;function y(){return(y=e((()=>{l(),d(),h=[{name:`clientOnly`,type:`boolean`},{name:`elementTarget`,type:`string | HTMLElement`},{name:`position`,type:`string`,option:[`auto`,`top`,`bottom`,`left`,`right`]},{name:`size`,type:`string`,option:[`sm`,`md`,`lg`]}],g=[],_=[],v={component:`Arrow`,props:h,slots:g,events:_,defaults:p,wikiDesign:c}})))()}var b;function x(){return(x=e((()=>{i(),o(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,a,s)})))()}var S=t({Arrow:()=>w,ArrowBasic:()=>T,__namedExportsOrder:()=>E,default:()=>C}),C,w,T,E;function D(){return(D=e((()=>{f(),x(),n(),C={title:`Ui/Arrow`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Arrow:m},setup:()=>({args:e}),template:`
...
}`,...T.parameters?.docs?.source}}},E=[`Arrow`,`ArrowBasic`]})))()}export{b as a,D as i,T as n,x as o,S as r,w as t};