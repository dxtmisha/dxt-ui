import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional/Composables/useApiPost - POST Request Execution` }), `
`, (0, c.jsx)(n.h1, { id: `useapipost`, children: (0, c.jsx)(n.code, { children: `useApiPost` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Trả về một đối tượng với trạng thái tải và phương thức `, (0, c.jsx)(n.code, { children: `send` }), ` để thực hiện các yêu cầu API `, (0, c.jsx)(n.code, { children: `POST` }), `. Đây là một trình bao bọc tiện lợi trên `, (0, c.jsx)(n.code, { children: `useApiRequest` }), ` được điền sẵn phương thức `, (0, c.jsx)(n.code, { children: `POST` }), `. Nhận các thiết lập dưới dạng một đối tượng `, (0, c.jsx)(n.code, { children: `UseApiPostSetup` }), ` duy nhất.`] }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Tham số:` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setup: UseApiPostSetup` }), ` — Đối tượng thiết lập cấu hình:`, `
`, (0, c.jsxs)(n.ul, { children: [`
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `send(request?: Request): Promise<Return | undefined>` }), ` — Phương thức bất đồng bộ để gửi yêu cầu `, (0, c.jsx)(n.code, { children: `POST` }), `. Nó tự động quản lý trạng thái `, (0, c.jsx)(n.code, { children: `loading` }), `, xác thực hợp đồng yêu cầu và phản hồi, áp dụng hàm biến đổi cho phản hồi, thực hiện callback `, (0, c.jsx)(n.code, { children: `action` }), ` khi thành công và xử lý lỗi một cách an toàn bằng cách ghi log ra console.`] }), `
`] }), `
