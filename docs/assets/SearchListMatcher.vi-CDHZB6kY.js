import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/SearchListMatcher - Logic So khớp Tìm kiếm` }), `
...
`, (0, c.jsxs)(n.p, { children: [`Lớp này chủ yếu sử dụng kiểu gốc `, (0, c.jsx)(n.code, { children: `RegExp` }), ` và logic nội bộ được quản lý bởi `, (0, c.jsx)(n.code, { children: `SearchListOptions` }), `.`] })] })
