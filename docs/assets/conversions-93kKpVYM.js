...
`})}),`
`,e.jsx(n.h2,{id:"blobtobase64",children:e.jsx(n.code,{children:"blobToBase64"})}),`
`,e.jsx(n.p,{children:"Converts a Blob to a Base64 string (data URL)."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"blob: Blob"})," — Blob object to convert"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { blobToBase64 } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h2,{id:"encodeattribute",children:e.jsx(n.code,{children:"encodeAttribute"})}),`
`,e.jsxs(n.p,{children:["Encodes special characters in a string for safe use in HTML attributes. Converts characters ",e.jsx(n.code,{children:"&"}),", ",e.jsx(n.code,{children:"<"}),", ",e.jsx(n.code,{children:">"}),", ",e.jsx(n.code,{children:'"'}),", ",e.jsx(n.code,{children:"'"})," into corresponding HTML entities to prevent XSS attacks and ensure correct display."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"text: string"})," — text to encode"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { encodeAttribute } from '@dxtmisha/functional'
...
`})}),`
`,e.jsx(n.h2,{id:"resizeimagebymax",children:e.jsx(n.code,{children:"resizeImageByMax"})}),`
`,e.jsx(n.p,{children:"Resizes an image to fit within a maximum size constraint."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"image: HTMLImageElement | string"})," — image element or URL"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"maxSize: number"})," — maximum size for width or height"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"type: 'auto' | 'width' | 'height'"})," — resize type (default 'auto')"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"typeData?: string"})," — data type for the resulting image (e.g., 'image/png', 'image/jpeg')"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { resizeImageByMax } from '@dxtmisha/functional'
