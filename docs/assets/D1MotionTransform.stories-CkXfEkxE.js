import{d,_ as i}from"./D1MotionTransform-2sz4JbnR.js";import{w as l,W as p,a as m,b as c}from"./wiki-BeTUR4cU.js";import{r as h}from"./iframe-okvuAVTt.js";import"./jsx-runtime-u17CrQMm.js";const g=[{name:"adaptive",type:"string",option:["planeAlways","planeSm","planeMd","planeLg","planeXl","plane2xl"]},{name:"animationHeadPosition",type:"string",option:["top","toBottom"]},{name:"animationShow",type:"boolean"},{name:"ariaDescribedby",type:"string"},{name:"ariaLabelledby",type:"string"},{name:"autoClose",type:"boolean"},{name:"clickOpen",type:"boolean"},{name:"ignore",type:"string | HTMLElement"},{name:"ignoreSelector",type:"string"},{name:"inDom",type:"boolean"},{name:"modelOpen",type:"boolean"},{name:"onUpdate:modelOpen",type:"(value: boolean) => void"},{name:"onUpdate:open",type:"(value: boolean) => void"},{name:"open",type:"boolean"},{name:"section",type:"boolean"},{name:"tagBody",type:"string"}],a={component:"MotionTransform",props:g,defaults:d,wikiDesign:l},s=new p(a.component,a.props,a.defaults,a.wikiDesign,m,c),u={title:"Ui/MotionTransform",component:i,parameters:{design:"d1",docs:{description:{component:s.getDescription()}}},argTypes:s.getWiki(),args:s.getValues()},e={render:r=>({components:{D1MotionTransform:i},setup:()=>({args:r}),template:`
