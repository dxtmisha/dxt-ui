...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isScreenshot()`}),` — Checks if `,(0,c.jsx)(t.code,{children:`ai-screenshot`}),` directory exists.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isDeveloper()`}),` — Checks if `,(0,c.jsx)(t.code,{children:`ai-developer.md`}),` file exists.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isMcp()`}),` — Checks if MCP server resources exist.`]}),`
`]}),`
`,(0,c.jsx)(t.hr,{}),`
`,(0,c.jsx)(t.h3,{id:`public--protected-helpers`,children:`Public & Protected Helpers`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getProjectName(): string`}),` — Reads project name from local `,(0,c.jsx)(t.code,{children:`package.json`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getDir(): string[]`}),` — Returns directory path segments array for the module.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getMcp(): Record<string, any>[] | undefined`}),` — Reads and returns MCP server resources configuration.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypes(): string | undefined`}),` — Copies the module types file into the root `,(0,c.jsx)(t.code,{children:`ai-types`}),` folder using the project name and formats the link to the copy.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesFileName(): string`}),` — Returns the copied types file name based on the project name.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesPath(): string[]`}),` — Returns the path to the copied types file in the root `,(0,c.jsx)(t.code,{children:`ai-types`}),` directory.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`copyTypes(targetPath: string[]): void`}),` — Copies the module types file into the destination `,(0,c.jsx)(t.code,{children:`ai-types`}),` directory.`]}),`
