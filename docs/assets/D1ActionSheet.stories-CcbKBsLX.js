import{n as e,r as t}from"./chunk-BneVvdWh.js";import{Ht as n,J as r,Rt as i,St as a,_t as o,bt as s,f as c,kt as l,nt as u,r as d,wt as f,xt as p,yt as m}from"./iframe-DHvUfpTv.js";import{a as h,d as g,f as _,g as v,l as y,n as b,p as x,t as ee,u as S}from"./wiki-COBgMBNI.js";import{i as C,n as w,t as te}from"./ModalDesignAbstract-BaVdtb1N-oFRuX-d3.js";var T,E,D=e((()=>{_(),o(),c(),T=80,E=class{constructor(e,t,n,r){x(this,`touche`,i()),x(this,`toucheMove`,i()),x(this,`mouse`,i()),x(this,`mouseMove`,i()),x(this,`onTouch`,{onTouchstart:e=>{this.touche.value=e.targetTouches?.[0],this.mouse.value={x:this.touche.value?.clientX??0,y:this.touche.value?.clientY??0},this.update(e.target)},onTouchend:e=>this.reset(e.target),onTouchcancel:e=>this.reset(e.target),onTouchmove:e=>{this.toucheMove.value=e.targetTouches?.[0],this.mouseMove.value={x:this.toucheMove.value?.clientX??0,y:this.toucheMove.value?.clientY??0},this.updateMove(e.target)}}),x(this,`onMouse`,{onMousedown:e=>{this.mouse.value={x:e.clientX,y:e.clientY},this.update(e.target)},onMouseup:e=>this.reset(e.target),onMousemove:e=>{this.mouseMove.value={x:e.clientX,y:e.clientY},this.updateMove(e.target)}}),this.start=e,this.move=t,this.end=n,this.element=r}getElement(e){return this.element?.value??e.closest(`[data-touch]`)}getTypeX(e){return e>=T?`right`:e<-T?`left`:`none`}getTypeY(e){return e>=T?`bottom`:e<-T?`top`:`none`}async callback(e){let t=this.mouse.value,n=this.mouseMove.value;if(t&&n){let i=n.x-t.x,a=n.y-t.y;if(!e||await r(e(this.getTypeX(i),this.getTypeY(a),i,a,t,n,this.touche.value,this.toucheMove.value)))return{x:i,y:a}}}reset(e){let t=this.getElement(e);this.callback(this.end).then(e=>{t&&(e?this.resetData(t):setTimeout(()=>this.resetData(t),400))})}resetData(e){this.touche.value=void 0,this.toucheMove.value=void 0,this.mouse.value=void 0,this.mouseMove.value=void 0,e.style.removeProperty(`--sys-touch-start-x`),e.style.removeProperty(`--sys-touch-start-y`),e.style.removeProperty(`--sys-touch-move-x`),e.style.removeProperty(`--sys-touch-move-y`)}update(e){let t=this.getElement(e),n=this.mouse.value;t&&n&&(t.style.setProperty(`--sys-touch-start-x`,`${n.x}px`),t.style.setProperty(`--sys-touch-start-y`,`${n.y}px`),r(this.start?.call(this,n,this.touche.value)).then())}updateMove(e){let t=this.getElement(e);this.callback(this.move).then(e=>{t&&e&&(t.style.setProperty(`--sys-touch-move-x`,`${e.x}px`),t.style.setProperty(`--sys-touch-move-y`,`${e.y}px`))})}}})),O,k,A,j=e((()=>{_(),D(),w(),o(),c(),O=class extends te{constructor(e,t,n,r,i,a,o,s,c){let{TouchEventIncludeConstructor:l=E}=c??{};super(e,t,n,r,i,a,o,s,m(()=>({open:e.open,adaptive:`actionSheet`,closeButton:e.barsBackHide,closeMobileHide:e.touchClose})),void 0,{align:`auto`},c),x(this,`touchEvent`,void 0),this.props=e,this.refs=t,this.element=n,this.classDesign=r,this.className=i,this.components=a,this.slots=o,this.emits=s,this.touchEvent=new l(void 0,(e,t,n,r)=>r>=0,(e,t)=>t===`bottom`?(this.window.expose.setOpen(!1).then(),!1):!0)}},k={barsBackHide:!0,touchClose:!0},A=class extends C{constructor(...e){super(...e),x(this,`renderTitleTouch`,e=>{let t=this.renderTitle(e);return this.props.touchClose?[a(`div`,{class:this.classes?.value.touch,...this.item.touchEvent.onTouch},[a(`div`,{class:this.classes?.value.tab}),...t])]:t})}initItem(){return new O(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits)}initClasses(){return{main:{},title:this.getSubClass(`title`),header:this.getSubClass(`header`),body:this.getSubClass(`body`),footer:this.getSubClass(`footer`),touch:this.getSubClass(`touch`),tab:this.getSubClass(`tab`)}}initRender(){return this.item.window.render({control:this.renderControl,title:this.renderTitleTouch,default:this.renderDefault,footer:this.renderFooter},d({class:this.classes?.value.main,"data-touch":`touch`},this.getAttrs()))}}})),M,N,P=e((()=>{j(),M={width:[`sm`,`md`,`lg`,`auto`]},N={...k,width:`md`}})),F=e((()=>{})),I,L=e((()=>{o(),c(),j(),P(),F(),I=p({name:`D1ActionSheet`,__name:`D1ActionSheet`,props:f({disabled:{type:Boolean},autoClose:{type:Boolean},windowAttrs:{},barsLabel:{},barsDescription:{},barsBackHide:{type:Boolean},barsHide:{type:Boolean},barsList:{},barsAttrs:{},actionsHide:{type:Boolean},actionsList:{},actionsSecondary:{},actionsAttrs:{},open:{type:Boolean},touchClose:{type:Boolean},width:{}},N),emits:[`window`,`bars`,`barsLite`,`barsBack`,`actions`,`actionsLite`],setup(e,{expose:t,emit:r}){let i=r,a=e,o=new A(`d1.actionSheet`,a,{emits:i,classes:m(()=>({main:{"d1-actionSheet":!0,[`d1-actionSheet--width--${a.width}`]:u(M.width,a.width)}})),styles:m(()=>({}))}),c=o.render();return t(o.expose()),(e,t)=>(l(),s(n(c)))}})})),R,z=e((()=>{L(),L(),R=I,I.__docgenInfo=Object.assign({displayName:I.name??I.__name},{name:`D1ActionSheet`,exportName:`default`,displayName:`D1ActionSheet`,description:``,tags:{},sourceFiles:[`/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/ActionSheet/D1ActionSheet.vue`]})})),B,V,H,U,W=e((()=>{S(),ee(),P(),B=[{name:`actionsAttrs`,type:`ConstrBind<ActionsPropsBasic>`},{name:`actionsHide`,type:`boolean`},{name:`actionsList`,type:`ConstrBind<ConstrBind<ButtonPropsBasic>[]>`},{name:`actionsSecondary`,type:`ConstrBind<ConstrBind<ButtonPropsBasic>[]>`},{name:`autoClose`,type:`boolean`},{name:`barsAttrs`,type:`ConstrBind<BarsPropsBasic>`},{name:`barsBackHide`,type:`boolean`},{name:`barsDescription`,type:`string`},{name:`barsHide`,type:`boolean`},{name:`barsLabel`,type:`string | number`},{name:`barsList`,type:`ConstrBind<ButtonPropsBasic>[]`},{name:`disabled`,type:`boolean`},{name:`open`,type:`boolean`},{name:`touchClose`,type:`boolean`},{name:`width`,type:`string`,option:[`sm`,`md`,`lg`,`auto`]},{name:`windowAttrs`,type:`ConstrBind<WindowPropsBasic>`}],V=[{name:`control`,description:`Control slot for window management/
...
Слот заголовка для шапки окна`,properties:[{name:`props`,type:`WindowControlItem`}]}],H=[{name:`actions`,description:`Click event for actions/ Событие клика для действий`,properties:[{name:`event`,type:`MouseEvent`},{name:`value`,type:`EventClickValue`}]},{name:`actionsLite`,description:`Simple click event for actions/ Простое событие клика для действий`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`bars`,description:`Click event for bars/ Событие клика для панелей`,properties:[{name:`event`,type:`MouseEvent`},{name:`value`,type:`EventClickValue`}]},{name:`barsBack`,description:`Back button click event for bars/ Событие клика кнопки назад для панелей`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`barsLite`,description:`Simple click event for bars/ Простое событие клика для панелей`,properties:[{name:`value`,type:`EventClickValue`}]},{name:`window`,description:`Window event triggered on state change/ Событие окна при изменении состояния`,properties:[{name:`options`,type:`WindowEmitOptions`}]}],U={component:`ActionSheet`,props:B,slots:V,events:H,defaults:N,wikiDesign:b}})),G,K=e((()=>{S(),h(),W(),G=new g(U.component,U.props,U.defaults,U.wikiDesign,y,v)})),q=t({ActionSheet:()=>Y,ActionSheetAllSlots:()=>Z,ActionSheetVModel:()=>X,__namedExportsOrder:()=>Q,default:()=>J}),J,Y,X,Z,Q,$=e((()=>{z(),K(),o(),J={title:`Ui/ActionSheet`,component:R,parameters:{design:`d1`,docs:{description:{component:G.getDescription()}}},argTypes:G.getWiki(),args:G.getValues()},Y={render:e=>({components:{D1ActionSheet:R},setup:()=>({args:e}),template:`
    ...
    `})},X={name:`Двусторонняя привязка (v-model)`,render:()=>({components:{D1ActionSheet:R},setup(){return{open:i(!1)}},template:`
...
}`,...Z.parameters?.docs?.source}}},Q=[`ActionSheet`,`ActionSheetVModel`,`ActionSheetAllSlots`]}));$();export{Y as ActionSheet,Z as ActionSheetAllSlots,X as ActionSheetVModel,Q as __namedExportsOrder,J as default,K as i,$ as n,G as r,q as t};