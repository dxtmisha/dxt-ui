import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/GeoFlag - Cờ các quốc gia` }), `
...
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `getList(codes?: string[], sort: boolean = true): GeoFlagItem[]` }), ` — Trả về một mảng dữ liệu quốc gia. Mặc định sắp xếp theo bảng chữ cái.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `getNational(codes?: string[], sort: boolean = true): GeoFlagNational[]` }), ` — Trả về danh sách các quốc gia với tên quốc gia gốc. Mặc định sắp xếp theo bảng chữ cái.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `phoneCode` }), `: string — Mã điện thoại quốc gia (ví dụ: `, (0, c.jsx)(n.code, { children: `+1` }), `, `, (0, c.jsx)(n.code, { children: `+7` }), `).`] }), `
`] }), `
