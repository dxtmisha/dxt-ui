import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { t as r } from './mdx-react-shim-B1U8VZv0.js'; function i(e) {
  let n = { a: `a`, code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }, { Meta: r } = n; return r || o(`Meta`, !0), (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(r, { title: `@dxtmisha/en/functional/Composables/useApiRef - API Requests` }), `
...
`, (0, s.jsxs)(n.li, { children: [(0, s.jsx)(n.code, { children: `errorContract?: ApiErrorStorageList` }), ` — storage of response error contracts.`] }), `
...
`, (0, s.jsxs)(n.li, { children: [(0, s.jsx)(n.code, { children: `errorItem: ComputedRef<ApiErrorItem | undefined>` }), ` — current error object if the request failed.`] }), `
