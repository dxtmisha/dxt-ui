...
`,(0,c.jsxs)(n.p,{children:[`Để đảm bảo hoạt động chính xác ở phía máy chủ (SSR), phương thức `,(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`initSsr()`})}),` phải được sử dụng.`]}),`
`,(0,c.jsxs)(n.h3,{id:`phương-thức-initssr`,children:[`Phương thức `,(0,c.jsx)(n.code,{children:`initSsr()`})]}),`
`,(0,c.jsxs)(n.p,{children:[`Khi được gọi trong `,(0,c.jsx)(n.code,{children:`setup()`}),` của một component, nó đảm bảo dữ liệu được tải trên máy chủ trước khi render trang và được áp dụng ngay lập tức ở phía máy khách.`]}),`
...
initSsr()
`})}),`
`,(0,c.jsxs)(n.h3,{id:`tự-động-hóa-qua-asyncref`,children:[`Tự động hóa qua `,(0,c.jsx)(n.code,{children:`AsyncRef`})]}),`
`,(0,c.jsxs)(n.p,{children:[`Để tránh việc gọi `,(0,c.jsx)(n.code,{children:`initSsr()`}),` thủ công, bạn có thể sử dụng phiên bản bất đồng bộ — `,(0,c.jsx)(n.a,{href:`./useApiAsyncRef.vi.mdx`,children:(0,c.jsx)(n.strong,{children:(0,c.jsx)(n.code,{children:`useApiAsyncRef`})})}),`. Nó tự động gọi `,(0,c.jsx)(n.code,{children:`initSsr()`}),` khi được tạo.`]}),`
