import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/scripts/Classes/StylesToMedia - Trình tạo truy vấn Media` }), `
`, (0, c.jsx)(n.h1, { id: `lớp-stylestomedia`, children: `Lớp StylesToMedia` }), `
`, (0, c.jsxs)(n.p, { children: [`Lớp `, (0, c.jsx)(n.code, { children: `StylesToMedia` }), ` chịu trách nhiệm tạo các truy vấn CSS `, (0, c.jsx)(n.code, { children: `@media` }), ` từ các thuộc tính thiết kế. Nó triển khai logic để bao bọc các quy tắc style lồng nhau bên trong một khối truy vấn media.`] }), `
`, (0, c.jsx)(n.h2, { id: `các-tính-năng-chính`, children: `Các tính năng chính` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Bao bọc truy vấn Media` }), ` — Tự động bao bọc nội dung style được tạo bên trong một quy tắc `, (0, c.jsx)(n.code, { children: `@media screen and ...` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Phân giải truy vấn động` }), ` — Sử dụng tên thuộc tính thiết kế để định nghĩa điều kiện của truy vấn media.`] }), `
...
`, (0, c.jsxs)(n.p, { children: [`Khởi tạo trình chuyển đổi `, (0, c.jsx)(n.code, { children: `StylesToMedia` }), ` với thuộc tính bắt buộc và một hàm gọi nội dung cho các quy tắc lồng nhau.`] }), `
