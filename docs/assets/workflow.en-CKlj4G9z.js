...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Special Tags`}),` — Use tags that the generator preserves in `,(0,c.jsx)(t.code,{children:`ai-types.md`}),`:`,`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`@remarks`}),` — Expanded technical rationale for complex logic.
`,(0,c.jsxs)(t.em,{children:[`(Search tags `,(0,c.jsx)(t.code,{children:`@keywords`}),` do not need to be written manually — the `,(0,c.jsx)(t.code,{children:`dxt-types`}),` generator synthesizes them automatically via AI in Step 3).`]})]}),`
`]}),`
`]}),`
`]}),`
