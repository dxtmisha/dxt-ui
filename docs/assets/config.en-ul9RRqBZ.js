...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiType`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`, default: `,(0,c.jsx)(t.code,{children:`'gemini'`}),`) — AI provider backend for JSDoc normalization and summary generation (see `,(0,c.jsx)(t.em,{children:`«11. Supported AI Providers»`}),` for full reference). Supported options:`,`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`gemini-cli`}),` — Local Gemini CLI invocations (`,(0,c.jsx)(t.code,{children:`gemini`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`antigravity-cli`}),` — Google Antigravity CLI invocations (`,(0,c.jsx)(t.code,{children:`agy`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude`}),` — Official Anthropic Claude API (via `,(0,c.jsx)(t.code,{children:`@anthropic-ai/sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-cli`}),` — Terminal Claude Code CLI invocations (`,(0,c.jsx)(t.code,{children:`claude`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-agent`}),` — Autonomous agent mode via Anthropic Claude Agent SDK (`,(0,c.jsx)(t.code,{children:`@anthropic-ai/claude-agent-sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`openai`}),` — OpenAI models (GPT-4o, GPT-4o-mini, and compatible endpoints).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`zai`}),` — xAI Grok models (via `,(0,c.jsx)(t.code,{children:`@ai-sdk/xai`}),` and Vercel AI SDK).`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiModel`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`) — Model identifier string (e.g., `,(0,c.jsx)(t.code,{children:`gemini-3.7-flash`}),`, `,(0,c.jsx)(t.code,{children:`gpt-4o`}),`, `,(0,c.jsx)(t.code,{children:`claude-3-7-sonnet`}),`, `,(0,c.jsx)(t.code,{children:`grok-4.5`}),`).`]}),`
