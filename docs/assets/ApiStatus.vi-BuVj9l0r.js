...
`,n.jsxs(t.p,{children:["Để khởi tạo đối tượng, hãy gọi hàm khởi tạo ",n.jsx(t.code,{children:"ApiStatus()"}),"."]}),`
`,n.jsx(t.pre,{children:n.jsx(t.code,{className:"language-typescript",children:`import { ApiStatus } from '@dxtmisha/functional'
...
`]})]})}function u(i={}){const{wrapper:t}={...s(),...i.components};return t?n.jsx(t,{...i,children:n.jsx(h,{...i})}):h(i)}export{u as default};
