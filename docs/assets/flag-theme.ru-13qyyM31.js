import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/# UI/properties/flags/Тема (theme)` }), `
`, (0, c.jsx)(n.h1, { id: `тема-theme`, children: `Тема (theme)` }), `
`, (0, c.jsxs)(n.p, { children: [`Флаг `, (0, c.jsx)(n.code, { children: `_theme` }), ` позволяет ограничить область действия стилей конкретной цветовой темой. Стили будут сгенерированы только внутри селектора соответствующей темы.`] }), `
