...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Работа через CLI`}),` — выполняет запросы путем формирования и запуска системных команд оболочки.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Окружение`}),` — зависит от доступности функции `,(0,c.jsx)(t.code,{children:`exec`}),` и файловой системы для хранения временных данных.`]}),`
