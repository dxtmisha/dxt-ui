import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/nitro-basic/Functions/initClientRouter - Ожидание готовности роутера` }), `
`, (0, c.jsx)(n.h1, { id: `initclientrouter`, children: (0, c.jsx)(n.code, { children: `initClientRouter` }) }), `
`, (0, c.jsx)(n.p, { children: `Асинхронная функция, которая ожидает инициализацию и полную готовность маршрутизатора Vue. Это гарантирует, что все асинхронные компоненты и начальные хуки навигации разрешены перед тем, как приложение продолжит выполнение (например, перед гидратацией на клиенте или рендерингом на сервере).` }), `
