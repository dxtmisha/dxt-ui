import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional/Composables/useQueryRef - Quản lý Query parameters` }), `
`, (0, c.jsx)(n.h1, { id: `usequeryref`, children: (0, c.jsx)(n.code, { children: `useQueryRef` }) }), `
`, (0, c.jsx)(n.p, { children: `Một composable để làm việc với các tham số truy vấn URL (GET parameters). Nó cho phép tạo các biến phản ứng tự động đồng bộ hóa với một khóa cụ thể trong chuỗi truy vấn.` }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Tham số:` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `name: string` }), ` — Tên khóa trong query string.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `defaultValue?: T | (() => T)` }), ` — Giá trị mặc định nếu khóa không tồn tại trong query string.`] }), `
`] }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsxs)(n.strong, { children: [`Trả về (`, (0, c.jsx)(n.code, { children: `Ref<T>` }), `):`] }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsx)(n.li, { children: `Một tham chiếu phản ứng đến giá trị trong các tham số truy vấn.` }), `
`] }), `
