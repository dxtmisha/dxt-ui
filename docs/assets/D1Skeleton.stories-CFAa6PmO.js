import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,d as r,l as i,m as a,n as o,r as s,t as c,u as l}from"./wiki-wIqBVsyI.js";import{i as u,n as d,r as f,t as p}from"./D1Skeleton-CTEnVdL2.js";var m,h,g,_;function v(){return(v=e((()=>{c(),u(),m=[{name:`active`,type:`boolean`}],h=[{name:`default`,description:`Slot for default skeleton content/ Слот для основного содержимого скелета`,properties:[{name:`props`,type:`(SkeletonClassesList) | undefined`}]}],g=[],_={component:`Skeleton`,props:m,slots:h,events:g,defaults:f,wikiDesign:o}})))()}var y;function b(){return(b=e((()=>{r(),i(),v(),y=new l(_.component,_.props,_.defaults,_.wikiDesign,s,a)})))()}var x=t({Skeleton:()=>C,SkeletonBasic:()=>w,__namedExportsOrder:()=>T,default:()=>S}),S,C,w,T;function E(){return(E=e((()=>{d(),b(),i(),S={title:`Ui/Skeleton`,component:p,parameters:{design:`d1`,docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},C={render:e=>({components:{D1Skeleton:p},setup:()=>({args:e}),template:`
      <D1Skeleton v-bind="args">
      <div class="wiki-storybook-card d1-skeleton__background">
        <div class="wiki-storybook-card__image d1-skeleton__background" style="background-image: url('${n}')"/>
...
}`,...w.parameters?.docs?.source}}},T=[`Skeleton`,`SkeletonBasic`]})))()}export{y as a,E as i,C as n,b as o,w as r,x as t};