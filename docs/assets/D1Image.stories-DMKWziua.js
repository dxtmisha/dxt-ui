import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{t as n}from"./wikiDescriptions-7XaHU3Yk-B5WkPyHr.js";import{a as r,c as i,d as a,i as o,l as s,n as c,o as l,r as u,s as d,t as f,u as p}from"./wiki-YLJtDFp2.js";import{i as m,n as h,r as g,t as _}from"./D1Image-yH2jXFqT.js";var v,y,b,x,S=e((()=>{f(),m(),v=[{name:`adaptive`,type:`boolean | undefined`},{name:`adaptiveAlways`,type:`boolean | undefined`},{name:`adaptiveGroup`,type:`string | undefined`},{name:`alt`,type:`string | undefined`},{name:`coordinator`,type:`number[] | any`},{name:`disabled`,type:`boolean | undefined`},{name:`fetchPriority`,type:`string`,option:[`auto`,`high`,`low`]},{name:`hide`,type:`boolean | undefined`},{name:`lazy`,type:`boolean | undefined`},{name:`objectHeight`,type:`string | number | undefined`},{name:`objectWidth`,type:`string | number | undefined`},{name:`picture`,type:`ImagePicture | undefined`},{name:`preloadOffset`,type:`string | undefined`},{name:`size`,type:`string | undefined`,option:[`auto`,`contain`,`cover`]},{name:`srcset`,type:`string | Record<string, string> | undefined`},{name:`tagImg`,type:`boolean | undefined`},{name:`turn`,type:`boolean | undefined`},{name:`url`,type:`string | undefined`},{name:`value`,type:`string | any`},{name:`x`,type:`string | number | undefined`},{name:`y`,type:`string | number | undefined`}],y=[],b=[{name:`load`,description:`Event triggered when the image is loaded/ Событие, срабатывающее при загрузке изображения`,properties:[{name:`image`,type:`ImageEventData`}]}],x={component:`Image`,props:v,slots:y,events:b,defaults:g,wikiDesign:c}})),C,w=e((()=>{a(),l(),S(),C=new p(x.component,x.props,x.defaults,x.wikiDesign,r,n)})),T=t({Image:()=>D,ImageAdaptive:()=>j,ImageSize:()=>k,ImageTagImg:()=>A,ImageType:()=>O,__namedExportsOrder:()=>M,default:()=>E}),E,D,O,k,A,j,M,N=e((()=>{h(),w(),l(),E={title:`Ui/Image`,component:_,parameters:{design:`d1`,docs:{description:{component:C.getDescription()}}},argTypes:C.getWiki(),args:C.getValues()},D={render:e=>({components:{D1Image:_},setup:()=>({args:e}),template:`
      <div class="wiki-storybook-item wiki-storybook-item--widescreen wiki-storybook-item--squared--sm">
        <D1Image v-bind="args"/>
      </div>
    `})},O={name:`Тип значения`,render:()=>({components:{D1Image:_},setup(){return{image1:u,demoPdf:s}},template:`
    ...
    `})},k={name:`Отображение`,render:()=>({components:{D1Image:_},setup(){return{image1:u}},template:`
        <div class="wiki-storybook-group">
    ...
    `})},A={name:`Использование тега img`,render:()=>({components:{D1Image:_},setup(){return{image1:u}},template:`
        <div class="wiki-storybook-group">
          <div class="wiki-storybook-item wiki-storybook-item--squared--md">
    ...
    `})},j={name:`Адаптированные изображения`,render:()=>({components:{D1Image:_},setup(){return{phone1:i,phone2:o,phone3:d}},template:`
        <div class="wiki-storybook-group">
          <div class="wiki-storybook-item wiki-storybook-item--squared--md">
