import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional/# Hook phản hồi (Composables)` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `useQueryRef` }), ` — Quản lý phản hồi các tham số truy vấn URL (`, (0, c.jsx)(n.code, { children: `window.location.search` }), `).`] }), `
...
` }) }), `
`, (0, c.jsx)(n.p, { children: `Cách tiếp cận này cho phép bạn xây dựng giao diện một cách khai báo: bạn mô tả dữ liệu nào bạn cần và cách chúng được liên kết, và các hook sẽ đảm nhận tất cả công việc đồng bộ hóa và cập nhật.` })] })
