import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional-basic/Classes/Icons - Управление Иконками` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setConfig(config: IconsConfig): void` }), ` — Обновляет конфигурацию иконок (URL и/или список иконок).`] }), `
`] }), `
...
`, (0, c.jsx)(n.p, { children: `Определение иконки. Может быть:` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `string` }), ` — Прямой контент SVG или путь к файлу SVG.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `Promise<string>` }), ` — Promise, который разрешается в контент SVG (полезно для динамических импортов).`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `() => Promise<string>` }), ` — Фабричная функция, возвращающая Promise (полезно для ленивой загрузки по требованию).`] }), `
`] }), `
`, (0, c.jsx)(n.h3, { id: `iconsconfig`, children: (0, c.jsx)(n.code, { children: `IconsConfig` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Объект конфигурации для метода `, (0, c.jsx)(n.code, { children: `setConfig` }), `:`] }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `url?: string` }), ` — Базовый URL для хранения иконок.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `list?: Record<string, IconsItem>` }), ` — Список иконок для регистрации.`] }), `
`] }), `
...
` }) }), `
`, (0, c.jsx)(n.h3, { id: `отложенная-загрузка`, children: `Отложенная загрузка` }), `
`, (0, c.jsx)(n.pre, { children: (0, c.jsx)(n.code, { className: `language-javascript`, children: `// Пометка как загружаемой
