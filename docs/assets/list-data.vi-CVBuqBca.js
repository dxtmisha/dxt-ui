import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,r as n}from"./lib-BRDOWE9X.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{f as i,s as a}from"./blocks-LSqYfV8h.js";function o(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...n(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(a,{title:`@dxtmisha/vi/functional/7. Quản lý danh sách`}),`
`,(0,c.jsx)(t.h1,{id:`quản-lý-danh-sách`,children:`Quản lý danh sách`}),`
`,(0,c.jsxs)(t.p,{children:[`Lớp `,(0,c.jsx)(t.strong,{children:`ListDataRef`}),` là một trình điều khiển để quản lý các danh sách dữ liệu phức tạp, menu thả xuống và cây trong hệ sinh thái `,(0,c.jsx)(t.strong,{children:`Vue 3`}),`. Nó tự động hóa các tác vụ định kỳ như lọc, chọn mục, quản lý tiêu điểm và làm việc với các cấu trúc lồng nhau.`]}),`
`,(0,c.jsx)(t.h2,{id:`khởi-tạo-và-dữ-liệu`,children:`Khởi tạo và Dữ liệu`}),`
`,(0,c.jsx)(t.p,{children:`Trình điều khiển chấp nhận các nguồn dữ liệu phản hồi và cung cấp các bộ thuộc tính được tối ưu hóa để kết xuất các thành phần.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`lựa-chọn-và-trạng-thái`,children:`Lựa chọn và Trạng thái`}),`
`,(0,c.jsx)(t.p,{children:`Tự động quản lý lựa chọn nhiều hoặc một mục, có tính đến các giới hạn và trạng thái địa phương hiện tại.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`điều-hướng-và-tiêu-điểm`,children:`Điều hướng và Tiêu điểm`}),`
`,(0,c.jsx)(t.p,{children:`Trình điều khiển cung cấp một hệ thống các phương thức để di chuyển "thông minh" qua danh sách. Điều hướng tự động bỏ qua các phần tử không hoạt động và các tiêu đề nhóm, chỉ làm việc với các mục có sẵn để lựa chọn.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`làm-việc-với-các-cấu-trúc-lồng-nhau`,children:`Làm việc với các cấu trúc lồng nhau`}),`
`,(0,c.jsxs)(t.p,{children:[`Để xử lý các nhóm hoặc cấu trúc dạng cây, phương thức `,(0,c.jsx)(t.code,{children:`getSubList()`}),` được sử dụng. Nó tạo ra một phiên bản trình điều khiển mới cho dữ liệu lồng nhau trong khi vẫn duy trì liên kết toàn cầu với các trạng thái tiêu điểm và lựa chọn.`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-javascript`,children:`// Bên trong một thành phần nhóm hoặc menu thả xuống:
