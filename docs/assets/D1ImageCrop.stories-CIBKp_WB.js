import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Dt as n,nn as r}from"./library-BfcLFF_v.js";import{d as i,i as a,l as o,m as s,n as c,o as l,t as u,u as d}from"./wiki-BHyzKkJP.js";import{i as f,n as p,r as m,t as h}from"./D1ImageCrop-CGd-4prb.js";var g,_,v,y;function b(){return(b=e((()=>{u(),f(),g=[{name:`alt`,type:`string`},{name:`cropAreaAttrs`,type:`ConstrBind<CropAreaProps>`},{name:`disabled`,type:`boolean`},{name:`image`,type:`string | ConstrBind<ImageProps>`},{name:`imageAttrs`,type:`ConstrBind<ImageProps>`},{name:`modelValue`,type:`Value`},{name:`onUpdate:modelValue`,type:`((value: any) => void)`},{name:`onUpdate:value`,type:`((value: any) => void)`},{name:`readonly`,type:`boolean`},{name:`value`,type:`CropAreaCoordinator`}],_=[{name:`default`,description:`Default slot / Слот по умолчанию`,properties:[{name:`props`,type:`(any) | undefined`}]}],v=[{name:`load`,description:`Event triggered when the image is loaded/ Событие, срабатывающее при загрузке изображения`,properties:[{name:`image`,type:`ImageEventData`}]},{name:`resize`,description:`Event emitted during resizing or moving / Событие, вызываемое при изменении размера или перемещении`,properties:[{name:`parameters`,type:`CropAreaEventParameters`}]},{name:`update:modelValue`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`any`}]},{name:`update:value`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`any`}]}],y={component:`ImageCrop`,props:g,slots:_,events:v,defaults:m,wikiDesign:c}})))()}var x;function S(){return(S=e((()=>{i(),o(),b(),x=new d(y.component,y.props,y.defaults,y.wikiDesign,a,s)})))()}var C=t({ImageCrop:()=>T,ImageCropVModel:()=>E,__namedExportsOrder:()=>D,default:()=>w}),w,T,E,D;function O(){return(O=e((()=>{p(),S(),n(),o(),w={title:`Ui/ImageCrop`,component:h,parameters:{design:`d1`,docs:{description:{component:x.getDescription()}}},argTypes:x.getWiki(),args:x.getValues()},T={render:e=>({components:{D1ImageCrop:h},setup:()=>({args:e}),template:`
      <D1ImageCrop
      ...
      v-bind="args"
    />
    `})},E={name:`v-model`,render:()=>({components:{D1ImageCrop:h},setup(){return{image1:l,coordinator:r([15,20,15,20])}},template:`
