...
`,n.jsxs(c.p,{children:["Để khởi tạo đối tượng, hãy gọi hàm khởi tạo ",n.jsx(c.code,{children:"DataStorage(name, isSession)"}),"."]}),`
`,n.jsx(c.p,{children:n.jsx(c.strong,{children:"Tham số:"})}),`
`,n.jsxs(c.ul,{children:[`
`,n.jsxs(c.li,{children:[n.jsx(c.code,{children:"name: string"})," — tên của khóa lưu trữ."]}),`
`,n.jsxs(c.li,{children:[n.jsx(c.code,{children:"isSession: boolean = false"})," — có sử dụng ",n.jsx(c.code,{children:"sessionStorage"})," hay không (mặc định là ",n.jsx(c.code,{children:"localStorage"}),")."]}),`
`]}),`
`,n.jsx(c.pre,{children:n.jsx(c.code,{className:"language-typescript",children:`import { DataStorage } from '@dxtmisha/functional'
...
`]})]})}function a(t={}){const{wrapper:c}={...h(),...t.components};return c?n.jsx(c,{...t,children:n.jsx(i,{...t})}):i(t)}export{a as default};
