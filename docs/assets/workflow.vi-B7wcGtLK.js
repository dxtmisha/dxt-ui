...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`@remarks`}),` — Giải thích kỹ thuật mở rộng cho logic phức tạp.
`,(0,c.jsxs)(t.em,{children:[`(Thẻ tìm kiếm `,(0,c.jsx)(t.code,{children:`@keywords`}),` không cần viết thủ công — bộ sinh `,(0,c.jsx)(t.code,{children:`dxt-types`}),` sẽ tự động tạo qua AI ở Bước 3).`]})]}),`
`]}),`
`]}),`
`]}),`
