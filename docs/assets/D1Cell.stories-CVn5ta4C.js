import{d as i,_ as o}from"./D1Cell-CaFaQ11v.js";import{W as r,w as s,a as p,b as m}from"./wiki-fb_eBW86.js";import"./iframe-BlCC38XJ.js";import"./jsx-runtime-D_zvdyIk.js";import{_ as c}from"./D1Skeleton-_eyYcCpr.js";const d=[{name:"caption",type:"string | number"},{name:"description",type:"string | number"},{name:"detail",type:"Record<string, any>"},{name:"disabled",type:"boolean"},{name:"divider",type:"boolean"},{name:"dividerLabel",type:"string",option:["always","none","adaptiveSm","adaptiveMd","adaptiveLg","adaptiveXl","adaptive2xl","containerSm","containerMd","containerLg","containerXl","container2xl"]},{name:"dynamic",type:"boolean"},{name:"dynamicHover",type:"boolean"},{name:"focus",type:"boolean"},{name:"icon",type:"IconValue<IconProps>"},{name:"iconAttrs",type:"ConstrBind<IconProps>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTop",type:"boolean"},{name:"iconTrailing",type:"IconValue<IconProps>"},{name:"iconTrailingDirOnly",type:"boolean"},{name:"iconTrailingPalette",type:"boolean"},{name:"iconTrailingTurnOnly",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"isSkeleton",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"loading",type:"boolean | ConstrBind<ProgressProps>"},{name:"padding",type:"string",option:["none","sm","md","lg","ySm","yMd","yLg"]},{name:"paddingByIndent",type:"boolean"},{name:"readonly",type:"boolean"},{name:"role",type:"string"},{name:"selected",type:"boolean"},{name:"tag",type:"string"},{name:"to",type:"string | RouteLocationAsRelativeGeneric | RouteLocationAsPathGeneric"},{name:"value",type:"EventClickValue['value']"}],a=new r("Cell",d,i,s,p,m),y={title:"Ui/Cell",component:o,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},e={render:l=>({components:{D1Cell:o},setup:()=>({args:l}),template:`
      <D1Cell v-bind="args"/>
    <D1Cell v-bind="args"/>
    <D1Cell v-bind="args"/>
