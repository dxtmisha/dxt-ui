...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Уникальные идентификаторы`}),` — автоматически увеличивает числовые идентификаторы файлов для предотвращения конфликтов параллельной записи.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Очистка данных`}),` — предоставляет методы для мгновенного удаления каталога с временными файлами для освобождения дискового пространства.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Полностью удаляет каталог временных файлов `,(0,c.jsx)(t.code,{children:`./ai-tmp`}),` с файловой системы.`]}),`
