...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptScanDepth(): number`}),` — trả về độ sâu quét thư mục tối đa để thu thập prompt AI.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptExclude(): string[]`}),` — trả về danh sách các thư viện cần loại trừ khỏi tệp ai-prompt.md.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptInclude(): string[]`}),` — trả về danh sách các thư viện cần bao gồm trong tệp ai-prompt.md.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptPackageOnly(): boolean | undefined`}),` — trả về cờ chỉ bao gồm các gói được liệt kê trong package.json vào ai-prompt.md hay không.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isPromptPackageOnly(): boolean`}),` — kiểm tra xem có chỉ bao gồm các gói được liệt kê trong package.json vào ai-prompt.md hay không.`]}),`
