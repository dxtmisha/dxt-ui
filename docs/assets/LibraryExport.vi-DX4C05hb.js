...
`,(0,c.jsxs)(t.p,{children:[`Lớp `,(0,c.jsx)(t.code,{children:`LibraryExport`}),` chịu trách nhiệm tổng hợp và tạo ra một tệp xuất bản (export) thống nhất cho thư viện. Nó quét các thư mục con được chỉ định để tìm các tệp TypeScript và Vue, tự động biên dịch tất cả các xuất bản thành một giao diện công khai duy nhất để đơn giản hóa việc nhập thư viện.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Tích hợp phong cách`}),` — Tự động kiểm tra và tích hợp các bảng kiểu dáng CSS hoặc SCSS toàn cục.`]}),`
...
`,(0,c.jsxs)(t.p,{children:[`Khởi tạo và thực thi trình tạo xuất bản thư viện bằng phương thức `,(0,c.jsx)(t.code,{children:`make`}),`:`]}),`
...
`,(0,c.jsx)(t.p,{children:`Kích hoạt quá trình biên dịch thư viện và tạo điểm truy cập. Lớp này quét tất cả các thư mục con được cấu hình, thu thập các tệp hợp lệ, lọc bỏ các mô-đun kiểm thử/không xuất bản, và ghi các câu lệnh nhập/xuất bản thống nhất vào tệp đích được chỉ định.`}),`
`,(0,c.jsx)(t.p,{children:(0,c.jsx)(t.strong,{children:`Tham số:`})}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsx)(t.li,{children:`Không yêu cầu tham số.`}),`
`]}),`
`,(0,c.jsxs)(t.p,{children:[(0,c.jsx)(t.strong,{children:`Trả về:`}),` `,(0,c.jsx)(t.code,{children:`void`}),` — Thay đổi tệp `,(0,c.jsx)(t.code,{children:`library.ts`}),` đích trên hệ thống tệp và ghi lại tiến trình vào bảng điều khiển (console).`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-typescript`,children:`import { LibraryExport } from '@dxtmisha/scripts'
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`initFile(): string`}),` — Xây dựng nội dung thô của tệp thư viện đầu ra, bao gồm các lệnh nhập, thiết lập phong cách và các xuất bản ký tự đại diện/có tên.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`initStyles(): string`}),` — Tạo ra các lệnh nhập cho bảng kiểu dáng toàn cục (`,(0,c.jsx)(t.code,{children:`style.scss`}),` hoặc `,(0,c.jsx)(t.code,{children:`style.css`}),`) nếu chúng tồn tại trong thư mục gốc nguồn.`]}),`
`]}),`
