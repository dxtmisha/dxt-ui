...
`})}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`component-name`}),` (Tùy chọn): Tên của một thành phần cụ thể để khởi tạo hoặc cập nhật. Nếu bỏ qua, tất cả các thành phần sẽ được cập nhật.`]}),`
