...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptScanDepth(): number`}),` — returns the maximum directory scan depth for AI prompt collection.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptExclude(): string[]`}),` — returns the list of library names to exclude from the ai-prompt.md file.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptInclude(): string[]`}),` — returns the list of library names to include in the ai-prompt.md file.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptPackageOnly(): boolean | undefined`}),` — returns whether only packages listed in package.json should be included in ai-prompt.md.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isPromptPackageOnly(): boolean`}),` — checks whether only packages listed in package.json should be included in ai-prompt.md.`]}),`
