import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/functional/Composables/useApiRequest - API Request Execution` }), `
`, (0, c.jsx)(n.h1, { id: `useapirequest`, children: (0, c.jsx)(n.code, { children: `useApiRequest` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Returns an object with a loading state and a `, (0, c.jsx)(n.code, { children: `send` }), ` method for executing API requests. Accepts settings as a single `, (0, c.jsx)(n.code, { children: `UseApiRequestSetup` }), ` object.`] }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Parameters:` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setup: UseApiRequestSetup` }), ` — Configuration setup object:`, `
`, (0, c.jsxs)(n.ul, { children: [`
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `method?: ApiMethodItem` }), ` — HTTP method to use for the request. Defaults to `, (0, c.jsx)(n.code, { children: `ApiMethodItem.post` }), `.`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `send(request?: Request): Promise<Return | undefined>` }), ` — An asynchronous method for sending the request. It automatically manages the `, (0, c.jsx)(n.code, { children: `loading` }), ` state, validates the request and response contracts, applies the transformation function to the response, executes the `, (0, c.jsx)(n.code, { children: `action` }), ` callback on success, and handles errors safely by logging them to the console.`] }), `
`] }), `
