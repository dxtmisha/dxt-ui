import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, em: `em`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional-basic/Classes/ApiInstance - Управление запросами` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — функция-обертка для выполнения запросов.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setWrapper(wrapper: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>): this` }), ` — Устанавливает функцию-обертку для запросов.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — локальная функция-обертка для выполнения данного запроса.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.p, { children: [`Обертку можно установить как глобально для всего инстанса (через `, (0, c.jsx)(n.code, { children: `options.wrapper` }), ` или метод `, (0, c.jsx)(n.code, { children: `setWrapper` }), `), так и локально для конкретного запроса в объекте `, (0, c.jsx)(n.code, { children: `ApiFetch` }), `.`] }), `
