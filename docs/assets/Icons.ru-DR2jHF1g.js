...
`]}),`
`,n.jsx(s.h2,{id:"система-загрузки",children:"Система загрузки"}),`
`,n.jsxs(s.p,{children:["Класс ",n.jsx(s.code,{children:"Icons"})," поддерживает механизм асинхронного ожидания. Это позволяет запрашивать иконку до того, как она будет фактически загружена или зарегистрирована в системе."]}),`
`,n.jsxs(s.ol,{children:[`
`,n.jsxs(s.li,{children:[n.jsx(s.strong,{children:"Регистрация ожидания"}),": С помощью метода ",n.jsx(s.code,{children:"addLoad(name)"})," иконка помечается специальным маркером ",n.jsx(s.code,{children:"--LOAD--"}),". Это указывает системе, что иконка появится позже."]}),`
`,n.jsxs(s.li,{children:[n.jsx(s.strong,{children:"Процесс ожидания"}),": Если вызвать ",n.jsx(s.code,{children:"get(name)"})," для иконки, которая находится в состоянии загрузки, метод не вернет ошибку, а перейдет в режим ожидания. Он будет проверять реестр каждые 320 мс."]}),`
`,n.jsxs(s.li,{children:[n.jsx(s.strong,{children:"Завершение загрузки"}),": Как только иконка будет добавлена через ",n.jsx(s.code,{children:"add(name, ...)"}),", все ожидающие вызовы ",n.jsx(s.code,{children:"get"})," автоматически разрешатся и вернут содержимое этой иконки."]}),`
`]}),`
`,n.jsx(s.p,{children:"Этот механизм критически важен для распределенных систем, где компоненты могут запрашивать ресурсы до завершения инициализации медиа-базы."}),`
...
`})})]})}function j(e={}){const{wrapper:s}={...d(),...e.components};return s?n.jsx(s,{...e,children:n.jsx(i,{...e})}):i(e)}export{j as default};
