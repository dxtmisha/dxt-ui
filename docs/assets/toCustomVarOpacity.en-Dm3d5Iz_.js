...
`,(0,c.jsxs)(t.p,{children:[`The function modifies a CSS variable reference string (e.g., `,(0,c.jsx)(t.code,{children:`var(--name)`}),`) to point to its corresponding opacity variable (`,(0,c.jsx)(t.code,{children:`var(--name-opacity)`}),`).`]}),`
`,(0,c.jsx)(t.p,{children:(0,c.jsx)(t.strong,{children:`Parameters:`})}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`$color: String`}),` — the CSS variable string to modify.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`$defaultValue: Number | null`}),` [null] — an optional fallback opacity value.`]}),`
`]}),`
`,(0,c.jsx)(t.p,{children:(0,c.jsx)(t.strong,{children:`Returns:`})}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`String`}),` — the modified variable string.`]}),`
`]}),`
