...
`,n.jsx(c.pre,{children:n.jsx(c.code,{className:"language-javascript",children:`import { CacheItem } from '@dxtmisha/functional'

// Hàm đệm nội bộ chứa lệnh tìm nạp data API
