import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional-basic/Classes/Geo - Dữ liệu Vùng Miền Toàn Cầu` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Tự động phát hiện` }), ` — xác định thông minh địa phương (locale) thông qua bộ nhớ hoặc mặc định của môi trường.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Lưu trữ lâu dài` }), ` — sử dụng `, (0, c.jsx)(n.code, { children: `DataStorage` }), ` để lưu và khôi phục các tùy chọn của người dùng.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Tích hợp cơ sở dữ liệu truyền thông` }), ` — cung cấp quyền truy cập vào cơ sở dữ liệu quốc gia và ngôn ngữ từ thư viện `, (0, c.jsx)(n.code, { children: `@dxtmisha/media` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Quản lý thời gian toàn cầu` }), ` — thiết lập và truy xuất tập trung các độ lệch múi giờ.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Truy cập tĩnh` }), ` — cung cấp giao diện toàn cầu thuận tiện mà không cần khởi tạo thủ công.`] }), `
`] }), `
