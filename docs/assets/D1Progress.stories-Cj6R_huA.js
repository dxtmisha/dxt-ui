import{d,_ as i}from"./D1Progress-CskdwKg8.js";import{w as m,W as b,a as c,b as y}from"./wiki-BeTUR4cU.js";import{r as v}from"./iframe-okvuAVTt.js";import"./jsx-runtime-u17CrQMm.js";const w=[{name:"ariaLabel",type:"string"},{name:"circular",type:"boolean"},{name:"delay",type:"string | number"},{name:"delayHide",type:"string | number"},{name:"dense",type:"boolean"},{name:"indeterminate",type:"string",option:["type1","type2","type3"]},{name:"inverse",type:"boolean"},{name:"linear",type:"boolean"},{name:"max",type:"string | number"},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"point",type:"boolean"},{name:"position",type:"string",option:["top","bottom","static"]},{name:"size",type:"string",option:["sm","md","lg"]},{name:"textLoading",type:"TextValue"},{name:"value",type:"string | number"},{name:"visible",type:"boolean"}],k={component:"Progress",props:w,defaults:d,wikiDesign:m},l=new b(k.component,k.props,k.defaults,k.wikiDesign,c,y),p={title:"Ui/Progress",component:i,parameters:{design:"d1",docs:{description:{component:l.getDescription()}}},argTypes:l.getWiki(),args:l.getValues()},o={render:e=>({components:{D1Progress:i},setup:()=>({args:e}),template:`
    ...
    `})},n={name:"Задержки",render:()=>({components:{D1Progress:i},setup(){const e=v(!1);return{visible:e,onClick:()=>{e.value=!e.value}}},template:`
        <div class="wiki-storybook-group">
...
}`,...n.parameters?.docs?.source}}};const g=["Progress","ProgressTypes","ProgressLinear","ProgressCircular","ProgressValues","ProgressDelays"],q=Object.freeze(Object.defineProperty({__proto__:null,Progress:o,ProgressCircular:r,ProgressDelays:n,ProgressLinear:t,ProgressTypes:s,ProgressValues:a,__namedExportsOrder:g,default:p},Symbol.toStringTag,{value:"Module"}));export{q as P,o as a,l as b,s as c,t as d,r as e,a as f,n as g};
