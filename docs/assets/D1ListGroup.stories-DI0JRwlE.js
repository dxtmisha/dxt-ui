import{a as e,i as t}from"./preload-helper-CqJKl217.js";import{t as n}from"./wikiDescriptions-36ZKeRT_-qFzQhC1d.js";import{d as r,l as i,n as a,o,t as s,u as c}from"./wiki-DwIxUKqL.js";import{i as l,n as u,r as d,t as f}from"./D1ListGroup-C4RHu74u.js";var p,m,h,g,_=t((()=>{s(),l(),p=[{name:`divider`,type:`boolean`},{name:`open`,type:`boolean`}],m=[{name:`head`,description:`Slot for the group header/ Слот для заголовка группы`,properties:[{name:`props`,type:`(ListGroupSlotsPropsInclude) | undefined`}]},{name:`list`,description:`Slot for the group list content/ Слот для содержимого списка группы`,properties:[{name:`props`,type:`(any) | undefined`}]}],h=[],g={component:`ListGroup`,props:p,slots:m,events:h,defaults:d,wikiDesign:a}})),v,y=t((()=>{r(),o(),_(),v=new c(g.component,g.props,g.defaults,g.wikiDesign,i,n)})),b=e({ListGroup:()=>S,__namedExportsOrder:()=>C,default:()=>x}),x,S,C,w=t((()=>{u(),y(),x={title:`Ui/ListGroup`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1ListGroup:f},setup:()=>({args:e}),template:`
