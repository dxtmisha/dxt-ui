...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptScanDepth(): number`}),` — возвращает максимальную глубину сканирования директорий для промпта ИИ.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptExclude(): string[]`}),` — возвращает список названий библиотек, исключаемых из файла ai-prompt.md.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptInclude(): string[]`}),` — возвращает список названий библиотек для включения в файл ai-prompt.md.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getPromptPackageOnly(): boolean | undefined`}),` — возвращает, следует ли включать в ai-prompt.md только пакеты, указанные в package.json.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`isPromptPackageOnly(): boolean`}),` — проверяет, следует ли включать в ai-prompt.md только пакеты, указанные в package.json.`]}),`
