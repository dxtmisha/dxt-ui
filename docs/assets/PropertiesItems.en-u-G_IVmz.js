...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`get(): PropertyList`}),` — returns the current property structure (supports focus filtering).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getDesigns(): string[]`}),` — returns a list of available design names.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getItem(index): PropertyItem`}),` — retrieves a specific property record by its index.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getInfo(index): PropertyItemsItem`}),` — resolves full metadata and parental hierarchy for a given index.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getKeys(index): string[]`}),` — decodes a path string into normalized key segments.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getName(name, item): string`}),` — returns the display name of a property, accounting for renames.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`each(callback, property?): T[]`}),` — performs a deep recursive traversal of the tree.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`find(callback): PropertyItemsItem[]`}),` — searches for records matching custom conditions.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`findCategory(category): PropertyItemsItem[]`}),` — extracts tokens belonging to specific functional categories.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`setFocusDesign(design): this`}),` — restricts the operational scope to a specific design.`]}),`
`]}),`
