import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/functional-basic/Functions/getSeparatingSearchExp - Build a RegExp for space-separated word search` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `search: string | RegExp` }), ` — A search string consisting of one or more space-separated words, or a `, (0, c.jsx)(n.code, { children: `RegExp` }), ` object.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `limit: number = 128` }), ` — The maximum allowed length of the search string (ignored if a `, (0, c.jsx)(n.code, { children: `RegExp` }), ` is passed).`] }), `
`] }), `
`, (0, c.jsxs)(n.p, { children: [(0, c.jsx)(n.strong, { children: `Returns:` }), `
`, (0, c.jsx)(n.code, { children: `RegExp` }), ` — A regular expression with flags `, (0, c.jsx)(n.code, { children: `ig` }), ` (global, case-insensitive). If the search string is empty or exceeds the limit, a regex that matches nothing is returned.`] }), `
