import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional-basic/Classes/EventItem - Продвинутое Управление Событиями` }), `
...
`, (0, c.jsxs)(n.p, { children: [`Элемент, на котором может висеть событие: `, (0, c.jsx)(n.code, { children: `HTMLElement | Window` }), `.`] }), `
`, (0, c.jsx)(n.h4, { id: `elementorstringe`, children: (0, c.jsx)(n.code, { children: `ElementOrString<E>` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Тип для передачи элемента или его селектора: `, (0, c.jsx)(n.code, { children: `E | string` }), `.`] }), `
`, (0, c.jsx)(n.h4, { id: `eventlistenerdetailo-d`, children: (0, c.jsx)(n.code, { children: `EventListenerDetail<O, D>` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Функция-обработчик события: `, (0, c.jsx)(n.code, { children: `(event: O, detail?: D) => void` }), `.`] }), `
`, (0, c.jsx)(n.h4, { id: `eventoptions`, children: (0, c.jsx)(n.code, { children: `EventOptions` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Опции прослушивания: `, (0, c.jsx)(n.code, { children: `AddEventListenerOptions | boolean | undefined` }), `.`] }), `
`, (0, c.jsx)(n.h4, { id: `eventactivityiteme`, children: (0, c.jsx)(n.code, { children: `EventActivityItem<E>` }) }), `
`, (0, c.jsx)(n.p, { children: `Внутренний интерфейс для отслеживания активных слушателей.` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `element: E | undefined` }), ` — Целевой элемент.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `type: string` }), ` — Тип события.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `listener?: (event: any) => void` }), ` — Активная функция.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `observer?: ResizeObserver` }), ` — Инстанс наблюдателя (для `, (0, c.jsx)(n.code, { children: `resize` }), `).`] }), `
`] }), `
