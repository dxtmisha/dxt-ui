import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional/Composables/useApiRequest - Thực hiện các yêu cầu` }), `
`, (0, c.jsx)(n.h1, { id: `useapirequest`, children: (0, c.jsx)(n.code, { children: `useApiRequest` }) }), `
`, (0, c.jsxs)(n.p, { children: [`Trả về một đối tượng với trạng thái tải và phương thức `, (0, c.jsx)(n.code, { children: `send` }), ` để thực hiện các yêu cầu API. Nhận các thiết lập dưới dạng một đối tượng `, (0, c.jsx)(n.code, { children: `UseApiRequestSetup` }), ` duy nhất.`] }), `
`, (0, c.jsx)(n.p, { children: (0, c.jsx)(n.strong, { children: `Tham số:` }) }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setup: UseApiRequestSetup` }), ` — Đối tượng thiết lập cấu hình:`, `
`, (0, c.jsxs)(n.ul, { children: [`
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `method?: ApiMethodItem` }), ` — Phương thức HTTP cho yêu cầu. Mặc định là `, (0, c.jsx)(n.code, { children: `ApiMethodItem.post` }), `.`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `send(request?: Request): Promise<Return | undefined>` }), ` — Phương thức bất đồng bộ để gửi yêu cầu. Nó tự động quản lý trạng thái `, (0, c.jsx)(n.code, { children: `loading` }), `, xác thực hợp đồng yêu cầu và phản hồi, áp dụng hàm biến đổi cho phản hồi, thực hiện callback `, (0, c.jsx)(n.code, { children: `action` }), ` khi thành công và xử lý lỗi một cách an toàn bằng cách ghi log ra console.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `pathFull?: string` }), ` — URL đầy đủ của yêu cầu. Nếu được chỉ định, sẽ bỏ qua `, (0, c.jsx)(n.code, { children: `api` }), ` and `, (0, c.jsx)(n.code, { children: `path` }), `.`] }), `
