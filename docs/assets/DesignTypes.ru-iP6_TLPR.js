...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`make(): Promise<this>`}),` — запускает полный конвейер генерации: сборку деклараций, MD5-кэширование, обработку через ИИ, генерацию описаний, MCP и сохранение.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`makeSave(): Promise<this>`}),` — выполняет сохранение итоговых типов и метаданных без повторного обращения к ИИ.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`Интеграция с .gitignore (`,(0,c.jsx)(t.code,{children:`initGitIgnore`}),`)`]}),`: автоматически добавляет созданные файлы (`,(0,c.jsx)(t.code,{children:`ai-types.md`}),`, `,(0,c.jsx)(t.code,{children:`ai-description.md`}),`, `,(0,c.jsx)(t.code,{children:`ai-mcp-resources.json`}),`) в `,(0,c.jsx)(t.code,{children:`.gitignore`}),` пакета в секцию `,(0,c.jsx)(t.code,{children:`# AI Resources`}),`.`]}),`
`]}),`
