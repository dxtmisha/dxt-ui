import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n,l as r,m as i,n as a,r as o,t as s,u as c}from"./wiki-wIqBVsyI.js";import{i as l,n as u,r as d,t as f}from"./D1HorizontalScroll-D8Hz51Gb.js";var p,m,h,g;function _(){return(_=e((()=>{s(),l(),p=[{name:`align`,type:`string`,option:[`block`,`center`,`left`,`right`]},{name:`bleed`,type:`boolean`},{name:`tag`,type:`string`}],m=[{name:`default`,description:`Slot for default horizontal scroll content/ Слот для основного содержимого горизонтальной прокрутки`,properties:[{name:`props`,type:`(any) | undefined`}]}],h=[],g={component:`HorizontalScroll`,props:p,slots:m,events:h,defaults:d,wikiDesign:a}})))()}var v;function y(){return(y=e((()=>{n(),r(),_(),v=new c(g.component,g.props,g.defaults,g.wikiDesign,o,i)})))()}var b=t({HorizontalScroll:()=>S,HorizontalScrollBasic:()=>C,__namedExportsOrder:()=>w,default:()=>x}),x,S,C,w;function T(){return(T=e((()=>{u(),y(),x={title:`Ui/HorizontalScroll`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1HorizontalScroll:f},setup:()=>({args:e}),template:`
...
}`,...C.parameters?.docs?.source}}},w=[`HorizontalScroll`,`HorizontalScrollBasic`]})))()}export{v as a,T as i,S as n,y as o,C as r,b as t};