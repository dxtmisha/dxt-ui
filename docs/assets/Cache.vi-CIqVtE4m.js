...
`,n.jsx(c.pre,{children:n.jsx(c.code,{className:"language-javascript",children:`import { Cache } from '@dxtmisha/functional'
...
`,n.jsxs(c.p,{children:["Về cơ chế chạy ở bên trong của quá trình phân giải, toàn bộ module ",n.jsx(c.code,{children:"Cache"})," tạo và trượt dữ liệu của nó ở từng dòng biến trên những phần tử gắn riêng biệt bằng list ",n.jsx(c.code,{children:"CacheItem"}),". Logic tạo rào lưu ở ",n.jsx(c.code,{children:"CacheItem"})," quản lý biến (value) thời điểm truy cập, giá trị thời gian biến cũ và định nghĩa tính hợp lệ logic (",n.jsx(c.code,{children:"isUpdate"}),")."]})]})}function g(h={}){const{wrapper:c}={...i(),...h.components};return c?n.jsx(c,{...h,children:n.jsx(e,{...h})}):e(h)}export{g as default};
