...
`,e.jsxs(n.p,{children:["Создает новый экземпляр ",e.jsx(n.code,{children:"Datetime"}),". Если параметры не переданы, используется текущее время и локаль по умолчанию."]}),`
