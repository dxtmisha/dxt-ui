...
Лёгкий эмит ввода без DOM-события: [value]`,properties:[{name:`value`,type:`FieldValidationItem<NumberOrString>`}]},{name:`update:modelValue`,description:`Update model value event/ Событие обновления значения модели`,properties:[{name:`value`,type:`NumberOrString`}]},{name:`update:value`,description:`Update value event/ Событие обновления значения`,properties:[{name:`value`,type:`NumberOrString`}]}],b={component:`Input`,props:_,slots:v,events:y,defaults:h,wikiDesign:c}})))()}var S;function C(){return(C=e((()=>{i(),o(),x(),S=new u(b.component,b.props,b.defaults,b.wikiDesign,a,s)})))()}var w=t({Input:()=>E,InputCurrency:()=>k,InputDate:()=>A,InputMask:()=>j,InputNumber:()=>O,InputSkeleton:()=>N,InputTypes:()=>D,InputVModel:()=>M,__namedExportsOrder:()=>P,default:()=>T}),T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{m(),C(),d(),n(),T={title:`Ui/Input`,component:g,parameters:{design:`d1`,docs:{description:{component:S.getDescription()}}},argTypes:S.getWiki(),args:S.getValues()},E={render:e=>({components:{D1Input:g},setup:()=>({args:e}),template:`
      <D1Input v-bind="args" />
...
}`,...N.parameters?.docs?.source}}},P=[`Input`,`InputTypes`,`InputNumber`,`InputCurrency`,`InputDate`,`InputMask`,`InputVModel`,`InputSkeleton`]})))()}export{j as a,D as c,S as d,C as f,A as i,M as l,E as n,O as o,k as r,N as s,w as t,F as u};