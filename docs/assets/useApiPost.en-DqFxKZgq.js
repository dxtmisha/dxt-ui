import{j as e}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as o}from"./index-DC9WpFni.js";import{M as r}from"./blocks-DrZFBXp-.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-okvuAVTt.js";function s(t){const n={code:"code",h1:"h1",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"@dxtmisha/en/functional/Composables/useApiPost - POST Request Execution"}),`
`,e.jsx(n.h1,{id:"useapipost",children:e.jsx(n.code,{children:"useApiPost"})}),`
`,e.jsxs(n.p,{children:["Returns an object with a loading state and a ",e.jsx(n.code,{children:"send"})," method for executing API ",e.jsx(n.code,{children:"POST"})," requests."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"send(request?: Request): Promise<Return | undefined>"})," — An asynchronous method for sending the ",e.jsx(n.code,{children:"POST"})," request. It automatically manages the ",e.jsx(n.code,{children:"loading"})," state, applies the transformation function to the response, executes the ",e.jsx(n.code,{children:"action"})," callback on success, and safely handles errors by logging them to the console."]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { useApiPost } from '@dxtmisha/functional'
