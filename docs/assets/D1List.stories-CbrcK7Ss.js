import{d as s,_ as o}from"./D1List-DmQQx4QB.js";import{W as l,w as n,a as r,b as m}from"./wiki-CHTdS6ju.js";import"./iframe-C6i5AnHO.js";import"./jsx-runtime-D_zvdyIk.js";const c=[{name:"axis",type:"string",option:["x","y"]},{name:"control",type:"boolean"},{name:"disabled",type:"boolean"},{name:"divider",type:"boolean"},{name:"focus",type:"NumberOrStringOrBoolean"},{name:"highlight",type:"string"},{name:"highlightLengthStart",type:"number"},{name:"iconArrowDown",type:"IconValue<IconProps>"},{name:"iconArrowRight",type:"IconValue<IconProps>"},{name:"itemAttrs",type:"ConstrBind<ListItemProps>"},{name:"itemGroupAttrs",type:"ConstrBind<ListItemProps>"},{name:"itemManagementAttrs",type:"ConstrBind<ListItemProps>"},{name:"itemMenuAttrs",type:"ConstrBind<ListItemProps>"},{name:"keyLabel",type:"string"},{name:"keyValue",type:"string"},{name:"list",type:"ListRecord<ListItemProps>"},{name:"lite",type:"boolean"},{name:"liteThreshold",type:"number"},{name:"selected",type:"ListSelectedList"},{name:"tag",type:"string",option:["div","button","a","span"]}],a=new l("List",c,s,n,r,m),p={title:"Ui/List",component:o,parameters:{design:"d1",docs:{description:{component:a.getDescription()}}},argTypes:a.getWiki(),args:a.getValues()},e={},t={name:"Выделение",render:()=>({components:{D1List:o},template:`
        <D1List
          :list="[
