...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Flexible Arguments Support`}),`: Allows targeting specific files and specific nodes dynamically through CLI parameters.`]}),`
`]}),`
...
`,(0,c.jsx)(t.li,{children:`The script reads the target Figma file key and optional node identifier passed directly from the command line arguments.`}),`
...
`,(0,c.jsx)(t.p,{children:`To retrieve layout images, execute the command passing your Figma file key and specific node ID:`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`cli-arguments`,children:`CLI Arguments`}),`
`,(0,c.jsx)(t.p,{children:`The command accepts two positional parameters:`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`fileKey`}),`: The unique identifier of the Figma file (typically found in the Figma file URL).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`nodeId`}),`: The specific node ID inside the file (e.g. `,(0,c.jsx)(t.code,{children:`1-24`}),` or `,(0,c.jsx)(t.code,{children:`1:24`}),`) to fetch.`]}),`
