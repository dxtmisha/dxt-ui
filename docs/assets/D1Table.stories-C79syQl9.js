import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Bt as n,Ft as r,Gt as i,Nt as a,Pt as o,in as s,kt as c,sn as l}from"./library-CO1fW2cN.js";import{d as u,f as d,i as f,l as p,n as m,t as h,u as g}from"./wiki-BMj2WokS.js";import{a as _,i as v,n as y,t as b}from"./ScrollSticky-C5XbfRdi.js";import{n as x,t as S}from"./D1TableRecord-BXW6MIR5.js";var C;function w(){return(w=e((()=>{v(),C={lazy:!0,page:1,stickyScrollBottom:!0}})))()}var T;function E(){return(E=e((()=>{x(),T=S})))()}var D;function O(){return(O=e((()=>{w(),D={...C}})))()}var k;function A(){return(A=e((()=>{c(),w(),y(),E(),O(),k=r({name:`D1Table`,__name:`D1Table`,props:n({caption:{},captionDecorative:{type:Boolean},list:{},search:{},searchColumns:{},searchOptions:{},sort:{},sortDir:{},sortFunction:{type:Function},page:{},rows:{},stickyScrollBottom:{type:Boolean},isSkeleton:{type:Boolean},stickyLeft:{},tableItemAttrs:{},tableItemColumnAttrs:{},selected:{},stickyTop:{},keyValue:{},lazy:{type:Boolean},defaultHeight:{},tableRecordAttrs:{},tableRowAttrs:{},columns:{},columnsWidth:{},header:{},foot:{},headerTop:{type:Boolean},captionBottom:{type:Boolean},bleed:{type:Boolean}},D),emits:[`sort`],setup(e,{expose:t,emit:n}){let r=n,s=e,c=a(()=>({main:{"d1-table":!0,"d1-table--headerTop":s.headerTop,"d1-table--captionBottom":s.captionBottom,"d1-table--bleed":s.bleed}})),u=a(()=>({})),d=new _(`d1.table`,s,{emits:r,classes:c,styles:u,components:{tableRecord:T,scrollSticky:b}}),f=d.render();return t(d.expose()),(e,t)=>(i(),o(l(f)))}})})))()}var j;function M(){return(M=e((()=>{A(),j=k,k.__docgenInfo=Object.assign({displayName:k.name??k.__name},{name:`D1Table`,exportName:`default`,displayName:`D1Table`,description:``,tags:{},sourceFiles:[`/Users/tung/Documents/GitHub/dxt-ui/packages/d1/src/components/Ui/Table/D1Table.vue`]})})))()}var N,P,F,I;function L(){return(L=e((()=>{h(),O(),N=[{name:`bleed`,type:`boolean`},{name:`caption`,type:`string | number`},{name:`captionBottom`,type:`boolean`},{name:`captionDecorative`,type:`boolean`},{name:`columns`,type:`string[]`},{name:`columnsWidth`,type:`Record<string, string | number>`},{name:`defaultHeight`,type:`string | number`},{name:`foot`,type:`TableHeader<TableRecordProps> | TableHeaders<TableRecordProps>`},{name:`header`,type:`TableHeader<TableRecordProps> | TableHeaders<TableRecordProps>`},{name:`headerTop`,type:`boolean`},{name:`isSkeleton`,type:`boolean`},{name:`keyValue`,type:`string`},{name:`lazy`,type:`boolean`},{name:`list`,type:`(TableItemProps[] & TableList<TableItemProps>)`},{name:`page`,type:`string | number`},{name:`rows`,type:`string | number`},{name:`search`,type:`string`},{name:`searchColumns`,type:`string[]`},{name:`searchOptions`,type:`SearchOptions`},{name:`selected`,type:`string | string[]`},{name:`sort`,type:`SortColumn`},{name:`sortDir`,type:`string`,option:[`asc`,`desc`]},{name:`sortFunction`,type:`SortFunction<TableItemProps>`},{name:`stickyLeft`,type:`string[]`},{name:`stickyScrollBottom`,type:`boolean`},{name:`stickyTop`,type:`string[]`},{name:`tableItemAttrs`,type:`ConstrBind<TableItemProps>`},{name:`tableItemColumnAttrs`,type:`Record<string, ConstrBind<TableItemProps>>`},{name:`tableRecordAttrs`,type:`ConstrBind<TableRecordPropsBasic<TableItemProps, TableRecordProps>>`},{name:`tableRowAttrs`,type:`Record<string, ConstrBind<TableRecordPropsBasic<TableItemProps, TableRecordProps>>>`}],P=[{name:`body`,description:`Slot for custom table body content /
...
Слот для пользовательского содержимого элементов таблицы`,properties:[{name:`props`,type:`({ columns: string[]; }) | undefined`}]}],F=[{name:`sort`,description:`Event triggered when sort button is clicked / Событие, вызываемое при клике по кнопке сортировки`,properties:[{name:`item`,type:`SortColumnItem`}]}],I={component:`Table`,props:N,slots:P,events:F,defaults:D,wikiDesign:m}})))()}var R;function z(){return(z=e((()=>{u(),p(),L(),R=new g(I.component,I.props,I.defaults,I.wikiDesign,f,d)})))()}var B=t({Table:()=>H,TableBasic:()=>U,TableSearch:()=>K,TableSlots:()=>W,TableSort:()=>G,__namedExportsOrder:()=>q,default:()=>V}),V,H,U,W,G,K,q;function J(){return(J=e((()=>{M(),z(),c(),V={title:`Ui/Table`,component:j,parameters:{design:`d1`,docs:{description:{component:R.getDescription()}}},argTypes:R.getWiki(),args:R.getValues()},H={},U={name:`Базовый`,render:()=>({components:{D1Table:j},template:`
    ...
    `})},G={name:`Сортировка`,render:()=>({components:{D1Table:j},template:`
        ...
        />
    `})},K={name:`Поиск`,render:()=>({components:{D1Table:j},setup(){return{searchValue:s(`an`)}},template:`
