...
`,(0,c.jsxs)(t.p,{children:[`The `,(0,c.jsx)(t.code,{children:`AiClaudeCliLite`}),` class is a lightweight implementation of `,(0,c.jsx)(t.code,{children:`AiAbstract`}),` that interacts with the official Claude CLI tool via system shell commands. It manages temporary prompt files using `,(0,c.jsx)(t.code,{children:`ApiTmp`}),` to bypass terminal argument length limits.`]}),`
`,(0,c.jsx)(t.h2,{id:`key-features`,children:`Key Features`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`CLI Shell Execution`}),` — leverages the system shell (`,(0,c.jsx)(t.code,{children:`node:child_process`}),`) to invoke `,(0,c.jsx)(t.code,{children:`claude`}),` CLI commands.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Prompt Safety`}),` — automatically escapes double quotes and enforces strict answering format (e.g., `,(0,c.jsx)(t.code,{children:`Output strictly the code/answer. No preamble, no chatter, no reasoning`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`response(model: string, contents: string): Promise<string>`}),` — Bundles all temporary files, escapes quote blocks, constructs the shell execution statement, runs it, and cleans up resources.`]}),`
