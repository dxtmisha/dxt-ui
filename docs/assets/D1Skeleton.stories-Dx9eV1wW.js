import{a as e,i as t}from"./preload-helper-CqJKl217.js";import{t as n}from"./wikiDescriptions-36ZKeRT_-qFzQhC1d.js";import{d as r,l as i,n as a,o,r as s,t as c,u as l}from"./wiki-DwIxUKqL.js";import{i as u,n as d,r as f,t as p}from"./D1Skeleton-Cxor4m_W.js";var m,h,g,_,v=t((()=>{c(),u(),m=[{name:`active`,type:`boolean`}],h=[{name:`default`,description:`Slot for default skeleton content/ Слот для основного содержимого скелета`,properties:[{name:`props`,type:`(SkeletonClassesList) | undefined`}]}],g=[],_={component:`Skeleton`,props:m,slots:h,events:g,defaults:f,wikiDesign:a}})),y,b=t((()=>{r(),o(),v(),y=new l(_.component,_.props,_.defaults,_.wikiDesign,i,n)})),x=e({Skeleton:()=>C,SkeletonBasic:()=>w,__namedExportsOrder:()=>T,default:()=>S}),S,C,w,T,E=t((()=>{d(),b(),o(),S={title:`Ui/Skeleton`,component:p,parameters:{design:`d1`,docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},C={render:e=>({components:{D1Skeleton:p},setup:()=>({args:e}),template:`
