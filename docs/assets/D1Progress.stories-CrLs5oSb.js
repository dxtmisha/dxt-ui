import{d as l,_ as i}from"./D1Progress-C0TI2H2s.js";import{W as d,w as m,a as b,b as c}from"./wiki-BNdC282o.js";import{r as y}from"./iframe-BGVIV1-M.js";import"./jsx-runtime-D_zvdyIk.js";const v=[{name:"circular",type:"boolean"},{name:"delay",type:"string | number"},{name:"delayHide",type:"string | number"},{name:"dense",type:"boolean"},{name:"indeterminate",type:"string",option:["type1","type2","type3"]},{name:"inverse",type:"boolean"},{name:"linear",type:"boolean"},{name:"max",type:"string | number"},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"point",type:"boolean"},{name:"position",type:"string",option:["top","bottom","static"]},{name:"size",type:"string",option:["sm","md","lg"]},{name:"value",type:"string | number"},{name:"visible",type:"boolean"}],k=new d("Progress",v,l,m,b,c),w={title:"Ui/Progress",component:i,parameters:{design:"d1",docs:{description:{component:k.getDescription()}}},argTypes:k.getWiki(),args:k.getValues()},o={render:e=>({components:{D1Progress:i},setup:()=>({args:e}),template:`
