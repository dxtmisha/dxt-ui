...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiType`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`, по умолчанию: `,(0,c.jsx)(t.code,{children:`'gemini'`}),`) — провайдер искусственного интеллекта для оптимизации JSDoc и генерации описаний (подробный обзор см. в разделе `,(0,c.jsx)(t.em,{children:`«11. Поддерживаемые AI-провайдеры»`}),`). Поддерживаются:`,`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`gemini-cli`}),` — вызовы через локальный интерфейс Gemini CLI (`,(0,c.jsx)(t.code,{children:`gemini`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`antigravity-cli`}),` — вызовы через консольный интерфейс Google Antigravity CLI (`,(0,c.jsx)(t.code,{children:`agy`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude`}),` — официальный Anthropic Claude API (через `,(0,c.jsx)(t.code,{children:`@anthropic-ai/sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-cli`}),` — вызовы через терминальную утилиту Claude Code CLI (`,(0,c.jsx)(t.code,{children:`claude`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-agent`}),` — автономный режим через Anthropic Claude Agent SDK (`,(0,c.jsx)(t.code,{children:`@anthropic-ai/claude-agent-sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`openai`}),` — модели OpenAI (GPT-4o, GPT-4o-mini и любые совместимые эндпоинты).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`zai`}),` — модели xAI Grok (через `,(0,c.jsx)(t.code,{children:`@ai-sdk/xai`}),` и Vercel AI SDK).`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiModel`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`) — точный идентификатор модели нейросети (например: `,(0,c.jsx)(t.code,{children:`gemini-3.7-flash`}),`, `,(0,c.jsx)(t.code,{children:`gpt-4o`}),`, `,(0,c.jsx)(t.code,{children:`claude-3-7-sonnet`}),`, `,(0,c.jsx)(t.code,{children:`grok-4.5`}),`).`]}),`
