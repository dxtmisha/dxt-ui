import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,r as n}from"./lib-BRDOWE9X.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{d as i,f as a,s as o}from"./blocks-DTffVoCm.js";function s(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...n(),...e.components};return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(o,{title:`@dxtmisha/vi/wiki/styles/# Tiện ích Bố cục`}),`
`,(0,l.jsx)(t.h1,{id:`tiện-ích-bố-cục`,children:`Tiện ích Bố cục`}),`
`,(0,l.jsx)(t.p,{children:`Tập hợp các class CSS để tổ chức cấu trúc không gian cho các khu vực trình diễn trong Storybook và Wiki. Những class này giúp bạn nhanh chóng tạo lưới (grid), khung linh hoạt (flex) và giới hạn chiều rộng nội dung.`}),`
`,(0,l.jsxs)(t.p,{children:[`Tất cả các class đều có tiền tố `,(0,l.jsx)(t.code,{children:`.wiki-storybook-`}),`.`]}),`
`,(0,l.jsx)(t.h2,{id:`thẻ-chứa`,children:`Thẻ chứa`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-container`}),` khởi tạo một thẻ chứa loại `,(0,l.jsx)(t.code,{children:`inline-size`}),`. Điều này cho phép các phần tử con sử dụng các truy vấn `,(0,l.jsx)(t.code,{children:`@container`}),`.`]}),`
...
`})}),`
`,(0,l.jsx)(t.h2,{id:`lưới`,children:`Lưới`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-group`}),` tạo ra một thẻ chứa CSS Grid với 12 cột và khoảng cách (gap) tiêu chuẩn là `,(0,l.jsx)(t.code,{children:`8px`}),`.`]}),`
...
`,(0,l.jsx)(t.h2,{id:`bố-cục-linh-hoạt`,children:`Bố cục linh hoạt`}),`
`,(0,l.jsx)(t.p,{children:`Các tiện ích để nhanh chóng căn chỉnh các phần tử theo chiều ngang hoặc chiều dọc.`}),`
`,(0,l.jsx)(t.h3,{id:`flex-tiêu-chuẩn`,children:`Flex tiêu chuẩn`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-flex`}),` — sắp xếp theo hàng ngang, tự động xuống dòng với khoảng cách `,(0,l.jsx)(t.code,{children:`8px`}),`.`]}),`
...
`,(0,l.jsx)(t.h3,{id:`căn-giữa-flex-center`,children:`Căn giữa (Flex Center)`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-flex-center`}),` căn chỉnh nội dung chính xác ở giữa.`]}),`
...
`,(0,l.jsx)(t.h3,{id:`căn-giữa-theo-chiều-dọc-flex-align-center`,children:`Căn giữa theo chiều dọc (Flex Align Center)`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-flex-align-center`}),` căn chỉnh các phần tử theo chiều ngang với căn giữa theo chiều dọc.`]}),`
...
`,(0,l.jsx)(t.h3,{id:`xếp-chồng-dọc-flex-column`,children:`Xếp chồng dọc (Flex Column)`}),`
`,(0,l.jsxs)(t.p,{children:[`Class `,(0,l.jsx)(t.code,{children:`.wiki-storybook-flex-column`}),` sắp xếp các phần tử theo chiều dọc với khoảng cách `,(0,l.jsx)(t.code,{children:`16px`}),`.`]}),`
