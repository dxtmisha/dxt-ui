import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,g as i,l as a,n as o,t as s,u as c}from"./wiki-COBgMBNI.js";import{i as l,n as u,r as d,t as f}from"./D1ListGroup-Cr_JVXZ3.js";var p,m,h,g,_=e((()=>{c(),s(),l(),p=[{name:`divider`,type:`boolean`},{name:`open`,type:`boolean`}],m=[{name:`head`,description:`Slot for the group header/ Слот для заголовка группы`,properties:[{name:`props`,type:`ListGroupSlotsPropsInclude`}]},{name:`list`,description:`Slot for the group list content/ Слот для содержимого списка группы`}],h=[],g={component:`ListGroup`,props:p,slots:m,events:h,defaults:d,wikiDesign:o}})),v,y=e((()=>{c(),n(),_(),v=new r(g.component,g.props,g.defaults,g.wikiDesign,a,i)})),b=t({ListGroup:()=>S,__namedExportsOrder:()=>C,default:()=>x}),x,S,C,w=e((()=>{u(),y(),x={title:`Ui/ListGroup`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1ListGroup:f},setup:()=>({args:e}),template:`
