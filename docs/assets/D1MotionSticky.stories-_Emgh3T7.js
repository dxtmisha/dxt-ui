import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Bt as n,Dt as r,Mt as i,Nt as a,Pt as o,Rt as s,Ut as c,Vt as l,an as u,jt as d,n as f,qt as p,y as m}from"./library-BfcLFF_v.js";import{O as h,d as g,i as _,k as v,l as y,m as b,n as x,p as S,t as C,u as w}from"./wiki-BHyzKkJP.js";var T,E,D,O,k;function A(){return(A=e((()=>{r(),h(),T=class{constructor(e,t,n){S(this,`props`,void 0),S(this,`element`,void 0),S(this,`emits`,void 0),this.props=e,this.element=t,this.emits=n}get focusElement(){return f(this.props.elementScroll)??document.scrollingElement??document.documentElement}get eventElement(){return this.props.elementScroll?f(this.props.elementScroll):window}getElement(){return this.element.value}getPositionStyle(){let e=this.element.value;if(e){let t=getComputedStyle(e);if(t.position===`sticky`)return{top:parseInt(t.top.replace(/[^0-9]/gi,``))||0,bottom:parseInt(t.bottom.replace(/[^0-9]/gi,``))||0}}}getPositionElement(){let e=this.element.value,t=this.focusElement;if(e&&t){let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=Math.round(n.top-(r.top>0?r.top:0));return{top:i<=-.99?0:i,bottom:Math.round((r.bottom>window.innerHeight?window.innerHeight:r.bottom)-n.bottom)}}}setStatus(e){let t=this.element.value;if(t){let r=e?`sticky`:`none`,i=this.getScrollState();if(this.props.classActivity&&t.classList.toggle(this.props.classActivity,e),this.updateSticky(r)){var n;(n=this.emits)==null||n.call(this,`sticky`,e)}this.updateScrollState(i)}}getScrollState(){let e=this.eventElement;return e&&(`scrollTop`in e&&e.scrollTop===0||`scrollY`in e&&e.scrollY===0)?`zero`:`active`}updateSticky(e){let t=this.element.value;return t&&e!==t.dataset.sticky?(t.dataset.sticky=e,!0):!1}updateScrollState(e){let t=this.element.value;return t&&e!==t.dataset.stickyScroll?(t.dataset.stickyScroll=e,!0):!1}},E=class{constructor(e,t){S(this,`props`,void 0),S(this,`stickyElement`,void 0),S(this,`event`,void 0),S(this,`onScroll`,()=>{let e=this.stickyElement.getPositionStyle(),t=this.stickyElement.getPositionElement();e&&t&&this.stickyElement.setStatus(e.top===Math.round(t.top)||e.top===Math.floor(t.top)||e.bottom===Math.ceil(t.bottom)||e.bottom===Math.floor(t.bottom))}),this.props=e,this.stickyElement=t,n(()=>{p([this.stickyElement.element,()=>this.stickyElement.eventElement],()=>{this.make(),requestAnimationFrame(this.onScroll)},{immediate:!0})}),l(()=>{this.stop()})}make(){let e=this.stickyElement.eventElement;e?(this.event=new m(e,`scroll`,this.onScroll),this.event.start()):this.stop()}stop(){var e;(e=this.event)==null||e.stop(),this.event=void 0}makeEvent(e){return new m(e,`scroll`,this.onScroll)}},D=class{constructor(e,t,n,r,i,a,o,s,c={}){S(this,`props`,void 0),S(this,`refs`,void 0),S(this,`classDesign`,void 0),S(this,`className`,void 0),S(this,`components`,void 0),S(this,`slots`,void 0),S(this,`emits`,void 0),S(this,`element`,void 0),S(this,`scroll`,void 0),this.props=e,this.refs=t,this.classDesign=r,this.className=i,this.components=a,this.slots=o,this.emits=s;let{MotionStickyElementConstructor:l=T,MotionStickyScrollConstructor:u=E}=c;this.element=new l(this.props,n,this.emits),this.scroll=new u(this.props,this.element)}get tag(){return this.props.tag??`div`}},O={tag:`div`},k=class extends v{constructor(e,t,n,r=D){super(e,t,n),S(this,`item`,void 0),this.item=new r(this.props,this.refs,this.element,this.getDesign(),this.getName(),this.components,this.slots,this.emits),this.init()}initExpose(){return{}}initClasses(){return{main:{}}}initStyles(){return{}}initRender(){return o(this.item.tag,{...this.getAttrs(),ref:this.element,class:this.classes?.value.main},this.initSlot(`default`))}}})))()}var j;function M(){return(M=e((()=>{A(),j={...O}})))()}var N;function P(){return(P=e((()=>{r(),A(),M(),N=a({name:`D1MotionSticky`,__name:`D1MotionSticky`,props:s({elementScroll:{},classActivity:{},tag:{}},j),emits:[`sticky`],setup(e,{expose:t,emit:n}){let r=n,a=e,o=d(()=>({main:{"d1-motionSticky":!0}})),s=d(()=>({})),l=new k(`d1.motionSticky`,a,{emits:r,classes:o,styles:s}),f=l.render();return t(l.expose()),(e,t)=>(c(),i(u(f)))}})})))()}var F;function I(){return(I=e((()=>{P(),F=N,N.__docgenInfo=Object.assign({displayName:N.name??N.__name},{name:`D1MotionSticky`,exportName:`default`,displayName:`D1MotionSticky`,description:``,tags:{},sourceFiles:[`/Volumes/T7/development/dxt-ui/packages/d1/src/components/Ui/MotionSticky/D1MotionSticky.vue`]})})))()}var L,R,z,B;function V(){return(V=e((()=>{C(),M(),L=[{name:`classActivity`,type:`string`},{name:`elementScroll`,type:`string | HTMLElement | Window`},{name:`tag`,type:`string`}],R=[{name:`default`,description:`Slot for default content / Слот для основного содержимого`,properties:[{name:`props`,type:`(any) | undefined`}]}],z=[{name:`sticky`,description:`Event triggered when sticky status changes / Событие при изменении статуса прикрепления`,properties:[{name:`status`,type:`boolean`}]}],B={component:`MotionSticky`,props:L,slots:R,events:z,defaults:j,wikiDesign:x}})))()}var H;function U(){return(U=e((()=>{g(),y(),V(),H=new w(B.component,B.props,B.defaults,B.wikiDesign,_,b)})))()}var W=t({MotionSticky:()=>K,__namedExportsOrder:()=>q,default:()=>G}),G,K,q;function J(){return(J=e((()=>{I(),U(),G={title:`Ui/MotionSticky`,component:F,parameters:{design:`d1`,docs:{description:{component:H.getDescription()}}},argTypes:H.getWiki(),args:H.getValues()},K={render:e=>({components:{D1MotionSticky:F},setup:()=>({args:e}),template:`
