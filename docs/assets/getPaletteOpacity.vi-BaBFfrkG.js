import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/styles/color/| functions/getPaletteOpacity - Độ mờ bảng màu` }), `
`, (0, c.jsx)(n.h1, { id: `getpaletteopacity`, children: (0, c.jsx)(n.code, { children: `getPaletteOpacity` }) }), `
`, (0, c.jsx)(n.p, { children: `Hàm xác định đúng biến độ mờ bảng màu cho một đầu vào màu cụ thể, xử lý cả tên bảng màu và giá trị màu trực tiếp.` }), `
...
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `String` }), ` — kết quả tham chiếu biến CSS cho độ mờ.`] }), `
`] }), `
