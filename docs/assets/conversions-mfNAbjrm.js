...
`})}),`
`,n.jsx(e.h2,{id:"blobtobase64",children:n.jsx(e.code,{children:"blobToBase64"})}),`
`,n.jsx(e.p,{children:"Преобразует Blob в строку Base64 (data URL)."}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Параметры:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"blob: Blob"})," — Blob объект для преобразования"]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-javascript",children:`import { blobToBase64 } from '@dxtmisha/functional'
...
`})}),`
`,n.jsx(e.h2,{id:"encodeattribute",children:n.jsx(e.code,{children:"encodeAttribute"})}),`
`,n.jsxs(e.p,{children:["Кодирует специальные символы в строке для безопасного использования в HTML-атрибутах. Преобразует символы ",n.jsx(e.code,{children:"&"}),", ",n.jsx(e.code,{children:"<"}),", ",n.jsx(e.code,{children:">"}),", ",n.jsx(e.code,{children:'"'}),", ",n.jsx(e.code,{children:"'"})," в соответствующие HTML-сущности для предотвращения XSS-атак и корректного отображения."]}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Параметры:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"text: string"})," — текст для кодирования"]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-javascript",children:`import { encodeAttribute } from '@dxtmisha/functional'
...
`})}),`
`,n.jsx(e.h2,{id:"resizeimagebymax",children:n.jsx(e.code,{children:"resizeImageByMax"})}),`
`,n.jsx(e.p,{children:"Изменяет размер изображения, чтобы оно соответствовало ограничению максимального размера."}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Параметры:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"image: HTMLImageElement | string"})," — элемент изображения или URL"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"maxSize: number"})," — максимальный размер ширины или высоты"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"type: 'auto' | 'width' | 'height'"})," — тип изменения размера (по умолчанию 'auto')"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"typeData?: string"})," — тип данных результирующего изображения (например, 'image/png', 'image/jpeg')"]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-javascript",children:`import { resizeImageByMax } from '@dxtmisha/functional'
