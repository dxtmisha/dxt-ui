import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { Vt as n, cn as r } from './iframe-D7czqiJA.js'; import { a as i, d as a, l as o, m as s, n as c, t as l, u } from './wiki-CUC2UhNU.js'; import { i as d, n as f, r as p, t as m } from './D1Menu-CX1Ra6n0.js'; var h, g, _, v, y = t(() => { l(), d(), h = [{ name: `ajax`, type: `string | (() => NormalOrPromise<ListRecord<ListItemProps>>)` }, { name: `autoClose`, type: `boolean` }, { name: `barsAdaptive`, type: `string`, option: [`showAlways`, `showSm`, `showMd`, `showLg`, `showXl`, `show2xl`] }, { name: `barsAttrs`, type: `ConstrBind<BarsProps>` }, { name: `barsBackHide`, type: `boolean` }, { name: `barsDescription`, type: `string` }, { name: `barsHide`, type: `boolean` }, { name: `barsLabel`, type: `string | number` }, { name: `barsList`, type: `ConstrBind<ButtonProps>[]` }, { name: `cache`, type: `boolean` }, { name: `disabled`, type: `boolean` }, { name: `embedded`, type: `boolean` }, { name: `filterMode`, type: `boolean` }, { name: `hideList`, type: `boolean` }, { name: `highlight`, type: `string` }, { name: `highlightLengthStart`, type: `number` }, { name: `isSelectedByValue`, type: `boolean` }, { name: `itemAttrs`, type: `ConstrBind<ListItemProps>` }, { name: `keyLabel`, type: `string` }, { name: `keyValue`, type: `string` }, { name: `list`, type: `ListRecord<ListItemProps>` }, { name: `listAttrs`, type: `ConstrBind<ListProps>` }, { name: `liteThreshold`, type: `number` }, { name: `max`, type: `string | number` }, { name: `modelSelected`, type: `string` }, { name: `onUpdate:modelSelected`, type: `((value: string) => void)` }, { name: `onUpdate:selected`, type: `((value: string) => void)` }, { name: `request`, type: `ApiFetch` }, { name: `roleItem`, type: `string` }, { name: `roleList`, type: `string` }, { name: `selected`, type: `ListSelectedList` }, { name: `selectionStyle`, type: `string`, option: [`checkbox`, `none`, `radio`, `checkmark`] }, { name: `showSearch`, type: `boolean` }, { name: `step`, type: `string | number` }, { name: `tag`, type: `string` }, { name: `windowAttrs`, type: `ConstrBind<WindowProps>` }], g = [{ name: `contextBottom`, description: `Context slot for bottom area / Слот контекстной области снизу`, properties: [{ name: `props`, type: `(MenuControlItem) | undefined` }] }, { name: `contextTop`, description: `Context slot for top area / Слот контекстной области сверху`, properties: [{ name: `props`, type: `(MenuControlItem) | undefined` }] }, { name: `control`, description: `Control slot for window management / Слот управления для управления окном`, properties: [{ name: `props`, type: `(MenuControlItem) | undefined` }] }, { name: `footer`, description: `Footer slot for window bottom/ Слот подвала для низа окна`, properties: [{ name: `props`, type: `(MenuControlItem) | undefined` }] }, { name: `title`, description: `Title slot for window title/ Слот заголовка для заголовка окна`, properties: [{ name: `props`, type: `(MenuControlItem) | undefined` }] }], _ = [{ name: `bars`, description: `Click event for bars/ Событие клика для панелей`, properties: [{ name: `event`, type: `MouseEvent` }, { name: `value`, type: `EventClickValue` }] }, { name: `barsBack`, description: `Back button click event for bars/ Событие клика кнопки назад для панелей`, properties: [{ name: `value`, type: `EventClickValue` }] }, { name: `barsLite`, description: `Simple click event for bars/ Простое событие клика для панелей`, properties: [{ name: `value`, type: `EventClickValue` }] }, { name: `click`, description: `Full click event with MouseEvent/ Полное событие клика с MouseEvent`, properties: [{ name: `event`, type: `MouseEvent` }, { name: `value`, type: `EventClickValue` }] }, { name: `clickLite`, description: `Lightweight click event/ Упрощённое событие клика`, properties: [{ name: `value`, type: `EventClickValue` }] }, { name: `clickSlot`, description: `Event for clicking on a slot/ Событие клика по слоту`, properties: [{ name: `value?`, type: `string | undefined` }] }, { name: `update:modelSelected`, description: `Update model value event/ Событие обновления значения модели`, properties: [{ name: `value`, type: `string` }] }, { name: `update:selected`, description: `Update value event/ Событие обновления значения`, properties: [{ name: `value`, type: `string` }] }, { name: `updateValue`, description: `Event for updating the value/ Событие обновления значения`, properties: [{ name: `value?`, type: `NumberOrStringOrBoolean | undefined` }] }, { name: `window`, description: `Window event triggered on state change/ Событие окна при изменении состояния`, properties: [{ name: `options`, type: `WindowEmitOptions` }] }], v = { component: `Menu`, props: h, slots: g, events: _, defaults: p, wikiDesign: c } }), b, x = t(() => { a(), o(), y(), b = new u(v.component, v.props, v.defaults, v.wikiDesign, i, s) }), S = e({ Menu: () => w, MenuAjax: () => E, MenuNavigation: () => T, MenuVModel: () => D, __namedExportsOrder: () => O, default: () => C }), C, w, T, E, D, O, k = t(() => {
  f(), x(), n(), C = { title: `Ui/Menu`, component: m, parameters: { design: `d1`, docs: { description: { component: b.getDescription() } } }, argTypes: b.getWiki(), args: b.getValues() }, w = { render: e => ({ components: { D1Menu: m }, setup: () => ({ args: e }), template: `
    ...
    ` }) }, D = { name: `Двусторонняя привязка (v-model)`, render: () => ({ components: { D1Menu: m }, setup() { return { selectedValue: r(`settings`), menuItems: r([{ label: `Dashboard`, value: `dashboard`, icon: `dashboard` }, { label: `Users`, value: `users`, icon: `people` }, { label: `Settings`, value: `settings`, icon: `settings` }, { label: `Reports`, value: `reports`, icon: `assessment` }, { label: `Help`, value: `help`, icon: `help` }]) } }, template: `
        <div class="wiki-storybook-flex-column">
          <div class="wiki-storybook-flex">
...
}`, ...D.parameters?.docs?.source } } }, O = [`Menu`, `MenuNavigation`, `MenuAjax`, `MenuVModel`]
}); k(); export { w as Menu, E as MenuAjax, T as MenuNavigation, D as MenuVModel, O as __namedExportsOrder, C as default, x as i, k as n, b as r, S as t }
