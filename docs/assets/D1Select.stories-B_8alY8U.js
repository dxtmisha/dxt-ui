import { a as e, i as t } from './preload-helper-Cv19cBWa.js'; import { Gt as n, Kt as r, Ut as i, Vt as a, Wt as o, Yt as s, cn as c, d as l, dn as u, en as ee, f as d, m as f } from './iframe-D7czqiJA.js'; import { a as p, d as m, f as te, l as ne, m as re, n as h, p as g, t as _, u as v } from './wiki-CUC2UhNU.js'; import { n as y, t as b } from './AriaStaticInclude-BsKgXpT8-Crt3dq7t.js'; import { n as x, t as S } from './D1Skeleton-atWhpGi3.js'; import { a as C, o as w } from './D1Field-BP_UcArC.js'; import { n as T, t as ie } from './Field-DL42FC6c.js'; import { n as ae, t as oe } from './Menu-BF-r8V7d.js'; import { n as se, t as ce } from './SelectAbstract-DzK9k-Al-AC6OHvmS.js'; import { n as E, t as le } from './D1SelectValue-DZsMEHxW.js'; var D, O, k, A, j = t(() => { b(), te(), w(), se(), a(), l(), D = class {constructor(e, t, n, r) { g(this, `props`, void 0), g(this, `attributes`, void 0), g(this, `value`, void 0), g(this, `event`, void 0), g(this, `onKeydown`, (e) => { e.target.click(), e.preventDefault() }), this.props = e, this.attributes = t, this.value = n, this.event = r }isEdit() { return !!(this.props.editValue && !this.props.multiple) } get binds() { return f(this.attributes.listForInput, { 'name': this.props.name, 'type': `text`, 'required': this.props.required, 'readonly': !this.isEdit(), 'placeholder': this.props.placeholder, 'data-menu-control': `1`, 'onInput': this.isEdit() ? this.event.onInput : this.event.onSelect }) }}, O = class extends ce {constructor(e, t, n, r, i, a, o, s, c = {}) { super(e, t, n, r, i, a, o, s, c), g(this, `field`, void 0), g(this, `input`, void 0), g(this, `onInputValue`, () => { var e; (e = this.menu.getElement()) == null || e.toOpen() }); let { FieldIncludeConstructor: l = C, SelectInputConstructor: u = D } = c; this.input = new u(this.props, this.attributes, this.value, this.event), this.field = new l(this.className, this.props, this.components, () => ({ iconTrailing: this.iconTrailing, maxlength: this.props.max, cancel: this.props.cancel ?? (this.props.multiple ? `auto` : `none`) }), void 0, this.value, this.event, void 0, void 0, () => this.menu.getElement()?.toggle(), () => this.menu.getElement()?.next(), () => this.menu.getElement()?.previous()) }}, k = {}, A = class extends d {constructor(e, t, n, i = O) { super(e, t, n), g(this, `item`, void 0), g(this, `renderMenu`, e => this.item.menu.render({ control: t => this.renderMenuControl(e, t), title: e => this.renderTitle(e), footer: e => this.initSlot(`footer`, void 0, e), contextTop: e => this.initSlot(`contextTop`, void 0, e), contextBottom: e => this.initSlot(`contextBottom`, void 0, e) }, { selected: this.item.value.item.value })), g(this, `renderMenuControl`, (e, t) => { let n = []; return this.item.input.isEdit() || n.push(this.renderMenuControlValue(e, t)), n.push(this.renderMenuControlInput(e, t)), n }), g(this, `renderMenuControlInput`, (e, t) => { let n = this.item.input.isEdit(), i = n ? e.className : e.classForFocus, a = {}; return r(`input`, f(this.item.input.binds, t.binds, { ref: this.element, id: e.id, value: this.item.value.get(), class: i, autocomplete: `off`, onInput: this.item.onInputValue, ...y.role(`combobox`) }, n ? void 0 : a)) }), g(this, `renderMenuControlValue`, (e, t) => this.components.renderOne(`selectValue`, f(t.binds, { class: e.className, disabled: this.props.disabled, value: t.selectedList.value, multiple: this.props.multiple, placeholder: this.props.placeholder, onClick: this.item.event.onSelect, ...y.role(`combobox`) }))), g(this, `renderTitle`, (e) => { let t = []; return this.initSlot(`title`, t, e), t }), this.item = new i(this.props, this.refs, this.element, this.getDesign(), this.getName(), this.components, this.slots, this.emits), this.init() }initExpose() { return { ...this.item.menu.expose, ...this.item.value.expose(), ...this.item.validation.expose() } }initClasses() { return { main: {} } }initStyles() { return {} }initRender() { let e = this.item.menu.expose.getOpen(); return this.item.field.render({ default: this.renderMenu }, { ...this.getAttrs(), focus: e, iconTurn: e, class: this.classes?.value.main, validationMessage: this.item.validation.message }) }} }), M, N = t(() => { E(), M = le }), P, F = t(() => { j(), P = { ...k, iconArrowDown: `keyboard_arrow_down`, menuAttrs: { itemAttrs: { dense: !0 } } } }), I = t(() => {}), L, R = t(() => { a(), j(), ae(), T(), N(), F(), I(), L = n({ name: `D1Select`, __name: `D1Select`, props: s({ 'icon': {}, 'selected': { type: Boolean }, 'iconTurn': { type: Boolean }, 'iconHide': { type: Boolean }, 'iconDir': { type: Boolean }, 'iconPalette': { type: Boolean }, 'iconAttrs': {}, 'iconTrailing': {}, 'iconTrailingTurnOnly': { type: Boolean }, 'iconTrailingDirOnly': { type: Boolean }, 'iconTrailingPalette': { type: Boolean }, 'prefix': {}, 'prefixId': {}, 'suffix': {}, 'suffixId': {}, 'caption': {}, 'captionDecorative': { type: Boolean }, 'label': {}, 'labelId': {}, 'counterShow': { type: Boolean }, 'counterId': {}, 'fieldCounterAttrs': {}, 'required': { type: Boolean }, 'fieldLabelAttrs': {}, 'forceShowMessage': { type: Boolean }, 'hasHtmlCode': { type: Boolean }, 'disabled': { type: Boolean }, 'helperMessage': {}, 'validationMessage': {}, 'fieldMessageAttrs': {}, 'helperId': {}, 'validationId': {}, 'loading': { type: [Boolean, Object] }, 'readonly': { type: Boolean }, 'href': {}, 'detail': {}, 'isSkeleton': { type: Boolean }, 'textCancel': { type: [String, Function] }, 'id': {}, 'focus': { type: Boolean }, 'align': {}, 'cancel': {}, 'fieldAttrs': {}, 'modelValue': {}, 'onUpdate:value': { type: Function }, 'onUpdate:modelValue': { type: Function }, 'placeholder': {}, 'value': {}, 'name': {}, 'autofocus': { type: Boolean }, 'tabindex': {}, 'form': {}, 'validationCode': {}, 'match': {}, 'inputAttrs': {}, 'max': {}, 'arrow': {}, 'arrowStep': {}, 'arrowAlign': {}, 'autocomplete': {}, 'autocapitalize': {}, 'inputMode': {}, 'enterKeyHint': {}, 'spellcheck': { type: [Boolean, String] }, 'autocorrect': {}, 'option': {}, 'multiple': { type: Boolean }, 'selectionStyle': {}, 'menuAttrs': {}, 'editValue': { type: Boolean }, 'hideList': { type: Boolean }, 'showSearch': { type: Boolean }, 'filterMode': { type: Boolean }, 'iconArrowDown': {} }, P), emits: [`update:value`, `update:modelValue`, `input`, `inputLite`, `change`, `changeLite`], setup(e, { expose: t, emit: n }) { let r = new A(`d1.select`, e, { emits: n, classes: i(() => ({ main: { 'd1-select': !0 } })), styles: i(() => ({})), components: { menu: oe, field: ie, selectValue: M } }), a = r.render(); return t(r.expose()), (e, t) => (ee(), o(u(a))) } }) }), z, B = t(() => { R(), R(), z = L, L.__docgenInfo = Object.assign({ displayName: L.name ?? L.__name }, { name: `D1Select`, exportName: `default`, displayName: `D1Select`, description: ``, tags: {}, sourceFiles: [`/Volumes/T7/Code/dxt-ui/packages/d1/src/components/Ui/Select/D1Select.vue`] }) }), V, H, U, W, ue = t(() => {
...
Лёгкий эмит ввода без DOM-события: [value]`, properties: [{ name: `value`, type: `FieldValidationItem<any>` }] }, { name: `update:modelValue`, description: `Update model value event/ Событие обновления значения модели`, properties: [{ name: `value`, type: `any` }] }, { name: `update:value`, description: `Update value event/ Событие обновления значения`, properties: [{ name: `value`, type: `any` }] }], W = { component: `Select`, props: V, slots: H, events: U, defaults: P, wikiDesign: h }
  }), G, K = t(() => { m(), ne(), ue(), G = new v(W.component, W.props, W.defaults, W.wikiDesign, p, re) }), de = e({ Select: () => J, SelectBasic: () => Y, SelectSkeleton: () => Z, SelectVModel: () => X, __namedExportsOrder: () => Q, default: () => q }), q, J, Y, X, Z, Q, $ = t(() => {
    B(), K(), x(), a(), q = { title: `Ui/Select`, component: z, parameters: { design: `d1`, docs: { description: { component: G.getDescription() } } }, argTypes: G.getWiki(), args: G.getValues() }, J = { args: { editValue: !0, multiple: !0 }, render: e => ({ components: { D1Select: z }, setup: () => ({ args: e }), template: `
      <D1Select v-bind="args" />
    ` }) }, Y = { name: `Базовые`, render: () => ({ components: { D1Select: z }, setup() { return { options: c([{ label: `JavaScript`, value: `js` }, { label: `TypeScript`, value: `ts` }, { label: `Python`, value: `py` }, { label: `Java`, value: `java` }, { label: `C++`, value: `cpp` }, { label: `Ruby`, value: `rb` }, { label: `Go`, value: `go` }, { label: `PHP`, value: `php` }]) } }, template: `
    ...
    ` }) }, X = { name: `Двусторонняя привязка (v-model)`, render: () => ({ components: { D1Select: z }, setup() { return { valueSingle: c(`option2`), valueMultiple: c([`option1`, `option3`]), options: [{ label: `First option`, value: `option1` }, { label: `Second option`, value: `option2` }, { label: `Third option`, value: `option3` }] } }, template: `
        <div class="wiki-storybook-flex-column">
    ...
    ` }) }, Z = { name: `Скелетон`, render: () => ({ components: { D1Select: z, D1Skeleton: S }, template: `
...
}`, ...Z.parameters?.docs?.source } } }, Q = [`Select`, `SelectBasic`, `SelectVModel`, `SelectSkeleton`]
  }); $(); export { J as Select, Y as SelectBasic, Z as SelectSkeleton, X as SelectVModel, Q as __namedExportsOrder, q as default, K as i, $ as n, G as r, de as t }
