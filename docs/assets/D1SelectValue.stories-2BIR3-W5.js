import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,g as i,l as a,n as o,t as s,u as c}from"./wiki-COBgMBNI.js";import{i as l,n as u,r as d,t as f}from"./D1SelectValue-GEvE-90L.js";var p,m,h,g,_=e((()=>{c(),s(),l(),p=[{name:`chipAttrs`,type:`ConstrBind<ChipPropsBasic>`},{name:`disabled`,type:`boolean`},{name:`iconAttrs`,type:`ConstrBind<IconPropsBasic>`},{name:`iconCancel`,type:`IconValue<IconPropsBasic>`},{name:`iconShow`,type:`boolean`},{name:`multiple`,type:`boolean`},{name:`placeholder`,type:`string`},{name:`readonly`,type:`boolean`},{name:`value`,type:`ListList`}],m=[],h=[{name:`click`,description:`Full click event with MouseEvent/ Полное событие клика с MouseEvent`,properties:[{name:`event`,type:`MouseEvent`},{name:`value`,type:`EventClickValue`}]},{name:`clickLite`,description:`Lightweight click event/ Упрощённое событие клика`,properties:[{name:`value`,type:`EventClickValue`}]}],g={component:`SelectValue`,props:p,slots:m,events:h,defaults:d,wikiDesign:o}})),v,y=e((()=>{c(),n(),_(),v=new r(g.component,g.props,g.defaults,g.wikiDesign,a,i)})),b=t({SelectValue:()=>S,SelectValueBasic:()=>C,__namedExportsOrder:()=>w,default:()=>x}),x,S,C,w,T=e((()=>{u(),y(),x={title:`Ui/SelectValue`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={},C={name:`Базовые`,render:()=>({components:{D1SelectValue:f},template:`
