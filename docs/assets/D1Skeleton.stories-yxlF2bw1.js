import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{t as n}from"./wikiDescriptions-7XaHU3Yk-B5WkPyHr.js";import{a as r,d as i,n as a,o,r as s,t as c,u as l}from"./wiki-YLJtDFp2.js";import{i as u,n as d,r as f,t as p}from"./D1Skeleton-Q9RSuxTW.js";var m,h,g,_,v=e((()=>{c(),u(),m=[{name:`active`,type:`boolean | undefined`}],h=[{name:`default`,description:`Slot for default skeleton content/ Слот для основного содержимого скелета`,properties:[{name:`props`,type:`(SkeletonClassesList) | undefined`}]}],g=[],_={component:`Skeleton`,props:m,slots:h,events:g,defaults:f,wikiDesign:a}})),y,b=e((()=>{i(),o(),v(),y=new l(_.component,_.props,_.defaults,_.wikiDesign,r,n)})),x=t({Skeleton:()=>C,SkeletonBasic:()=>w,__namedExportsOrder:()=>T,default:()=>S}),S,C,w,T,E=e((()=>{d(),b(),o(),S={title:`Ui/Skeleton`,component:p,parameters:{design:`d1`,docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},C={render:e=>({components:{D1Skeleton:p},setup:()=>({args:e}),template:`
