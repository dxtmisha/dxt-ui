import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/scripts/Classes/DesignTypes - Trình tạo kiểu AI` }), `
...
`, (0, c.jsx)(n.p, { children: `Mục tiêu chính của lớp này là tạo ra một "kiến thức nhân tạo" có thể được tiêm vào hệ thống prompt của các LLM đang làm việc trong dự án. Bằng cách cung cấp một cái nhìn tổng quan sạch sẽ, cô đọng về tất cả các kiểu và interface có sẵn, AI có thể viết mã an toàn về kiểu (type-safe) và hiểu kiến trúc thành phần với độ chính xác cao hơn đáng kể và chi phí thấp hơn.` })] })
