...
`,e.jsxs(n.p,{children:["Internally, ",e.jsx(n.code,{children:"Cache"})," uses instances of ",e.jsx(n.code,{children:"CacheItem"})," to manage each individual cache entry. ",e.jsx(n.code,{children:"CacheItem"})," handles the storage of the current value, the old value, and the dependency checking logic (",e.jsx(n.code,{children:"isUpdate"}),")."]})]})}function u(c={}){const{wrapper:n}={...a(),...c.components};return n?e.jsx(n,{...c,children:e.jsx(s,{...c})}):s(c)}export{u as default};
