...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Инкрементальное кэширование по версиям`}),`: Сравнивает версию пакета с кэшем лога для предотвращения повторной сборки неизмененного кода.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`Пользовательский лог-файл и интеграция с `,(0,c.jsx)(t.code,{children:`.gitignore`})]}),`: Позволяет задавать имя файла лога и автоматически добавляет путь к файлу в `,(0,c.jsx)(t.code,{children:`.gitignore`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Интеллектуальный выбор скрипта сборки`}),`: Поддерживает пользовательские команды/скрипты сборки (`,(0,c.jsx)(t.code,{children:`code`}),`) либо автоматически выбирает команду из `,(0,c.jsx)(t.code,{children:`package.json`}),` в строгом порядке приоритета:`,`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Автоматическое сохранение лога`}),`: Записывает обновленные версии собранных пакетов в файл лога только при наличии успешно собранных пакетов (`,(0,c.jsx)(t.code,{children:`changed > 0`}),`).`]}),`
`]}),`
`,(0,c.jsx)(t.h2,{id:`конструктор`,children:`Конструктор`}),`
`,(0,c.jsxs)(t.p,{children:[`Конструктор принимает путь к директории с пакетами (по умолчанию константа `,(0,c.jsx)(t.code,{children:`UI_DIR_PACKAGES`}),` = `,(0,c.jsx)(t.code,{children:`'packages'`}),`), опциональную команду сборки (`,(0,c.jsx)(t.code,{children:`code`}),`), опциональное имя или путь к файлу лога (`,(0,c.jsx)(t.code,{children:`logFile`}),`) и загружает существующий кэш версий:`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly code?: string`}),` — пользовательская команда сборки или имя npm-скрипта (например, `,(0,c.jsx)(t.code,{children:`'types'`}),` или `,(0,c.jsx)(t.code,{children:`'npm run types'`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected readonly logFile?: string`}),` — пользовательское имя или путь к файлу лога сборки (например, `,(0,c.jsx)(t.code,{children:`'ui-types'`}),` или `,(0,c.jsx)(t.code,{children:`'logs/ui-types.log.json'`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Добавляет файл лога в `,(0,c.jsx)(t.code,{children:`.gitignore`}),` (`,(0,c.jsx)(t.code,{children:`initGitIgnore`}),`).`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getCode(packageFile: PackageFile): string | undefined`}),` — возвращает команду сборки: использует переданный `,(0,c.jsx)(t.code,{children:`this.code`}),` (при необходимости преобразуя имя скрипта в `,(0,c.jsx)(t.code,{children:`npm run <script>`}),`) либо стандартный скрипт через `,(0,c.jsx)(t.code,{children:`packageFile.getCodeBuildOrRecovery()`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected getLogPath(): string[]`}),` — возвращает сегменты пути к файлу лога сборки на основе `,(0,c.jsx)(t.code,{children:`this.logFile`}),` (по умолчанию `,(0,c.jsx)(t.code,{children:`['.', 'logs', 'ui-build.log.json']`}),`).`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`Определяет скрипт через `,(0,c.jsx)(t.code,{children:`this.getCode(packageFile)`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Выполняет команду сборки в директории пакета с помощью утилиты `,(0,c.jsx)(t.code,{children:`run`}),`.`]}),`
...
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected initGitIgnore(): void`}),` — добавляет путь к файлу лога сборки в `,(0,c.jsx)(t.code,{children:`.gitignore`}),` под секцией `,(0,c.jsx)(t.code,{children:`# Logs`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`protected saveLog(): void`}),` — сохраняет текущую карту версий `,(0,c.jsx)(t.code,{children:`this.log`}),` в файл лога через `,(0,c.jsx)(t.code,{children:`PropertiesFile.writeByPath`}),`.`]}),`
