import{d as c,_ as t}from"./D1Button-DaS6SeED.js";import{w as d,W as B,a as p,b as y}from"./wiki-BeIQM_4B.js";import"./iframe-B21bnPHY.js";import"./jsx-runtime-u17CrQMm.js";import{_ as D}from"./D1Skeleton-LvRPzgGQ.js";const k=[{name:"adaptive",type:"string",option:["iconAlways","block","auto","iconSm","iconMd","iconLg","iconXl","icon2xl","fullSm","fullMd","fullLg","fullXl","full2xl"]},{name:"ariaLabel",type:"string"},{name:"container",type:"string",option:["iconSm","iconMd","iconLg","iconXl","icon2xl","fullSm","fullMd","fullLg","fullXl","full2xl"]},{name:"detail",type:"Record<string, any>"},{name:"disabled",type:"boolean"},{name:"focus",type:"boolean"},{name:"grid",type:"boolean"},{name:"href",type:"string"},{name:"icon",type:"IconValue<Icon>"},{name:"iconAttrs",type:"ConstrBind<Icon>"},{name:"iconDir",type:"boolean"},{name:"iconHide",type:"boolean"},{name:"iconPalette",type:"boolean"},{name:"iconTrailing",type:"IconValue<Icon>"},{name:"iconTrailingDirOnly",type:"boolean"},{name:"iconTrailingPalette",type:"boolean"},{name:"iconTrailingTurnOnly",type:"boolean"},{name:"iconTurn",type:"boolean"},{name:"inverse",type:"boolean"},{name:"isSkeleton",type:"boolean"},{name:"label",type:"NumberOrString"},{name:"labelId",type:"string"},{name:"loading",type:"boolean | ConstrBind<Progress>"},{name:"outline",type:"boolean"},{name:"palette",type:"string",option:["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","slate","gray","zinc","neutral","stone","black","white"]},{name:"primary",type:"boolean"},{name:"readonly",type:"boolean"},{name:"roundedFull",type:"boolean"},{name:"secondary",type:"boolean"},{name:"selected",type:"boolean"},{name:"size",type:"string",option:["xs","sm","md","lg","xl"]},{name:"tag",type:"string",option:["button","a","span"]},{name:"text",type:"boolean"},{name:"textAlign",type:"string",option:["left","center","right"]},{name:"to",type:"string | RouteLocationAsRelativeGeneric | RouteLocationAsPathGeneric"},{name:"type",type:"string",option:["button","submit","reset"]},{name:"value",type:"EventClickValue['value']"}],l={component:"Button",props:k,defaults:c,wikiDesign:d},m=new B(l.component,l.props,l.defaults,l.wikiDesign,p,y),b={title:"Ui/Button",component:t,parameters:{design:"d1",docs:{description:{component:m.getDescription()}}},argTypes:m.getWiki(),args:m.getValues()},o={},n={name:"Базовые",render:()=>({components:{D1Button:t},template:`
    ...
    `})},u={name:"Скелетон",render:()=>({components:{D1Button:t,D1Skeleton:D},template:`
...
}`,...u.parameters?.docs?.source}}};const v=["Button","ButtonBasic","ButtonPrimary","ButtonSecondary","ButtonOutline","ButtonText","ButtonAdaptive","ButtonSkeleton"],_=Object.freeze(Object.defineProperty({__proto__:null,Button:o,ButtonAdaptive:s,ButtonBasic:n,ButtonOutline:a,ButtonPrimary:e,ButtonSecondary:i,ButtonSkeleton:u,ButtonText:r,__namedExportsOrder:v,default:b},Symbol.toStringTag,{value:"Module"}));export{_ as B,o as a,m as b,n as c,e as d,i as e,a as f,r as g,s as h,u as i};
