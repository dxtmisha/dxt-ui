...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Quy trình làm việc qua CLI`}),` — thực hiện các yêu cầu bằng cách xây dựng và chạy các lệnh shell.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Môi trường`}),` — dựa trên tính khả dụng của hàm `,(0,c.jsx)(t.code,{children:`exec`}),` và hệ thống tệp cho lưu trữ tạm thời.`]}),`
