import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/scripts/Classes/StylesToMedia - Генератор медиа-запросов` }), `
`, (0, c.jsx)(n.h1, { id: `класс-stylestomedia`, children: `Класс StylesToMedia` }), `
`, (0, c.jsxs)(n.p, { children: [`Класс `, (0, c.jsx)(n.code, { children: `StylesToMedia` }), ` отвечает за создание CSS-запросов `, (0, c.jsx)(n.code, { children: `@media` }), ` на основе свойств дизайна. Он реализует логику для обертывания вложенных правил стилей в блок медиа-запроса.`] }), `
`, (0, c.jsx)(n.h2, { id: `ключевые-возможности`, children: `Ключевые возможности` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Обертка Медиа-запроса` }), ` — Автоматически оборачивает созданный контент стилей в правило `, (0, c.jsx)(n.code, { children: `@media screen and ...` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Динамическое разрешение запроса` }), ` — Использует имя свойства дизайна для определения условия медиа-запроса.`] }), `
...
`, (0, c.jsxs)(n.p, { children: [`Инициализируйте преобразователь `, (0, c.jsx)(n.code, { children: `StylesToMedia` }), ` с помощью необходимого свойства и функции контента для вложенных правил.`] }), `
