import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{Et as n,tn as r}from"./library-CUIf7uCS.js";import{d as i,l as a,m as o,n as s,r as c,t as l,u}from"./wiki-wIqBVsyI.js";import{i as d,n as f,r as p,t as m}from"./D1Arrow-BcwkpzKi.js";var h,g,_,v;function y(){return(y=e((()=>{l(),d(),h=[{name:`clientOnly`,type:`boolean`},{name:`elementTarget`,type:`string | HTMLElement`},{name:`position`,type:`string`,option:[`auto`,`top`,`bottom`,`left`,`right`]},{name:`size`,type:`string`,option:[`sm`,`md`,`lg`]}],g=[],_=[],v={component:`Arrow`,props:h,slots:g,events:_,defaults:p,wikiDesign:s}})))()}var b;function x(){return(x=e((()=>{i(),a(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,c,o)})))()}var S=t({Arrow:()=>w,ArrowBasic:()=>T,__namedExportsOrder:()=>E,default:()=>C}),C,w,T,E;function D(){return(D=e((()=>{f(),x(),n(),C={title:`Ui/Arrow`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Arrow:m},setup:()=>({args:e}),template:`
