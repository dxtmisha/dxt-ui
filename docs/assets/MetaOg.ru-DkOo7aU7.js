import{j as e}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as c}from"./index-DC9WpFni.js";import{M as r}from"./blocks-DrZFBXp-.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-okvuAVTt.js";function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"@dxtmisha/ru/functional-basic/Classes/MetaOg - Open Graph мета-теги"}),`
...
`,e.jsxs(n.p,{children:["Для управления данными Open Graph вызовите конструктор ",e.jsx(n.code,{children:"new MetaOg()"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Особенности:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Наследование"})," — расширяет ",e.jsx(n.code,{children:"MetaManager"}),", используя атрибут ",e.jsx(n.code,{children:"property"})," для управления тегами."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Стандарт"})," — предустановлен список всех основных тегов протокола ",e.jsx(n.a,{href:"https://ogp.me/",rel:"nofollow",children:"Open Graph"}),"."]}),`
`]}),`
