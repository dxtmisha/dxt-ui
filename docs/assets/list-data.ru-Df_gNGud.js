import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,r as n}from"./lib-BRDOWE9X.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{f as i,s as a}from"./blocks-WIGGT2yz.js";function o(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...n(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(a,{title:`@dxtmisha/ru/functional/# Управление списками`}),`
`,(0,c.jsx)(t.h1,{id:`управление-списками`,children:`Управление списками`}),`
`,(0,c.jsxs)(t.p,{children:[`Класс `,(0,c.jsx)(t.strong,{children:`ListDataRef`}),` — это контроллер для управления сложными списками данных, выпадающими меню и деревьями в экосистеме `,(0,c.jsx)(t.strong,{children:`Vue 3`}),`. Он автоматизирует рутинные задачи по фильтрации, выделению элементов, управлению фокусом и работе со вложенными структурами.`]}),`
`,(0,c.jsx)(t.h2,{id:`инициализация-и-данные`,children:`Инициализация и Данные`}),`
`,(0,c.jsx)(t.p,{children:`Контроллер принимает реактивные источники данных и предоставляет оптимизированные наборы свойств для отрисовки компонентов.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`выделение-и-состояние`,children:`Выделение и Состояние`}),`
`,(0,c.jsx)(t.p,{children:`Автоматическое управление множественным или одиночным выбором с учетом лимитов и текущего состояния локали.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`навигация-и-фокус`,children:`Навигация и Фокус`}),`
`,(0,c.jsx)(t.p,{children:`Контроллер предоставляет систему методов для «умного» перемещения по списку. Навигация автоматически пропускает неактивные элементы и заголовки групп, работая только с доступными для выбора пунктами.`}),`
...
`})}),`
`,(0,c.jsx)(t.h2,{id:`работа-с-вложенностью`,children:`Работа с вложенностью`}),`
`,(0,c.jsxs)(t.p,{children:[`Для работы с группами или древовидными структурами используется метод `,(0,c.jsx)(t.code,{children:`getSubList()`}),`. Он создает новый экземпляр контроллера для вложенных данных, сохраняя общую связь с глобальным состоянием фокуса и выделения.`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-javascript`,children:`// Внутри компонента группы или выпадающего меню:
