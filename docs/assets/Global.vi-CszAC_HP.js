import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as c}from"./index-BaLriJNq.js";import{M as h}from"./blocks-SOxllcy3.js";import"./preload-helper-DV8odVq5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B21bnPHY.js";function l(i){const t={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(h,{title:"@dxtmisha/vi/functional-basic/Classes/Global - Dữ liệu Toàn cục"}),`
`,n.jsx(t.h1,{id:"lớp-global",children:"Lớp Global"}),`
`,n.jsxs(t.p,{children:["Một lớp tĩnh để lưu trữ và truy xuất dữ liệu toàn cục của ứng dụng. Dữ liệu được ghi ",n.jsx(t.strong,{children:"một lần duy nhất"})," trong quá trình khởi tạo và sau đó chỉ có thể đọc. Được sử dụng để truyền cấu hình hoặc dữ liệu từ máy chủ sang phía client."]}),`
...
Global.add({ apiUrl: 'https://other.com' }) // Không có hiệu lực
`})}),`
...
`})})]})}function g(i={}){const{wrapper:t}={...c(),...i.components};return t?n.jsx(t,{...i,children:n.jsx(l,{...i})}):l(i)}export{g as default};
