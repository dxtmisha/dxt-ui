...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypes(): string | undefined`}),` — Sao chép tệp kiểu dữ liệu mô-đun vào thư mục gốc `,(0,c.jsx)(t.code,{children:`ai-types`}),` theo tên dự án và định dạng liên kết đến bản sao.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesFileName(): string`}),` — Trả về tên tệp bản sao kiểu dữ liệu dựa trên tên dự án.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesPath(): string[]`}),` — Trả về đường dẫn đến tệp bản sao trong thư mục `,(0,c.jsx)(t.code,{children:`ai-types`}),` ở thư mục gốc.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`copyTypes(targetPath: string[]): void`}),` — Sao chép tệp kiểu dữ liệu mô-đun vào thư mục đích `,(0,c.jsx)(t.code,{children:`ai-types`}),`.`]}),`
