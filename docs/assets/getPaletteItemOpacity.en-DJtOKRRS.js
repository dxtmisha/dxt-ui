...
`,(0,c.jsxs)(t.p,{children:[`The function generates a nested CSS variable chain (using the `,(0,c.jsx)(t.code,{children:`var()`}),` fallback parameter) to search for an opacity value across multiple palette nodes.`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`String`}),` — a nested `,(0,c.jsx)(t.code,{children:`var(--name1-opacity, var(--name2-opacity, ...))`}),` string.`]}),`
`]}),`
