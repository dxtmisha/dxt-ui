import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/styles/color/! Về Hệ thống Màu sắc` }), `
...
`] }), `
`, (0, c.jsxs)(n.p, { children: [`Sử dụng các mixin được mô tả trong phần `, (0, c.jsx)(n.strong, { children: `Sử dụng Thuộc tính Cơ bản` }), ` và `, (0, c.jsx)(n.strong, { children: `Làm việc với Bảng màu` }), ` để giữ cho giao diện luôn có khả năng mở rộng và dễ duy trì.`] })] })
