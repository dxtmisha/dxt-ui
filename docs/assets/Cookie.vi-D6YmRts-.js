...
`,n.jsxs(e.p,{children:["Để khởi tạo đối tượng, hãy gọi hàm khởi tạo ",n.jsx(e.code,{children:"Cookie(name)"}),"."]}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"Tham số:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"name: string"})," — tên của cookie bạn muốn quản lý."]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-typescript",children:`import { Cookie } from '@dxtmisha/functional'
...
`]})]})}function a(c={}){const{wrapper:e}={...i(),...c.components};return e?n.jsx(e,{...c,children:n.jsx(h,{...c})}):h(c)}export{a as default};
