import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional-basic/Classes/Geo - Глобальные Географические Данные` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Автоматическое определение` }), ` — интеллектуально определяет локаль через хранилище или настройки окружения.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Персистентность` }), ` — использует `, (0, c.jsx)(n.code, { children: `DataStorage` }), ` для сохранения и восстановления предпочтений пользователя.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Интеграция с медиа-базой` }), ` — предоставляет доступ к базе данных стран и языков из библиотеки `, (0, c.jsx)(n.code, { children: `@dxtmisha/media` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Глобальное управление временем` }), ` — централизованная установка и получение смещения часового пояса.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `Статический доступ` }), ` — удобный глобальный интерфейс без необходимости ручного создания экземпляров.`] }), `
`] }), `
