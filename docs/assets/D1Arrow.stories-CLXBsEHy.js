import{a as e,i as t}from"./preload-helper-Cv19cBWa.js";import{Ft as n,nn as r}from"./iframe-B-LNhFWZ.js";import{d as i,m as a,n as o,o as s,s as c,t as l,u}from"./wiki-DgltPJFG.js";import{i as d,n as f,r as p,t as m}from"./D1Arrow-D30C5P_s.js";var h,g,_,v,y=t((()=>{l(),d(),h=[{name:`clientOnly`,type:`boolean`},{name:`elementTarget`,type:`string | HTMLElement`},{name:`position`,type:`string`,option:[`auto`,`top`,`bottom`,`left`,`right`]},{name:`size`,type:`string`,option:[`sm`,`md`,`lg`]}],g=[],_=[],v={component:`Arrow`,props:h,slots:g,events:_,defaults:p,wikiDesign:o}})),b,x=t((()=>{i(),c(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,s,a)})),S=e({Arrow:()=>w,ArrowBasic:()=>T,__namedExportsOrder:()=>E,default:()=>C}),C,w,T,E,D=t((()=>{f(),x(),n(),C={title:`Ui/Arrow`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1Arrow:m},setup:()=>({args:e}),template:`
