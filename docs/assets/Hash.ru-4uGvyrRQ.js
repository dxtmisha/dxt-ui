import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/ru/functional-basic/Classes/Hash - Состояние URL Hash` }), `
`, (0, c.jsx)(n.h1, { id: `класс-hash`, children: `Класс Hash` }), `
`, (0, c.jsxs)(n.p, { children: [`Статический класс-фасад для управления данными, которые хранятся в URL-хэше (`, (0, c.jsx)(n.code, { children: `#` }), `). Он делегирует выполнение классу `, (0, c.jsx)(n.code, { children: `HashInstance` }), `, обеспечивая централизованный доступ и изоляцию состояния (например, при SSR).`] }), `
`, (0, c.jsxs)(n.p, { children: [`Автоматически синхронизирует состояние приложения с URL — каждый вызов `, (0, c.jsx)(n.code, { children: `set` }), ` обновляет строку хэша в браузере, а событие `, (0, c.jsx)(n.code, { children: `hashchange` }), ` обновляет внутреннее состояние.`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `SSR-изоляция` }), ` — Через `, (0, c.jsx)(n.code, { children: `ServerStorage` }), ` обеспечивается уникальный экземпляр данных для каждого запроса на сервере.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `static getItem(): HashInstance` }), ` — Возвращает текущий экземпляр `, (0, c.jsx)(n.code, { children: `HashInstance` }), ` (изолированный для текущего запроса).`] }), `
`] }), `
`, (0, c.jsx)(n.h3, { id: `чтение-и-запись`, children: `Чтение и запись` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `static get<T>(name: string, defaultValue?: T | (() => T)): T` }), ` — Возвращает значение переменной из хэша.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `static set<T>(name: string, callback: T | (() => T)): void` }), ` — Устанавливает значение переменной и обновляет URL-хэш.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `static reload(): void` }), ` — Принудительно синхронизирует состояние с текущим URL-хэшем.`] }), `
`] }), `
