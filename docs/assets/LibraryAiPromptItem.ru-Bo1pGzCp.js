...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypes(): string | undefined`}),` — Копирует файл типов модуля в корневую папку `,(0,c.jsx)(t.code,{children:`ai-types`}),` под именем проекта и формирует ссылку на копию.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesFileName(): string`}),` — Возвращает имя файла копии типов на основе названия проекта.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`getTypesPath(): string[]`}),` — Возвращает путь к скопированному файлу в корневой папке `,(0,c.jsx)(t.code,{children:`ai-types`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`copyTypes(targetPath: string[]): void`}),` — Выполняет копирование файла типов модуля в целевую директорию `,(0,c.jsx)(t.code,{children:`ai-types`}),`.`]}),`
