...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiType`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`, mặc định: `,(0,c.jsx)(t.code,{children:`'gemini'`}),`) — Nhà cung cấp trí tuệ nhân tạo để tối ưu hóa JSDoc và tạo mô tả (xem phần `,(0,c.jsx)(t.em,{children:`«11. Các nhà cung cấp AI được hỗ trợ»`}),` để biết chi tiết). Hỗ trợ:`,`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`gemini-cli`}),` — Gọi qua giao diện dòng lệnh Gemini CLI cục bộ (`,(0,c.jsx)(t.code,{children:`gemini`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`antigravity-cli`}),` — Gọi qua giao diện dòng lệnh Google Antigravity CLI (`,(0,c.jsx)(t.code,{children:`agy`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude`}),` — Anthropic Claude API chính thức (qua `,(0,c.jsx)(t.code,{children:`@anthropic-ai/sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-cli`}),` — Gọi qua công cụ dòng lệnh Claude Code CLI (`,(0,c.jsx)(t.code,{children:`claude`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`claude-agent`}),` — Chế độ tác tử tự trị qua Anthropic Claude Agent SDK (`,(0,c.jsx)(t.code,{children:`@anthropic-ai/claude-agent-sdk`}),`).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`openai`}),` — Các mô hình OpenAI (GPT-4o, GPT-4o-mini và các endpoint tương thích).`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`zai`}),` — Các mô hình xAI Grok (qua `,(0,c.jsx)(t.code,{children:`@ai-sdk/xai`}),` và Vercel AI SDK).`]}),`
`]}),`
`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`aiModel`})}),` (`,(0,c.jsx)(t.code,{children:`string`}),`) — Định danh chính xác của mô hình AI (ví dụ: `,(0,c.jsx)(t.code,{children:`gemini-3.7-flash`}),`, `,(0,c.jsx)(t.code,{children:`gpt-4o`}),`, `,(0,c.jsx)(t.code,{children:`claude-3-7-sonnet`}),`, `,(0,c.jsx)(t.code,{children:`grok-4.5`}),`).`]}),`
