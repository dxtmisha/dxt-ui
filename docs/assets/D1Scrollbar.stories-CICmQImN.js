import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,g as i,l as a,n as o,t as s,u as c}from"./wiki-CMC-2lzg.js";import{i as l,n as u,r as d,t as f}from"./D1Scrollbar-5CQG-tK6.js";var p,m,h,g,_=e((()=>{c(),s(),l(),p=[{name:`divider`,type:`boolean`},{name:`dividerBottom`,type:`boolean`},{name:`dividerHide`,type:`boolean`},{name:`dividerTop`,type:`boolean`},{name:`inverse`,type:`boolean`},{name:`standard`,type:`boolean`},{name:`tag`,type:`string`},{name:`visible`,type:`boolean`}],m=[{name:`default`}],h=[{name:`bottom`,properties:[{name:`isBottom`,type:`boolean`}]},{name:`edge`,properties:[{name:`isTop`,type:`boolean`},{name:` isBottom`,type:`boolean`},{name:` edge`,type:`ScrollbarEdgeType`}]},{name:`leaveBottom`},{name:`leaveTop`},{name:`reachBottom`},{name:`reachTop`},{name:`top`,properties:[{name:`isTop`,type:`boolean`}]}],g={component:`Scrollbar`,props:p,slots:m,events:h,defaults:d,wikiDesign:o}})),v,y=e((()=>{c(),n(),_(),v=new r(g.component,g.props,g.defaults,g.wikiDesign,a,i)})),b=t({Scrollbar:()=>S,__namedExportsOrder:()=>C,default:()=>x}),x,S,C,w=e((()=>{u(),y(),x={title:`Ui/Scrollbar`,component:f,parameters:{design:`d1`,docs:{description:{component:v.getDescription()}}},argTypes:v.getWiki(),args:v.getValues()},S={render:e=>({components:{D1Scrollbar:f},setup:()=>({args:e}),template:`
      <D1Scrollbar
