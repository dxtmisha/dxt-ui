import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, em: `em`, h1: `h1`, h2: `h2`, h3: `h3`, h4: `h4`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/functional-basic/Classes/ApiInstance - Request Management` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — wrapper function for request execution.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `setWrapper(wrapper: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>): this` }), ` — Sets the wrapper function for requests.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `wrapper?: <R>(callback: () => Promise<R>, apiFetch: ApiFetch) => Promise<R>` }), ` — local wrapper function for executing this specific request.`] }), `
`] }), `
...
`, (0, c.jsxs)(n.p, { children: [`The wrapper can be configured globally for the entire instance (via `, (0, c.jsx)(n.code, { children: `options.wrapper` }), ` or the `, (0, c.jsx)(n.code, { children: `setWrapper` }), ` method) or locally for a single request inside the `, (0, c.jsx)(n.code, { children: `ApiFetch` }), ` object.`] }), `
