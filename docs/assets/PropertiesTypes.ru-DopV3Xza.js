...
`,(0,c.jsx)(t.p,{children:`Проверяет, относится ли тип свойства к контейнерным типам (container query).`}),`
`,(0,c.jsx)(t.h3,{id:`isscssname-string-boolean`,children:(0,c.jsx)(t.code,{children:`isScss(name: string): boolean`})}),`
`,(0,c.jsx)(t.p,{children:`Проверяет, является ли имя свойства специальной переменной SCSS.`}),`
`,(0,c.jsx)(t.h3,{id:`isrootname-string-boolean`,children:(0,c.jsx)(t.code,{children:`isRoot(name: string): boolean`})}),`
`,(0,c.jsx)(t.p,{children:`Проверяет, относится ли свойство к корневому уровню (:root).`}),`
