...
`,(0,l.jsx)(t.p,{children:`A utility for saving data to Figma's client storage. It sends a message from the UI to the plugin side to store the provided value under a specific name.`}),`
