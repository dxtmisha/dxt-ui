import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{Ht as n,xt as r}from"./iframe-yo6yIkeP.js";import{a as i,d as a,m as o,n as s,o as c,t as l,u}from"./wiki-Ck-JDNL8.js";import{i as d,n as f,r as p,t as m}from"./D1MotionTransform-B9zxDkGJ.js";var h,g,_,v,y=e((()=>{l(),d(),h=[{name:`adaptive`,type:`string | undefined`,option:[`planeAlways`,`planeSm`,`planeMd`,`planeLg`,`planeXl`,`plane2xl`]},{name:`animationHeadPosition`,type:`string | undefined`,option:[`top`,`toBottom`]},{name:`animationShow`,type:`boolean | undefined`},{name:`ariaDescribedby`,type:`string | undefined`},{name:`ariaLabelledby`,type:`string | undefined`},{name:`autoClose`,type:`boolean | undefined`},{name:`clickOpen`,type:`boolean | undefined`},{name:`ignore`,type:`string | HTMLElement | undefined`},{name:`ignoreSelector`,type:`string | undefined`},{name:`inDom`,type:`boolean | undefined`},{name:`modelOpen`,type:`boolean | undefined`},{name:`onUpdate:modelOpen`,type:`((value: boolean) => void) | undefined`},{name:`onUpdate:open`,type:`((value: boolean) => void) | undefined`},{name:`open`,type:`boolean | undefined`},{name:`section`,type:`boolean | undefined`},{name:`tagBody`,type:`string | undefined`}],g=[{name:`body`,description:`Body slot for content/ Слот тела для содержимого`,properties:[{name:`props`,type:`(MotionTransformControlItem) | undefined`}]},{name:`head`,description:`Head slot for controls/ Слот шапки для элементов управления`,properties:[{name:`props`,type:`(MotionTransformControlItem) | undefined`}]}],_=[{name:`transform`,description:`Event triggered on transformation completion/ Событие, вызываемое при завершении трансформации`,properties:[{name:`event`,type:`Event | undefined`},{name:`options`,type:`MotionTransformEmitOptions`}]},{name:`transformLite`,description:`Lightweight transformation event/ Облегченное событие трансформации`,properties:[{name:`options`,type:`MotionTransformEmitOptions`}]},{name:`update:modelOpen`,description:`Update model open event/ Событие обновления открытия модели`,properties:[{name:`value`,type:`boolean`}]},{name:`update:open`,description:`Update open event/ Событие обновления открытия`,properties:[{name:`value`,type:`boolean`}]}],v={component:`MotionTransform`,props:h,slots:g,events:_,defaults:p,wikiDesign:s}})),b,x=e((()=>{a(),c(),y(),b=new u(v.component,v.props,v.defaults,v.wikiDesign,i,o)})),S=t({MotionTransform:()=>w,MotionTransformAnimationHeadPosition:()=>T,MotionTransformIgnore:()=>E,MotionTransformVModel:()=>D,__namedExportsOrder:()=>O,default:()=>C}),C,w,T,E,D,O,k=e((()=>{f(),x(),r(),C={title:`Ui/MotionTransform`,component:m,parameters:{design:`d1`,docs:{description:{component:b.getDescription()}}},argTypes:b.getWiki(),args:b.getValues()},w={render:e=>({components:{D1MotionTransform:m},setup:()=>({args:e}),template:`
