import{n as e,r as t}from"./chunk-BneVvdWh.js";import{a as n,d as r,g as i,i as a,l as o,n as s,t as c,u as l}from"./wiki-COBgMBNI.js";import{i as u,n as d,r as f,t as p}from"./D1Skeleton-CFezRexj.js";var m,h,g,_,v=e((()=>{l(),c(),u(),m=[{name:`active`,type:`boolean`}],h=[{name:`default`,description:`Slot for default skeleton content/ Слот для основного содержимого скелета`,properties:[{name:`props`,type:`SkeletonClassesList`}]}],g=[],_={component:`Skeleton`,props:m,slots:h,events:g,defaults:f,wikiDesign:s}})),y,b=e((()=>{l(),n(),v(),y=new r(_.component,_.props,_.defaults,_.wikiDesign,o,i)})),x=t({Skeleton:()=>C,SkeletonBasic:()=>w,__namedExportsOrder:()=>T,default:()=>S}),S,C,w,T,E=e((()=>{d(),b(),n(),S={title:`Ui/Skeleton`,component:p,parameters:{design:`d1`,docs:{description:{component:y.getDescription()}}},argTypes:y.getWiki(),args:y.getValues()},C={render:e=>({components:{D1Skeleton:p},setup:()=>({args:e}),template:`
      <D1Skeleton v-bind="args">
      <div class="wiki-storybook-card d1-skeleton__background">
        <div class="wiki-storybook-card__image d1-skeleton__background" style="background-image: url('${a}')"/>
