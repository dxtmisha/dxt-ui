import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/en/functional-basic/Classes/Meta - SEO Meta Tag Management` }), `
...
`] }), `
`, (0, c.jsx)(n.h2, { id: `methods-for-generating-html`, children: `Methods for Generating HTML` }), `
`, (0, c.jsxs)(n.ul, { children: [`
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `html(): string` }), ` — generates the full HTML string of all meta tags: standard + Open Graph + Twitter Card. Used for SSR.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `htmlTitle(): string` }), ` — generates the page title.`] }), `
`] }), `
...
`, (0, c.jsx)(n.p, { children: `Generates the current title (including suffix).` }), `
`, (0, c.jsx)(n.pre, { children: (0, c.jsx)(n.code, { className: `language-javascript`, children: `const meta = new Meta()
