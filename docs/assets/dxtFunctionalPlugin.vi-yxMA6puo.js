import { i as e } from './preload-helper-Cv19cBWa.js'; import { a as t, t as n } from './jsx-runtime-D1H6-shM.js'; import { f as r, s as i } from './blocks-CKlddtvc.js'; import { t as a } from './mdx-react-shim-B1U8VZv0.js'; function o(e) {
  let n = { code: `code`, h1: `h1`, h2: `h2`, h3: `h3`, li: `li`, ol: `ol`, p: `p`, pre: `pre`, strong: `strong`, ul: `ul`, ...t(), ...e.components }; return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(i, { title: `@dxtmisha/vi/functional/Functions/dxtFunctionalPlugin - Khởi tạo thống nhất` }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.strong, { children: `ErrorCenter` }), `: Cấu hình danh sách nguyên nhân lỗi định trước thông qua `, (0, c.jsx)(n.code, { children: `ErrorCenter.addList()` }), ` và đăng ký các trình xử lý lỗi thông qua `, (0, c.jsx)(n.code, { children: `ErrorCenter.addHandlerList()` }), `.`] }), `
...
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `errorCauses?: ErrorCenterCauseList` }), ` — Danh sách các nguyên nhân lỗi định trước cho `, (0, c.jsx)(n.code, { children: `ErrorCenter` }), `.`] }), `
`, (0, c.jsxs)(n.li, { children: [(0, c.jsx)(n.code, { children: `errorHandlers?: ErrorCenterHandlerList` }), ` — Danh sách các trình xử lý lỗi cho `, (0, c.jsx)(n.code, { children: `ErrorCenter` }), `.`] }), `
`] }), `
